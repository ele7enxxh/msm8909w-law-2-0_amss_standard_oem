...
ifeq ($(TARGET_ENABLE_QC_BT_SOC_LOG),true)
ifeq ($(TARGET_BUILD_VARIANT),userdebug)
#LOCAL_CFLAGS += -DQSOCLOG_USERDEBUG
endif
endif
...
# add libbtnv library
LOCAL_SHARED_LIBRARIES := libbtnv
LOCAL_SHARED_LIBRARIES  += libqmiservices libqmi_cci libqcci_legacy libqmi_client_qmux liblog
LOCAL_C_INCLUDES += $(TARGET_OUT_HEADERS)/qmi-framework/inc
LOCAL_C_INCLUDES += $(TARGET_OUT_HEADERS)/qmi/inc
endif
...
include $(TEMP_LOCAL_PATH)/aptX/16bit/Android.mk
include $(TEMP_LOCAL_PATH)/aptX/aptXScheduler/Android.mk
