...
/*==========================================================================
  ...
  FUNCTION       bt_hci_qcomm_pfal_sendsocloggingcmd

  DESCRIPTION    This routine enables soc logging for user debug builds

  DEPENDENCIES   None

  PARAMETERS     None

  RETURN VALUE   boolean: TRUE if vendor specific command send successful
