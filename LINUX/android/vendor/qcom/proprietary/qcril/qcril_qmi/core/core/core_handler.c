...
***************************************************************************************************/
void* core_handler_thread_proc(CRI_UNUSED(void* core_handler_thread_proc_param))
{
...
***************************************************************************************************/
int core_queue_add_evaluator(CRI_UNUSED(util_list_node_data_type *to_be_added_data),
