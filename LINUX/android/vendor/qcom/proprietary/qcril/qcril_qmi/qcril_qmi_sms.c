...
*/
/*=========================================================================*/
void qcril_qmi_sms_set_primary_client( QCRIL_UNUSED(void * param) )
{
    qmi_client_error_type qmi_err;
...
)
{
  ...
  do
  {
    ...
    if ( (res = qcril_qmi_client_send_msg_sync_ex(
                                  QCRIL_QMI_CLIENT_WMS,
    ...
    if ( TRUE == nw_reg_response_msg.transport_nw_reg_status_valid )
    {
        ...
        if ( WMS_TRANSPORT_NW_REG_STATUS_FULL_SERVICE_V01 == nw_reg_response_msg.transport_nw_reg_status )
        {
            ...
            if ((res = qcril_qmi_client_send_msg_sync_ex( QCRIL_QMI_CLIENT_WMS,
                                  QMI_WMS_GET_TRANSPORT_LAYER_INFO_REQ_V01,
                                  NULL,
                                  0,
                                  &response_msg,
...
)
{
  ...
  do
  {
        ...
        qmi_mwi_msg->message_waiting_detail_info_len > 0)
    {
      ...
      QCRIL_LOG_INFO( "num of mwi_msg_summary = %d", detail_len);
  ...
  qcril_qmi_npb_release(ims_Mwi_fields, &ims_mwi);
