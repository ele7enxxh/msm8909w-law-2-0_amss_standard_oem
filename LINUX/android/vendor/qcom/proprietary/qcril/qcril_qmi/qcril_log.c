...
static const qcril_qmi_event_log_type qcril_request_name[]  =
{
  ...
  { RIL_REQUEST_CAF_SIM_OPEN_CHANNEL_WITH_P2,         "RIL_REQUEST_CAF_SIM_OPEN_CHANNEL_WITH_P2" },
#endif /* RIL_REQUEST_CAF_SIM_OPEN_CHANNEL_WITH_P2 */

  /* 234 */
  { RIL_REQUEST_SET_LTE_BAND_PREF,                    "RIL_REQUEST_SET_LTE_BAND_PREF" },
  ...
  { RIL_REQUEST_GET_ADN_RECORD,                       "RIL_REQUEST_GET_ADN_RECORD" },
  { RIL_REQUEST_UPDATE_ADN_RECORD,                    "RIL_REQUEST_UPDATE_ADN_RECORD" },
...
static const qcril_qmi_event_log_type qcril_unsol_response_name[] =
{
  ...
  { RIL_UNSOL_RESPONSE_ADN_INIT_DONE,                 "RIL_UNSOL_RESPONSE_ADN_INIT_DONE" },
  { RIL_UNSOL_RESPONSE_ADN_RECORDS,                   "RIL_UNSOL_RESPONSE_ADN_RECORDS" },
#if (RIL_QCOM_VERSION >= 2)
...
void qcril_log_timer_expiry_cb(QCRIL_UNUSED(void * params))
{
    struct timeval tv;
    struct timespec ts;
    struct tm* tm = NULL;
