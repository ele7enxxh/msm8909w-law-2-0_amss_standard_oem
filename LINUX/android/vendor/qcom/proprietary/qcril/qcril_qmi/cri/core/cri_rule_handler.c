...
***************************************************************************************************/
int rule_queue_add_evaluator(CRI_UNUSED(util_list_node_data_type *to_be_added_data),
...
void rule_check_helper(util_list_node_data_type *rule_node_data,
                       CRI_UNUSED(cri_core_context_type context),
                       cri_core_error_type cri_core_error,
                       void *cri_resp_data)
{
