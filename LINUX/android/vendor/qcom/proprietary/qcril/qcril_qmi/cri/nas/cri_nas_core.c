...
void cri_nas_core_sys_info_ind_handler(CRI_UNUSED(int qmi_service_client_id),
...
void cri_nas_core_sig_info_ind_handler(CRI_UNUSED(int qmi_service_client_id),
...
void cri_nas_core_managed_roaming_ind_handler(CRI_UNUSED(int qmi_service_client_id),
...
void cri_nas_core_nas_reject_ind_handler(CRI_UNUSED(int qmi_service_client_id),
...
void cri_nas_core_system_selection_ind_handler(CRI_UNUSED(int qmi_service_client_id),
...
cri_core_error_type cri_nas_core_set_pref_mode_resp_handler(
                        CRI_UNUSED(int qmi_service_client_id),
...
{
    void *reg_info = NULL;
    cri_nas_rte_type rte = CRI_NAS_RTE_UNKNOWN;
    cri_nas_tech_reg_status_type reg_status = CRI_NAS_TECH_REG_STATUS_UNKNOWN;
    cri_nas_rte_reg_confidence_type reg_confidence = CRI_NAS_RTE_REG_CONFIDENCE_UNKNOWN;

    cri_nas_rte_gsm_reg_info_type *gsm_reg_info = NULL;
    cri_nas_rte_wcdma_reg_info_type *wcdma_reg_info = NULL;
    cri_nas_rte_tdscdma_reg_info_type *tdscdma_reg_info = NULL;
    cri_nas_rte_lte_reg_info_type *lte_reg_info = NULL;
    cri_nas_rte_cdma_reg_info_type *cdma_reg_info = NULL;
    cri_nas_rte_hdr_reg_info_type *hdr_reg_info = NULL;
...
cri_core_error_type cri_nas_fetch_system_selection_preference()
{
    ...
    ret_val = (cri_core_error_type) cri_core_qmi_send_msg_sync(nas_client_id,
                                                            ...
                                                            uint32_t *is_changed)
{
        ...
        curr_roaming_pref != roaming_pref ) )
    {
        ...
        if(rule_data)
        {
            ...
            ret_val = (cri_core_error_type) cri_core_qmi_send_msg_async(cri_core_context,
                                                nas_client_id,
...
void cri_nas_core_nw_scan_resp_handler(CRI_UNUSED(int qmi_service_client_id),
                                        void *nw_scan_resp_msg,
                                        cri_core_context_type cri_core_context)
{
    cri_core_error_type cri_core_error;
...

{
    ...
    return (cri_core_error_type) ret_val;
...
cri_core_error_type cri_nas_core_limit_sys_info_indication(uint8_t flag)
{
    ...
    req_msg.limit_sys_info_chg_rpt = flag ? (NAS_LIMIT_BY_SRV_STATUS_V01 | NAS_LIMIT_BY_SRV_DOMAIN_V01 | NAS_LIMIT_BY_LTE_EMBMS_COVERAGE_V01) : NIL;
                                            ...
                                            uint8_t is_nw_sel_in_progress)
{
    ...
    cri_error = (cri_core_error_type) cri_core_qmi_send_msg_sync( nas_client_id,
