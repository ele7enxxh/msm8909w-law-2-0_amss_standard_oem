...
/***************************************************************************************************
    ...
    None.
***************************************************************************************************/
void cri_csvt_originate_resp_handler(CRI_UNUSED(int qmi_service_client_id),
...
/***************************************************************************************************
    ...
    None.
***************************************************************************************************/
void cri_csvt_answer_resp_handler(CRI_UNUSED(int qmi_service_client_id),
                                  csvt_answer_call_resp_msg_v01 *csvt_answer_call_resp_msg,
                                  cri_core_context_type cri_core_context)
{
    cri_core_error_type cri_core_error;
...
/***************************************************************************************************
    ...
    None.
***************************************************************************************************/
void cri_csvt_end_resp_handler(CRI_UNUSED(int qmi_service_client_id),
                               csvt_end_call_resp_msg_v01 *csvt_end_call_resp_msg,
                               cri_core_context_type cri_core_context)
{
    cri_core_error_type cri_core_error;
...
/***************************************************************************************************
    ...
    None.
***************************************************************************************************/
void cri_csvt_confirm_resp_handler(CRI_UNUSED(int qmi_service_client_id),
