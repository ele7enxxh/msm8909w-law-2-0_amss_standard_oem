...
static util_list_node_data_type* cri_voice_call_list_find_node(const util_list_info_type* call_list_ptr, int (*evaluator)(const util_list_node_data_type* node_data, const void* data), const void* data);
static cri_voice_call_obj_type* cri_voice_call_list_find_call_obj(const util_list_info_type* call_list_ptr, int (*evaluator)(const util_list_node_data_type* node_data, const void* data), const void* data);

int cri_voice_call_list_add_evaluator(CRI_UNUSED(util_list_node_data_type *to_be_added_data),
                                      CRI_UNUSED(util_list_node_data_type *to_be_evaluated_data))
{
    return FALSE;
}
...
{
    cri_core_error_type err = CRI_ERR_INTERNAL_V01;
    uint8_t cri_call_id;
...
util_list_node_data_type* cri_voice_call_list_find_node(const util_list_info_type* call_list_ptr, int (*evaluator)(const util_list_node_data_type* node_data, const void* data), const void* data)
{
...
cri_voice_call_obj_type* cri_voice_call_list_find_call_obj(const util_list_info_type* call_list_ptr, int (*evaluator)(const util_list_node_data_type* node_data, const void* data), const void* data)
{
    cri_voice_call_obj_type* call_obj_ptr = NULL;
...
int cri_voice_compare_call_obj_cri_call_id(const util_list_node_data_type* node_data_ptr, const void* cri_call_id_param)
{
    int ret = FALSE;
...
int cri_voice_compare_call_obj_qmi_voice_call_id(const util_list_node_data_type* node_data_ptr, const void* cri_call_id_param)
{
    int ret = FALSE;
...
int cri_voice_compare_call_obj_qmi_call_state(const util_list_node_data_type* node_data_ptr, const void* param)
{
    int ret = FALSE;
    const call_state_enum_v02 qmi_call_state = (call_state_enum_v02)param;
    if (node_data_ptr && node_data_ptr->user_data)
    {
        cri_voice_call_obj_type *call_obj_ptr = (cri_voice_call_obj_type *)node_data_ptr->user_data;
...
int cri_voice_compare_call_obj_cri_call_state(const util_list_node_data_type* node_data_ptr, const void* param)
{
    int ret = FALSE;
