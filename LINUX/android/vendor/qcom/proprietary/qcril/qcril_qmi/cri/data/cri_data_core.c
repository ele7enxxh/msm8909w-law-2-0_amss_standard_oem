...
void cri_data_core_async_resp_handler(CRI_UNUSED(int qmi_service_client_id),
                                     unsigned long message_id,
                                     CRI_UNUSED(void *resp_data),
                                     CRI_UNUSED(int resp_data_len),
                                     CRI_UNUSED(cri_core_context_type cri_core_context))
{
...
void cri_data_core_system_status_ind_handler(CRI_UNUSED(int qmi_service_client_id),
