...
{
    {ims_MsgId_REQUEST_DIAL, hlos_csvt_dial_request_handler},
    {ims_MsgId_REQUEST_HANGUP, hlos_csvt_hangup_request_handler},
    {ims_MsgId_REQUEST_LAST_CALL_FAIL_CAUSE, hlos_csvt_last_call_failure_cause_request_handler},
    {ims_MsgId_REQUEST_GET_CURRENT_CALLS, hlos_csvt_get_current_calls_request_handler},
    {ims_MsgId_REQUEST_ANSWER, hlos_csvt_answer_request_handler}
};
