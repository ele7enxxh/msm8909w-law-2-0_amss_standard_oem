                                                ...
                                                uint8_t *buf, size_t buf_size)
{
    ...
    if(qcril_uim_remote_client_is_msg_valid(message_id, type))
    {
        ...
        const pb_field_t* fields = qcril_uim_remote_client_get_msg_pb_fields(message_id, type);
                                              ...
                                              qcril_evt_e_type* event_ptr)
{
    ...
    *event_ptr = qcril_uim_remote_client_get_msg_event(msg_id, msg_type);
    ...
    {
        const pb_field_t* fields = qcril_uim_remote_client_get_msg_pb_fields(msg_id, msg_type);
