...
const pb_field_t com_qualcomm_uimremoteclient_UimRemoteEventReq_fields[9] = {
    ...
    PB_FIELD2(  5, ENUM    , OPTIONAL, STATIC  , OTHER, com_qualcomm_uimremoteclient_UimRemoteEventReq, transport, error_code, 0),
    PB_FIELD2(  6, ENUM    , OPTIONAL, STATIC  , OTHER, com_qualcomm_uimremoteclient_UimRemoteEventReq, usage, transport, 0),
    PB_FIELD2(  7, UINT32  , OPTIONAL, STATIC  , OTHER, com_qualcomm_uimremoteclient_UimRemoteEventReq, apdu_timeout, usage, 0),
    PB_FIELD2(  8, UINT32  , OPTIONAL, STATIC  , OTHER, com_qualcomm_uimremoteclient_UimRemoteEventReq, disable_all_polling, apdu_timeout, 0),
    PB_LAST_FIELD
};
