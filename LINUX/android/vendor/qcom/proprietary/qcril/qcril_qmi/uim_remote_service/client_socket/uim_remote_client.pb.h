...
typedef enum _com_qualcomm_uimremoteclient_UimRemoteEventReq_Transport {
    com_qualcomm_uimremoteclient_UimRemoteEventReq_Transport_UIM_REMOTE_TRANSPORT_OTHER = 0,
    com_qualcomm_uimremoteclient_UimRemoteEventReq_Transport_UIM_REMOTE_TRANSPORT_BLUETOOTH = 1,
    com_qualcomm_uimremoteclient_UimRemoteEventReq_Transport_UIM_REMOTE_TRANSPORT_IP = 2
} com_qualcomm_uimremoteclient_UimRemoteEventReq_Transport;

typedef enum _com_qualcomm_uimremoteclient_UimRemoteEventReq_Usage {
    com_qualcomm_uimremoteclient_UimRemoteEventReq_Usage_UIM_REMOTE_USAGE_REDUCED = 0,
    com_qualcomm_uimremoteclient_UimRemoteEventReq_Usage_UIM_REMOTE_USAGE_NORMAL = 1
} com_qualcomm_uimremoteclient_UimRemoteEventReq_Usage;
...
typedef struct _com_qualcomm_uimremoteclient_UimRemoteEventReq {
    ...
    bool has_transport;
    com_qualcomm_uimremoteclient_UimRemoteEventReq_Transport transport;
    bool has_usage;
    com_qualcomm_uimremoteclient_UimRemoteEventReq_Usage usage;
...
#define com_qualcomm_uimremoteclient_UimRemoteEventReq_transport_tag 5
#define com_qualcomm_uimremoteclient_UimRemoteEventReq_usage_tag 6
#define com_qualcomm_uimremoteclient_UimRemoteEventReq_apdu_timeout_tag 7
#define com_qualcomm_uimremoteclient_UimRemoteEventReq_disable_all_polling_tag 8
...
extern const pb_field_t com_qualcomm_uimremoteclient_UimRemoteEventReq_fields[9];
