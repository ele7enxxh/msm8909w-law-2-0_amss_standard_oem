...
)
{
    ...
    else
    {
        status_t status = AudioSystem::setParameters(
                             0,
                             qcril_am_convert_vsid_audio_call_state_to_string(audio_vsid, audio_call_state, call_mode));
...
***************************************************************************************************/
static void qcril_am_audio_system_error_callback_helper(QCRIL_UNUSED(void * param))
{
