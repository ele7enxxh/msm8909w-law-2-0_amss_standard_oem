...
)
{
  ...
  switch (qcril_err_code)
  {
    ...
    case QMI_SERVICE_ERR_INVALID_CLIENT_ID:
    case QMI_SERVICE_ERR_INVALID_HANDLE:
    case QMI_SERVICE_ERR_INVALID_PROFILE:
    case QMI_SERVICE_ERR_INVALID_PINID:
    case QMI_SERVICE_ERR_MISSING_ARG:
    case QMI_SERVICE_ERR_ARG_TOO_LONG:
    case QMI_SERVICE_ERR_INVALID_TX_ID:
    case QMI_SERVICE_ERR_AUTHENTICATION_FAILED:
    case QMI_SERVICE_ERR_INVALID_ARG:
    case QMI_SERVICE_ERR_INVALID_INDEX:
    case QMI_SERVICE_ERR_INVALID_OPERATION:
    case QMI_SERVICE_ERR_INVALID_QMI_CMD:
    case QMI_SERVICE_ERR_INVALID_SESSION_TYPE:
    case QMI_SERVICE_ERR_INVALID_PB_TYPE:
      ril_error_value = QCRIL_UIM_RIL_E_INVALID_ARGUMENTS;
      break;

    case QMI_SERVICE_ERR_CLIENT_IDS_EXHAUSTED:
    case QMI_SERVICE_ERR_INSUFFICIENT_RESOURCES:
      ril_error_value = QCRIL_UIM_RIL_E_NO_RESOURCES;
      break;

    case QMI_SERVICE_ERR_INCORRECT_PIN:
    case QMI_SERVICE_ERR_PIN_BLOCKED:
    case QMI_SERVICE_ERR_PIN_PERM_BLOCKED:
    case QMI_SERVICE_ERR_SIM_NOT_INITIALIZED:
    case QMI_SERVICE_ERR_PB_NOT_READY:
    case QMI_SERVICE_ERR_PIN_RESTRICTION:
    case QMI_SERVICE_ERR_PIN2_RESTRICTION:
    case QMI_SERVICE_ERR_PUK_RESTRICTION:
    case QMI_SERVICE_ERR_PUK2_RESTRICTION:
    case QMI_SERVICE_ERR_PB_ACCESS_RESTRICTED:
    case QMI_SERVICE_ERR_PB_DELETE_IN_PROG:
      ril_error_value = QCRIL_UIM_RIL_E_INVALID_SIM_STATE;
      break;

    case QMI_SERVICE_ERR_SESSION_INACTIVE:
    case QMI_SERVICE_ERR_SESSION_INVALID:
    case QMI_SERVICE_ERR_SESSION_OWNERSHIP:
    case QMI_SERVICE_ERR_SIM_FILE_NOT_FOUND:
    case QMI_SERVICE_ERR_FDN_RESTRICT:
    case QMI_SERVICE_ERR_NO_SUBSCRIPTION:
    case QMI_SERVICE_ERR_CARD_CALL_CONTROL_FAILED:
    case QMI_SERVICE_ERR_NO_SIM:
      ril_error_value = QCRIL_UIM_RIL_E_SIM_ERR;
      break;

    case QMI_SERVICE_ERR_DISABLED:
