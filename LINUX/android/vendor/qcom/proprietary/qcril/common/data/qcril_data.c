...
typedef struct
{
#if ((RIL_QCOM_VERSION >= 1) || (QCRIL_RIL_VERSION >= 6))
...
#endif /* (RIL_QCOM_VERSION >= 1) || (QCRIL_RIL_VERSION >= 6) */
...
#else /*((RIL_QCOM_VERSION >= 1) || (QCRIL_RIL_VERSION >= 6))*/
static RIL_Data_Call_Response_v6 call_tbl[ MAX_CONCURRENT_UMTS_DATA_CALLS ] =
{
  { 0, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4},
  { 1, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 2, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 3, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 4, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 5, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 6, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 7, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 8, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 9, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 10, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 11, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 12, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 13, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 14, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 15, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 16, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 17, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 18, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 },
  { 19, CALL_INACTIVE, '\0', '\0', '\0', RADIO_TECH_UNKNOWN, PDP_FAIL_OEM_DCFAILCAUSE_4 }
};
#endif /*((RIL_QCOM_VERSION >= 1) || (QCRIL_RIL_VERSION >= 6))*/
...
)
{
  ...
  switch( evt_info_ptr->evt )
  {
    ...
    case DSI_EVT_NET_NO_NET:
      ...
      {
        //call_tbl [ info_tbl_ptr->index ].inactiveReason = PDP_FAIL_OEM_DCFAILCAUSE_4;
        QCRIL_LOG_ERROR( "dsi_get_last_call_fail_cause FAILED, setting [%u]", PDP_FAIL_OEM_DCFAILCAUSE_4 );
      }
