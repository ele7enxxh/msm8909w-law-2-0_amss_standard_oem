...
#define CHK_ERR(err,s) if ((err)<=0) { perror(s); }
...
extern int tcp_connection_active;

extern int                 qmi_ip_server_fd;
...
extern int qmi_ip_wds_init(qmi_ip_conf_t * conf, int *server_fd,
