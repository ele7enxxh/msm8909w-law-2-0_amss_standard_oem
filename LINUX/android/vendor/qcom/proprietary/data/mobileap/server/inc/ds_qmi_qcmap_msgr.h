...
typedef void (*qcmap_msgr_eth_backhaul_mode_ind_cb_fcn)
(
  void                           *user_data,              /* Call back User data */
  qcmap_msgr_eth_backhaul_status_enum_v01 conn_status              /* Connection Status enum */
);
...
typedef struct
{
  ...
  qcmap_msgr_eth_backhaul_mode_ind_cb_fcn  eth_backhaul_cb;
