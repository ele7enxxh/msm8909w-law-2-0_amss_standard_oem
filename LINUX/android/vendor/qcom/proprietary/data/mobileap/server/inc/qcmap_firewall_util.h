...
Copyright (c) 2004-2009,2013 Qualcomm Technologies, Inc.  All Rights Reserved.
...
/******************************************************************************
    ...
    --------   ---        -------------------------------------------------------
    02/05/14        pm         added file to source directory
******************************************************************************/
...
typedef enum
{
  ...
  PS_IPPROTO_NO_PROTO     = 0,                  /* No Protocol specified   */
  ...
  PS_IPPROTO_DNS          = 53,                 /* Authentication Header      */
