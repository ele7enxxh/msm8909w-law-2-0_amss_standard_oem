...
boolean QCMAP_Client::EnableMobileAP(qmi_error_type_v01 *qmi_err_num)
{
  ...
  qcmap_msgr_eth_backhaul_mode_status_ind_register_req_msg_v01
                                         qcmap_eth_backhaul_mode_status_ind_reg;
  qcmap_msgr_eth_backhaul_mode_status_ind_register_resp_msg_v01
                                         qcmap_eth_backhaul_mode_status_ind_rsp;
  ...
  memset(&qcmap_eth_backhaul_mode_status_ind_reg, 0,
         sizeof(qcmap_msgr_eth_backhaul_mode_status_ind_register_req_msg_v01));
  memset(&qcmap_eth_backhaul_mode_status_ind_rsp, 0,
         sizeof(qcmap_msgr_eth_backhaul_mode_status_ind_register_resp_msg_v01));
  qcmap_eth_backhaul_mode_status_ind_reg.register_indication =
                                     QCMAP_MSGR_ETH_BACKHAUL_STATUS_IND_REG_V01;

  qmi_error = qmi_client_send_msg_sync(this->qmi_qcmap_msgr_handle,
               QMI_QCMAP_MSGR_ETH_BACKHAUL_MODE_STATUS_IND_REG_REQ_V01,
               (void*)&qcmap_eth_backhaul_mode_status_ind_reg,
           sizeof(qcmap_msgr_eth_backhaul_mode_status_ind_register_req_msg_v01),
               (void*)&qcmap_eth_backhaul_mode_status_ind_rsp,
          sizeof(qcmap_msgr_eth_backhaul_mode_status_ind_register_resp_msg_v01),
               QCMAP_MSGR_QMI_TIMEOUT_VALUE);

  LOG_MSG_INFO1("qmi_client_send_msg_sync: error %d result %d",
     qmi_error, qcmap_eth_backhaul_mode_status_ind_rsp.resp.result,0);
  if ( ( qmi_error == QMI_TIMEOUT_ERR ) ||
       ( qmi_error != QMI_NO_ERR ) ||
       ( qcmap_eth_backhaul_mode_status_ind_rsp.resp.result != QMI_NO_ERR ))
  {
    LOG_MSG_ERROR("Cannot register for ETH Backhaul mode indications %d : %d",
                qmi_error, qcmap_eth_backhaul_mode_status_ind_rsp.resp.error,0);
    *qmi_err_num = qcmap_eth_backhaul_mode_status_ind_rsp.resp.error;
     return false;
  }
  LOG_MSG_INFO1("Registered for ETH Backhaul mode status",0,0,0);
...
boolean QCMAP_Client::SetFirewall(boolean enable_firewall, boolean pkts_allowed,
	                               qmi_error_type_v01 *qmi_err_num)
{
...
boolean QCMAP_Client::GetFirewall(boolean *enable_firewall, boolean *pkts_allowed,
	                                qmi_error_type_v01 *qmi_err_num)
{
...
boolean QCMAP_Client::GetDDNSConfig(qcmap_msgr_get_dynamic_dns_config_resp_msg_v01 *ddns_server, qmi_error_type_v01 *qmi_err_num)
{
  ...
  if ( get_ddns_resp_msg.ddns_config_len > 0)
  {
   ...
   if(get_ddns_resp_msg.hostname_valid)
    memcpy(ddns_server->hostname,get_ddns_resp_msg.hostname,QCMAP_MSGR_DDNS_HOSTNAME_LENGTH_V01);
...
boolean QCMAP_Client::SetUPNPState(boolean firewall_state, boolean upnp_pinhole_flag, qmi_error_type_v01 *qmi_err_num)
{
 qcmap_msgr_set_firewall_config_req_msg_v01 set_firewall_req_msg;
 qcmap_msgr_set_firewall_config_resp_msg_v01 set_firewall_resp_msg;
 qmi_client_error_type qmi_error;
 boolean enable_firewall, pkts_allowed;
 //QcMapClient->GetFirewall(boolean *enable_firewall,boolean *pkts_allowed,qmi_error_type_v01 * qmi_err_num);
 ...
 {
   set_firewall_req_msg.upnp_pinhole_flag = upnp_pinhole_flag;
   set_firewall_req_msg.upnp_pinhole_flag_valid = false;
 }

 LOG_MSG_INFO1("\n firewall_enabled =%d upnp_pinhole_flag =%d ",enable_firewall,upnp_pinhole_flag,0);
 qmi_error = qmi_client_send_msg_sync(this->qmi_qcmap_msgr_handle,
                                       QMI_QCMAP_MSGR_SET_FIREWALL_CONFIG_REQ_V01,
                                       &set_firewall_req_msg,
                                       sizeof(qcmap_msgr_set_firewall_config_req_msg_v01),
...
/*===========================================================================
  FUNCTION Get ETH Backahul Mode
  ===========================================================================*/
/*!
  @brief
  Gets ETH Backhaul Mode
...
boolean QCMAP_Client::GetEthBackhaulMode
(
...
{
  qmi_client_error_type qmi_error, qmi_err_code = QMI_NO_ERR;
  qcmap_msgr_get_eth_backhaul_mode_resp_msg_v01 eth_mode_resp;

  QCMAP_LOG_FUNC_ENTRY();

  memset(&eth_mode_resp, 0, sizeof(
                           qcmap_msgr_get_eth_backhaul_mode_resp_msg_v01));
  qmi_error = qmi_client_send_msg_sync(this->qmi_qcmap_msgr_handle,
                          QMI_QCMAP_MSGR_GET_ETH_BACKHAUL_MODE_REQ_V01,
                          NULL,
                          0,
                          &eth_mode_resp,
  ...
  LOG_MSG_INFO1("qmi_client_send_msg_sync(GetEthBackhaulModeStatus):"
                " error %d result %d",
  ...
  {
    LOG_MSG_ERROR("Can not get eth backhaul mode status %d : %d",
...
/*===========================================================================
  FUNCTION Set ETH Backhaul Mode
  ===========================================================================*/
/*!
  @brief
  Sets ETH Backhaul Mode
...
boolean QCMAP_Client::SetEthBackhaulMode
(
   qcmap_msgr_eth_backhaul_mode_v01 mode,
   qmi_error_type_v01 *qmi_err_num
)
{
  qmi_client_error_type qmi_error, qmi_err_code = QMI_NO_ERR;
  qcmap_msgr_set_eth_backhaul_mode_req_msg_v01 eth_mode_req;
  qcmap_msgr_set_eth_backhaul_mode_resp_msg_v01 eth_mode_resp;

  QCMAP_LOG_FUNC_ENTRY();

  memset(&eth_mode_req, 0, sizeof(qcmap_msgr_set_eth_backhaul_mode_req_msg_v01));
  memset(&eth_mode_resp, 0, sizeof(qcmap_msgr_set_eth_backhaul_mode_resp_msg_v01));

  eth_mode_req.mode = mode;
  eth_mode_req.mobile_ap_handle = this->mobile_ap_handle;

  qmi_error = qmi_client_send_msg_sync(this->qmi_qcmap_msgr_handle,
                           QMI_QCMAP_MSGR_SET_ETH_BACKHAUL_MODE_REQ_V01,
                           &eth_mode_req,
                           sizeof(qcmap_msgr_set_eth_backhaul_mode_req_msg_v01),
                           &eth_mode_resp,
                          sizeof(qcmap_msgr_set_eth_backhaul_mode_resp_msg_v01),
                           QCMAP_MSGR_QMI_TIMEOUT_VALUE);

  LOG_MSG_INFO1("qmi_client_send_msg_sync(SetETHBackhaulModeStatus):"
                " error %d result %d",
      qmi_error, eth_mode_resp.resp.result, 0);
  ...
  if ( ( qmi_error == QMI_TIMEOUT_ERR ) ||
       ...
       ( eth_mode_resp.resp.result != QMI_NO_ERR ) )
  {
    LOG_MSG_ERROR("Can not set eth backhaul mode status %d : %d",
        qmi_error, eth_mode_resp.resp.error, 0);
    *qmi_err_num = eth_mode_resp.resp.error;
    return false;
  }
 ...
 */
/*=========================================================================*/
boolean QCMAP_Client::BringupBTTethering(qmi_error_type_v01 *qmi_err_num)
{
  qmi_client_error_type qmi_error, qmi_err_code = QMI_NO_ERR;
...
/*!
  @brief
  Displays the BT Tethering  is bring up or not
  @return
  true  - on Success
  false - on Failure
...
boolean QCMAP_Client::GetBTTetheringStatus(boolean *enable, qmi_error_type_v01 *qmi_err_num)
{
  ...
  *enable = get_bt_tethering_status_resp_msg.bt_tethering_status;
  return true;
}
