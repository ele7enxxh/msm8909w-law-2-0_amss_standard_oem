...
#define QCMAP_MSGR_V01_IDL_MINOR_VERS 0x27
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define QCMAP_MSGR_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define QCMAP_MSGR_V01_MAX_MESSAGE_ID 0x00A9
/**
    @}
  */
...
#define QCMAP_MSGR_MAX_WLAN_IFACE_V01 3
/**
    @}
  */
...
typedef enum {
  ...
  QCMAP_MSGR_WLAN_MODE_AP_STA_BRIDGE_V01 = 0x04, /**<  WLAN is in AP/STA Bridge Mode  */
...
/** @addtogroup qcmap_msgr_qmi_enums
  ...
  */
typedef enum {
  QCMAP_MSGR_ETH_BACKHAUL_MODE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  QCMAP_MSGR_ETH_BACKHAUL_LAN_ROUTER_V01 = 0x00, /**<  ETH Backhaul mode LAN router */
  QCMAP_MSGR_ETH_BACKHAUL_WAN_BRIDGE_V01 = 0x01, /**<   ETH Backhaul mode WAN bridge  */
  QCMAP_MSGR_ETH_BACKHAUL_WAN_ROUTER_V01 = 0x02, /**<   ETH Backhaul mode WAN router  */
  QCMAP_MSGR_ETH_BACKHAUL_MODE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
...
/** @addtogroup qcmap_msgr_qmi_enums
  ...
  */
typedef enum {
  QCMAP_ETH_BACKHAUL_STATUS_IND_REG_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  QCMAP_MSGR_ETH_BACKHAUL_STATUS_IND_DEREG_V01 = 0, /**<   0 -- Do not register or deregister the control point
                if already registered   */
  QCMAP_MSGR_ETH_BACKHAUL_STATUS_IND_REG_V01 = 1, /**<   1 -- Register for the indication; ignore if already registered   */
  QCMAP_ETH_BACKHAUL_STATUS_IND_REG_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}qcmap_eth_backhaul_status_ind_reg_enum_v01;
/**
    @}
  */
...
/** @addtogroup qcmap_msgr_qmi_enums
  ...
  */
typedef enum {
  QCMAP_MSGR_ETH_BACKHAUL_STATUS_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  ...
  QCMAP_MSGR_ETH_BACKHAUL_STATUS_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}qcmap_msgr_eth_backhaul_status_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Identifies the WLAN mode. Values: \n
      ...
      - QCMAP_MSGR_WLAN_MODE_AP_STA_BRIDGE (0x04) --  WLAN is in AP/STA Bridge Mode
 */
...
typedef struct {
  ...
  /* Mandatory */
  /*  Register Indication */
  qcmap_eth_backhaul_status_ind_reg_enum_v01 register_indication;
  /**<   Specifies the registration. Values: \n
       - 0 -- Do not register or deregister the control point if already registered \n
       - 1 -- Register for the indication; ignore if already registered
  */
}qcmap_msgr_eth_backhaul_mode_status_ind_register_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup qcmap_msgr_qmi_messages
    @{
  */
/** Response Message; Response to the ETH Backhaul status indication reg message */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}qcmap_msgr_eth_backhaul_mode_status_ind_register_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup qcmap_msgr_qmi_messages
    @{
  */
/** Request Message; Retrieves Ethernet Backhaul mode. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}qcmap_msgr_get_eth_backhaul_mode_req_msg_v01;
...
/** @addtogroup qcmap_msgr_qmi_messages
    @{
  */
/** Response Message; Retrieves Ethernet Backhaul mode. */
typedef struct {
  ...
  /**<   Identifies the ETH Backhaul mode. Values: \n
      - QCMAP_MSGR_ETH_BACKHAUL_LAN_ROUTER (0x00) --  ETH Backhaul mode LAN router
      - QCMAP_MSGR_ETH_BACKHAUL_WAN_BRIDGE (0x01) --   ETH Backhaul mode WAN bridge
      - QCMAP_MSGR_ETH_BACKHAUL_WAN_ROUTER (0x02) --   ETH Backhaul mode WAN router
 */
}qcmap_msgr_get_eth_backhaul_mode_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup qcmap_msgr_qmi_messages
    @{
  */
/** Request Message; Sets the ETH Backhaul mode. */
typedef struct {
  ...
  */
  ...
  /*  Ethernet Backhaul Mode */
  qcmap_msgr_eth_backhaul_mode_v01 mode;
  /**<   Identifies the Ethernet Backhaul mode. Values: \n
      - QCMAP_MSGR_ETH_BACKHAUL_LAN_ROUTER (0x00) --  ETH Backhaul mode LAN router
      - QCMAP_MSGR_ETH_BACKHAUL_WAN_BRIDGE (0x01) --   ETH Backhaul mode WAN bridge
      - QCMAP_MSGR_ETH_BACKHAUL_WAN_ROUTER (0x02) --   ETH Backhaul mode WAN router
 */
}qcmap_msgr_set_eth_backhaul_mode_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup qcmap_msgr_qmi_messages
    @{
  */
/** Response Message; Sets the ETH Backhaul mode. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}qcmap_msgr_set_eth_backhaul_mode_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup qcmap_msgr_qmi_messages
    @{
  */
/** Indication Message; Indicates a change in the current Ethernet Backhaul mode status. */
typedef struct {
  ...
  qcmap_msgr_eth_backhaul_status_enum_v01 eth_backhaul_status;
 ...
 */
}qcmap_msgr_eth_backhaul_mode_status_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Indicates the BT Tethering. Values & LAN conf change: \n
...
//#define REMOVE_QMI_QCMAP_MSGR_ETH_BACKHAUL_MODE_STATUS_IND_V01
//#define REMOVE_QMI_QCMAP_MSGR_ETH_BACKHAUL_MODE_STATUS_IND_REG_V01
...
//#define REMOVE_QMI_QCMAP_MSGR_GET_ETH_BACKHAUL_MODE_V01
...
//#define REMOVE_QMI_QCMAP_MSGR_SET_ETH_BACKHAUL_MODE_V01
...
#define QMI_QCMAP_MSGR_GET_ETH_BACKHAUL_MODE_REQ_V01 0x009E
#define QMI_QCMAP_MSGR_GET_ETH_BACKHAUL_MODE_RESP_V01 0x009E
#define QMI_QCMAP_MSGR_SET_ETH_BACKHAUL_MODE_REQ_V01 0x009F
#define QMI_QCMAP_MSGR_SET_ETH_BACKHAUL_MODE_RESP_V01 0x009F
#define QMI_QCMAP_MSGR_ETH_BACKHAUL_MODE_STATUS_IND_V01 0x00A0
#define QMI_QCMAP_MSGR_ETH_BACKHAUL_MODE_STATUS_IND_REG_REQ_V01 0x00A1
#define QMI_QCMAP_MSGR_ETH_BACKHAUL_MODE_STATUS_IND_REG_RESP_V01 0x00A1
