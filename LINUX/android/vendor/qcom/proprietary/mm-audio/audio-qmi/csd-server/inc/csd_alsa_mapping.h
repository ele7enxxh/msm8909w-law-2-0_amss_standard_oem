...
static struct session_id_to_usecase_type session_id_to_verb_table[] =
{
    ...
    {VOICE_MULTIMODE1_ID, "Voice Call Multimode1"},
    {VOICE_MULTIMODE2_ID, "Voice Call Multimode2"},
};
...
static struct session_id_to_usecase_type session_id_to_mod_table[] =
{
    ...
    {VOICE_MULTIMODE1_ID, "Play Voice Multimode1"},
    {VOICE_MULTIMODE2_ID, "Play Voice Multimode2"},
};
...
static struct csd_alsa_card_mapping csd_alsa_card_mapping_list[] =
{
    ...
    {"mdm9640-tomtom-i2s-snd-card", "snd_soc_msm_Tomtom_I2S"},
    {"mdmfermium-tomtom-i2s-snd-card", "snd_soc_msm_Tomtom_I2S"},
