...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/imsa/api/ip_multimedia_subsystem_application_v01.h#4 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define IMSA_V01_IDL_MINOR_VERS 0x18
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define IMSA_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define IMSA_V01_MAX_MESSAGE_ID 0x0035
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Subscription information to bind with
         If not set default used as IMSA_SUBSCRIPTION_TYPE_PRIMARY
    */
