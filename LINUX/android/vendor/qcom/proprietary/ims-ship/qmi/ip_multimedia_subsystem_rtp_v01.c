...
static const uint8_t imsrtp_initialize_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_initialize_req_msg_v01, vsid) - QMI_IDL_OFFSET8(imsrtp_initialize_req_msg_v01, vsid_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
...
static const uint8_t imsrtp_session_configure_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(imsrtp_session_configure_req_msg_v01, disable_drop_set) - QMI_IDL_OFFSET16RELATIVE(imsrtp_session_configure_req_msg_v01, disable_drop_set_valid)),
  0x3E,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
...
static const uint8_t imsrtp_video_quality_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_video_quality_ind_msg_v01, reason_code) - QMI_IDL_OFFSET8(imsrtp_video_quality_ind_msg_v01, reason_code_valid)),
  0x10,
   QMI_IDL_GENERIC_8_BYTE,
...
static const qmi_idl_service_message_table_entry imsrtp_service_command_messages_v01[] = {
  ...
  {QMI_IMSRTP_INITIALIZE_REQ_V01, QMI_IDL_TYPE16(0, 0), 14},
  ...
  {QMI_IMSRTP_SESSION_CONFIGURE_REQ_V01, QMI_IDL_TYPE16(0, 12), 1982},
  ...
  {QMI_IMSRTP_SESSION_RESUME_REQ_V01, QMI_IDL_TYPE16(0, 25), 15},
  {QMI_IMSRTP_CONFIGURE_RTCP_REPORTS_REQ_V01, QMI_IDL_TYPE16(0, 27), 24},
  {QMI_IMSRTP_CONFIGURE_RTP_LINK_MONITOR_REQ_V01, QMI_IDL_TYPE16(0, 30), 13},
  {QMI_IMSRTP_CONFIGURE_RTCP_LINK_MONITOR_REQ_V01, QMI_IDL_TYPE16(0, 33), 13},
  {QMI_IMSRTP_SEND_DTMF_REQ_V01, QMI_IDL_TYPE16(0, 36), 17},
  {QMI_IMSRTP_START_CONTINUOUS_DTMF_REQ_V01, QMI_IDL_TYPE16(0, 38), 12},
  {QMI_IMSRTP_STOP_CONTINUOUS_DTMF_REQ_V01, QMI_IDL_TYPE16(0, 40), 4},
  {QMI_IMSRTP_FLUSH_AUDIO_JITTER_BUFFER_REQ_V01, QMI_IDL_TYPE16(0, 42), 4},
  {QMI_IMSRTP_REGISTER_RTP_SERVICES_REQ_V01, QMI_IDL_TYPE16(0, 47), 15},
  {QMI_IMSRTP_GET_SESSION_STATUS_REQ_V01, QMI_IDL_TYPE16(0, 44), 4},
  ...
  {QMI_IMSRTP_SESSION_VIDEO_CAPABILITY_REQ_V01, QMI_IDL_TYPE16(0, 74), 46},
  {QMI_IMSRTP_CONFIGURE_NAT_OVER_RTP_REQ_V01, QMI_IDL_TYPE16(0, 76), 13},
  {QMI_IMSRTP_CONFIGURE_NAT_OVER_RTCP_REQ_V01, QMI_IDL_TYPE16(0, 78), 13},
...
static const qmi_idl_service_message_table_entry imsrtp_service_indication_messages_v01[] = {
  ...
  {QMI_IMSRTP_CONFIGURE_RTCP_REPORTS_IND_V01, QMI_IDL_TYPE16(0, 29), 11},
  {QMI_IMSRTP_CONFIGURE_RTP_LINK_MONITORING_IND_V01, QMI_IDL_TYPE16(0, 32), 11},
  {QMI_IMSRTP_CONFIGURE_RTCP_LINK_MONITORING_IND_V01, QMI_IDL_TYPE16(0, 35), 11},
  {QMI_IMSRTP_GET_SESSION_STATUS_IND_V01, QMI_IDL_TYPE16(0, 46), 19},
  {QMI_IMSRTP_ERROR_IND_V01, QMI_IDL_TYPE16(0, 49), 11},
  {QMI_IMSRTP_RTCP_REPORTS_IND_V01, QMI_IDL_TYPE16(0, 50), 465},
  ...
  {QMI_IMS_RTP_VIDEO_IDR_GENERATE_IND_V01, QMI_IDL_TYPE16(0, 72), 4},
  {QMI_IMS_RTP_VIDEO_BIT_RATE_ADAPT_IND_V01, QMI_IDL_TYPE16(0, 73), 11},
  {QMI_IMS_RTP_FIRST_PKT_RCVD_IND_V01, QMI_IDL_TYPE16(0, 80), 11},
  {QMI_IMS_RTP_VIDEO_QUALITY_IND_V01, QMI_IDL_TYPE16(0, 68), 22}
};
