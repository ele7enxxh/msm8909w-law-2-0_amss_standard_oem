            ...
            if (count != noOfIterations) {
                ...
                if(AppGlobalState.getPresenceService() != null && AppGlobalState.isCdByOption() == false)
                {
                    ...
                    if(AppGlobalState.listCapPollingRequestinfo.size() == 1)
                    {
                        ...
                        if(listCapPollinghandler != null)
                        {
                            listCapPollinghandler.removeCallbacks(listCapPollingRunnable);
                            listCapPollinghandler.postDelayed(listCapPollingRunnable, ((subscriptionExpireTime + 2) * 1000));
                            Log.d("PRESENCE_UI","ListCapabilityPollingTask added in runnable in handler queue");
                        }
                    }
                    else
                    {
