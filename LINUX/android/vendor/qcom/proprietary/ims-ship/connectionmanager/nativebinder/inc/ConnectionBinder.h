...
@{ */
        ...
        */
        ...
        status_t sendMessage(ConnectionMessage* message, uint32_t messageId);
        ...
        */
        ...
        @param[in] featureTag FeatureTag/Service.
        ...
        returned.
        */
        status_t setStatus(char* featureTag, uint32_t status);
