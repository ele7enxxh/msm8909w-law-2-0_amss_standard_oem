...
@{ */
            ...
            */
            ...
            =====================================================================*/
            /** @xreflabel{hdr:handleTerminateEvent}
            Callback used to indicate the Service\FeatureTag related
            session should be terminated as handoff failed to bring up
            PDP.

            @param[in] event      Connection event based on #QIMSCONNECTION_EVENT.
            @param[in] featureTag Feature Tag\Service whose session should be terminated.

            @return
            None.
            */
            virtual void handleTerminateEvent(int32_t event,char* featureTag) = 0;
    };
