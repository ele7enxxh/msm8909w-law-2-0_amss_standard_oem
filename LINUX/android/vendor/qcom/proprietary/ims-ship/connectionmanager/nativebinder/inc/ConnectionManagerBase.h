...
namespace IMSConnectionManager
{
	...
	typedef enum
  	{
          CM_MESSAGE_TYPE_REQUEST,
          /* SIP REQUEST MESSAGE IDENTIFIER */
          CM_MESSAGE_TYPE_RESPONSE,
          /* SIP RESPONSE MESSAGE IDENTIFIER */
          CM_MESSAGE_TYPE_INVALID_MAX,
          /* MAX INVALID VALUE */
        }CM_MESSAGE_TYPE;	
    ...
    typedef  enum
    {
      ...
      /* Android Native Service died */
      CM_STATUS_SERVICE_CLOSING,
      /* Android Native Service close in progress */
      CM_STATUS_SERVICE_RESTARTED,
      /* Android Native Service close in progress */
    } CM_STATUS;
...
/*    typedef enum
    {
        CM_SIP_PROTOCOL_UDP,
        CM_SIP_PROTOCOL_TCP,
        QIMSCM_SIP_PROTOCOL_INVALID_MAX;
    }CM_SIP_PROTOCOL;*/
