...
@{ */
    ...
    application.ims.iari.rcse.ft""" @endcode
        ...
        */
        ...
        /*=====================================================================
          Function: triggerReRegistration
        =====================================================================*/
        /** @xreflabel{triggerReRegistration()}
        Used to trigger re-registration.

        This must be done only after receiving registration success
        for the triggerRegistration call.
        This method will trigger a re-registration on all the feature 
        tags forcefully.
        @vertspace{-4}
        ...
        returned.
        */
		status_t triggerReRegistration();
        ...
        */
        ...
        from #QIMSCM_STATUSCODE.
        */
		status_t methodResponse(char* method, int responseCode);
		status_t getAutoConfigurationXML();
        /** @cond
        */
