...
mm-pp-daemon-inc   += $(BOARD_KERNEL_HEADER_DIR)
mm-pp-daemon-inc   += $(TOP)/$(BOARD_DISPLAY_HAL)/libqservice
mm-pp-daemon-inc   += external/zlib
mm-pp-daemon-inc   += external/tinyxml2
mm-pp-daemon-inc   += $(BOARD_DISPLAY_HAL)/libqdutils
...
LOCAL_C_INCLUDES += $(TOP)/external/tinyxml2
