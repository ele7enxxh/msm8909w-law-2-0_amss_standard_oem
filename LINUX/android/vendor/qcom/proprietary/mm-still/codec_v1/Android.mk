...
ifeq ($(call is-platform-sdk-version-at-least,22),false)
LOCAL_C_INCLUDES += external/openssl/src/include
OPENSSL_HEADER_DIR := external/openssl/src/include
else
LOCAL_C_INCLUDES += external/boringssl/src/include
OPENSSL_HEADER_DIR := external/boringssl/src/include
endif
...
LOCAL_SHARED_LIBRARIES := libdl libcutils liblog libmmjpeg
ifeq ($(strip $(FACT_VER)),codecB)
