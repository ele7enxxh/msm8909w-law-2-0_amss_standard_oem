ifeq ($(call is-vendor-board-platform,QCOM),true)
  ...
  ifeq ($(call is-board-platform-in-list,$(CODECV1_LIST)),true)
    ifeq ($(call is-board-platform-in-list,msm8974 msm8916 msm8226 msm8610 msm_bronze msm8916 msm8909 msm8909w),true)
      JPEGD_VER := jpeg10
      JPEGE_VER := jpeg10
      FACT_VER := codecB
    ...
    ifeq ($(call is-chipset-prefix-in-board-platform,msm8974 msm8610 msm_bronze msm8916 msm8909 msm8909w),true)
      USES_GEMINI := false
      USES_MERCURY := false
