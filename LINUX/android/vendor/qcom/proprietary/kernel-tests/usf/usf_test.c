...
#define PORT_SAMPLES_DATA_SIZE 768
...
static void set_valid_tx_configuration1()
{
	...
	transparentTxData.frameSize = PORT_SAMPLES_DATA_SIZE;
	...
	unsigned short frame_size = PORT_SAMPLES_DATA_SIZE*
...
static void set_valid_rx_configuration1()
{
	...
	transparentRxData.frameSize = PORT_SAMPLES_DATA_SIZE;
	...
	frame_size = PORT_SAMPLES_DATA_SIZE *
...
static int nominal_test(void)
{
	bool rc = false;
	int  errors = 0;
	static unsigned char pattern[PORT_SAMPLES_DATA_SIZE * sizeof(unsigned short)];
