...
compare_cpus_num() {
	...
	8660 | 8960)
		num_cpus=2
		;;
	8064 | 8974 | 8226 | 8x26 | 8926 | 8026 | 8962 | 8084 | 8916 | 8092 | 8936 | 8909 | 8996 | gold)
		num_cpus=4
		;;
	8x10 | 8610)
		if [ "$1" == "2" ] || [ "$1" == "4" ]
	...
	9630 | mdm9607)
		num_cpus=1
		;;
	8994 | 8939 | 8952 | 8976 | 8937 | titanium)
		num_cpus=8
		;;
	8992 | 8956)
		num_cpus=6
...
cat /proc/cpuinfo | grep -q -e ARMv7 -e AArch64 -e 'CPU architecture: 8'
if [ $? -ne 0 ]
then
