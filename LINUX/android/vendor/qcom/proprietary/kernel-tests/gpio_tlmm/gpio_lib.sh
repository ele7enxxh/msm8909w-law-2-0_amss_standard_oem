...
if [ "$target_name" == "8996" ]; then
	gpio_label="1010000.pinctrl"
fi

if [ "$target_name" == "8937" ] ||
   [ "$target_name" == "8909w" ] ||
   [ "$target_name" == "gold" ] ||
   [ "$target_name" == "titanium" ]; then
	gpio_label="1000000.pinctrl"
fi

if [ "$target_name" == "mdm9607" ] ||
   [ "$target_name" == "mdmcalifornium" ]; then
	gpio_label="1000000.pinctrl"
fi
