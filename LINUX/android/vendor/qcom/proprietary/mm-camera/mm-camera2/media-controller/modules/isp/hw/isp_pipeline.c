...
static int isp_pipeline_set_hdr(isp_pipeline_t *pipeline,
  int32_t *ae_bracketing_enable, uint32_t in_params_size)
{
  pipeline->pix_params.cfg_and_3a_params.cfg.ae_bracketing_enable = *ae_bracketing_enable;
  return 0;
}
  ...
  void *in_params, uint32_t in_params_size)
{
  ...
  case ISP_PIX_SET_HDR: {
    /* int maps to camera_HDR_mode_type */
    int *ae_bracketing_enable = (int *)in_params;
    pipeline->pix_params.cfg_and_3a_params.cfg.ae_bracketing_enable =
      ae_bracketing_enable;
    rc = isp_pipeline_set_hdr(pipeline, (int32_t *)in_params,
           in_params_size);
  }
    break;
