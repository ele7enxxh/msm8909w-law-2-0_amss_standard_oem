...
typedef enum {
  AEC_ADRC_ISP_MOD_NONE   =   0x00,
  AEC_ADRC_ISP_MOD_LA     =   0x01,
  AEC_ADRC_ISP_MOD_LTM    =   0x02,
  AEC_ADRC_ISP_MOD_GTM    =   0x04,
  AEC_ADRC_ISP_MOD_GAMMA  =   0x08,
} aec_adrc_isp_mod_mask_t;
...
typedef struct _aec_set_parameter {
  ...
  union {
    ...
    uint32_t                      adrc_isp_module_mask;
    boolean                       adrc_isp_module_available;
  } u;
} aec_set_parameter_t;
