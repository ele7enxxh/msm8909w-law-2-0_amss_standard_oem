...
typedef enum _mct_event_module_type {
  ...
  MCT_EVENTS_MODULE_PDAF_ISP_INFO,
  ...
  MCT_EVENT_MODULE_STATS_PDAF_UPDATE,
  ...
  MCT_EVENT_MODULE_STATS_GYRO_STATS_AF,
  MCT_EVENT_MODULE_STATS_DATA,
  MCT_EVENT_MODULE_STATS_EXT_DATA,
  MCT_EVENT_MODULE_STATS_DATA_ACK, /* mct_event_stats_isp_t */
  ...
  MCT_EVENT_MODULE_STATS_GET_DS_THREAD_OBJECT, /*DivertStats Thread Object*/
  ...
  MCT_EVENT_MODULE_GRAVITY_VECTOR_UPDATE,
  MCT_EVENT_MODULE_GRAVITY_VECTOR_ENABLE,
  ...
  MCT_EVENT_MODULE_ISP_DIVERT_TO_3A,
  ...
  MCT_EVENT_MODULE_SENSOR_PDAF_CONFIG,
  MCT_EVENT_MODULE_TOF_UPDATE,
  MCT_EVENT_MODULE_ISP_PDAF_STREAMOFF,
  MCT_EVENT_MODULE_SENSOR_UPDATE_FPS,
  MCT_EVENT_MODULE_ISP_ADRC_MODULE_MASK,
  MCT_EVENT_MODULE_ISP_ADRC_SPL_EFFECT,
