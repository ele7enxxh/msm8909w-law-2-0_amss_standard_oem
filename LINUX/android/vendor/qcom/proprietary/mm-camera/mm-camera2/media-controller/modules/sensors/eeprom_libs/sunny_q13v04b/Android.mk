SUNNY_Q13V04B_EEPROM_LIBS_PATH := $(call my-dir)

# ---------------------------------------------------------------------------
#        Make the shared library (libmmcamera_sunny_q13v04b_eeprom.so)
# ---------------------------------------------------------------------------

include $(CLEAR_VARS)
LOCAL_PATH := $(SUNNY_Q13V04B_EEPROM_LIBS_PATH)
...
LOCAL_SRC_FILES:= sunny_q13v04b_eeprom.c
LOCAL_MODULE           := libmmcamera_sunny_q13v04b_eeprom
LOCAL_CLANG := false
