SUNNY_Q8V18A_EEPROM_LIBS_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(SUNNY_Q8V18A_EEPROM_LIBS_PATH)
...
LOCAL_SRC_FILES:= sunny_q8v18a_eeprom.c
LOCAL_MODULE           := libmmcamera_sunny_q8v18a_eeprom
LOCAL_CLANG            := false
