...
#ifndef __ISP_PIPELINE40_H__
#define __ISP_PIPELINE40_H__
#include "chromatix.h"
...
#define ISP40_MODULE_CFG 0x00000018
#define ISP40_MODULE_CFG_LEN 4
#define ISP40_CORE_CFG 0x0000001C
#define ISP40_CORE_CFG_LEN 4
#define ISP40_REALIGN_BUF_CFG 0x00000884
#define ISP40_REALIGN_BUF_CFG_LEN 4
#define ISP40_CHROMA_UPSAMPLE_CFG 0x0000057C
#define ISP40_CHROMA_UPSAMPLE_CFG_LEN 4
#define ISP40_STATS_CFG 0x00000888
#define ISP40_STATS_CFG_LEN 4
#define ISP40_CAMIF_CFG 0x000002F8
#define ISP40_CAMIF_CFG_LEN 36

#define ISP40_DMI_CFG_DEFAULT 0x00000100
#define ISP40_DMI_CFG_OFF 0x00000910
#define ISP40_DMI_ADDR 0x00000914
#define ISP40_DMI_DATA_HI 0x00000918
#define ISP40_DMI_DATA_LO 0x0000091c

#define ISP40_DMI_NO_MEM_SELECTED 0
...
typedef struct ISP_OperationConfigCmdType {
  ISP_CoreCfgPacked           ispCfg;            /* ISP40_CORE_CFG */
  ISP_ModuleCfgPacked         moduleCfg;         /* ISP40_MODULE_CFG */
  ISP_RealignConfigCmdType    realignBufCfg;     /* ISP40_REALIGN_BUF_CFG */
  ISP_ChromaUpsampleCfgPacked chromaUpsampleCfg; /* ISP40_CHROMA_UPSAMPLE_CFG*/
  ISP_StatsCfg                ispStatsCfg;       /* ISP40_STATS_CFG */
