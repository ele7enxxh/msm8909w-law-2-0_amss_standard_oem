...
#define SENSOR_MODEL_NO_OV2680_5987FHQ "ov2680_5987fhq"
#define OV2680_5987FHQ_LOAD_CHROMATIX(n) \
  "libchromatix_"SENSOR_MODEL_NO_OV2680_5987FHQ"_"#n".so"
...
static struct msm_camera_i2c_reg_array init_reg_array0[] = {
  ...
  {0x3820, 0xc6}, //vsun48_blc, vflip_blc, vbinf
  {0x3821, 0x05}, //hbin
...
static struct msm_camera_csid_vc_cfg ov2680_5987fhq_cid_cfg[] = {
  {0, CSI_RAW10, CSI_DECODE_10BIT},
  {1, CSI_EMBED_DATA, CSI_DECODE_8BIT},
};

static struct msm_camera_csi2_params ov2680_5987fhq_csi_params = {
  .csid_params = {
    .lane_cnt = 1,
    .lut_params = {
      .num_cid = ARRAY_SIZE(ov2680_5987fhq_cid_cfg),
      .vc_cfg = {
         &ov2680_5987fhq_cid_cfg[0],
         &ov2680_5987fhq_cid_cfg[1],
      },
    },
  },
  .csiphy_params = {
...
static struct sensor_pix_fmt_info_t ov2680_5987fhq_pix_fmt0_fourcc[] = {
  { V4L2_PIX_FMT_SBGGR10 },
};

static struct sensor_pix_fmt_info_t ov2680_5987fhq_pix_fmt1_fourcc[] = {
  { MSM_V4L2_PIX_FMT_META },
};

static sensor_stream_info_t ov2680_5987fhq_stream_info[] = {
  {1, &ov2680_5987fhq_cid_cfg[0], ov2680_5987fhq_pix_fmt0_fourcc},
  {1, &ov2680_5987fhq_cid_cfg[1], ov2680_5987fhq_pix_fmt1_fourcc},
};

static sensor_stream_info_array_t ov2680_5987fhq_stream_info_array = {
  .sensor_stream_info = ov2680_5987fhq_stream_info,
  .size = ARRAY_SIZE(ov2680_5987fhq_stream_info),
};
...
static struct msm_camera_i2c_reg_array res0_reg_array[] = {
 ...
 //sysclk = 66Mhz, MIPI data rate 330Mbps
  ...
  {0x3814, 0x11}, //x inc
  {0x3815, 0x11}, //y inc
  {0x3820, 0xc4}, //vsun48_blc, vflip_blc, vbin off
  {0x3821, 0x04}, //hbin off
...
static struct msm_camera_csi2_params *csi_params[] = {
  &ov2680_5987fhq_csi_params, /* RES 0*/
};
...
static sensor_res_cfg_type_t ov2680_5987fhq_res_cfg[] = {
...
static struct sensor_res_cfg_table_t ov2680_5987fhq_res_table = {
  .res_cfg_type = ov2680_5987fhq_res_cfg,
  .size = ARRAY_SIZE(ov2680_5987fhq_res_cfg),
};

static struct sensor_lib_chromatix_t ov2680_5987fhq_chromatix[] = {
#ifndef VFE_40
  {
    .common_chromatix = OV2680_5987FHQ_LOAD_CHROMATIX(common_v32),
    .camera_preview_chromatix = OV2680_5987FHQ_LOAD_CHROMATIX(snapshot_v32), /* RES0 */
    .camera_snapshot_chromatix = OV2680_5987FHQ_LOAD_CHROMATIX(snapshot_v32), /* RES0 */
    .camcorder_chromatix = OV2680_5987FHQ_LOAD_CHROMATIX(default_video_v32), /* RES0 */
  },
#else
  {
    .common_chromatix = OV2680_5987FHQ_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = OV2680_5987FHQ_LOAD_CHROMATIX(snapshot), /* RES0 */
    .camera_snapshot_chromatix = OV2680_5987FHQ_LOAD_CHROMATIX(snapshot), /* RES0 */
    .camcorder_chromatix = OV2680_5987FHQ_LOAD_CHROMATIX(default_video), /* RES0 */
  },
#endif
};

static struct sensor_lib_chromatix_array ov2680_5987fhq_lib_chromatix_array = {
  .sensor_lib_chromatix = ov2680_5987fhq_chromatix,
  .size = ARRAY_SIZE(ov2680_5987fhq_chromatix),
};

/*===========================================================================
 * FUNCTION    - ov2680_5987fhq_real_to_register_gain -
 *
 * DESCRIPTION:
 *==========================================================================*/
static uint16_t ov2680_5987fhq_real_to_register_gain(float gain)
{
...
/*===========================================================================
 * FUNCTION    - ov2680_5987fhq_register_to_real_gain -
 *
 * DESCRIPTION:
 *==========================================================================*/
static float ov2680_5987fhq_register_to_real_gain(uint16_t reg_gain)
{
...
/*===========================================================================
 * FUNCTION    - ov2680_5987fhq_calculate_exposure -
 *
 * DESCRIPTION:
 *==========================================================================*/
static int32_t ov2680_5987fhq_calculate_exposure(float real_gain,
  uint16_t line_count, sensor_exposure_info_t *exp_info)
{
  if (!exp_info) {
    return -1;
  }
  exp_info->reg_gain = ov2680_5987fhq_real_to_register_gain(real_gain);
  exp_info->sensor_real_gain = ov2680_5987fhq_register_to_real_gain(exp_info->reg_gain);
...
/*===========================================================================
 * FUNCTION    - ov2680_5987fhq_fill_exposure_array -
 *
 * DESCRIPTION:
 *==========================================================================*/
static int32_t ov2680_5987fhq_fill_exposure_array(uint16_t gain, uint32_t line,
...
static sensor_exposure_table_t ov2680_5987fhq_expsoure_tbl = {
  .sensor_calculate_exposure = ov2680_5987fhq_calculate_exposure,
  .sensor_fill_exposure_array = ov2680_5987fhq_fill_exposure_array,
};
...
static sensor_lib_t sensor_lib_ptr = {
  ...
  /* csi cid params */
  .csi_cid_params = ov2680_5987fhq_cid_cfg,
  /* csi csid params array size */
  .csi_cid_params_size = ARRAY_SIZE(ov2680_5987fhq_cid_cfg),
  /* init settings */
  ...
  .sensor_res_cfg_table = &ov2680_5987fhq_res_table,
  /* res settings */
  ...
  .sensor_stream_info_array = &ov2680_5987fhq_stream_info_array,
  /* exposure funtion table */
  .exposure_func_table = &ov2680_5987fhq_expsoure_tbl,
  /* chromatix array */
  .chromatix_array = &ov2680_5987fhq_lib_chromatix_array,
  /* sensor pipeline immediate delay */
  .sensor_max_immediate_frame_delay = 2,
};

/*===========================================================================
 * FUNCTION    - ov2680_5987fhq_open_lib -
 *
 * DESCRIPTION:
 *==========================================================================*/
void *ov2680_5987fhq_open_lib(void)
{
