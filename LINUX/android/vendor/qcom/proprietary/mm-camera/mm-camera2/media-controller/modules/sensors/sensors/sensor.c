...
static int32_t sensor_write_init_settings(void *sctrl)
{
  ...
  if (lib->sensor_lib_ptr->init_settings_array) {
    cfg.cfgtype = CFG_WRITE_I2C_ARRAY;
    init_settings = ctrl->lib_params->sensor_lib_ptr->init_settings_array;
...
static int8_t sensor_set_start_stream(void *sctrl)
{
  ...
  if (ctrl->lib_params->sensor_lib_ptr->start_settings) {
    cfg.cfgtype = CFG_WRITE_I2C_ARRAY;
    cfg.cfg.setting = ctrl->lib_params->sensor_lib_ptr->start_settings;
  } else {
    SERR("ERROR: No start settings for this sensor");
    return FALSE;
  }
...
static int32_t sensor_set_resolution(void *sctrl, void *data)
{
  ...
  if (lib->sensor_lib_ptr->res_settings_array) {
    ...
    SERR("ERROR: No resolution settings for this sensor");
    return SENSOR_FAILURE;
  }
