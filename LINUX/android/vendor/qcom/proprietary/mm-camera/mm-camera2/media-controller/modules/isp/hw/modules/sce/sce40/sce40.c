...
static void sce_adjustment(chromatix_SCE_type *sce, isp_skin_enhan_sat_adj_t *sce1,
                           isp_skin_enhan_sat_adj_t *sce2, isp_skin_enhan_sat_adj_t *sce4,
                           float la_gain)
{
  float factor;
  if(sce->sce_enable)
  ...
  // Convert LA gain to log domain
  la_gain = log2(la_gain);

  if(la_gain <= sce1->la_gain){
    sce->destination_triangles_A = sce1->destination_triangles_A;
    sce->destination_triangles_D65 = sce1->destination_triangles_D65;
    sce->destination_triangles_TL84 = sce1->destination_triangles_TL84;
    sce->origin_triangles_A = sce1->origin_triangles_A;
    sce->origin_triangles_D65 = sce1->origin_triangles_D65;
    sce->origin_triangles_TL84 = sce1->origin_triangles_TL84;
    sce->shift_vector_A = sce1->shift_vector_A;
    sce->shift_vector_D65 = sce1->shift_vector_D65;
    sce->shift_vector_TL84 = sce1->shift_vector_TL84;
  } else if(la_gain <= sce2->la_gain) {
    factor = (la_gain - sce1->la_gain)/(sce2->la_gain - sce1->la_gain);
    trigger_interpolate_sce_triangles(&sce2->origin_triangles_TL84,
      &sce1->origin_triangles_TL84, &sce->origin_triangles_TL84, factor);
    trigger_interpolate_sce_triangles(&sce2->origin_triangles_D65,
      &sce1->origin_triangles_D65, &sce->origin_triangles_D65, factor);
    trigger_interpolate_sce_triangles(&sce2->origin_triangles_A,
      &sce1->origin_triangles_A, &sce->origin_triangles_A, factor);
    trigger_interpolate_sce_triangles(&sce2->destination_triangles_TL84,
      &sce1->destination_triangles_TL84, &sce->destination_triangles_TL84, factor);
    trigger_interpolate_sce_triangles(&sce2->destination_triangles_D65,
      &sce1->destination_triangles_D65, &sce->destination_triangles_D65, factor);
    trigger_interpolate_sce_triangles(&sce2->destination_triangles_A,
      &sce1->destination_triangles_A, &sce->origin_triangles_A, factor);
    trigger_interpolate_sce_vectors(&sce2->shift_vector_TL84,
      &sce1->shift_vector_TL84, &sce->shift_vector_TL84, factor);
    trigger_interpolate_sce_vectors(&sce2->shift_vector_D65,
      &sce1->shift_vector_D65, &sce->shift_vector_D65, factor);
    trigger_interpolate_sce_vectors(&sce2->shift_vector_A,
      &sce1->shift_vector_A, &sce->shift_vector_A, factor);
  } else if(la_gain <= sce4->la_gain) {
    factor = (la_gain - sce2->la_gain)/(sce4->la_gain - sce2->la_gain);
    trigger_interpolate_sce_triangles(&sce4->origin_triangles_TL84,
      &sce2->origin_triangles_TL84, &sce->origin_triangles_TL84, factor);
    trigger_interpolate_sce_triangles(&sce4->origin_triangles_D65,
      &sce2->origin_triangles_D65, &sce->origin_triangles_D65, factor);
    trigger_interpolate_sce_triangles(&sce4->origin_triangles_A,
      &sce2->origin_triangles_A, &sce->origin_triangles_A, factor);
    trigger_interpolate_sce_triangles(&sce4->destination_triangles_TL84,
      &sce2->destination_triangles_TL84, &sce->destination_triangles_TL84, factor);
    trigger_interpolate_sce_triangles(&sce4->destination_triangles_D65,
      &sce2->destination_triangles_D65, &sce->destination_triangles_D65, factor);
    trigger_interpolate_sce_triangles(&sce4->destination_triangles_A,
      &sce2->destination_triangles_A, &sce->destination_triangles_A, factor);
    trigger_interpolate_sce_vectors(&sce4->shift_vector_TL84,
      &sce2->shift_vector_TL84, &sce->shift_vector_TL84, factor);
    trigger_interpolate_sce_vectors(&sce4->shift_vector_D65,
      &sce2->shift_vector_D65, &sce->shift_vector_D65, factor);
    trigger_interpolate_sce_vectors(&sce4->shift_vector_A,
      &sce2->shift_vector_A, &sce->shift_vector_A, factor);
  } else {
    sce->destination_triangles_A = sce4->destination_triangles_A;
    sce->destination_triangles_D65 = sce4->destination_triangles_D65;
    sce->destination_triangles_TL84 = sce4->destination_triangles_TL84;
    sce->origin_triangles_A = sce4->origin_triangles_A;
    sce->origin_triangles_D65 = sce4->origin_triangles_D65;
    sce->origin_triangles_TL84 = sce4->origin_triangles_TL84;
    sce->shift_vector_A = sce4->shift_vector_A;
    sce->shift_vector_D65 = sce4->shift_vector_D65;
    sce->shift_vector_TL84 = sce4->shift_vector_TL84;
  }
}
  ...
  uint32_t in_param_size)
{
  ...
  float la_gain;
  isp_skin_enhan_sat_adj_type *adrc_sce;
  ...
  la_gain = trigger_params->trigger_input.stats_update.aec_update.la_gain;
  ...
  update_sce = ((sce_mod->old_streaming_mode != trigger_params->cfg.streaming_mode) ||
    ...
    !F_EQUAL(sce_mod->prev_la_gain, la_gain));
  if(update_sce) {
    ...
    ISP_DBG(ISP_MOD_SCE, "Prev LA gain %f new %f", sce_mod->prev_la_gain, la_gain);
    if (!chromatix_SCE->sce_enable
      && isp_util_adrc_is_gain_valid(la_gain) && chromatix_adrc->sce.enable) {
        sce_adjustment(chromatix_SCE, &chromatix_adrc->sce.sce[0],
          &chromatix_adrc->sce.sce[1], &chromatix_adrc->sce.sce[2], la_gain);
        sce_reorder_triangles(sce_mod, &trigger_params->cfg);
    }
 ...
 *
 **/
isp_ops_t *sce40_open(uint32_t version)
{
