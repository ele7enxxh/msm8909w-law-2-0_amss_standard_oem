SUNNY_Q8V19W_EEPROM_LIBS_PATH := $(call my-dir)

# ---------------------------------------------------------------------------
#        Make the shared library (libmmcamera_sunny_q8v18a_eeprom.so)
# ---------------------------------------------------------------------------

include $(CLEAR_VARS)
LOCAL_PATH := $(SUNNY_Q8V19W_EEPROM_LIBS_PATH)
...
LOCAL_SRC_FILES:= sunny_ov8858_q8v19w_eeprom.c
LOCAL_MODULE           := libmmcamera_sunny_ov8858_q8v19w_eeprom
LOCAL_CLANG := false
