...
typedef struct {
  ...
  uint32_t LUT_Yratio[ISP_LA_TABLE_LENGTH]; /* LUT for LA*/
  uint32_t applied_LUT_YRatio[ISP_LA_TABLE_LENGTH];
  uint32_t solarize_la_tbl[ISP_LA_TABLE_LENGTH]; /* LUT for LA*/
  uint32_t posterize_la_tbl[ISP_LA_TABLE_LENGTH]; /* LUT for LA*/
