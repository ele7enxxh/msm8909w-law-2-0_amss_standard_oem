...
/* ========================================================================= *
    ...
    Purpose:  LogModule header file
            ...
            -------------------------------------------------------
                Copyright © 2005-2013 , 2016 Qualcomm Technologies, Inc.
                           All Rights Reserved.
...
#if defined(ANDROID_CFUZZER_BUILD)
	#define FUZZ_LOG_DIR     "/data/misc/camera/cFuzzer/cFuzzerLogs"
	#define FUZZ_SOCK_PATH   "/data/misc/camera/cFuzzer/Sockets"
	#define FUZZ_LOG_CONFIG  "/data/misc/camera/cFuzzer/LogConfig.txt"
