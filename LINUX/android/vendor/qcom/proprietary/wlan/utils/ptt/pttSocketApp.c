...
#ifdef AID_QCOM_DIAG
#define AID_DIAG_VERSION AID_QCOM_DIAG
#else
#define AID_DIAG_VERSION AID_DIAG
#endif
 ...
 * AID_DIAG_VERSION : Access DIAG debugfs
 * AID_WIFI      : WIFI Operation
 */
const gid_t groups[] = {AID_INET, AID_NET_ADMIN, AID_DIAG_VERSION, AID_WIFI,
                        AID_SDCARD_R, AID_MEDIA_RW };
