...
/*===========================================================================
  FUNCTION  qmi_atcop_srvc_indication_cb_helper
===========================================================================*/
/*!
@brief
   This function will help decode the raw ind data. To be used until AT QMI
   QCCI interface files are fully defined.
...
/*===========================================================================
  FUNCTION  qmi_atcop_reg_at_command_fwd_req_msg_helper
===========================================================================*/
/*!
@brief
  Helper function to prepare the raw msg for command
...
/*=========================================================================*/
int
qmi_atcop_reg_at_command_fwd_req_msg_helper
(
  qmi_atcop_at_cmd_fwd_req_type     *cmd_fwd_req,
  unsigned char                     *msg,
  int                               *msg_size
)
{
  ...
  if (rc < 0)
  {
    QMI_ERR_MSG_0 ("qmi_atcop_reg_at_command_fwd_req: Unable to format cmd list.\n");
    return rc;
  }
  ...
  *msg_size = QMI_SRVC_PDU_SIZE(QMI_ATCOP_STD_MSG_SIZE);
  ...
  if ((rc = qmi_util_write_std_tlv (&msg,
                                       ...
                                       (void *) param_buf)) < 0)
  {
    QMI_ERR_MSG_0 ("qmi_atcop_reg_at_command_fwd_req: Error writing std TLV.\n");
    return rc;
  }
...
{
  unsigned char     msg[QMI_ATCOP_STD_MSG_SIZE];
  int               msg_size, rc;
  unsigned char     param_buf[QMI_ATCOP_MAX_PARAM_BUF_SIZE];
  int               param_buf_size = QMI_ATCOP_MAX_PARAM_BUF_SIZE;
  ...
  if ( (rc = qmi_atcop_reg_at_command_fwd_req_msg_helper(cmd_fwd_req, tmp_msg_ptr, &msg_size)) < 0)
  {
      QMI_ERR_MSG_0 ("qmi_atcop_reg_at_command_fwd_req: Error processing at_command_fwd_req.\n");
      return rc;
  }
...
/*===========================================================================
  FUNCTION  qmi_atcop_fwd_at_cmd_resp_helper
===========================================================================*/
/*!
@brief
  Help pack the wire format at fwd cmd response. This helper is required
  until QCCI message definitions are available.
