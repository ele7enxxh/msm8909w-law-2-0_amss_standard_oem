...
vtest-inc        += $(TOP)/hardware/qcom/display/msm8909/libgralloc/
vtest-inc        += $(TOP)/hardware/qcom/display/msm8909/libqdutils/
...
LOCAL_SHARED_LIBRARIES  := libOmxCore libbinder libcutils
...
LOCAL_SRC_FILES += common/src/vtest_Encoder.cpp
LOCAL_SRC_FILES += common/src/vtest_EncoderFileSink.cpp
LOCAL_SRC_FILES += common/src/vtest_EncoderFileSource.cpp
LOCAL_SRC_FILES += common/src/vtest_TestEncode.cpp
