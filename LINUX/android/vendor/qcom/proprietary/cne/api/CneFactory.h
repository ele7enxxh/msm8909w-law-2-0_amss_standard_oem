 ...
 *
 *                   Copyright 2010-2012,2015 Qualcomm Technologies, Inc.
 *                   All Rights Reserved.
...
class CneFactory
{
  ...
  */
  static ICneNetworkRequest* CreateCneNetworkRequest(CnoNetType network, ICneNetworkObserverNotifier* cnoNotifier);
