...
static jint dpl_cameraOpen(JNIEnv*, jobject, jint cameraId) {
    ALOGD("%s", __func__);
...
static jint dpl_cameraOpenWithPackage(JNIEnv *e, jobject, jint cameraId, jstring packageName) {
    ALOGD("%s", __func__);
...
static short dpl_cameraRelease(JNIEnv*, jobject) {
    ALOGD("%s", __func__);
...
static short dpl_cameraStartPreview(JNIEnv*, jobject) {
    ALOGD("%s", __func__);
...
static short dpl_cameraStopPreview(JNIEnv*, jobject) {
    ALOGD("%s", __func__);
...
static short dpl_cameraStartRecording(JNIEnv*, jobject) {
    ALOGD("%s", __func__);
...
static short dpl_cameraStopRecording(JNIEnv*, jobject) {
    ALOGD("%s", __func__);
...
static int dpl_setPreviewTexture(JNIEnv *e, jobject, jobject osurface) {
    ALOGD("%s", __func__);
...
static short dpl_cameraSetDisplayOrientation(JNIEnv*, jobject, jint rotation) {
    ALOGD("%s", __func__);
...
static bool dpl_cameraIsZoomSupported(JNIEnv*, jobject) {
    ALOGD("%s", __func__);
...
static int dpl_cameraGetMaxZoom(JNIEnv*, jobject) {
    ALOGD("%s", __func__);
...
static void dpl_cameraSetZoom(JNIEnv*, jobject, jint zoomValue) {
    ALOGD("%s", __func__);
...
static short dpl_cameraSetPreviewSize(JNIEnv*, jobject, jint width, jint height) {
    ALOGD("%s", __func__);
...
static short dpl_cameraSetFpsRange(JNIEnv*, jobject, jint fps) {
    ALOGD("%s", __func__);
