                ...
                for (int i = 0; i < num; i++) {
                    ...
                    if (call.hasFailCause()) {
                        ...
                        if (call.getFailCause().hasFailcause()) {
                            ...
                            //report IMS call fail cause to upper layer
                            ...
                            intent.putExtra("stateChanged", 1);
                            mContext.sendBroadcast(intent);
                            log("CallFailCauseResponse sent to upper layer");
                        } else {
    ...
    private int getImsReasonForCallFailCause(ImsQmiIF.CallFailCauseResponse failCauseResp) {
        ...
        switch (failCause) {
            ...
            case ImsQmiIF.CALL_FAIL_HO_NOT_FEASIBLE:
                imsCode = ImsReasonInfo.CODE_LOCAL_HO_NOT_FEASIBLE;
                break;
