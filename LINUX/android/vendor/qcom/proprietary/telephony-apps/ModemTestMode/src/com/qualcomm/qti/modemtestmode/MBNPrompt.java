...
public class MBNPrompt extends RelativeLayout implements Checkable {
    private boolean mChecked;
    private List<Checkable> mCheckableList;

    public MBNPrompt(Context context, AttributeSet attrs,
            int defStyle) {
    ...
    public MBNPrompt(Context context, int checkableId) {
        super(context);
        initCheckable(null);
    }
