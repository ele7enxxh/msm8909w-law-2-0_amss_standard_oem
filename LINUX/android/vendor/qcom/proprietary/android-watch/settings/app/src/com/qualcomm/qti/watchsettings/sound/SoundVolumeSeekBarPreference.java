...
public class SoundVolumeSeekBarPreference extends SeekBarPreference
        implements PreferenceManager.OnActivityStopListener {
    private static final String TAG = "WatchSoundVolumeSeekBarPreference";
    ...
    public SoundVolumeSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr,
            int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        setLayoutResource(R.layout.sound_preference_volume_slider);
    }
    ...
    public SoundVolumeSeekBarPreference(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SoundVolumeSeekBarPreference(Context context) {
        this(context, null);
    }
 ...
 public void onActivityPause() {
    ...
    private void init() {
        ...
        final SeekBarVolumizer.Callback sbvc = new SeekBarVolumizer.Callback() {
            ...
            @Override
            public void onMuted(boolean muted, boolean zenmute) {
