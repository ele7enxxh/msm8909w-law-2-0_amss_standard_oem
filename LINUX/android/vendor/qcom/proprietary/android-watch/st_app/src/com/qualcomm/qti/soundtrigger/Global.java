...
public class Global {
    ...
    /*public final static String TAG_SOUND_MODEL_TO_QUERY = "soundModelToQuery";
    public final static String TAG_SOUND_MODEL_TO_TRAIN = "soundModelToTrain";*/
    ...
    public ShortBuffer[] getUserRecordings(int numRecordings) {
        return Arrays.copyOfRange(this.userRecordings, 0, numRecordings);
    }
    ...
    //TODO next fix voiceRequestLength not saving,
    // check if this is saving the right length when being called by adding a log
