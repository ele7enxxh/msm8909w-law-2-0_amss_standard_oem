...
import com.qualcomm.qti.soundtrigger.Keyphrase;
import com.qualcomm.qti.soundtrigger.MessageType;
import com.qualcomm.qti.soundtrigger.SoundModel;
import com.qualcomm.qti.soundtrigger.User;
import com.qualcomm.qti.soundtrigger.VwuService;
...
public class SoundModelDetailsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soundmodeldetails);

        Intent intent = new Intent(this, VwuService.class);
        Log.v(TAG, "onCreate: implicit intent: " + intent );
        Intent explicitIntent = new Intent();
        explicitIntent = Utils.createExplicitFromImplicitIntent(this, intent);
    ...
    private void showDeleteSoundModelDialog() {
        ...
        uiContent.setTextColor(getResources().getColor(R.color.text_white));
    ...
    private void initializeUserInterface() {
        ...
        uiOptions = (Button)findViewById(R.id.soundmodeldetails_options);
        ...
        uiOptions.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
            	
                Log.v(TAG, "uiOptionButton.onClick");
                Dialog dialog = new Dialog(SoundModelDetailsActivity.this);
                dialog.setContentView(R.layout.activity_detection_options);
       
                optionsListView = (ListView) dialog.findViewById(R.id.optionsListView); 
                
                
                final String[] menuOptions = new String[] { getString(R.string.soundmodeldetails_popup_copy), 
                									  		getString(R.string.soundmodeldetails_popup_merge),
                									  		getString(R.string.soundmodeldetails_popup_delete) };
                ArrayList<String> menuList = new ArrayList<String>();
                menuList.addAll(Arrays.asList(menuOptions));

                listAdapter = new ArrayAdapter<String>(getApplicationContext(), R.layout.activity_detection_menu, menuList);  
                
                // Set the ArrayAdapter as the ListView's adapter.  
                optionsListView.setAdapter(listAdapter);
                
                optionsListView.setClickable(true);
                ...
                { 
                	...
                	Log.v(TAG, "optionsListView.onItemClick");
        	        Intent intent;

        	        if (menuOptions[position].equals(getApplicationContext().getString(R.string.soundmodeldetails_popup_copy))) {
        	        	copySoundModel();
        	            return;
        	        }

        	        if (menuOptions[position].equals(getApplicationContext().getString(R.string.soundmodeldetails_popup_merge))) {
        	        	showMergingSelection();
        	        	return;
        	        }
        	        if (menuOptions[position].equals(getApplicationContext().getString(R.string.soundmodeldetails_popup_delete))) {
        	        	showDeleteSoundModelDialog();
        	        	return;
        	        }
