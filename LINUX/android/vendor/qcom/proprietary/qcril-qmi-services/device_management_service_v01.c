...
static const uint8_t dms_indication_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_psm_cfg_change) - QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_psm_cfg_change_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
...
static const qmi_idl_service_message_table_entry dms_service_command_messages_v01[] = {
  ...
  {QMI_DMS_INDICATION_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 5), 8},
...
static const qmi_idl_service_message_table_entry dms_service_response_messages_v01[] = {
  ...
  {QMI_DMS_GET_DEVICE_CAP_RESP_V01, QMI_IDL_TYPE16(0, 8), 3430},
