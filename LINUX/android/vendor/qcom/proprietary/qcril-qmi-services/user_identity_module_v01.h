...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/uim/api/user_identity_module_v01.h#7 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Wed Aug 31 2016 (Spin 0)
...
#define UIM_V01_IDL_MINOR_VERS 0x41
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define UIM_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define UIM_V01_MAX_MESSAGE_ID 0x006B
/**
    @}
  */
...
#define UIM_GET_CONFIGURATION_AUTOMATIC_SELECTION_V01 ((uim_get_configuration_mask_v01)0x01) /**<  Automatic selection  */
#define UIM_GET_CONFIGURATION_PERSONALIZATION_STATUS_V01 ((uim_get_configuration_mask_v01)0x02) /**<  Personalization status  */
#define UIM_GET_CONFIGURATION_HALT_SUBSCRIPTION_V01 ((uim_get_configuration_mask_v01)0x04) /**<  Halt subscription  */
#define UIM_GET_CONFIGURATION_USB_UICC_SUPPORTED_V01 ((uim_get_configuration_mask_v01)0x08) /**<  USB UICC is supported  */
#define UIM_GET_CONFIGURATION_SAP_CLIENT_SUPPORTED_V01 ((uim_get_configuration_mask_v01)0x10) /**<  SAP in client mode is supported  */
#define UIM_GET_CONFIGURATION_PERSO_REACTIVATION_STATUS_V01 ((uim_get_configuration_mask_v01)0x20) /**<  Personalization reactivation status  */
#define UIM_GET_CONFIGURATION_REMOTE_SIMLOCK_STORAGE_V01 ((uim_get_configuration_mask_v01)0x40) /**<  Remote simlock storage  */
#define UIM_GET_CONFIGURATION_EMERGENCY_ONLY_V01 ((uim_get_configuration_mask_v01)0x80) /**<  Emergency Only mode status  */
/** @addtogroup uim_qmi_messages
    @{
  */
...
typedef struct {
  ...
  /**<   Requested configurations:\n
      - UIM_GET_CONFIGURATION_AUTOMATIC_SELECTION (0x01) --  Automatic selection 
      - UIM_GET_CONFIGURATION_PERSONALIZATION_STATUS (0x02) --  Personalization status 
      - UIM_GET_CONFIGURATION_HALT_SUBSCRIPTION (0x04) --  Halt subscription 
      - UIM_GET_CONFIGURATION_USB_UICC_SUPPORTED (0x08) --  USB UICC is supported 
      - UIM_GET_CONFIGURATION_SAP_CLIENT_SUPPORTED (0x10) --  SAP in client mode is supported 
      - UIM_GET_CONFIGURATION_PERSO_REACTIVATION_STATUS (0x20) --  Personalization reactivation status 
      - UIM_GET_CONFIGURATION_REMOTE_SIMLOCK_STORAGE (0x40) --  Remote simlock storage 
      - UIM_GET_CONFIGURATION_EMERGENCY_ONLY (0x80) --  Emergency Only mode status 
 \n
...
typedef enum {
  ...
  UIM_APDU_BEHAVIOR_NO_GET_RESPONSE_FOR_WARNING_V01 = 0x01, /**<  APDU behavior is not to issue automatic GET RESPONSE 
       command for warning status words 62XX/63XX. \n
   */
  UIM_APDU_BEHAVIOR_AUTOMATIC_GET_RESPONSE_FOR_WARNING_V01 = 0x02, /**<  APDU behavior is to issue automatic GET RESPONSE 
       command for warning status words 62XX/63XX. \n
   */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Set APDU behavior of modem for 62XX/63XX warning status words */
typedef struct {
 ...
 */
  ...
  /**<   Set behavior of modem for warning status words. Valid values:\n
      - UIM_APDU_BEHAVIOR_NO_GET_RESPONSE_FOR_WARNING (0x01) --  APDU behavior is not to issue automatic GET RESPONSE 
       command for warning status words 62XX/63XX. \n
  
      - UIM_APDU_BEHAVIOR_AUTOMATIC_GET_RESPONSE_FOR_WARNING (0x02) --  APDU behavior is to issue automatic GET RESPONSE 
       command for warning status words 62XX/63XX. \n
  
 Other values are ignored by the service and the error 
 QMI_ERR_INVALID_ARG is returned.
 */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Set APDU behavior of modem for 62XX/63XX warning status words */
typedef struct {
