...
ONCRPC_PATH := $(QCPATH)/oncrpc

include $(QCPATH)/common/build/remote_api_makefiles/target_api_enables.mk
include $(QCPATH)/common/build/remote_api_makefiles/remote_api_defines.mk
include $(QCPATH)/oncrpc/oncrpc_defines.mk
