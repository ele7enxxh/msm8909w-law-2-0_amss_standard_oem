...
ifneq (, $(filter $(PRODUCT_LIST), $(TARGET_PRODUCT)))
  ...
  ifeq ($(wildcard $(QC_PROP_ROOT)/common-noship/etc/device-vendor-noship.mk),)
    XML_CONF_PATH := $(QCPATH)/common/etc
...
$(call inherit-product-if-exists, $(QCPATH)/qrdplus/Extension/products.mk)
# Include the QRD customer extensions for ChinaMobile.
$(call inherit-product-if-exists, $(QCPATH)/qrdplus/ChinaMobile/products.mk)
# Include the QRD customer extensions for ChinaTelecom.
$(call inherit-product-if-exists, $(QCPATH)/qrdplus/ChinaTelecom/products.mk)
# Include the QRD customer extensions for ChinaUnicom.
$(call inherit-product-if-exists, $(QCPATH)/qrdplus/ChinaUnicom/products.mk)
# Include the QRD customer extensions for Regional.
$(call inherit-product-if-exists, $(QCPATH)/qrdplus/Regional/products.mk)
# Include the QRD customer extensions for Regional SP.
$(call inherit-product-if-exists, $(QCPATH)/qrdplus/RegionalSP/*/products.mk)
endif
...
MM_AUDIO += QRD_SKUT_Bluetooth_cal.acdb
MM_AUDIO += QRD_SKUT_General_cal.acdb
MM_AUDIO += QRD_SKUT_Global_cal.acdb
MM_AUDIO += QRD_SKUT_Handset_cal.acdb
MM_AUDIO += QRD_SKUT_Hdmi_cal.acdb
MM_AUDIO += QRD_SKUT_Headset_cal.acdb
MM_AUDIO += QRD_SKUT_Speaker_cal.acdb
...
MM_CAMERA += libchromatix_imx135_adrc
...
MM_CAMERA += libchromatix_ov2680_zs2p80f1_common
MM_CAMERA += libchromatix_ov2680_zs2p80f1_default_video
MM_CAMERA += libchromatix_ov2680_zs2p80f1_preview
MM_CAMERA += libchromatix_ov2680_zs2p80f1_snapshot
...
MM_CAMERA += libchromatix_ar0542_common
MM_CAMERA += libchromatix_ar0542_default_video
MM_CAMERA += libchromatix_ar0542_liveshot
MM_CAMERA += libchromatix_ar0542_preview
MM_CAMERA += libchromatix_ar0542_snapshot
MM_CAMERA += libmmcamera_ar0542
...
MM_CAMERA += libmmcamera_ov2680_zs2p80f1
...
#OMA_PACKAGES - Packages for OMA DRM and CP
...
SENSORS += activity_recognition.msm8909
...
PRODUCT_PACKAGES += $(WATCH_PACKAGES)
