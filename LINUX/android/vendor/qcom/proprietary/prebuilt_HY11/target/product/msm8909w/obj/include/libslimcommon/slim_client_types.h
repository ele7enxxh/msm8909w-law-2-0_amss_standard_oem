...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/7.5/gnss/slim/common/client/inc/slim_client_types.h#4 $ */
...
typedef enum
{
  ...
  eSLIM_PED_ALIGNMENT_EVENT_UNSTABLE_DEVICE_MOTION  = 4,
  /**< Unstabel device motion detected */
  /* Add new events here. */
...
/** Pedestrian alignment event mask can be set to represent one or a group
    ...
    - Set value:              SLIM_MASK_SET
      Example:                SLIM_MASK_SET(mask, eSLIM_PED_ALIGNMENT_EVENT_TURN_DETECTED);
    - Clear value:            SLIM_MASK_CLEAR
      Example:                SLIM_MASK_CLEAR(mask, eSLIM_PED_ALIGNMENT_EVENT_TURN_DETECTED);
    - Check if value is set:  SLIM_MASK_IS_SET
      Example:                if (SAML_MASK_IS_SET(mask, eSLIM_PED_ALIGNMENT_EVENT_TURN_DETECTED))
                              {
                                ...
                              }
**/
