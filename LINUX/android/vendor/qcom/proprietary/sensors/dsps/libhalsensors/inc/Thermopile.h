/*============================================================================
  ...
  @brief
  Thermopile class definition.

  Copyright (c) 2015 Qualcomm Technologies, Inc.  All Rights Reserved.
  Qualcomm Technologies Proprietary and Confidential.
============================================================================*/
#ifndef ANDROID_THERMOPILE_SENSOR_H
#define ANDROID_THERMOPILE_SENSOR_H
...
class Thermopile : public SMGRSensor {
public:
    Thermopile(int handle);
    ~Thermopile();
/*===========================================================================
