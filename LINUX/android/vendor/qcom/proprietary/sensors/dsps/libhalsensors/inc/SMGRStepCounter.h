/*============================================================================
  @file SMGRStepCounter.h

  @brief
  SMGRStepCounter class definition.

  Copyright (c) 2014-2015 Qualcomm Technologies, Inc.  All Rights Reserved.
  Qualcomm Technologies Proprietary and Confidential.
============================================================================*/
#ifndef ANDROID_SMGR_STEPCOUNTER_SENSOR_H
#define ANDROID_SMGR_STEPCOUNTER_SENSOR_H

#include "SMGRSensor.h"

/*============================================================================
 * Class SMGRStepCounter
=============================================================================*/

class SMGRStepCounter : public SMGRSensor {
    uint32_t smgr_last_step_count;
public:
	SMGRStepCounter(int handle);
	 ~SMGRStepCounter();
/*===========================================================================
