...
#ifndef SNS_LA_SIM
/*
 * Class:     com_qualcomm_qti_sensors_core_sensortest_SensorsReg
 * Method:    setRegistryValue
 * Signature: (S[BB)I
 */
JNIEXPORT jint JNICALL Java_com_qualcomm_qti_sensors_core_sensortest_SensorsReg_setRegistryValue
 ...
 * Signature: (S)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_qualcomm_qti_sensors_core_sensortest_SensorsReg_getRegistryValue
  (JNIEnv *, jclass, jint);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_qualcomm_qti_sensors_core_sensortest_SensorsReg_open
  (JNIEnv *, jclass);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_qualcomm_qti_sensors_core_sensortest_SensorsReg_close
  (JNIEnv *, jclass);
#endif /* SNS_LA_SIM */
#endif /* _SENSOR_REG_ */
