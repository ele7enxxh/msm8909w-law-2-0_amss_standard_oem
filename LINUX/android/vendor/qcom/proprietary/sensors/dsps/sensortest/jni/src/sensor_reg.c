...
Java_com_qualcomm_qti_sensors_core_sensortest_SensorsReg_setRegistryValue
...
Java_com_qualcomm_qti_sensors_core_sensortest_SensorsReg_getRegistryValue
...
JNIEXPORT jint JNICALL
Java_com_qualcomm_qti_sensors_core_sensortest_SensorsReg_open( JNIEnv *env, jclass class )
{
   return sensor_reg_open();
}

JNIEXPORT jint JNICALL
Java_com_qualcomm_qti_sensors_core_sensortest_SensorsReg_close( JNIEnv *env, jclass class )
{
...
static const JNINativeMethod gMethods[] = {
   { "setRegistryValue",
     "(I[BB)I",
     (void*)Java_com_qualcomm_qti_sensors_core_sensortest_SensorsReg_setRegistryValue
   },
   { "getRegistryValue",
     "(I)[B",
     (void*)Java_com_qualcomm_qti_sensors_core_sensortest_SensorsReg_getRegistryValue
   },
   { "open",
     "()I",
     (void*)Java_com_qualcomm_qti_sensors_core_sensortest_SensorsReg_open
   },
   { "close",
     "()I",
     (void*)Java_com_qualcomm_qti_sensors_core_sensortest_SensorsReg_close
   }
};
...
registerMethods(JNIEnv* env)
{
   static const char* const kClassName =
                        "com/qualcomm/qti/sensors/core/sensortest/SensorsReg";
   jclass class;
