...
#define SNS_PRINTF_STRING_LOW_0(module_id,str)                          \
  {                                                                     \
    ...
    {                                                                   \
      ...
      format_params.filename = strrchr( __FILE__, '/');                 \
      if( format_params.filename == NULL ) format_params.filename =  strrchr( __FILE__, '\\' ); \
      if( format_params.filename == NULL ) format_params.filename = __FILE__; \
      else format_params.filename++;                                    \
      format_params.num_params_valid = 0;                               \
      sns_debug_printf_string(module_id,SNS_MSG_LOW,str,&format_params); \
    }                                                                   \
  }
...
#define SNS_PRINTF_STRING_LOW_1(module_id,str,parameter1)               \
  {                                                                     \
    ...
    {                                                                   \
      ...
      format_params.param1 = (intptr_t)(parameter1);                    \
...
#define SNS_PRINTF_STRING_LOW_2(module_id,str,parameter1,parameter2)    \
  {                                                                     \
    ...
    {                                                                   \
      ...
      format_params.param1 = (intptr_t)(parameter1);                    \
      format_params.param2 = (intptr_t)(parameter2);                    \
...
#define SNS_PRINTF_STRING_LOW_3(module_id,str,parameter1,parameter2,parameter3) \
  {                                                                     \
    ...
    {                                                                   \
      ...
      format_params.param1 = (intptr_t)(parameter1);                    \
      format_params.param2 = (intptr_t)(parameter2);                    \
      format_params.param3 = (intptr_t)(parameter3);                    \
      MSG_3(MSG_SSID_SNS,MSG_LEGACY_LOW,str,format_params.param1,       \
...
#define SNS_PRINTF_STRING_MEDIUM_0(module_id,str)                       \
  {                                                                     \
    ...
    {                                                                   \
      ...
      format_params.num_params_valid = 0;                               \
      sns_debug_printf_string(module_id,SNS_MSG_MEDIUM,str,&format_params); \
    }                                                                   \
  }
...
#define SNS_PRINTF_STRING_HIGH_0(module_id,str)                         \
  {                                                                     \
    ...
    {                                                                   \
      ...
      format_params.num_params_valid = 0;                               \
      sns_debug_printf_string(module_id,SNS_MSG_HIGH,str,&format_params); \
    }                                                                   \
  }
...
#define SNS_PRINTF_STRING_FATAL_0(module_id,str)                        \
  {                                                                     \
    ...
    {                                                                   \
      ...
      format_params.num_params_valid = 0;                               \
      sns_debug_printf_string(module_id,SNS_MSG_FATAL,str,&format_params); \
    }                                                                   \
  }
...
#define SNS_PRINTF_STRING_ERROR_0(module_id,str)                        \
  {                                                                     \
    ...
    {                                                                   \
      ...
      format_params.num_params_valid = 0;                               \
      sns_debug_printf_string(module_id,SNS_MSG_ERROR,str,&format_params); \
    }                                                                   \
  }
