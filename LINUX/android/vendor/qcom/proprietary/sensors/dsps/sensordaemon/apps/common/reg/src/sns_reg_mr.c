    ...
    void *service_cookie )
{
  ...
  qmi_err = qmi_idl_get_message_c_struct_len( SNS_REG2_SVC_get_service_object_v02(),
...
sns_reg_mr_init()
{
  ...
  qmi_csi_error csi_err;
  qmi_idl_service_object_type service_obj = SNS_REG2_SVC_get_service_object_v02();
