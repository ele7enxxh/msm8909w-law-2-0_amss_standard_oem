...
public class SensorAdapter extends QSensor {
  ...
  static {
    ...
    try {
        SensorAdapter.isAudioPlayer = QSensorContext.readProperty("persist.sensors.no_audio").equals("false");
        Log.d(QSensorContext.TAG,"persist.sensors.no_audio:" + SensorAdapter.isAudioPlayer);
    } catch(IOException e) {
      e.printStackTrace();
    }
