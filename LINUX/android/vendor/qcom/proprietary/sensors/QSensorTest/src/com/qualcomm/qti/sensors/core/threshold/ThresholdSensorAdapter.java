...
============================================================================*/
package com.qualcomm.qti.sensors.core.threshold;
...
import com.qualcomm.qti.sensors.core.stream.SensorListener;
...
public class ThresholdSensorAdapter extends SensorAdapter {
   ...
   public void thresholdIs(int streamRate, int threshXValue, int threshYValue, int threshZValue) {
     ...
     Log.d(QSensorContext.TAG, "Change threshold sensor rate for " + this.sensor().getType() +
     ...
     if(-1 != streamRate) {
       try {
         ...
         Log.e(QSensorContext.TAG, "Error registering threshold");
       }
     }
   }
}