...
public class SuspendMonitor {
  ...
  public SuspendMonitor(){
    ...
    this.pm = (PowerManager) QSensorContext.getContext().getSystemService(Context.POWER_SERVICE);
    this.wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK,"beep");
    this.ringTone = RingtoneManager.getRingtone(QSensorContext.getContext(), notificationRing);
  }
