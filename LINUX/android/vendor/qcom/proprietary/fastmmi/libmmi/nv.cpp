...
int process_diag_data(unsigned char *ptr, int len, void *context_data) {
    ...
    MMI_ALOGI("Process diag reply data");
    ...
    MMI_ALOGI("rsp cmd_code=%d, item_id=%d, data_size=%d\n", cmd_code, rspItem.item_id, rspItem.length);
...
void register_callback(void) {
    ...
    MMI_ALOGI("diag: register callback for handle diag data\n");
