...
public class QualcommSettings extends PreferenceActivity implements
   ...
   public static final String ENABLE_441KHZ_NATIVE_SUPPORT = "enable_441KHz_native_support";
   ...
   private CheckBoxPreference Enable441KHz;
   ...
   @Override
      ...
      public void onCreate(Bundle icicle)
      {
         ...
         Enable441KHz = (CheckBoxPreference)findPreference(ENABLE_441KHZ_NATIVE_SUPPORT);
         ...
         /* CABL version 1 and SVI are incompatible */
         if(SystemProperties.getInt("ro.qualcomm.cabl", 0) != 1) {
             if(SystemProperties.getInt("ro.qualcomm.svi", 0) == 1)
   ...
   private void update441KHzNativeSupport()
   {
       int status_441KHz=0;
       SharedPreferences qcSharedPref = getSharedPreferences("settings_preferences", 0);
       status_441KHz = qcSharedPref.getInt(ENABLE_441KHZ_NATIVE_SUPPORT, 0);
       if(status_441KHz==1){
           Enable441KHz.setChecked(true);
           mAudioManager.setParameters("audio.nat.codec.enabled=true");
           Enable441KHz.setSummary("Enabled");
       }else{
           Enable441KHz.setChecked(false);
           mAudioManager.setParameters("audio.nat.codec.enabled=false");
           Enable441KHz.setSummary("Disabled");
       }
   }
  ...
  private void change441KHzStatus()
   {
       boolean enabled_441KHz = Enable441KHz.isChecked();
       mAudioManager.setParameters("audio.nat.codec.enabled="+(enabled_441KHz ? "true" : "false"));
       Enable441KHz.setSummary(enabled_441KHz ? "Enabled":"Disabled");
       SharedPreferences qcSharedPref = getSharedPreferences("settings_preferences", 0);
       SharedPreferences.Editor editor = qcSharedPref.edit();
       editor.putInt(ENABLE_441KHZ_NATIVE_SUPPORT, enabled_441KHz ? 1 : 0);
       editor.commit();
   }
  ...
  private void changeDIAGSettings()
  {
   ...
   public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
     ...
     else if (key.equals(ENABLE_441KHZ_NATIVE_SUPPORT)) {
         change441KHzStatus();
      }
