...
public class MultiSimSettings extends PreferenceActivity implements
    ...
    private static final String TUNE_AWAY_STATUS = "tune_away_status";
    private static final String PRIORITY_SUBSCRIPTION_INDEX = "priority_subscription_index";
    private SharedPreferences mSimSettingPreferences;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSimSettingPreferences = PreferenceManager.getDefaultSharedPreferences(mContext);
    ...
    private void updateTuneAwayReceiverSummary() {
        boolean tuneAway =  (mSimSettingPreferences.getInt(TUNE_AWAY_STATUS,0) == 1);
    ...
    private void updatePrioritySubscriptionSummary() {
        ...
        mPrioritySubscription.setEntryValues(entryValues);
            ...
            int prioritySubIndex =  mSimSettingPreferences.getInt(PRIORITY_SUBSCRIPTION_INDEX,0);
     ...
     private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            SharedPreferences.Editor editor = mSimSettingPreferences.edit();
            switch (msg.what) {
                case EVENT_SET_TUNE_AWAY_DONE:
                    boolean qcRilTuneAwayResult = (boolean) msg.obj;
                    if (qcRilTuneAwayResult) {
                        if (mTuneAway) {
                            editor.putInt(TUNE_AWAY_STATUS, TUNE_AWAY_RECEIVER_ENABLED);
                        } else {
                            editor.putInt(TUNE_AWAY_STATUS, TUNE_AWAY_RECEIVER_DISABLED);
                        }
                        editor.commit();
                        updateTuneAwayReceiverSummary();
                    } else {
                ...
                case EVENT_SET_PRIORITY_SUBSCRIPTION_DONE:
                    ...
                    if (qcRilPrioritySubResult) {
                        editor.putInt(PRIORITY_SUBSCRIPTION_INDEX, mSubscriptionIndex);
                        editor.commit();
                        updatePrioritySubscriptionSummary();
                    } else {
