...
#-------------------------------------------------------------------------------
#
#  $Header: //source/qcom/qct/core/pkg/wcnss/pr/rel/2.2/tools/build/scons/gensecimage/mbn_tools.py#2 $
#  $DateTime: 2013/08/13 14:34:07 $
#  $Author: coresvc $
...
def modify_relocatable_flags(env, output_elf ):
   ...
   #Set default to 1MB alignment if given value is not an allowed value
   alignment_value = env.get('alignvalue',[0x0])[0]
   if alignment_value not in ALLOWED_IMG_ALIGN_VALUES:
       alignment_value = ALLOWED_IMG_ALIGN_VALUES[0]
