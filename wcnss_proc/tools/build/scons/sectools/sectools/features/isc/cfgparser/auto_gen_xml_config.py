...
class complex_image(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, image_type=None, sign_id=None, cert_config=None, name=None, pil_split=None, general_properties_overrides=None, signing_attributes_overrides=None, meta_build_location=None, post_process_commands=None):
