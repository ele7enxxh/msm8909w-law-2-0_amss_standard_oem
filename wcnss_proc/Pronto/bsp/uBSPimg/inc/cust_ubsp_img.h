...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.wcnss/4.1/Pronto/bsp/uBSPimg/inc/cust_ubsp_img.h#1 $
...
/* 0.1.10 modem tmc changes */
#undef FEATURE_MODEM_TARGET_BUILD
