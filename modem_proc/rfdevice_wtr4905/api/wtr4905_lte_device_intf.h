/*!
  @file wtr4905_lte_api.h

  @brief
  Exports prototypes for WTR4905 device interface maping functions.

  @addtogroup WTR4905_LTE
  @{
*/
...
$DateTime: 2016/12/13 08:00:30 $ $Author: mplcsds1 $
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfdevice_wtr4905/api/wtr4905_lte_device_intf.h#1 $ 
...
08/02/12   shb     Moved wtr4905_lte_set_rx/tx_port() from 
                   wtr4905_lte_api.h to wtr4905_lte.h
07/13/12   vss     Add support for LTE instance 1 
07/12/12   sr      Add conditional extern 'C'  
04/03/12   shb     Deleted unused APIs: rfdevice_lte_wtr4905_<rx/tx>_config
07/18/11   aca     Interface Update- WTR 1605 development
07/07/11   aca     Multi device support
07/05/11   aca     Initial version.
==============================================================================*/ 

#ifndef WTR4905_LTE_API_H
#define WTR4905_LTE_API_H
...
#define WTR4905_MAX_LTE_DEVICES 2
