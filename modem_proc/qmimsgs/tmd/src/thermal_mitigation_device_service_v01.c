...
GENERAL DESCRIPTION
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/qmimsgs/tmd/src/thermal_mitigation_device_service_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
static const qmi_idl_message_table_entry tmd_message_table_v01[] = {
  {sizeof(tmd_get_mitigation_device_list_req_msg_v01), 0},
...
static const qmi_idl_service_message_table_entry tmd_service_command_messages_v01[] = {
  {QMI_TMD_GET_SUPPORTED_MSGS_REQ_V01, QMI_IDL_TYPE16(1, 0), 0},
  {QMI_TMD_GET_SUPPORTED_FIELDS_REQ_V01, QMI_IDL_TYPE16(1, 2), 5},
  {QMI_TMD_GET_MITIGATION_DEVICE_LIST_REQ_V01, QMI_IDL_TYPE16(0, 0), 0},
  {QMI_TMD_SET_MITIGATION_LEVEL_REQ_V01, QMI_IDL_TYPE16(0, 2), 40},
  {QMI_TMD_GET_MITIGATION_LEVEL_REQ_V01, QMI_IDL_TYPE16(0, 4), 36},
  {QMI_TMD_REGISTER_NOTIFICATION_MITIGATION_LEVEL_REQ_V01, QMI_IDL_TYPE16(0, 6), 36},
  {QMI_TMD_DEREGISTER_NOTIFICATION_MITIGATION_LEVEL_REQ_V01, QMI_IDL_TYPE16(0, 8), 36}
};

static const qmi_idl_service_message_table_entry tmd_service_response_messages_v01[] = {
  {QMI_TMD_GET_SUPPORTED_MSGS_RESP_V01, QMI_IDL_TYPE16(1, 1), 8204},
  {QMI_TMD_GET_SUPPORTED_FIELDS_RESP_V01, QMI_IDL_TYPE16(1, 3), 115},
  {QMI_TMD_GET_MITIGATION_DEVICE_LIST_RESP_V01, QMI_IDL_TYPE16(0, 1), 1099},
  {QMI_TMD_SET_MITIGATION_LEVEL_RESP_V01, QMI_IDL_TYPE16(0, 3), 7},
  {QMI_TMD_GET_MITIGATION_LEVEL_RESP_V01, QMI_IDL_TYPE16(0, 5), 15},
  {QMI_TMD_REGISTER_NOTIFICATION_MITIGATION_LEVEL_RESP_V01, QMI_IDL_TYPE16(0, 7), 7},
  {QMI_TMD_DEREGISTER_NOTIFICATION_MITIGATION_LEVEL_RESP_V01, QMI_IDL_TYPE16(0, 9), 7}
};

static const qmi_idl_service_message_table_entry tmd_service_indication_messages_v01[] = {
  {QMI_TMD_MITIGATION_LEVEL_REPORT_IND_V01, QMI_IDL_TYPE16(0, 10), 40}
};
