...
GENERAL DESCRIPTION
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/qmimsgs/dsd/src/data_system_determination_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Sat Jan 30 2016 (Spin 0)
...
static const uint8_t dsd_indication_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_roaming_status_change) - QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_roaming_status_change_valid)),
  0x15,
   QMI_IDL_GENERIC_1_BYTE,
...
static const uint8_t dsd_wqe_profile_init_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, wifi_rssi_threshold_high) - QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, wifi_rssi_threshold_high_valid)),
  0x11,
   QMI_IDL_GENERIC_2_BYTE,
...
static const qmi_idl_service_message_table_entry dsd_service_command_messages_v01[] = {
  ...
  {QMI_DSD_INDICATION_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 46), 24},
