...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/qmimsgs/lowi/api/lowi_service_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define LOWI_V01_IDL_MINOR_VERS 0x03
...
typedef struct {
  ...
  /**<   Indicates whether RTT3 is supported by the node. */
