...
GENERAL DESCRIPTION
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/qmimsgs/lowi/src/lowi_service_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.14.5 
   It was generated on: Thu May 14 2015 (Spin 0)
...
static const uint8_t QmiLowiBatchingSubscriptionRequest_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(QmiLowiBatchingSubscriptionRequest_v01, maxApsPerScan) - QMI_IDL_OFFSET8(QmiLowiBatchingSubscriptionRequest_v01, maxApsPerScan_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
...
static const uint8_t QmiLowiBatchingSubscriptionInd_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(QmiLowiBatchingSubscriptionInd_v01, numAPAvailable) - QMI_IDL_OFFSET8(QmiLowiBatchingSubscriptionInd_v01, numAPAvailable_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
...
static const qmi_idl_service_message_table_entry lowi_service_command_messages_v01[] = {
  ...
  {QMI_LOWI_BATCHING_SUBSCRIPTION_REQ_V01, QMI_IDL_TYPE16(0, 9), 26},
  {QMI_LOWI_GET_BATCHING_RESULTS_REQ_V01, QMI_IDL_TYPE16(0, 11), 22},
  {QMI_LOWI_BGSCAN_BATCHING_SUBSCRIPTION_REQ_V01, QMI_IDL_TYPE16(0, 9), 26},
...
static const qmi_idl_service_message_table_entry lowi_service_indication_messages_v01[] = {
  ...
  {QMI_LOWI_BATCHING_SUBSCRIPTION_IND_V01, QMI_IDL_TYPE16(0, 10), 22},
  {QMI_LOWI_GET_BATCHING_RESULTS_IND_V01, QMI_IDL_TYPE16(0, 12), 6025},
  {QMI_LOWI_BGSCAN_BATCHING_SUBSCRIPTION_IND_V01, QMI_IDL_TYPE16(0, 10), 22},
