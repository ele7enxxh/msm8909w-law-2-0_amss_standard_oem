...
Confidential and Proprietary - Qualcomm Technologies, Inc.
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/qmimsgs/atp/api/application_traffic_pairing_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.7 
   It was generated on: Tue Feb 25 2014 (Spin 1)
...
typedef struct {
  ...
  */
  ...
  /**<   Values:  \n
       - 0 -- Do not report \n
       - 1 -- Report a change in the policy information
  */
...
/** @addtogroup atp_qmi_messages
    @{
  */
/** Response Message; Queries the ATP activation status. */
typedef struct {
...
/** @addtogroup atp_qmi_messages
    @{
  */
/** Response Message; Queries the ATP policy information. */
typedef struct {
...
typedef struct {
  ...
  */
  ...
  /**<   Timeout value for each filter report; if no acknowledgment is received 
       from the network in the duration, a socket call is returned.
  */
...
typedef struct {
  ...
  /**<   Unique ID for this policy information report (same for all segments).\n
       0x00 is reserved; do not use.
  */

  uint32_t total_list_entries;
  /**<   Total number of entries in the list received from the network.
       For example, if the list has a total of 500 entries and is sent in 
...
/** @addtogroup atp_qmi_messages
    @{
  */
/** Indication Message; Indicates a change in ATP policy information. */
typedef struct {
...
typedef enum {
  ...
  ATP_FILTER_ACTION_ADD_V01 = 0x01, /**<  Add the filter \n  */
  ATP_FILTER_ACTION_REMOVE_V01 = 0x02, /**<  Delete the filter  */
...
typedef enum {
  ...
  ATP_FILTER_PROTOCOL_UDP_V01 = 0, /**<  Protocol is UDP \n  */
  ATP_FILTER_PROTOCOL_TCP_V01 = 1, /**< Protocol is TCP  */
...
typedef enum {
  ...
  ATP_FILTER_ADDR_V4_V01 = 0, /**<  IPv4 filter \n */
  ATP_FILTER_ADDR_V6_V01 = 1, /**<  IPv6 filter  */
...
typedef struct {
  ...
  */
  ...
  /**<   IPv6 prefix length (in number of bits). Values: 0 to 128.
  */
...
/** @addtogroup atp_qmi_messages
    @{
  */
/** Request Message; Requests a filter report from the modem. */
typedef struct {

  /* Mandatory */
  /*  Report ID */
  uint32_t report_id;
  /**<   A track ID, generated by the control point, that is returned
  ...
  /**<   Filter action. Values: \n
      - ATP_FILTER_ACTION_ADD (0x01) --  Add the filter \n 
      - ATP_FILTER_ACTION_REMOVE (0x02) --  Delete the filter 
 */
  ...
  /**<   IP type: IPv4 or IPv6. Values: \n
      - ATP_FILTER_ADDR_V4 (0) --  IPv4 filter \n
      - ATP_FILTER_ADDR_V6 (1) --  IPv6 filter 
 */
  ...
  */
  ...
  /**<   Protocol type. Values: \n
      - ATP_FILTER_PROTOCOL_UDP (0) --  Protocol is UDP \n 
      - ATP_FILTER_PROTOCOL_TCP (1) -- Protocol is TCP 
 */
...
/** @addtogroup atp_qmi_messages
    @{
  */
/** Response Message; Requests a filter report from the modem. */
typedef struct {
