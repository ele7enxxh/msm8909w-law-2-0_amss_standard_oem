...
*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  (c) 2011-2014 Qualcomm Technologies, Inc.
  All rights reserved.
  Confidential and Proprietary - Qualcomm Technologies, Inc.


  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/qmimsgs/auth/api/authentication_service_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define AUTH_V01_IDL_MINOR_VERS 0x08
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define AUTH_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define AUTH_V01_MAX_MESSAGE_ID 0x002B
/**
    @}
  */
