#ifndef SAP_SERVICE_01_H
#define SAP_SERVICE_01_H
/**
...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/qmimsgs/sap/api/service_access_proxy_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define SAP_V01_IDL_MINOR_VERS 0x02
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define SAP_V01_IDL_TOOL_VERS 0x06
...
/** @addtogroup sap_qmi_msg_ids
    @{
  */
#define QMI_SAP_REGISTER_GET_SUPPORTED_MSGS_REQ_V01 0x001E
#define QMI_SAP_REGISTER_GET_SUPPORTED_MSGS_RESP_V01 0x001E
#define QMI_SAP_REGISTER_GET_SUPPORTED_FIELDS_REQ_V01 0x001F
#define QMI_SAP_REGISTER_GET_SUPPORTED_FIELDS_RESP_V01 0x001F
