...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/qmimsgs/wms/api/wireless_messaging_service_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define WMS_V01_IDL_MINOR_VERS 0x18
...
typedef struct {
  ...
  */
  ...
  /**<   Indicates whether the service is ready to handle 3GPP/3GPP2 SMS requests.
       ...
       - 0x03 -- Both 3GPP SMS and 3GPP2 SMS services are ready \n
