...
GENERAL DESCRIPTION
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/qmimsgs/ssreq/src/subsystem_request_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
static const uint8_t qmi_ssreq_system_shutdown_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_ssreq_system_shutdown_req_msg_v01, res_code) - QMI_IDL_OFFSET8(qmi_ssreq_system_shutdown_req_msg_v01, res_code_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_ssreq_system_shutdown_req_msg_v01, res_code)
};
...
static const uint8_t qmi_ssreq_system_restart_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_ssreq_system_restart_req_msg_v01, res_code) - QMI_IDL_OFFSET8(qmi_ssreq_system_restart_req_msg_v01, res_code_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_ssreq_system_restart_req_msg_v01, res_code)
};
...
static const uint8_t qmi_ssreq_peripheral_restart_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_ssreq_peripheral_restart_req_msg_v01, res_code) - QMI_IDL_OFFSET8(qmi_ssreq_peripheral_restart_req_msg_v01, res_code_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(qmi_ssreq_peripheral_restart_req_msg_v01, res_code)
};
...
static const qmi_idl_service_message_table_entry ssreq_service_command_messages_v01[] = {
  {QMI_SSREQ_SYSTEM_SHUTDOWN_REQ_V01, QMI_IDL_TYPE16(0, 0), 14},
  {QMI_SSREQ_SYSTEM_RESTART_REQ_V01, QMI_IDL_TYPE16(0, 3), 14},
  {QMI_SSREQ_PERIPHERAL_RESTART_REQ_V01, QMI_IDL_TYPE16(0, 6), 14}
};
