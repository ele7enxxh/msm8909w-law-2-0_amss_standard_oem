...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/qmimsgs/ctl/api/control_service_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.14.2 
   It was generated on: Thu Nov 20 2014 (Spin 5)
...
typedef struct {
  ...
  /**<   QMI service type, as defined in \hyperref[Q2]{[Q2]}.
  */
...
typedef struct {
  ...
  /**<   Handle specified by the control point representing the Power Save state.
       The client-specified value is to match the value used in
       QMI_CTL_SET_PWR_SAVE_MODE_REQ. \n
       Reserved values: 0x00 through 0xFF.
  */
...
typedef struct {
  ...
  /**<   Handle specified by the control point representing the Power Save state.
       ...
       QMI_CTL_CONFIG_PWR_SAVE_SETTINGS_EXT. \n
       Reserved values: 0x00 through 0xFF.
  */

  uint8_t response_reporting;
  /**<   Indicates whether QMI response messages are to be reported when the 
       Power Save state is not set to NORMAL. Values: \n
...
/** @addtogroup ctl_qmi_messages
    @{
  */
/** Request Message; Sets the control service reporting conditions for the requesting 
           control point. */
typedef struct {
  ...
  /**<   Indicates whether available QMI services are to be reported. 
         Values: \n
         - 0 -- Do not report \n
...
/** @addtogroup ctl_qmi_messages
    @{
  */
/** Response Message; Sets the control service reporting conditions for the requesting 
           control point. */
typedef struct {
...
/** @addtogroup ctl_qmi_messages
    @{
  */
/** Request Message; Queries the versions of all QMI services supported by the device. */
typedef struct {
...
/** @addtogroup ctl_qmi_messages
    @{
  */
/** Request Message; Synchronizes the service provider and service consumer. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup ctl_qmi_messages
    @{
  */
/** Indication Message; Synchronizes the service provider and service consumer. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup ctl_qmi_messages
    @{
  */
/** Request Message; Gets the current QMI framework Power Save mode. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
typedef struct {
  ...
  */
  ...
  uint8_t response_reporting;
  /**<   Indicates whether QMI response messages are reported for the current 
       Power Save state. Values: \n
       - 0 -- Do not report responses \n
       - 1 -- Report responses even when Power Save state is not set to NORMAL
  */
...
/** @addtogroup ctl_qmi_messages
    @{
  */
/** Request Message; Gets the response reporting settings of all configured power states. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup ctl_qmi_messages
    @{
  */
/** Response Message; Gets the response reporting settings of all configured power states. */
typedef struct {
...
/** @addtogroup ctl_qmi_messages
    @{
  */
/** Request Message; Configures the list of QMI services to be reported 
    to the control point when the services become available.  */
typedef struct {
...
/** @addtogroup ctl_qmi_messages
    @{
  */
/** Response Message; Configures the list of QMI services to be reported 
    to the control point when the services become available.  */
typedef struct {
...
/** @addtogroup ctl_qmi_messages
    @{
  */
/** Request Message; Queries the list of QMI services to be reported 
    to the TE when the service is available.  */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup ctl_qmi_messages
    @{
  */
/** Indication Message; Indicates that a service in the QMI Service Available list is 
           available. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
...
//#define REMOVE_QMI_CTL_CONFIGURE_RESPONSE_FILTERING_IN_PWR_SAVE_V01 
//#define REMOVE_QMI_CTL_CONFIG_PWR_SAVE_SETTINGS_V01 
//#define REMOVE_QMI_CTL_CONFIG_PWR_SAVE_SETTINGS_EXT_V01 
//#define REMOVE_QMI_CTL_GET_CLIENT_ID_V01 
//#define REMOVE_QMI_CTL_GET_PWR_SAVE_MODE_V01 
//#define REMOVE_QMI_CTL_GET_RESPONSE_FILTERING_SETTING_IN_PWR_SAVE_V01 
//#define REMOVE_QMI_CTL_GET_SVC_AVAIL_LIST_V01 
//#define REMOVE_QMI_CTL_GET_VERSION_INFO_V01 
//#define REMOVE_QMI_CTL_INVALID_CLIENT_ID_IND_V01 
//#define REMOVE_QMI_CTL_PWR_SAVE_MODE_IND_V01 
//#define REMOVE_QMI_CTL_REG_PWR_SAVE_MODE_V01 
//#define REMOVE_QMI_CTL_RELEASE_CLIENT_ID_V01 
//#define REMOVE_QMI_CTL_REVOKE_CLIENT_ID_IND_V01 
//#define REMOVE_QMI_CTL_SET_DATA_FORMAT_V01 
//#define REMOVE_QMI_CTL_SET_EVENT_REPORT_V01 
//#define REMOVE_QMI_CTL_SET_INSTANCE_ID_V01 
//#define REMOVE_QMI_CTL_SET_PWR_SAVE_MODE_V01 
//#define REMOVE_QMI_CTL_SET_SVC_AVAIL_LIST_V01 
//#define REMOVE_QMI_CTL_SVC_AVAIL_IND_V01 
//#define REMOVE_QMI_CTL_SYNC_V01 
//#define REMOVE_QMI_CTL_SYNC_IND_V01 
