...
GENERAL DESCRIPTION
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/qmimsgs/ctl/src/control_service_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
static const qmi_idl_service_message_table_entry ctl_service_command_messages_v01[] = {
  {QMI_CTL_SET_INSTANCE_ID_REQ_V01, QMI_IDL_TYPE16(0, 0), 4},
  {QMI_CTL_GET_VERSION_INFO_REQ_V01, QMI_IDL_TYPE16(0, 2), 0},
  {QMI_CTL_GET_CLIENT_ID_REQ_V01, QMI_IDL_TYPE16(0, 4), 4},
  {QMI_CTL_RELEASE_CLIENT_ID_REQ_V01, QMI_IDL_TYPE16(0, 6), 5},
  {QMI_CTL_SET_DATA_FORMAT_REQ_V01, QMI_IDL_TYPE16(0, 10), 13},
  {QMI_CTL_SYNC_REQ_V01, QMI_IDL_TYPE16(0, 12), 0},
  {QMI_CTL_REG_PWR_SAVE_MODE_REQ_V01, QMI_IDL_TYPE16(0, 15), 4},
  {QMI_CTL_CONFIG_PWR_SAVE_SETTINGS_REQ_V01, QMI_IDL_TYPE16(0, 18), 32},
  {QMI_CTL_SET_PWR_SAVE_MODE_REQ_V01, QMI_IDL_TYPE16(0, 20), 7},
  {QMI_CTL_GET_PWR_SAVE_MODE_REQ_V01, QMI_IDL_TYPE16(0, 22), 0},
  {QMI_CTL_CONFIGURE_RESPONSE_FILTERING_IN_PWR_SAVE_REQ_V01, QMI_IDL_TYPE16(0, 24), 1279},
  {QMI_CTL_GET_RESPONSE_FILTERING_SETTING_IN_PWR_SAVE_REQ_V01, QMI_IDL_TYPE16(0, 26), 0},
  {QMI_CTL_SET_SVC_AVAIL_LIST_REQ_V01, QMI_IDL_TYPE16(0, 30), 259},
  {QMI_CTL_GET_SVC_AVAIL_LIST_REQ_V01, QMI_IDL_TYPE16(0, 32), 0},
  {QMI_CTL_SET_EVENT_REPORT_REQ_V01, QMI_IDL_TYPE16(0, 28), 4},
...
static const qmi_idl_service_message_table_entry ctl_service_response_messages_v01[] = {
  {QMI_CTL_SET_INSTANCE_ID_RESP_V01, QMI_IDL_TYPE16(0, 1), 12},
  {QMI_CTL_GET_VERSION_INFO_RESP_V01, QMI_IDL_TYPE16(0, 3), 2821},
  {QMI_CTL_GET_CLIENT_ID_RESP_V01, QMI_IDL_TYPE16(0, 5), 12},
  {QMI_CTL_RELEASE_CLIENT_ID_RESP_V01, QMI_IDL_TYPE16(0, 7), 12},
  {QMI_CTL_SET_DATA_FORMAT_RESP_V01, QMI_IDL_TYPE16(0, 11), 16},
  {QMI_CTL_SYNC_RESP_V01, QMI_IDL_TYPE16(0, 13), 7},
  {QMI_CTL_REG_PWR_SAVE_MODE_RESP_V01, QMI_IDL_TYPE16(0, 16), 7},
  {QMI_CTL_CONFIG_PWR_SAVE_SETTINGS_RESP_V01, QMI_IDL_TYPE16(0, 19), 7},
  {QMI_CTL_SET_PWR_SAVE_MODE_RESP_V01, QMI_IDL_TYPE16(0, 21), 7},
  {QMI_CTL_GET_PWR_SAVE_MODE_RESP_V01, QMI_IDL_TYPE16(0, 23), 18},
  {QMI_CTL_CONFIGURE_RESPONSE_FILTERING_IN_PWR_SAVE_RESP_V01, QMI_IDL_TYPE16(0, 25), 1286},
  {QMI_CTL_GET_RESPONSE_FILTERING_SETTING_IN_PWR_SAVE_RESP_V01, QMI_IDL_TYPE16(0, 27), 1286},
  {QMI_CTL_SET_SVC_AVAIL_LIST_RESP_V01, QMI_IDL_TYPE16(0, 31), 266},
  {QMI_CTL_GET_SVC_AVAIL_LIST_RESP_V01, QMI_IDL_TYPE16(0, 33), 266},
  {QMI_CTL_SET_EVENT_REPORT_RESP_V01, QMI_IDL_TYPE16(0, 29), 11},
...
static const qmi_idl_service_message_table_entry ctl_service_indication_messages_v01[] = {
  {QMI_CTL_REVOKE_CLIENT_ID_IND_V01, QMI_IDL_TYPE16(0, 8), 5},
  {QMI_CTL_INVALID_CLIENT_ID_IND_V01, QMI_IDL_TYPE16(0, 9), 5},
  {QMI_CTL_SYNC_IND_V01, QMI_IDL_TYPE16(0, 14), 0},
  {QMI_CTL_PWR_SAVE_MODE_IND_V01, QMI_IDL_TYPE16(0, 17), 11},
