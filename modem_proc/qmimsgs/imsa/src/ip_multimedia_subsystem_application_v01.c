...
GENERAL DESCRIPTION
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/qmimsgs/imsa/src/ip_multimedia_subsystem_application_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Tue May  3 2016 (Spin 1)
...
static const uint8_t imsa_ind_reg_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, vowifiprofile_status_config) - QMI_IDL_OFFSET8(imsa_ind_reg_req_msg_v01, vowifiprofile_status_config_valid)),
  0x19,
   QMI_IDL_GENERIC_1_BYTE,
...
static const qmi_idl_service_message_table_entry imsa_service_command_messages_v01[] = {
  ...
  {QMI_IMSA_IND_REG_REQ_V01, QMI_IDL_TYPE16(0, 4), 40},
