...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/qmimsgs/nas/api/network_access_service_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define NAS_V01_IDL_MINOR_VERS 0xA7
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define NAS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define NAS_V01_MAX_MESSAGE_ID 0x00C1
/**
    @}
  */
...
typedef enum {
  ...
  NAS_LTE_BW_NRB_6_V01 = 0, /**<  1.4MHz bandwidth \n  */
  NAS_LTE_BW_NRB_15_V01 = 1, /**<  3MHz bandwidth \n  */
  NAS_LTE_BW_NRB_25_V01 = 2, /**<  5MHz bandwidth \n  */
  NAS_LTE_BW_NRB_50_V01 = 3, /**<  10MHz bandwidth  */
  NAS_LTE_BW_NRB_75_V01 = 4, /**<  15MHz bandwidth \n  */
  NAS_LTE_BW_NRB_100_V01 = 5, /**<  20MHz bandwidth  */
 ...
 */
  ...
  /**<   Bandwidth. Values: \n
      - NAS_LTE_BW_NRB_6 (0) --  1.4MHz bandwidth \n 
      - NAS_LTE_BW_NRB_15 (1) --  3MHz bandwidth \n 
      - NAS_LTE_BW_NRB_25 (2) --  5MHz bandwidth \n 
      - NAS_LTE_BW_NRB_50 (3) --  10MHz bandwidth 
      - NAS_LTE_BW_NRB_75 (4) --  15MHz bandwidth \n 
      - NAS_LTE_BW_NRB_100 (5) --  20MHz bandwidth 
 */
...
typedef enum {
  ...
  QMI_SRV_DOMAIN_PREF_FORCE_PS_DETACH_V01 = 0x07, /**<  Packet-switched detach where PS service loss would be done forcibly by Modem.    */
...
typedef struct {
  ...
  */
  ...
  /**<   Service domain preference. Values: \n
      ...
      - QMI_SRV_DOMAIN_PREF_FORCE_PS_DETACH (0x07) --  Packet-switched detach where PS service loss would be done forcibly by Modem.   
 */
 ...
 */
  ...
  /**<  
      Status of eDRX support in the current cell.Values: \n
...
typedef struct {
  ...
  */
  ...
  /**<   List of the user-configured LTE bands, ordered by priority. The ordering 
       ...
       - 120 to 163 -- LTE band classes (see Table @latexonly\ref{tbl:bandClass}@endlatexonly for details)
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Maximum number of EMM reject event. 
 ...
 */
  ...
  /* Optional */
  /*  Scell Information(deprecated, it has same information as 
 Scell info present in 0th index of cphy_scell_info_list variable) */
  uint8_t scell_info_valid;  /**< Must be set to true if scell_info is being passed */
  nas_lte_cphy_scell_info_type_v01 scell_info;
  ...
  /* Optional */
  /*  Scell Index (deprecated, it has same information as
 scell_idx present in 0th index of cphy_scell_info_list variable) */
  uint8_t scell_idx_valid;  /**< Must be set to true if scell_idx is being passed */
  uint8_t scell_idx;
  /**<   Scell index. */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Informs the modem about a change in the voice roaming status. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Informs the modem about a change in the voice roaming status. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Sets the eDRX for the device. */
typedef struct {

  /* Mandatory */
  /*  eDRX */
  uint8_t edrx_params;
  /**<   eDRX setting for the device. Value to be set as per Spec TS 24.008 Rel-13 (10.5.5.32) which includes eDRX cycle length value and Page time window.
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Sets the eDRX for the device. */
typedef struct {
...
typedef struct {
  ...
  */
  ...
  /**<   Cycle Length in eDRX. Value to be set as per Spec TS 24.008 Rel-13 (10.5.5.32).
  */
  ...
  uint8_t edrx_ptw;
  /**<   Page Time window in eDRX.Value to be set as per Spec TS 24.008 Rel-13 (10.5.5.32).
  */
...
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}nas_get_edrx_params_req_msg_v01;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Indication Message; Indicates the Change in the value of eDRX. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Indication Message; Indicates the Gcell information. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Lets the APPs query for the Gcell info from modem. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Lets the APPs query for the Gcell info from modem. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; This messgae allows the APPs to bar the specified GCELL for specified time. */
typedef struct {

  /* Mandatory */
  /*  GERAN cell info */
  geran_grr_gcell_identifier_s_v01 uid_camped_cell;
  /**<   Id of the Gcell which has to be barred.
  */

  /* Mandatory */
  /*  BAR Time */
  uint32_t bar_time;
  /**<   Time for which the GERAN cell needs to be barred. Bar time should be in minutes.
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; This messgae allows the APPs to bar the specified GCELL for specified time. */
typedef struct {
