...
GENERAL DESCRIPTION
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/qmimsgs/dpm/src/data_port_mapper_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
static const uint8_t dpm_get_supported_capabilities_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dpm_get_supported_capabilities_resp_msg_v01, is_rev_ip_sync_supported) - QMI_IDL_OFFSET8(dpm_get_supported_capabilities_resp_msg_v01, is_rev_ip_sync_supported_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
...
static const qmi_idl_service_message_table_entry dpm_service_response_messages_v01[] = {
  ...
  {QMI_DPM_GET_SUPPORTED_CAPABILITIES_RESP_V01, QMI_IDL_TYPE16(0, 5), 15}
};
