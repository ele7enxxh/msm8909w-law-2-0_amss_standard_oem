...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/stubs/api/modem_mem.h#1 $
...
typedef enum _modem_mem_client_e
{
  ...
  ** with 1.
  */
  MODEM_MEM_NUM_CLIENTS            = MODEM_MEM_CLIENT_UTILS,
