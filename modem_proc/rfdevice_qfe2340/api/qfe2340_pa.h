...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfdevice_qfe2340/api/qfe2340_pa.h#1 $
...
#include "rfdevice_physical_device.h"
    ...
    class qfe2340_pa: public rfdevice_pa
    {
    public:
        ...
        qfe2340_pa(rfc_device_cfg_info_type *device_info);

        /* Overloaded constructor for physical device support */
        qfe2340_pa(rfdevice_physical_device *phy_dev_obj_ptr,rfc_phy_device_info_type *phy_device_info, rfc_logical_device_info_type *logical_device_info); 
    ...
    protected:
        ...
        qfe2340_ltefdd_pa_port_data_type ltefdd_tx_band_port_mapping[RFCOM_NUM_LTE_BANDS] ;

        qfe2340_ltetdd_pa_port_data_type ltetdd_tx_band_port_mapping[RFCOM_NUM_LTE_BANDS] ;

        qfe2340_tdscdma_pa_port_data_type tdscdma_tx_band_port_mapping[RFCOM_NUM_TDSCDMA_BANDS] ;
        ...
        qfe2340_common_driver_settings_type pa_params;

        void qfe2340_rtuner_write_data(void);

        void qfe2340_rtuner_cal(void);
