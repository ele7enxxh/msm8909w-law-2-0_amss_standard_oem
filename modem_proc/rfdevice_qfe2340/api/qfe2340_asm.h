#ifndef QFE2340_ASM_H
#define QFE2340_ASM_H
/*!
   @file
   qfe2340_asm.h
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfdevice_qfe2340/api/qfe2340_asm.h#1 $
...
#include "rfdevice_physical_device.h"
  ...
  class qfe2340_asm: public rfdevice_asm
  {
  public:
    ...
    qfe2340_asm(rfc_device_cfg_info_type *device_info);

    /* Overloaded constructor to push the device information */
    qfe2340_asm(rfdevice_physical_device *phy_dev_obj_ptr,rfc_phy_device_info_type *phy_device_info, rfc_logical_device_info_type *logical_device_info); 
  ...
  protected:
    ...
    qfe2340_ltefdd_asm_port_data_type ltefdd_rx_band_port_mapping[RFCOM_NUM_LTE_BANDS] ;

    qfe2340_ltefdd_asm_port_data_type ltefdd_tx_band_port_mapping[RFCOM_NUM_LTE_BANDS] ;

    qfe2340_ltetdd_asm_port_data_type ltetdd_rx_band_port_mapping[RFCOM_NUM_LTE_BANDS] ;

    qfe2340_ltetdd_asm_port_data_type ltetdd_tx_band_port_mapping[RFCOM_NUM_LTE_BANDS] ;

    qfe2340_tdscdma_asm_port_data_type tdscdma_rx_band_port_mapping[RFCOM_NUM_TDSCDMA_BANDS] ;

    qfe2340_tdscdma_asm_port_data_type tdscdma_tx_band_port_mapping[RFCOM_NUM_TDSCDMA_BANDS] ;
    ...
    qfe2340_common_driver_settings_type asm_params;
