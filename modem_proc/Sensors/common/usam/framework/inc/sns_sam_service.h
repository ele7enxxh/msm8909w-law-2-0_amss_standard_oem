 ...
 */
sns_sam_err sns_sam_service_init_fw( void );
 ...
 */
void sns_sam_process_svc_msg_q( void );
...
/**
 * Process all disconnect events.  Will involve iterating over and removing
 * all associated client requests.
 */
