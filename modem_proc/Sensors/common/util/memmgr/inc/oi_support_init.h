...
/*============================================================================
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/Sensors/common/util/memmgr/inc/oi_support_init.h#1 $
  $DateTime: 2016/12/13 08:00:23 $

  when       who    what, where, why
  ---------- --- -----------------------------------------------------------
  2013-07-24 vh  Eliminated compiler warnings
  2013-06-03 pn  Fixed compiler warnings
 ...
 *                        memory manager from operating properly.
 */
extern OI_STATUS OI_MEMMGR_DeInit(void);
