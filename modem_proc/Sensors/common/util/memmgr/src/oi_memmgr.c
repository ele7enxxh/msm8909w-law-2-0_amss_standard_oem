...
/*============================================================================
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/Sensors/common/util/memmgr/src/oi_memmgr.c#1 $
  $DateTime: 2016/12/13 08:00:23 $

  when       who    what, where, why 
  ---------- --- -----------------------------------------------------------
  2013-06-12 agk Excluding this file for adsp baselines
...
/* Use OI_Mem* functions only in case of ARM7 (DSPS) */
 ...
 */
#define IS_DYNAMIC_ALLOC(a) TRUE
...
//sean OI_AssertFail
//static void OI_AssertFail(char* file, int line, char* reason)
//{
//	DBG_PRINT1(("%d of %s : %s\n", line, file, reason));
//} 
