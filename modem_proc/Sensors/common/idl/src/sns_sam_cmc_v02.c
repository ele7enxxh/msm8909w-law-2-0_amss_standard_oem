...
GENERAL DESCRIPTION
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/Sensors/common/idl/src/sns_sam_cmc_v02.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t sns_sam_cmc_enable_req_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_sam_cmc_enable_req_msg_v02, notify_suspend) - QMI_IDL_OFFSET8(sns_sam_cmc_enable_req_msg_v02, notify_suspend_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(sns_sam_cmc_enable_req_msg_v02, notify_suspend),
  QMI_IDL_TYPE88(2, 1),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_sam_cmc_enable_req_msg_v02, enabled_motion_states_bit_mask) - QMI_IDL_OFFSET8(sns_sam_cmc_enable_req_msg_v02, enabled_motion_states_bit_mask_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(sns_sam_cmc_enable_req_msg_v02, enabled_motion_states_bit_mask)
};
...
static const qmi_idl_service_message_table_entry SNS_SAM_CMC_SVC_service_command_messages_v02[] = {
  ...
  {SNS_SAM_CMC_ENABLE_REQ_V02, QMI_IDL_TYPE16(0, 0), 15},
