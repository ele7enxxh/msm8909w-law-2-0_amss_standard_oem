...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/Sensors/common/idl/inc/sns_smgr_internal_api_v02.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.14 
   It was generated on: Sat Nov  1 2014 (Spin 0)
...
#define SNS_SMGR_INTERNAL_SVC_V02_IDL_MINOR_VERS 0x04
...
typedef struct {
  ...
  /* Optional */
  uint8_t is_accurate_ts_client_present_valid;  /**< Must be set to true if is_accurate_ts_cilent_present is being passed */
