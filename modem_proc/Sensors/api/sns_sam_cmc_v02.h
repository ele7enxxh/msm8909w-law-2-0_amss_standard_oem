...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/Sensors/api/sns_sam_cmc_v02.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Sun Apr 17 2016 (Spin 0)
...
#define SNS_SAM_CMC_SVC_V02_IDL_MINOR_VERS 0x04
...
/**  Max number of concurrently active supported motion states.
  The report indication is sized to this value (and cannot be changed!)
  and reports all the active motion states. */
...
typedef enum {
  ...
  SNS_SAM_CMC_MS_HIKE_V02 = 9, 
  SNS_SAM_CMC_MS_INACTIVE_V02 = 10, 
  SNS_SAM_CMC_MS_WALK_STEP_RATE_V02 = 11, 
  SNS_SAM_CMC_MS_JOG_STEP_RATE_V02 = 12, 
  SNS_SAM_CMC_MS_RUN_STEP_RATE_V02 = 13, 
...
typedef struct {
  ...
  /* Optional */
  uint8_t enabled_motion_states_bit_mask_valid;  /**< Must be set to true if enabled_motion_states_bit_mask is being passed */
  uint32_t enabled_motion_states_bit_mask;
  /**<   Bit mask formed by ORing the sns_sam_cmc_ms_e bit position
       of the motion states that should be reported. If omitted,
       the default enabled sates are 
       SNS_SAM_CMC_MS_UNKNOWN, SNS_SAM_CMC_MS_WALK, SNS_SAM_CMC_MS_RUN,
       SNS_SAM_CMC_MS_BIKE, SNS_SAM_CMC_MS_HIKE, and SNS_SAM_CMC_MS_INACTIVE.

       The value of the bit mask is then 
