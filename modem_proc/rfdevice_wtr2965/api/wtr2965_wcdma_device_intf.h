#ifndef WTR2965_WCDMA_DEVICE_INTF_H
#define WTR2965_WCDMA_DEVICE_INTF_H
/*! 
  @file
  wtr2965_wcdma_device_intf.h
 
  @brief
  Contains the interface for RFC to WTR2965 WCDMA driver

  @details
  Contains function prototypes to create WTR2965 WCDMA devices and any other
...
10/15/13   rp      WTR2965 WCDMA device driver modification to support C++ interface.
...
08/02/12   shb     Moved wtr2965_wcdma_rx/tx_set_band_port back as they are used 
                   directly by DIME RFC 
08/02/12   shb     Moved wtr2965_wcdma_rx/tx_set_band_port from 
                   wtr2965_wcdma_devices.c to wtr2965_wcdma.c 
...
#define WTR2965_MAX_WCDMA_DEVICES 2

boolean
wtr2965_wcdma_create_device
(
...
#endif /* WTR2965_WCDMA_DEVICE_INTF_H */
