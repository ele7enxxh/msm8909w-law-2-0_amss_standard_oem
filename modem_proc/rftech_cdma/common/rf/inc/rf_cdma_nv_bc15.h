#ifndef RF_CDMA_NV_BC15_H
#define RF_CDMA_NV_BC15_H
...
/*!
  ...
  interface with the RF 1X NV Manager for Band Class 15
*/
...
/*==============================================================================
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rftech_cdma/common/rf/inc/rf_cdma_nv_bc15.h#1 $
