#ifndef DS_PROFILE_FILE_EFS_H
#define DS_PROFILE_FILE_EFS_H
/*===========================================================================
  @file ds_Profile_FileEFS.h

  This file defines EFS File class which is wrapper for various file 
...
namespace ds
{
  namespace Profile
  {
    class FileEFS : public File
    {
      public:

        DS_PROFILE_DB_USE_MEMORY_MANAGEMENT(PS_MEM_PROFILE_DB_FILE_EFS_TYPE);

        FileEFS():fs_handle(-1), profile_num(-1), is_new(false){};

        FileEFS(ds_profile_db_profile_num_type num, ds_profile_db_subs_type subs, FlagType flag = F_RW);
        ...
        static mcfg_fs_e_type file_type;      
      ...
      private:
        ...
        virtual ds_profile_db_result_type Open(const char* file_name, 
                                               FlagType flag = F_RW,
                                               ds_profile_db_subs_type subs = 
                                               (ds_profile_db_subs_type)ps_sys_get_default_data_subscription());
