...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/datamodem/interface/dss/src/DSS_MCastRegisterHandler_2_0.cpp#1 $
...
void DSSMCastRegisterHandler2_0::EventOccurred()
{
   ...
   if (mpHandlerDataClone->mpEventData->bReg)
   {
      ...
      if (AEE_SUCCESS != res) {
         LOG_MSG_ERROR_1("DSSMCastRegisterHandler2_0::EventOccurred(): "
      ...
      if (AEE_SUCCESS != res) {
         LOG_MSG_ERROR_1("DSSMCastRegisterHandler2_0::EventOccurred(): "
                         "GetRegStateAndInfoCodeBCMCS2_0() failed: %d", res);
         return;
      }
      ...
      LOG_MSG_INFO3_1("DSSMCastRegisterHandler2_0::EventOccurred(): "
...
AEEResult DSSMCastRegisterHandler2_0::RegisterIDL()
{
   ...
   if (AEE_SUCCESS != res) {
      LOG_MSG_ERROR_1("DSSMCastRegisterHandler2_0::RegisterIDL(): "
                      "GetMCastSession() failed: %d", res);
      return res;
   }
   
   LOG_MSG_INFO1_1("DSSMCastRegisterHandler2_0::RegisterIDL(): "
                   "Registering to QDS_EV_REGISTRATION_STATE_PRIV_BCMCS2_0, MCastSessionPriv obj 0x%p",
                   piNetMCast);
   res = piNetMCast->OnStateChange(mpSignal, MCastSessionPrivEvent::QDS_EV_REGISTRATION_STATE_PRIV_BCMCS2_0, &pRegObj);
