...
{
   virtual int CDECL ErrRealloc(int nSize, void** ppBlock) = 0;
   virtual int CDECL ErrReallocName(int nSize, void** ppBlock, const char* cpszName) = 0;
   virtual int CDECL ErrReallocNoZI(int nSize, void** ppBlock) = 0;
   virtual int CDECL ErrReallocNameNoZI(int nSize, void** ppBlock, const char* cpszName) = 0;
