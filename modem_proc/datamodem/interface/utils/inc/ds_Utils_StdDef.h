...
=======================================================================
        Copyright 2005 - 2014 Qualcomm Technologies Incorporated.
               All Rights Reserved.
...
#define __FILE_LINE__ __FILENAME__ ":" __TOSTR__(__LINE__)
...
Description:
   This is a BREW unique ID.  Used to express unique types, interfaces, classes.
     The BREW ClassID Generator generates 
...
Description:
   The compiler's __FILENAME__ (a string) and __LINE__ (an integer) are pasted
