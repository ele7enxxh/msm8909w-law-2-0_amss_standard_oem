#ifndef PS_IPDC_LOGGING_EX_H
#define PS_IPDC_LOGGING_EX_H
...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/datamodem/protocols/dc/ipdc/v1/inc/ps_ipdc_logging_ex.h#1 $
  $Author: mplcsds1 $
...
// UE Target  : All Stats counters are reset after being reported 
  ...
  */
  ...
  uint32 sh_saved_bytes;                    /* Total nr of packet bytes saved by sh */
...
PARAMETERS
  ipdc_handle_type *handle - pointer to the ipdc handle
  update_metrics : Whether to log metrics or not
  update_stats   : Whether to log stats or not
  force_stats_f3_logging : Whether to print the statistics via F3 or not
...
===========================================================================*/
void ps_ipdc_log_comp_update_log_data_ex
(
  ipdc_handle_type  handle,
  boolean           update_metrics,
  boolean           update_stats,
  boolean           force_stats_f3_logging
);
...
SIDE EFFECTS
  None
===========================================================================*/
void ipdc_logging_log_comp_pkt_ex
(
  ipdc_handle_type               handle,
...
SIDE EFFECTS
  None
===========================================================================*/
void ipdc_logging_log_comp_engine_memory_ex
(
  ipdc_handle_type               handle
);
...
SIDE EFFECTS
  None
===========================================================================*/
boolean ipdc_alloc_comp_metrics_stats_log_pkts_ex(void);

#ifdef __cplusplus
}
#endif

#endif /* PS_IPDC_LOGGING_EX_H */
