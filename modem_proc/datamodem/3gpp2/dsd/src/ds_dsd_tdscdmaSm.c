/*===========================================================================
                     D S _ D S D _ T D S C D M A S M . C
...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/datamodem/3gpp2/dsd/src/ds_dsd_tdscdmaSm.c#1 $
...
/*===========================================================================
FUNCTION      DS_DSD_TDSCDMASM_EVENT_NOTIFY_CB
...
===========================================================================*/
boolean ds_dsd_tdscdmaSm_event_notify_cb
(
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
  ...
  ---------------------------------------------------------------------*/
  sm_ptr = ds_dsd_proc_get_radio_sm_instance(subs_id, DS_DSD_RADIO_TDSCDMA);
  if(sm_ptr == NULL)
  {
  ...
  switch(notified_event)
  {
    ...
    case DSD_OOS_RADIO_EV:
      if(source_radio == DS_DSD_RADIO_TDSCDMA)
      {
        /*-------------------------------------------------------------------
  ...
  return TRUE;
}/* ds_dsd_tdscdmaSm_event_notify_cb() */
...
/*===========================================================================
FUNCTION      DS_DSD_TDSCDMASM_CREATE_SM_INSTANCE

DESCRIPTION   This function creates TDS SM instance corresponding to subs id
...
===========================================================================*/
ds_dsd_sm_type* ds_dsd_tdscdmaSm_create_sm_instance
(
  ds3gsubsmgr_subs_id_e_type  subs_id
)
{
...
}/* ds_dsd_tdscdmaSm_create_sm_instance() */

/*===========================================================================
FUNCTION      DS_DSD_TDSCDMASM_INIT

DESCRIPTION   This function initializes TDS state machine
...
===========================================================================*/
void ds_dsd_tdscdmaSm_init(void)
{
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
  /* Register with event dispatcher */
  ds_dsd_event_dp_reg_client(DS_DSD_CLIENT_TDSCDMA, 
                             ds_dsd_tdscdmaSm_event_notify_cb, 
