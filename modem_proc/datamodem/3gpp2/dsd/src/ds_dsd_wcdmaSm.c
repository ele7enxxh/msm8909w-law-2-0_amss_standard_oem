...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/datamodem/3gpp2/dsd/src/ds_dsd_wcdmaSm.c#1 $
...
/*===========================================================================
FUNCTION      DS_DSD_WCDMASM_EVENT_NOTIFY_CB
...
===========================================================================*/
boolean ds_dsd_wcdmaSm_event_notify_cb
(
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
  ...
  ---------------------------------------------------------------------*/
  sm_ptr = ds_dsd_proc_get_radio_sm_instance(subs_id, DS_DSD_RADIO_WCDMA);
  if(sm_ptr == NULL)
  {
  ...
  switch(notified_event)
  {
    ...
    case DSD_OOS_RADIO_EV:
      if(source_radio == DS_DSD_RADIO_WCDMA)
      {
        /*-------------------------------------------------------------------
  ...
  return TRUE;
}/* ds_dsd_wcdmaSm_event_notify_cb() */
...
}/* ds_dsd_wcdmaSm_create_sm_instance() */
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
  ...
  ds_dsd_event_dp_reg_client(DS_DSD_CLIENT_WCDMA,
                             ds_dsd_wcdmaSm_event_notify_cb,
                             DS_DSD_RADIO_WCDMA );
