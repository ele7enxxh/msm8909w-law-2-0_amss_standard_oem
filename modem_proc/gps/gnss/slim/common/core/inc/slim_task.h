...
*/
/* $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/gps/gnss/slim/common/core/inc/slim_task.h#1 $ */
...
typedef enum
{
  M_IPC_SLIM_TX_TIMER_ID = IPC_SLIM_TIMER_ID_MIN,
  /**< Timer for use SLIM for timeout controls */
