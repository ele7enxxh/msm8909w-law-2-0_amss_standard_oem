...
============================================================================*/
/* $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/gps/gnss/slim/common/client/inc/slim_api.h#1 $ */
...
/*
  ...
  type in SLIM, please make appropriate changes at following places:
    ...
    2. Update the SLIM API version string in slim_api.h header (this) file

  Updated: 02/01/2016
*/
#define SLIM_API_VERSION_ID  (1)
