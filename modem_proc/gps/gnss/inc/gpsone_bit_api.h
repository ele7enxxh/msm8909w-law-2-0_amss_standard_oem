...
/*===========================================================================
   ...
   GPSONE BIT (BEARER-INDEPENDENT-TRANSPORT) INTERFACE PUBLIC HEADER FILE

DESCRIPTION
  This header file contains the data/API definition for the BIT interface 
  between modem processor and apps processor.
...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/gps/gnss/inc/gpsone_bit_api.h#1 $DateTime: 2010/05/10 18:43:35 $$Author: mplcsds1 $
...
/************************************************************************************/
/*                                                                                  */
/*                BIT constants, types, data structures definitions                 */
/*                                                                                  */
/************************************************************************************/
...
typedef enum 
{
  ...
  GPSONE_BIT_EVENT_ABORT_CONNNECTION,  /* event to notify PDSM to abort a connection */
  GPSONE_BIT_EVENT_ABORT_ALL           /* event to notify PDSM to abort all connections */
...
/************************************************************************************/
/*                                                                                  */
/*           Function prototypes which BIT daemon should provide to PDSM            */
/*                                                                                  */
/************************************************************************************/
...
/************************************************************************************/
/*                                                                                  */
/*             BIT Public APIs exposed from Modem to BIT daemon on Apps             */
/*                                                                                  */
/************************************************************************************/
