...
/*===========================================================================
 ...
 $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/gps/gnss/pd_comms/inc/gpsone_bit_local_api.h#1 $$DateTime: 2016/12/13 07:59:45 $$Author: mplcsds1 $ 
...
#define BIT_MSG_FUNC( str, a, b, c )                                          \
                  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "=BIT API= " str,  a, b, c )
#define BIT_MSG_LOW( str, a, b, c )                                          \
                  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "=BIT API= " str,  a, b, c )
#define BIT_MSG_MED( str, a, b, c )                                          \
                  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_MED, "=BIT API= " str, a, b, c )
#define BIT_MSG_HIGH( str, a, b, c )                                         \
                  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_HIGH, "=BIT API= " str, a, b, c )
#define BIT_MSG_ERROR( str, a, b, c )                                        \
                  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_ERROR, "=BIT API= " str, a, b, c )
#define BIT_ERR_FATAL( str, a, b, c )                                        \
                  MSG_3(MSG_SSID_GPSSM, MSG_LEGACY_FATAL, "=BIT API= " str, a, b, c )
...
#define GPSONE_BIT_TRANSID_OPCODE(trans_id)      ( ((trans_id) & 0xFFFF0000) >> 16 )
