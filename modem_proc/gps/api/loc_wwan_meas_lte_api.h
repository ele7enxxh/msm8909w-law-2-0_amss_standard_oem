...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/gps/api/loc_wwan_meas_lte_api.h#1 $
...
#pragma pack(push, PB_STUBS_C, 1)
#endif //#ifdef _ME_PLAYBACK_OFFLINE
...
} loc_wwan_me_LtePlmnLogType;

#ifdef _ME_PLAYBACK_OFFLINE
#pragma pack(pop, PB_STUBS_C)
#endif //#ifdef _ME_PLAYBACK_OFFLINE
...
typedef struct
{
  ...
  /*! Unique Cell ID */
  loc_wwan_me_LtePlmnIpcType z_plmn;
