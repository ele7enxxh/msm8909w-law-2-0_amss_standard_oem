# 
#$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/gps/gnss_tools/standalone_rfv/cgps_mode_switch/HelperFunctions.pm#1 $ $DateTime: 2016/12/13 07:59:45 $ $Author: mplcsds1 $
######################################################################
