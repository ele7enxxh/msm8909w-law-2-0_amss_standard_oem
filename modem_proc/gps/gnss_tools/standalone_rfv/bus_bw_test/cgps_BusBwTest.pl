# 
#$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/gps/gnss_tools/standalone_rfv/bus_bw_test/cgps_BusBwTest.pl#1 $ $DateTime: 2016/12/13 07:59:45 $ $Author: mplcsds1 $
#*****************************************************************************
...
my $task_cnt = 106;
# /* This variable can be configured to any number, to emulate tracking please change this to 50 */
...
$req->{"integ_length"}         = 0;# 1-1023 0-EMEM 1-IMEM
