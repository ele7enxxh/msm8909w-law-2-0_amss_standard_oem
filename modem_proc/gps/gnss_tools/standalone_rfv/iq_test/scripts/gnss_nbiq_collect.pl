# 
#$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/gps/gnss_tools/standalone_rfv/iq_test/scripts/gnss_nbiq_collect.pl#1 $ $DateTime: 2016/12/13 07:59:45 $ $Author: mplcsds1 $
#*****************************************************************************
#  Copyright (C) 2004 - 2011 Qualcomm, Inc.
#
#                  Qualcomm, Inc.
...
$CollectMode = 5;              # VALID VALUES for "CollectMode":-
                               ...
                               #     LSB is the most recently captured sample.
							   # 15	 FBIQ BP3 (10 MHz sample rate)
							   # 16  ADC IEQ at 81MHz
...
$Num1kSamples = 60;        # 1-1024 allowed for all WB. 0-1024 allowed for NB. 0=>Collect Forever
$Integrations = 1;            # Greater than 0
