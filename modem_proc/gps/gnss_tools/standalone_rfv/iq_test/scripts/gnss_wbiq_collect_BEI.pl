# 
#$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/gps/gnss_tools/standalone_rfv/iq_test/scripts/gnss_wbiq_collect_BEI.pl#1 $ $DateTime: 2016/12/13 07:59:45 $ $Author: mplcsds1 $
#*****************************************************************************
#  Copyright (C) 2004-2013 Qualcomm, Inc.
#
#                  Qualcomm, Inc.
...
$CollectMode = 17;              # VALID VALUES for "CollectMode":-
...
$Num1kSamples = 512;	       # 1-1024 allowed for all WB. 0-1024 allowed for NB. 0=>Collect Forever
