##########################################################################
# $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/gps/gnss_tools/pdapi_scripts/pd_DelEph.pl#1 $
# $DateTime: 2016/12/13 07:59:45 $
# $Author: mplcsds1 $
#
# This example demonstrates using a DM Command to initialize, register,
# & activate a PDAPI client; delete Ephemeris by sending a
...
#
# Usage: perl pd_DelEph.pl 11 8 (11 is the COM Port the FFA is connected
...
if (not defined ($comport)) {
    print("\nUsage: perl pd_DelEph.pl <COM Port> <Client Type>\n\n");
...
#########################################################################
  ...
  print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
  print("Doing DeleteEph (warm start) operation\n");
  print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
...
######################################################################
  ...
  $req_coldstart->{"delete_bitmap"}   = 1;  # Delete Eph (0000|0000|0000|0001 = 1)
                                            # DELETE_EPH         = 0x0001
                                            # DELETE_ALM         = 0x0002
                                            # DELETE_POS         = 0x0004
                                            # DELETE_TIME        = 0x0008
  ...
  $req_coldstart->{"gnss_delete_bitmap"} = 0x2080403;
  ...
  $req_coldstart->{"sbas_eph_sv_mask"}     = 0xFFFFFFFF;  # delete SBAS eph
  $req_coldstart->{"sbas_alm_sv_mask"}     = 0;  # delete SBAS alm
...
Syntax:   pd_DelEph [options]

Options:  -help               Display this help message.

Example:  perl pd_DelEph.pl <COM Port> <Client Type>
