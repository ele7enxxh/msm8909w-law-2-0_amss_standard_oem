##########################################################################
# $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/gps/gnss_tools/pdapi_scripts/pd_DelAllButAlm.pl#1 $
...
######################################################################
  ...
  $req_coldstart->{"delete_bitmap"}   = 0x87FD; # Delete all but Alm (1000|0111|1111|1101 = 34813)
                                            # DELETE_EPH         = 0x0001
                                            # DELETE_ALM         = 0x0002
                                            # DELETE_POS         = 0x0004
                                            # DELETE_TIME        = 0x0008
    ...
    $req_coldstart->{"gnss_delete_bitmap"} = 0x7BEFF7F3;
