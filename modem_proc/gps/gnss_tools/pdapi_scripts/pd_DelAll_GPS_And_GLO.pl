##########################################################################
# $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/gps/gnss_tools/pdapi_scripts/pd_DelAll_GPS_And_GLO.pl#1 $
...
# uint32              q_Reserved
  ...
  $req_coldstart->{"gnss_delete_bitmap"} = 0xFFFFFFFF; # Delete All includes GPS and Glonass
