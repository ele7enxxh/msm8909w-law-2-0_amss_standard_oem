##########################################################################
# $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/gps/gnss_tools/pdapi_scripts/pd_DelSVDir.pl#1 $
...
# uint32              q_Reserved
  ...
  $req_coldstart->{"delete_bitmap"}   = 0x0080; # Delete All (1000|0111|1111|1111 = 0x87FF = 34815)
                                            # DELETE_EPH         = 0x0001
                                            # DELETE_ALM         = 0x0002
                                            # DELETE_POS         = 0x0004
                                            # DELETE_TIME        = 0x0008
  ...
  $req_coldstart->{"gnss_delete_bitmap"} = 0x8201030;
                                            # DELETE_EPH_GLO
                                            # DELETE_EPH_SBAS
                                            # DELETE_ALM_GLO
                                            # DELETE_ALM_SBAS
