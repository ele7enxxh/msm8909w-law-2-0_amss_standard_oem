##########################################################################
# $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/gps/gnss_tools/pdapi_scripts/pd_DelAll.pl#1 $
# $DateTime: 2016/12/13 07:59:45 $
# $Author: mplcsds1 $
#
# This example demonstrates using a DM Command to initialize, register,
# & activate a PDAPI client; deletes almanac, ephemeris, position, time,
# iono, UTC, RTI, Health, SV Direction, SV Steering, and Sensitivity
# Assistance by sending a CGPS_SET_PARAM_CMD; deactivate, deregister, &
# release a PDAPI client.
#
# Run pd_StartDiag.pl before calling this script to start a Diag Task.
#
# Usage: perl pd_DelAll.pl 11 8 (11 is the COM Port the FFA is connected
...
if (not defined ($comport)) {
    print("\nUsage: perl pd_DelAll.pl <COM Port> <Client Type>\n\n");
...
#########################################################################
  ...
  print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
  print("Doing DeleteALL (coldstart) operation\n");
  print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
...
#  uint32             q_GmssDelParamsFlags; /* See ENUM gpsdiag_eDelParamsType */
#  uint32             q_DelParamsFlags_Reserved; /* See ENUM gpsdiag_eDelParamsType */
...
#  uint32             q_DelClockInfoMask;  /* Clock info Delete Mask */
# uint32              q_Reserved
  ...
  $req_coldstart->{"delete_bitmap"}   = 0x187FF; # Delete All (0001-1000|0111|1111|1111 = 0x187FF)
                                            # DELETE_EPH         = 0x0001
                                            # DELETE_ALM         = 0x0002
                                            # DELETE_POS         = 0x0004
                                            # DELETE_TIME        = 0x0008
                                            ...
                                            # PA_DELETE_ALM_CORR = 0x00010000
                                            # FREQ_BIAS_EST      = 0x00020000
                                            # DELETE_SV_NO_EXIST = 0x00040000

  $req_coldstart->{"gnss_delete_bitmap"} = 0x7FFFFFFF;
                                            ...
                                            # DELETE_ALM_CORR_GLO           =  U32BITMASK_BIT(8)
                                            ...
                                            # DELETE_ALM_CORR_BDS           =  U32BITMASK_BIT(14)
                                            ...
                                            # DELETE_ALM_CORR_GAL           =  U32BITMASK_BIT(23)
                                            ...
                                            # DELETE_ALM_CORR_QZSS          =  U32BITMASK_BIT(29)
...
Example:  perl pd_DelAll.pl <COM Port> <Client Type>
