##########################################################################
# $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/gps/gnss_tools/pdapi_scripts/pd_DelUtc.pl#1 $
...
# uint32              q_Reserved
  ...
  $req_coldstart->{"delete_bitmap"}   = 0x0020; # Delete All (1000|0111|1111|1111 = 0x87FF = 34815)
                                            # DELETE_EPH         = 0x0001
                                            # DELETE_ALM         = 0x0002
                                            # DELETE_POS         = 0x0004
                                            # DELETE_TIME        = 0x0008
  ...
  $req_coldstart->{"gnss_delete_bitmap"} = 0; # DELETE_GLO_EPH         = 0x0001
                                            # DELETE_SBAS_EPH         = 0x0002
                                            # DELETE_GLO_ALM          = 0x0004
                                            # DELETE_SBAS_ALM         = 0x0008
                                            # DELETE_GLO_SVDIR        = 0x0010
                                            # DELETE_SBAS_SVDIR       = 0x0020
                                            # DELETE_GLO_SVSTEER      = 0x0040
                                            # DELETE_SBAS_SVSTEER     = 0x0080
                                            # DELETE_GLO_ALM_CORR     = 0x0100
                                            # DELETE_CLOCK_INFO       = 0x0200
