...
#
# $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/mcs/stm2/tools/stmcomp.pl#1 $
#
...
Copyright (c) Qualcomm Technologies Incorporated, 2007- $currentyear
...
/*===========================================================================
  ...
  Copyright (c) $currentyear Qualcomm Technologies Incorporated.
  All Rights Reserved
  Qualcomm Confidential and Proprietary
