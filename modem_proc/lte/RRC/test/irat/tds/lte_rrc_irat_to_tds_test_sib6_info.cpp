...
/*!
  @file lte_rrc_irat_to_tds_sib6_info.cpp
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/lte/RRC/test/irat/tds/lte_rrc_irat_to_tds_test_sib6_info.cpp#1 $
...
#include "__lte_rrc_irat_to_tds_mgr.h"
...
#include "lte_rrc_irat_to_tds_test_common.h"
...
static const uint8 lte_rrc_to_tds_test_sib6_tdd_msg1[] = \
{\
...
void lte_rrc_irat_to_tds_test_send_sib6 ( void )
{
...
void lte_rrc_irat_to_tds_test_send_sib6_for_new_cell ( void )
{
  lte_rrc_sib_updated_indi_s    sib_updated_indi; 
#ifdef FEATURE_QTF_CRM_TODO
  STD_ZEROAT(&sib_updated_indi);
...
void lte_rrc_irat_to_tds_test_send_sib6_not_available (void )
{
  lte_rrc_sib_updated_indi_s    sib_updated_indi   ; 
#ifdef FEATURE_QTF_CRM_TODO
  STD_ZEROAT(&sib_updated_indi);
...
void lte_rrc_irat_to_tds_test_send_sib6_not_available_for_new_cell (void )
{
  lte_rrc_sib_updated_indi_s    sib_updated_indi   ; 
#ifdef FEATURE_QTF_CRM_TODO
  STD_ZEROAT(&sib_updated_indi);
...
void lte_rrc_irat_to_tds_test_verify_sib6( void )
{
  uint32                         buf_len               = 0;
  ...
  // Check priority
  TF_ASSERT ( ind_ptr->priority_UTRAN_TDD == 5 );
  TF_ASSERT ( ind_ptr->priority_UTRAN_FDD == LTE_RRC_INVALID_SIB_PRIORITY);


  
}

void lte_rrc_irat_to_tds_test_verify_sib6_not_available ( void )
{
  uint32                         buf_len      = 0;
  lte_rrc_sib6_info_ind_s*    ind_ptr      = NULL;
  ...
  // Check priority
  TF_ASSERT ( ind_ptr->priority_UTRAN_TDD == 0 );
  TF_ASSERT ( ind_ptr->priority_UTRAN_FDD == LTE_RRC_INVALID_SIB_PRIORITY);
...
/*===========================================================================
                        ...
                        lte_rrc_irat_to_tds_test_sib6_ind
...
TF_DEFINE_TEST_CASE ( COMPONENT, lte_rrc_irat_to_tds_test_sib6_ind ) ;

void lte_rrc_irat_to_tds_test_sib6_ind::Setup()
{
  ...
  lte_rrc_utf_setup(LTE_RRC_IRAT_TO_TDS_MGR_SM, umid_list,
         sizeof(umid_list)/sizeof(umid_list[0]));

  lte_rrc_irat_to_tds_test_sib6_ind_init ( );
}/*  lte_rrc_irat_to_tds_test_sib6_ind */

void lte_rrc_irat_to_tds_test_sib6_ind::Test()
{

  // Make sure that the state machine has been activated and that the 
  // initial state is 'Initial'
  TF_ASSERT(stm_get_state(LTE_RRC_IRAT_TO_TDS_MGR_SM) == LTE_RRC_IRAT_TO_TDS_MGR_SM__INITIAL);

  lte_rrc_to_tds_mgr_test_decode_sib6((void*) lte_rrc_to_tds_test_sib6_tdd_msg1,
                                sizeof(lte_rrc_to_tds_test_sib6_tdd_msg1));
  
  // Send SIB-6
  lte_rrc_irat_to_tds_test_send_sib6 ();

  // Receive and verifiy that IRAT Mgr sends SIB-6
  lte_rrc_irat_to_tds_test_verify_sib6 ();
  ...
  lte_rrc_irat_to_tds_test_send_sib6_not_available ();

  // Receive and verifiy that IRAT Mgr sends SIB-6 not avail
  lte_rrc_irat_to_tds_test_verify_sib6_not_available ();
...
void lte_rrc_irat_to_tds_test_sib6_ind::Teardown()
{
  lte_rrc_utf_teardown();
}/* lte_rrc_irat_to_tds_test_sib6_ind */

TF_DEFINE_TEST_CASE ( COMPONENT, lte_rrc_irat_to_tds_test_sib6_ind_new_cells ) ;

void lte_rrc_irat_to_tds_test_sib6_ind_new_cells::Setup()
{
  /* Only add those external UMIDs that 1X RAT Mgr will send out */
  uint32 umid_list[] = 
    { 
  ...
  lte_rrc_irat_to_tds_test_sib6_ind_init ( );
}/*  lte_rrc_irat_to_tds_test_sib6_ind_new_cells */

void lte_rrc_irat_to_tds_test_sib6_ind_new_cells::Test()
{
  ...
  // move to a new cell
  lte_rrc_irat_to_tds_test_sib6_ind_init_new_serv_cell();

  // sib6 not avail in new cell
  lte_rrc_irat_to_tds_test_send_sib6_not_available_for_new_cell();
...
void lte_rrc_irat_to_tds_test_sib6_ind_new_cells::Teardown()
{
  lte_rrc_utf_teardown();
}/* lte_rrc_irat_to_tds_test_sib6_ind_new_cells */
