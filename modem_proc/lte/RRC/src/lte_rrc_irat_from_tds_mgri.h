...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/lte/RRC/src/lte_rrc_irat_from_tds_mgri.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
12/29/2011 np      Initial revision
===========================================================================*/

#ifndef LTE_RRC_IRAT_FROM_TDS_MGRI_H
#define LTE_RRC_IRAT_FROM_TDS_MGRI_H
/*===========================================================================
...
#include "lte_rrc_irat_from_tds_mgr.h"
...
{
  /*! Default value */
  LTE_RRC_IRAT_FROM_TDS_MODE_INITIAL,

  /*! IRAT Resel to LTE started */
  LTE_RRC_IRAT_FROM_TDS_MODE_RESEL_STARTED,

  /*! IRAT Resel to LTE failed */
  LTE_RRC_IRAT_FROM_TDS_MODE_RESEL_FAILED,

  /*! IRAT Resel to LTE aborted */
  LTE_RRC_IRAT_FROM_TDS_MODE_RESEL_ABORTED_BY_TDS,

  /*! IRAT Redir to LTE Blind Started */
  LTE_RRC_IRAT_FROM_TDS_MODE_REDIR_BLIND_STARTED,

  /*! IRAT Redir to LTE (List) Started */
  LTE_RRC_IRAT_FROM_TDS_MODE_REDIR_LIST_STARTED,

  /*! IRAT Redir to LTE (Full) started */
  LTE_RRC_IRAT_FROM_TDS_MODE_REDIR_FULL_STARTED,

  /*! IRAT Redir to LTE (Any) aborted by TDS */
  LTE_RRC_IRAT_FROM_TDS_MODE_REDIR_ABORTED_BY_TDS,

  /*! IRAT Redir to LTE failed, for conn reject case, wait timer has expired */
  LTE_RRC_IRAT_FROM_TDS_MODE_REDIR_WAIT_TMR_EXPIRED,

  /*! IRAT Redir to LTE failed, blind guard timer has expired */
  LTE_RRC_IRAT_FROM_TDS_MODE_REDIR_BLIND_TMR_EXPIRED,

  /*! IRAT Redir to LTE failed for conn release case! */
  LTE_RRC_IRAT_FROM_TDS_MODE_REDIR_FAILED,

  /*! IRAT Resel to LTE Success! */
  LTE_RRC_IRAT_FROM_TDS_MODE_RESEL_SUCCESS,

  /*! IRAT Redir to LTE Success! */
  LTE_RRC_IRAT_FROM_TDS_MODE_REDIR_SUCCESS,

  /*! PLMN  Search Normal */
  LTE_RRC_IRAT_FROM_TDS_PLMN_SRCH_NORMAL,

  /*! PLMN  Search Aborted */
  LTE_RRC_IRAT_FROM_TDS_PLMN_SRCH_ABORTED,

  /*! IRAT PSHO to LTE started */
  LTE_RRC_IRAT_FROM_TDS_MODE_PSHO_STARTED,

  /*! IRAT PSHO to LTE Success! */
  LTE_RRC_IRAT_FROM_TDS_MODE_PSHO_SUCCESS,

  /*! IRAT PSHO to LTE failed */
  LTE_RRC_IRAT_FROM_TDS_MODE_PSHO_FAILED,

  /*! IRAT PSHO to LTE aborted */
  LTE_RRC_IRAT_FROM_TDS_MODE_PSHO_ABORTED_BY_TDS,

}lte_rrc_irat_from_tds_mode_e;

typedef union
{
  /*! The reselection request from TDSCDMA RRC */
  lte_rrc_tdscdma_resel_req_s               resel_req;

  /*! The redirection request from TDSCDMA RRC */
  lte_rrc_tdscdma_redir_req_s               redir_req;  
}lte_rrc_from_tds_req_proc_u;
...
typedef struct
{
  ...
  lte_rrc_from_tds_req_proc_u             proc_req; 

   /*! Current Inter-RAT procedure response structure */
  lte_rrc_from_tds_rsp_proc_u             proc_rsp;
  ...
  lte_rrc_irat_from_tds_mode_e              mode;

  /*! Next mode that the STM will be operating in */
  lte_rrc_irat_from_tds_mode_e              next_mode;

  /*! TDS2L PSHO RRC Reconf msg */
  lte_rrc_osys_DL_DCCH_Message                    *psho_decoded_msg_ptr;
  /*! Flag to keep track of key generation needed for TDS2L PSHO */
...
} lte_rrc_irat_from_tds_mgr_dynamic_data_s;
...
} lte_rrc_irat_from_tds_mgr_static_data_s;
...
{ 
  ...
  lte_rrc_irat_from_tds_mgr_dynamic_data_s    *dd_ptr;

  /* Static data pointer */
  lte_rrc_irat_from_tds_mgr_static_data_s     *sd_ptr;
  
} lte_rrc_irat_from_tds_mgr_s;
...
#endif /* LTE_RRC_IRAT_FROM_TDS_MGRI_H */
