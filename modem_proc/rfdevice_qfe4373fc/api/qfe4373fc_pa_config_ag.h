...
#ifndef QFE4373FC_PA_CONFIG_AG_H
#define QFE4373FC_PA_CONFIG_AG_H/*
...
boolean rfdevice_qpa_qfe4373fc_construct_driver_ag
(
  rfdevice_qpa_4g_settings_type* qpa_settings,
  rfdevice_qpa_4g_func_tbl_type* pa_fn_ptrs
);

uint8 rfdevice_qpa_qfe4373fc_get_efs_data_column
(
  uint8 port_index, 
