...
#ifndef RFC_WTR4905_NON_CA_TDSCDMA_CONFIG_AG
#define RFC_WTR4905_NON_CA_TDSCDMA_CONFIG_AG
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfc_jolokia/rf_card/rfc_wtr4905_non_ca/tdscdma/inc/rfc_wtr4905_non_ca_tdscdma_config_ag.h#1 $ 
...
class rfc_wtr4905_non_ca_tdscdma_ag:public rfc_tdscdma_data
{
public:
...
protected:
  rfc_wtr4905_non_ca_tdscdma_ag(void);  /*  Constructor  */
};
