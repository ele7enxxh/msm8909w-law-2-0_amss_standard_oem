...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfc_jolokia/rf_card/rfc_wtr2965_dual_wtr_4320_srx_w/common/src/rfc_wtr2965_dual_wtr_4320_srx_w_cmn_ag.cpp#1 $ 
...
#ifdef FEATURE_GSM
#include "rfc_wtr2965_dual_wtr_4320_srx_w_gsm_config_ag.h" 
#endif  
...
#ifdef FEATURE_CGPS
#include "rfc_wtr2965_dual_wtr_4320_srx_w_gnss_config_ag.h"
#endif


rfc_phy_device_info_type rfc_wtr2965_dual_wtr_4320_srx_w_phy_devices_list[] =
{
  { /*Device: WTR2965 */ 
...
rfc_logical_device_info_type rfc_wtr2965_dual_wtr_4320_srx_w_logical_devices_list[] = 
{
  { /*Device: WTR2965 */ 
...
rfc_signal_info_type rfc_wtr2965_dual_wtr_4320_srx_w_sig_info[RFC_WTR2965_DUAL_WTR_4320_SRX_W_SIG_NUM + 1] = 
{
  { RFC_MSM_TIMING_PA_CTL , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_TIMING_PA_CTL */ 
  { RFC_MSM_TIMING_PA_RANGE , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_TIMING_PA_RANGE */ 
  { RFC_MSM_TIMING_ASM_CTL , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_TIMING_ASM_CTL */ 
  { RFC_MSM_TIMING_TUNER_CTL , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_TIMING_TUNER_CTL */ 
  { RFC_MSM_TIMING_PAPM_CTL , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_TIMING_PAPM_CTL */ 
  { RFC_MSM_TIMING_TX_TX_RF_ON0 , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_TIMING_TX_TX_RF_ON0 */ 
  { RFC_MSM_TIMING_TX_RX_RF_ON0 , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_TIMING_TX_RX_RF_ON0 */ 
  { RFC_MSM_TIMING_ASM_TRIGGER , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_TIMING_ASM_TRIGGER */ 
  { RFC_MSM_TIMING_PAPM_TX_TX_TRIGGER , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_TIMING_PAPM_TX_TX_TRIGGER */ 
  { RFC_MSM_TIMING_PAPM_OFF_TX_RX_TX_TRIGGER , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_TIMING_PAPM_OFF_TX_RX_TX_TRIGGER */ 
  { RFC_MSM_TIMING_PA_TRIGGER , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_TIMING_PA_TRIGGER */ 
  { RFC_MSM_TIMING_PAPM_OFF_TX_RX_TX_CTL , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_TIMING_PAPM_OFF_TX_RX_TX_CTL */ 
  { RFC_MSM_TIMING_PAPM_TX_TX_CTL , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_TIMING_PAPM_TX_TX_CTL */ 
  { RFC_MSM_TIMING_PAPM_MULTISLOT_CTL , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_TIMING_PAPM_MULTISLOT_CTL */ 
  { RFC_MSM_RF_PATH_SEL_01 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RF_PATH_SEL_01 */            
  { RFC_MSM_RF_PATH_SEL_09 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RF_PATH_SEL_09 */            
  { RFC_MSM_RF_PATH_SEL_02 , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RF_PATH_SEL_02 */            
  { RFC_MSM_RF_PATH_SEL_11 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RF_PATH_SEL_11 */            
  { RFC_MSM_RF_PATH_SEL_04 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RF_PATH_SEL_04 */            
  { RFC_MSM_RF_PATH_SEL_17 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RF_PATH_SEL_17 */            
  { RFC_MSM_RF_PATH_SEL_15 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RF_PATH_SEL_15 */            
  { RFC_MSM_RF_PATH_SEL_05 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RF_PATH_SEL_05 */            
  { RFC_MSM_RF_PATH_SEL_20 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RF_PATH_SEL_20 */            
  { RFC_MSM_RF_PATH_SEL_06 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RF_PATH_SEL_06 */            
  { RFC_MSM_RF_PATH_SEL_08 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RF_PATH_SEL_08 */            
  { RFC_MSM_RF_PATH_SEL_07 , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RF_PATH_SEL_07 */            
  { RFC_MSM_GPDATA0_0 , RFC_CONFIG_ONLY, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_GPDATA0_0 */            
  { RFC_MSM_RFFE1_CLK , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RFFE1_CLK */            
  { RFC_MSM_RFFE1_DATA , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RFFE1_DATA */            
  { RFC_MSM_RFFE2_CLK , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RFFE2_CLK */            
  { RFC_MSM_RFFE2_DATA , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RFFE2_DATA */            
  { RFC_MSM_RFFE4_CLK , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RFFE4_CLK */            
  { RFC_MSM_RFFE4_DATA , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RFFE4_DATA */            
  { RFC_MSM_RFFE5_CLK , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RFFE5_CLK */            
  { RFC_MSM_RFFE5_DATA , RFC_CONFIG_ONLY, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_RFFE5_DATA */            
  { RFC_MSM_INTERNAL_GNSS_BLANK , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_INTERNAL_GNSS_BLANK */            
  { RFC_MSM_INTERNAL_GNSS_BLANK_CONCURRENCY , RFC_LOW, DAL_GPIO_NO_PULL, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_INTERNAL_GNSS_BLANK_CONCURRENCY */            
  { RFC_MSM_TX_GTR_TH , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_TX_GTR_TH */            
  { RFC_MSM_PA_IND , RFC_LOW, DAL_GPIO_PULL_DOWN, DAL_GPIO_2MA, (DALGpioIdType)NULL }, /* RFC_WTR2965_DUAL_WTR_4320_SRX_W_PA_IND */            
...
rfc_common_data* rfc_wtr2965_dual_wtr_4320_srx_w_cmn_ag::get_instance(rf_hw_type rf_hw)
{
  if (rfc_common_data_ptr == NULL)
  {
    rfc_common_data_ptr = (rfc_common_data *)new rfc_wtr2965_dual_wtr_4320_srx_w_cmn_ag(rf_hw);
  }
  return( (rfc_common_data *)rfc_common_data_ptr);
}

//constructor
rfc_wtr2965_dual_wtr_4320_srx_w_cmn_ag::rfc_wtr2965_dual_wtr_4320_srx_w_cmn_ag(rf_hw_type rf_hw)
  :rfc_common_data(rf_hw)
{
}


uint32 rfc_wtr2965_dual_wtr_4320_srx_w_cmn_ag::sig_info_table_get(rfc_signal_info_type **rfc_info_table)
{
  ...
  *rfc_info_table = &rfc_wtr2965_dual_wtr_4320_srx_w_sig_info[0];

#ifdef FEATURE_GSM
  // Create GSM RFC AG Data Object
  rfc_gsm_data* rfc_gsm_data = rfc_wtr2965_dual_wtr_4320_srx_w_gsm_ag::get_instance();
  ...
  rfc_wcdma_data* rfc_wcdma_data = rfc_wtr2965_dual_wtr_4320_srx_w_wcdma_ag::get_instance();
  ...
  rfc_cdma_data* rfc_cdma_data = rfc_wtr2965_dual_wtr_4320_srx_w_cdma_ag::get_instance();
  ...
  rfc_lte_data* rfc_lte_data = rfc_wtr2965_dual_wtr_4320_srx_w_lte_ag::get_instance();
  ...
  rfc_gnss_data* rfc_gnss_data = rfc_wtr2965_dual_wtr_4320_srx_w_gnss_ag::get_instance();
  ...
  return RFC_WTR2965_DUAL_WTR_4320_SRX_W_SIG_NUM;
}

rfc_phy_device_info_type* rfc_wtr2965_dual_wtr_4320_srx_w_cmn_ag::get_phy_device_cfg( void )
{
  return (&rfc_wtr2965_dual_wtr_4320_srx_w_phy_devices_list[0]);
}

rfc_logical_device_info_type* rfc_wtr2965_dual_wtr_4320_srx_w_cmn_ag::get_logical_device_cfg( void )
{
  return (&rfc_wtr2965_dual_wtr_4320_srx_w_logical_devices_list[0]);
}




rfm_devices_configuration_type rfc_wtr2965_dual_wtr_4320_srx_w_logical_device_properties = 
{
233, /* HWID */
...
boolean rfc_wtr2965_dual_wtr_4320_srx_w_cmn_ag::get_logical_path_config(rfm_devices_configuration_type* dev_cfg)
{
  if ( dev_cfg == NULL )
  {
  ...
  memscpy(dev_cfg,
          ...
          &rfc_wtr2965_dual_wtr_4320_srx_w_logical_device_properties,
          sizeof(rfm_devices_configuration_type));
...
rfc_cmn_properties_type rfc_wtr2965_dual_wtr_4320_srx_w_cmn_properties = 
{
  RFC_ENCODED_REVISION,   
  RFC_ATTENUATION_STATE_MID,
};

boolean rfc_wtr2965_dual_wtr_4320_srx_w_cmn_ag::get_cmn_properties(rfc_cmn_properties_type **ptr)
{
  if (NULL==ptr)
  {
    return FALSE;
  ...
  *ptr = &rfc_wtr2965_dual_wtr_4320_srx_w_cmn_properties;
  return TRUE;
}
