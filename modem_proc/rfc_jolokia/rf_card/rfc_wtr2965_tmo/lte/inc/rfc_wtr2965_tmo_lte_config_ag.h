...
#ifndef RFC_WTR2965_TMO_LTE_CONFIG_AG
#define RFC_WTR2965_TMO_LTE_CONFIG_AG
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfc_jolokia/rf_card/rfc_wtr2965_tmo/lte/inc/rfc_wtr2965_tmo_lte_config_ag.h#1 $ 
...
class rfc_wtr2965_tmo_lte_ag:public rfc_lte_data
{
public:
...
protected:
  rfc_wtr2965_tmo_lte_ag(void);  /*  Constructor  */
};
