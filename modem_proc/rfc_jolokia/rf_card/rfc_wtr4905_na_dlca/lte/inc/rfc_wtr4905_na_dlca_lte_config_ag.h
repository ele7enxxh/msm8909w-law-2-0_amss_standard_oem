...
#ifndef RFC_WTR4905_NA_DLCA_LTE_CONFIG_AG
#define RFC_WTR4905_NA_DLCA_LTE_CONFIG_AG
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfc_jolokia/rf_card/rfc_wtr4905_na_dlca/lte/inc/rfc_wtr4905_na_dlca_lte_config_ag.h#1 $ 
...
class rfc_wtr4905_na_dlca_lte_ag:public rfc_lte_data
{
public:
...
protected:
  rfc_wtr4905_na_dlca_lte_ag(void);  /*  Constructor  */
};
