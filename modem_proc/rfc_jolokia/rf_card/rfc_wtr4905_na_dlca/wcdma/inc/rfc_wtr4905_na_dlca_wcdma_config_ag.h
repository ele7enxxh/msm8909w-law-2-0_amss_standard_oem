...
#ifndef RFC_WTR4905_NA_DLCA_WCDMA_CONFIG_AG
#define RFC_WTR4905_NA_DLCA_WCDMA_CONFIG_AG
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfc_jolokia/rf_card/rfc_wtr4905_na_dlca/wcdma/inc/rfc_wtr4905_na_dlca_wcdma_config_ag.h#1 $ 
...
class rfc_wtr4905_na_dlca_wcdma_ag:public rfc_wcdma_data
{
public:
...
protected:
  rfc_wtr4905_na_dlca_wcdma_ag(void);  /*  Constructor  */
};
