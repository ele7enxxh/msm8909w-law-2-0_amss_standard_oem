...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfc_jolokia/rf_card/rfc_wtr4905_tmo/gnss/src/rfc_wtr4905_tmo_gnss_config_data_ag.c#1 $ 
...
rfc_device_info_type rf_card_wtr4905_tmo_gnss_device_info = 
{
...
rfc_sig_info_type rf_card_wtr4905_tmo_gnss_sig_cfg = 
{
  RFC_ENCODED_REVISION, 
  {
