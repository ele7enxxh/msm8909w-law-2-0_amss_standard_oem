...
#ifndef RFC_WTR2965_SWOC_NA_GNSS_CONFIG_AG
#define RFC_WTR2965_SWOC_NA_GNSS_CONFIG_AG
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfc_jolokia/rf_card/rfc_wtr2965_swoc_na/gnss/inc/rfc_wtr2965_swoc_na_gnss_config_ag.h#1 $ 
...
class rfc_wtr2965_swoc_na_gnss_ag:public rfc_gnss_data
{
public:
...
protected:
  rfc_wtr2965_swoc_na_gnss_ag(void);  /*  Constructor  */
};
