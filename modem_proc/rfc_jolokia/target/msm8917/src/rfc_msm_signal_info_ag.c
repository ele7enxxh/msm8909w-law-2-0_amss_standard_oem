...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfc_jolokia/target/msm8917/src/rfc_msm_signal_info_ag.c#1 $ 
...
rfc_msm_signal_info_type rfc_msm8917_signal_info[RFC_MSM_SIG_NUM] =
{
...
uint32 rfc_msm_sig_info_table_get(rfc_msm_signal_info_type **msm_info_table)
{
  ...
  *msm_info_table = &rfc_msm8917_signal_info[0];
