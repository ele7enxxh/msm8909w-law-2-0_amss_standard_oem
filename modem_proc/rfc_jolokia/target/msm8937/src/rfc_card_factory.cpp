...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfc_jolokia/target/msm8937/src/rfc_card_factory.cpp#1 $
...
boolean rfc_set_card (rf_hw_type rf_hw)
{
  ...
  else
  {
    ...
    {
      RF_MSG_1 ( RF_ERROR, "rfc_set_card: Failed to Create rfc_intf object (hwid=%d)",
               rf_hw );
    }
  }
