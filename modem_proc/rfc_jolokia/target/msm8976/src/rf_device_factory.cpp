...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfc_jolokia/target/msm8976/src/rf_device_factory.cpp#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
05/19/15   fhuo    Add QFE2082FC and QFE3340FC support
05/15/15   md      Removing support for WTR2955V110 device ID
