...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfc_jolokia/target/msm8976/src/rfc_msm_signal_info_ag.c#1 $ 
...
rfc_msm_signal_info_type rfc_msm8976_signal_info[RFC_MSM_SIG_NUM] = 
{
  ...
  {  RFC_ANT_SEL                         ,  80              ,  0              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[0]"},  /* Signal: RFC_MSM_RF_PATH_SEL_01, MSM Pin Name: GPIO_80*/
  {  RFC_ANT_SEL                         ,  82              ,  2              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[2]"},  /* Signal: RFC_MSM_RF_PATH_SEL_02, MSM Pin Name: GPIO_82*/
  ...
  {  RFC_ANT_SEL                         ,  84              ,  4              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[4]"},  /* Signal: RFC_MSM_RF_PATH_SEL_04, MSM Pin Name: GPIO_84*/
  {  RFC_ANT_SEL                         ,  87              ,  7              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[7]"},  /* Signal: RFC_MSM_RF_PATH_SEL_05, MSM Pin Name: GPIO_87*/
  {  RFC_ANT_SEL                         ,  89              ,  9              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[9]"},  /* Signal: RFC_MSM_RF_PATH_SEL_06, MSM Pin Name: GPIO_89*/
  {  RFC_ANT_SEL                         ,  91              ,  11             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[11]"},  /* Signal: RFC_MSM_RF_PATH_SEL_07, MSM Pin Name: GPIO_91*/
  {  RFC_ANT_SEL                         ,  93              ,  13             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[13]"},  /* Signal: RFC_MSM_RF_PATH_SEL_08, MSM Pin Name: GPIO_93*/
  {  RFC_ANT_SEL                         ,  81              ,  1              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[1]"},  /* Signal: RFC_MSM_RF_PATH_SEL_09, MSM Pin Name: GPIO_81*/
  ...
  {  RFC_ANT_SEL                         ,  83              ,  3              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[3]"},  /* Signal: RFC_MSM_RF_PATH_SEL_11, MSM Pin Name: GPIO_83*/
  ...
  {  RFC_ANT_SEL                         ,  90              ,  10             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[10]"},  /* Signal: RFC_MSM_RF_PATH_SEL_14, MSM Pin Name: GPIO_90*/
  {  RFC_ANT_SEL                         ,  86              ,  6              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[6]"},  /* Signal: RFC_MSM_RF_PATH_SEL_15, MSM Pin Name: GPIO_86*/
  {  RFC_ANT_SEL                         ,  92              ,  12             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[12]"},  /* Signal: RFC_MSM_RF_PATH_SEL_16, MSM Pin Name: GPIO_92*/
  {  RFC_ANT_SEL                         ,  85              ,  5              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[5]"},  /* Signal: RFC_MSM_RF_PATH_SEL_17, MSM Pin Name: GPIO_85*/
  ...
  {  RFC_ANT_SEL                         ,  88              ,  8              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[8]"},  /* Signal: RFC_MSM_RF_PATH_SEL_20, MSM Pin Name: GPIO_88*/
  {  RFC_ANT_SEL                         ,  94              ,  14             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[14]"},  /* Signal: RFC_MSM_RF_PATH_SEL_21, MSM Pin Name: GPIO_94*/
  ...
  {  RFC_PA_RANGE0                       ,  85              ,  5              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[5]"},  /* Signal: RFC_MSM_PA0_R0, MSM Pin Name: GPIO_85*/
  ...
  {  RFC_PA_RANGE0                       ,  81              ,  1              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[1]"},  /* Signal: RFC_MSM_PA1_R0_DEFAULT, MSM Pin Name: GPIO_81*/
  {  RFC_PA_RANGE1                       ,  83              ,  3              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[3]"},  /* Signal: RFC_MSM_PA1_R1_DEFAULT, MSM Pin Name: GPIO_83*/
  {  RFC_PA_RANGE0                       ,  88              ,  8              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[8]"},  /* Signal: RFC_MSM_PA0_R0_ALT1, MSM Pin Name: GPIO_88*/
  {  RFC_PA_RANGE1                       ,  89              ,  9              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[9]"},  /* Signal: RFC_MSM_PA0_R1_ALT1, MSM Pin Name: GPIO_89*/
  {  RFC_PA_RANGE0                       ,  93              ,  13             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[13]"},  /* Signal: RFC_MSM_PA1_R2, MSM Pin Name: GPIO_93*/
  {  RFC_PA_RANGE1                       ,  86              ,  6              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[6]"},  /* Signal: RFC_MSM_PA0_R2, MSM Pin Name: GPIO_86*/
  {  RFC_PA_RANGE0                       ,  84              ,  4              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[4]"},  /* Signal: RFC_MSM_PA0_R3, MSM Pin Name: GPIO_84*/
  ...
  {  RFC_PA_ON                           ,  88              ,  8              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[8]"},  /* Signal: RFC_MSM_PA_ON_00, MSM Pin Name: GPIO_88*/
  {  RFC_PA_ON                           ,  83              ,  3              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[3]"},  /* Signal: RFC_MSM_PA_ON_01, MSM Pin Name: GPIO_83*/
  {  RFC_PA_ON                           ,  87              ,  7              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[7]"},  /* Signal: RFC_MSM_PA_ON_02, MSM Pin Name: GPIO_87*/
  {  RFC_PA_ON                           ,  92              ,  12             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[12]"},  /* Signal: RFC_MSM_PA_ON_03, MSM Pin Name: GPIO_92*/
  {  RFC_PA_ON                           ,  80              ,  0              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[0]"},  /* Signal: RFC_MSM_PA_ON_04, MSM Pin Name: GPIO_80*/
  {  RFC_PA_ON                           ,  94              ,  14             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[14]"},  /* Signal: RFC_MSM_PA_ON_05, MSM Pin Name: GPIO_94*/
  {  RFC_PA_ON                           ,  84              ,  4              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[4]"},  /* Signal: RFC_MSM_PA_ON_06, MSM Pin Name: GPIO_84*/
  ...
  {  RFC_PA_ON                           ,  81              ,  1              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[1]"},  /* Signal: RFC_MSM_PA_ON_10, MSM Pin Name: GPIO_81*/
  ...
  {  RFC_PA_ON                           ,  93              ,  13             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[13]"},  /* Signal: RFC_MSM_PA_ON_12, MSM Pin Name: GPIO_93*/
  ...
  {  RFC_PA_ON                           ,  89              ,  9              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[9]"},  /* Signal: RFC_MSM_PA_ON_18, MSM Pin Name: GPIO_89*/
  ...
  {  RFC_RFFE1_CLK                       ,  70              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe1_clk"},  /* Signal: RFC_MSM_RFFE1_CLK, MSM Pin Name: GPIO_70*/
  {  RFC_RFFE1_DATA                      ,  71              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe1_data"},  /* Signal: RFC_MSM_RFFE1_DATA, MSM Pin Name: GPIO_71*/
  {  RFC_RFFE2_CLK                       ,  72              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe2_clk"},  /* Signal: RFC_MSM_RFFE2_CLK, MSM Pin Name: GPIO_72*/
  {  RFC_RFFE2_DATA                      ,  73              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe2_data"},  /* Signal: RFC_MSM_RFFE2_DATA, MSM Pin Name: GPIO_73*/
  {  RFC_RFFE3_CLK                       ,  74              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe3_clk"},  /* Signal: RFC_MSM_RFFE3_CLK, MSM Pin Name: GPIO_74*/
  {  RFC_RFFE3_DATA                      ,  75              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe3_data"},  /* Signal: RFC_MSM_RFFE3_DATA, MSM Pin Name: GPIO_75*/
  {  RFC_RFFE4_CLK                       ,  78              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe4_clk"},  /* Signal: RFC_MSM_RFFE4_CLK, MSM Pin Name: GPIO_78*/
  {  RFC_RFFE4_DATA                      ,  79              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe4_data"},  /* Signal: RFC_MSM_RFFE4_DATA, MSM Pin Name: GPIO_79*/
  {  RFC_RFFE5_CLK                       ,  76              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe5_clk"},  /* Signal: RFC_MSM_RFFE5_CLK, MSM Pin Name: GPIO_76*/
  {  RFC_RFFE5_DATA                      ,  77              ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe5_data"},  /* Signal: RFC_MSM_RFFE5_DATA, MSM Pin Name: GPIO_77*/
  ...
  {  RFC_GPDATA_CHAN0                    ,  99              ,  RFC_GRFC_NUM_NA,  RFC_GPIO       ,  1,  DAL_GPIO_OUTPUT                      ,"gsm0_tx_phase_d"},  /* Signal: RFC_MSM_GPDATA0_0, MSM Pin Name: GPIO_99*/
  ...
  {  RFC_GPDATA_CHAN1                    ,  95              ,  RFC_GRFC_NUM_NA,  RFC_GPIO       ,  2,  DAL_GPIO_OUTPUT                      ,"gsm1_tx_phase_d"},  /* Signal: RFC_MSM_GPDATA1_0, MSM Pin Name: GPIO_95*/
  ...
  {  RFC_GPS_TX_AGGRESSOR                ,  91              ,  11             ,  RFC_GPIO       ,  1,  DAL_GPIO_INPUT                       ,"rf_gpio_invalid_name"},  /* Signal: RFC_MSM_GPS_TX_AGGRESSOR, MSM Pin Name: GPIO_91*/
  {  RFC_PA_IND                          ,  92              ,  RFC_GRFC_NUM_NA,  RFC_GPIO       ,  2,  DAL_GPIO_OUTPUT                      ,"pa_indicator_1_or_2"},  /* Signal: RFC_MSM_PA_IND, MSM Pin Name: GPIO_92*/
...
uint32 rfc_msm_sig_info_table_get(rfc_msm_signal_info_type **msm_info_table)
{
  ...
  *msm_info_table = &rfc_msm8976_signal_info[0];
