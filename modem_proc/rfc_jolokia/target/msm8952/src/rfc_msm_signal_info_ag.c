...
Generated using: D:\Builds\MSM8952\TA10_CRM897_RFA3_TIPS_2015_07_07_09_45_57\modem_proc\rfc_tabasco\common\etc\rfc_autogen.exe
Generated from:  V5.11.306 of C:\Dropbox\RFCard\TA\TA1.x\RFC_HWSWCD_1.x_306.xlsm
*/
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfc_jolokia/target/msm8952/src/rfc_msm_signal_info_ag.c#1 $ 
...
rfc_msm_signal_info_type rfc_msm8952_signal_info[RFC_MSM_SIG_NUM] = 
{
  ...
  {  RFC_ANT_SEL                         ,  100             ,  0              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[0]"},  /* Signal: RFC_MSM_RF_PATH_SEL_01, MSM Pin Name: GPIO_100*/
  {  RFC_ANT_SEL                         ,  102             ,  2              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[2]"},  /* Signal: RFC_MSM_RF_PATH_SEL_02, MSM Pin Name: GPIO_102*/
  ...
  {  RFC_ANT_SEL                         ,  104             ,  4              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[4]"},  /* Signal: RFC_MSM_RF_PATH_SEL_04, MSM Pin Name: GPIO_104*/
  {  RFC_ANT_SEL                         ,  107             ,  7              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[7]"},  /* Signal: RFC_MSM_RF_PATH_SEL_05, MSM Pin Name: GPIO_107*/
  {  RFC_ANT_SEL                         ,  109             ,  9              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[9]"},  /* Signal: RFC_MSM_RF_PATH_SEL_06, MSM Pin Name: GPIO_109*/
  {  RFC_ANT_SEL                         ,  111             ,  11             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[11]"},  /* Signal: RFC_MSM_RF_PATH_SEL_07, MSM Pin Name: GPIO_111*/
  {  RFC_ANT_SEL                         ,  113             ,  13             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[13]"},  /* Signal: RFC_MSM_RF_PATH_SEL_08, MSM Pin Name: GPIO_113*/
  {  RFC_ANT_SEL                         ,  101             ,  1              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[1]"},  /* Signal: RFC_MSM_RF_PATH_SEL_09, MSM Pin Name: GPIO_101*/
  ...
  {  RFC_ANT_SEL                         ,  103             ,  3              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[3]"},  /* Signal: RFC_MSM_RF_PATH_SEL_11, MSM Pin Name: GPIO_103*/
  ...
  {  RFC_ANT_SEL                         ,  110             ,  10             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[10]"},  /* Signal: RFC_MSM_RF_PATH_SEL_14, MSM Pin Name: GPIO_110*/
  {  RFC_ANT_SEL                         ,  106             ,  6              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[6]"},  /* Signal: RFC_MSM_RF_PATH_SEL_15, MSM Pin Name: GPIO_106*/
  {  RFC_ANT_SEL                         ,  112             ,  12             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[12]"},  /* Signal: RFC_MSM_RF_PATH_SEL_16, MSM Pin Name: GPIO_112*/
  {  RFC_ANT_SEL                         ,  105             ,  5              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[5]"},  /* Signal: RFC_MSM_RF_PATH_SEL_17, MSM Pin Name: GPIO_105*/
  ...
  {  RFC_ANT_SEL                         ,  108             ,  8              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[8]"},  /* Signal: RFC_MSM_RF_PATH_SEL_20, MSM Pin Name: GPIO_108*/
  {  RFC_ANT_SEL                         ,  114             ,  14             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[14]"},  /* Signal: RFC_MSM_RF_PATH_SEL_21, MSM Pin Name: GPIO_114*/
  ...
  {  RFC_PA_RANGE0                       ,  105             ,  5              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[5]"},  /* Signal: RFC_MSM_PA0_R0, MSM Pin Name: GPIO_105*/
  ...
  {  RFC_PA_RANGE0                       ,  101             ,  1              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[1]"},  /* Signal: RFC_MSM_PA1_R0_DEFAULT, MSM Pin Name: GPIO_101*/
  {  RFC_PA_RANGE1                       ,  103             ,  3              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[3]"},  /* Signal: RFC_MSM_PA1_R1_DEFAULT, MSM Pin Name: GPIO_103*/
  {  RFC_PA_RANGE0                       ,  108             ,  8              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[8]"},  /* Signal: RFC_MSM_PA0_R0_ALT1, MSM Pin Name: GPIO_108*/
  {  RFC_PA_RANGE1                       ,  109             ,  9              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[9]"},  /* Signal: RFC_MSM_PA0_R1_ALT1, MSM Pin Name: GPIO_109*/
  {  RFC_PA_RANGE0                       ,  113             ,  13             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[13]"},  /* Signal: RFC_MSM_PA1_R2, MSM Pin Name: GPIO_113*/
  {  RFC_PA_RANGE1                       ,  106             ,  6              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[6]"},  /* Signal: RFC_MSM_PA0_R2, MSM Pin Name: GPIO_106*/
  {  RFC_PA_RANGE0                       ,  104             ,  4              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[4]"},  /* Signal: RFC_MSM_PA0_R3, MSM Pin Name: GPIO_104*/
  ...
  {  RFC_PA_ON                           ,  108             ,  8              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[8]"},  /* Signal: RFC_MSM_PA_ON_00, MSM Pin Name: GPIO_108*/
  {  RFC_PA_ON                           ,  103             ,  3              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[3]"},  /* Signal: RFC_MSM_PA_ON_01, MSM Pin Name: GPIO_103*/
  {  RFC_PA_ON                           ,  107             ,  7              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[7]"},  /* Signal: RFC_MSM_PA_ON_02, MSM Pin Name: GPIO_107*/
  {  RFC_PA_ON                           ,  112             ,  12             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[12]"},  /* Signal: RFC_MSM_PA_ON_03, MSM Pin Name: GPIO_112*/
  {  RFC_PA_ON                           ,  100             ,  0              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[0]"},  /* Signal: RFC_MSM_PA_ON_04, MSM Pin Name: GPIO_100*/
  {  RFC_PA_ON                           ,  114             ,  14             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[14]"},  /* Signal: RFC_MSM_PA_ON_05, MSM Pin Name: GPIO_114*/
  {  RFC_PA_ON                           ,  104             ,  4              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[4]"},  /* Signal: RFC_MSM_PA_ON_06, MSM Pin Name: GPIO_104*/
  {  RFC_PA_ON                           ,  102             ,  2              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[2]"},  /* Signal: RFC_MSM_PA_ON_07, MSM Pin Name: GPIO_102*/
  ...
  {  RFC_PA_ON                           ,  101             ,  1              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[1]"},  /* Signal: RFC_MSM_PA_ON_10, MSM Pin Name: GPIO_101*/
  ...
  {  RFC_PA_ON                           ,  113             ,  13             ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[13]"},  /* Signal: RFC_MSM_PA_ON_12, MSM Pin Name: GPIO_113*/
  ...
  {  RFC_PA_ON                           ,  109             ,  9              ,  RFC_GRFC       ,  1,  DAL_GPIO_OUTPUT                      ,"grfc[9]"},  /* Signal: RFC_MSM_PA_ON_18, MSM Pin Name: GPIO_109*/
  ...
  {  RFC_RFFE1_CLK                       ,  118             ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe1_clk"},  /* Signal: RFC_MSM_RFFE1_CLK, MSM Pin Name: GPIO_118*/
  {  RFC_RFFE1_DATA                      ,  119             ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe1_data"},  /* Signal: RFC_MSM_RFFE1_DATA, MSM Pin Name: GPIO_119*/
  {  RFC_RFFE2_CLK                       ,  120             ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe2_clk"},  /* Signal: RFC_MSM_RFFE2_CLK, MSM Pin Name: GPIO_120*/
  {  RFC_RFFE2_DATA                      ,  121             ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe2_data"},  /* Signal: RFC_MSM_RFFE2_DATA, MSM Pin Name: GPIO_121*/
  {  RFC_RFFE3_CLK                       ,  126             ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe3_clk"},  /* Signal: RFC_MSM_RFFE3_CLK, MSM Pin Name: GPIO_126*/
  {  RFC_RFFE3_DATA                      ,  127             ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe3_data"},  /* Signal: RFC_MSM_RFFE3_DATA, MSM Pin Name: GPIO_127*/
  ...
  {  RFC_RFFE5_CLK                       ,  124             ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe5_clk"},  /* Signal: RFC_MSM_RFFE5_CLK, MSM Pin Name: GPIO_124*/
  {  RFC_RFFE5_DATA                      ,  125             ,  RFC_GRFC_NUM_NA,  RFC_RFFE       ,  1,  DAL_GPIO_OUTPUT                      ,"rffe5_data"},  /* Signal: RFC_MSM_RFFE5_DATA, MSM Pin Name: GPIO_125*/
  ...
  {  RFC_GPDATA_CHAN0                    ,  117             ,  RFC_GRFC_NUM_NA,  RFC_GPIO       ,  1,  DAL_GPIO_OUTPUT                      ,"gsm0_tx_phase_d"},  /* Signal: RFC_MSM_GPDATA0_0, MSM Pin Name: GPIO_117*/
  ...
  {  RFC_GPDATA_CHAN1                    ,  115             ,  RFC_GRFC_NUM_NA,  RFC_GPIO       ,  2,  DAL_GPIO_OUTPUT                      ,"gsm1_tx_phase_d"},  /* Signal: RFC_MSM_GPDATA1_0, MSM Pin Name: GPIO_115*/
  ...
  {  RFC_GPS_TX_AGGRESSOR                ,  111             ,  11             ,  RFC_GPIO       ,  1,  DAL_GPIO_INPUT                       ,"rf_gpio_invalid_name"},  /* Signal: RFC_MSM_GPS_TX_AGGRESSOR, MSM Pin Name: GPIO_111*/
  {  RFC_PA_IND                          ,  112             ,  RFC_GRFC_NUM_NA,  RFC_GPIO       ,  2,  DAL_GPIO_OUTPUT                      ,"pa_indicator_1_or_2"},  /* Signal: RFC_MSM_PA_IND, MSM Pin Name: GPIO_112*/
...
uint32 rfc_msm_sig_info_table_get(rfc_msm_signal_info_type **msm_info_table)
{
  ...
  *msm_info_table = &rfc_msm8952_signal_info[0];
