...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfc_jolokia/target/mdm9607/src/rfc_msm_signal_info_ag.c#1 $ 
...
rfc_msm_signal_info_type rfc_mdm9607_signal_info[RFC_MSM_SIG_NUM] =
{
  ...
  {  RFC_GPS_TX_AGGRESSOR                ,  52              ,  11             ,  RFC_GRFC             ,  2,  DAL_GPIO_INPUT                      , "rf_gpio_invalid_name"},  /* Signal: RFC_MSM_GPS_TX_AGGRESSOR, MSM Pin Name: MAX*/
