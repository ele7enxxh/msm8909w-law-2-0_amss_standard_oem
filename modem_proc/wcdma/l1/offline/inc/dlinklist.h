...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/wcdma/l1/offline/inc/dlinklist.h#1 $ $DateTime: 2016/12/13 08:00:12 $ $Author: mplcsds1 $
...
typedef struct
{
  ...
  /* head node pointer */
  dll_node_struct_type *head;
  /* tail node pointer */
  dll_node_struct_type *tail;
  /* current node pointer */
  dll_node_struct_type *cur_link;
...
extern void dll_init(
  ...
  dll_struct_type *ll_ptr);

/*===========================================================================
FUNCTION dll_link_node
...
extern dll_node_struct_type* dll_link_node(
...
extern void dll_insert_node(
  /* link list pointer */
  dll_struct_type *ll_ptr,
  /* link list node pointer to insert */
  dll_node_struct_type *ll_node,
  /* insert position */
  dll_pos_enum_type insert_pos,
  /* link list node pointer if insert before of after node */
  dll_node_struct_type *ll_node_before_after);

/*===========================================================================
FUNCTION dll_remove_node
...
extern dll_node_struct_type* dll_get_cur_node(
    /* link list pointer */
  dll_struct_type *ll_ptr);

/*===========================================================================
FUNCTION dll_get_next_node
...
extern dll_node_struct_type* dll_get_next_node(
  /* link list pointer */
  dll_struct_type *ll_ptr,
...
extern dll_node_struct_type* dll_get_prev_node(
  /* link list pointer */
  dll_struct_type *ll_ptr,
  /* set the current node to next node */
  boolean seek);
...
extern dll_node_struct_type* dll_seek_node(
  /* link list pointer */
  dll_struct_type *ll_ptr,
  /* insert position */
  dll_pos_enum_type seek_pos,
  /* link list node pointer to seek */
  dll_node_struct_type *ll_node_to_seek);

/*===========================================================================
FUNCTION dll_mode_circular
