...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/wcdma/api/public/wcdmatmcif.h#1 $
...
===========================================================================*/
extern  void  wcdma_mac_hs_dl_task( dword dummy );
