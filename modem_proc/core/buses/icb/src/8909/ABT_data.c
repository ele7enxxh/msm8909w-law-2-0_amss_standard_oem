...
$Header: //components/rel/core.mpss/3.5.c12.3/buses/icb/src/8909/ABT_data.c#1 $ 
...
#define ABT_ULTAUDIO_BMSK  HWIO_TCSR_TIMEOUT_INTR_STATUS_BUS_TIMEOUT_ULTAUDIO_IRQ_SHFT
