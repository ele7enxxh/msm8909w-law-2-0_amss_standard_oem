...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.5.c12.3/services/diag/diag_mask_tbl/src/msg_arrays_i.c#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
02/16/16   as      Added new message SSIDs
04/21/15   xy      Added new message SSIDs  
04/08/15   xy      Added new message SSIDs    
02/12/15   xy      Added new message SSIDs   
12/04/14   xy      Added new message SSIDs   
08/04/14   xy      Added new message SSIDs  
06/18/14   xy      Added new message SSIDs 
05/28/14   xy      Added new message SSIDs  
05/01/14   xy      Update msg_mask_tbl 
04/23/14   xy      Added new message SSIDs   
03/31/14   xy      Added new message SSIDs    
01/29/14   xy      Added new message SSIDs 
01/27/14   xy      Added new message SSIDs   
12/26/13   xy      Added new message SSIDs  
10/01/13   sa      Support for F3 listeners mask
09/25/13   xy      Added new message SSIDs 
07/18/13   sr      Added new message SSIDs  
06/12/13   sr      Added new message SSIDs  
...
#define DIAG_MAX_PRESET_ID 2 //ToDo: Remove
#define DIAG_MAX_DCI_ID    1 //ToDo: Remove
...
static uint32 msg_rt_masks_dci_gen[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_gen) / sizeof(msg_bld_masks_gen[0])];
 uint32 msg_listener_masks_gen[sizeof (msg_bld_masks_gen) / sizeof (msg_bld_masks_gen[0])];
 uint32 msg_listener_ext_masks_gen[sizeof (msg_bld_masks_gen) / sizeof (msg_bld_masks_gen[0])];
...
static uint32 msg_rt_masks_dci_oncrpc[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_oncrpc) / sizeof(msg_bld_masks_oncrpc[0])];
 ...
 uint32 msg_listener_masks_oncrpc[sizeof (msg_bld_masks_oncrpc) / sizeof (msg_bld_masks_oncrpc[0])];
 uint32 msg_listener_ext_masks_oncrpc[sizeof (msg_bld_masks_oncrpc) / sizeof (msg_bld_masks_oncrpc[0])];
/* This table must be maintained as SSIDs are added! */
...
static uint32 msg_rt_masks_dci_1X[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_1X) / sizeof(msg_bld_masks_1X[0])];
 uint32 msg_listener_masks_1X[sizeof (msg_bld_masks_1X) / sizeof (msg_bld_masks_1X[0])];
 uint32 msg_listener_ext_masks_1X[sizeof (msg_bld_masks_1X) / sizeof (msg_bld_masks_1X[0])];
...
static uint32 msg_rt_masks_dci_hdr[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_hdr) / sizeof(msg_bld_masks_hdr[0])];
 ...
 uint32 msg_listener_masks_hdr[sizeof (msg_bld_masks_hdr) / sizeof (msg_bld_masks_hdr[0])];
 uint32 msg_listener_ext_masks_hdr[sizeof (msg_bld_masks_hdr) / sizeof (msg_bld_masks_hdr[0])];
/* This table must be maintained as SSIDs are added! */
...
static uint32 msg_rt_masks_dci_umts[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_umts) / sizeof(msg_bld_masks_umts[0])];
 ...
 uint32 msg_listener_masks_umts[sizeof (msg_bld_masks_umts) / sizeof (msg_bld_masks_umts[0])];
 uint32 msg_listener_ext_masks_umts[sizeof (msg_bld_masks_umts) / sizeof (msg_bld_masks_umts[0])];
/* This table must be maintained as SSIDs are added! */
...
static uint32 msg_rt_masks_dci_gsm[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_gsm) / sizeof(msg_bld_masks_gsm[0])];
 uint32 msg_listener_masks_gsm[sizeof (msg_bld_masks_gsm) / sizeof (msg_bld_masks_gsm[0])];
 uint32 msg_listener_ext_masks_gsm[sizeof (msg_bld_masks_gsm) / sizeof (msg_bld_masks_gsm[0])];
...
static uint32 msg_rt_masks_dci_wlan[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_wlan) / sizeof(msg_bld_masks_wlan[0])];
 ...
 uint32 msg_listener_masks_wlan[sizeof (msg_bld_masks_wlan) / sizeof (msg_bld_masks_wlan[0])];
 uint32 msg_listener_ext_masks_wlan[sizeof (msg_bld_masks_wlan) / sizeof (msg_bld_masks_wlan[0])];
/* This table must be maintained as SSIDs are added! */
...
static uint32 msg_rt_masks_dci_mcs[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_mcs) / sizeof(msg_bld_masks_mcs[0])];
 uint32 msg_listener_masks_mcs[sizeof (msg_bld_masks_mcs) / sizeof (msg_bld_masks_mcs[0])];
 uint32 msg_listener_ext_masks_mcs[sizeof (msg_bld_masks_mcs) / sizeof (msg_bld_masks_mcs[0])];
...
uint32 msg_listener_masks_ds[sizeof (msg_bld_masks_ds) / sizeof (msg_bld_masks_ds[0])];
 uint32 msg_listener_ext_masks_ds[sizeof (msg_bld_masks_ds) / sizeof (msg_bld_masks_ds[0])];
...
static uint32 msg_rt_masks_dci_sec[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_sec) / sizeof(msg_bld_masks_sec[0])];
   uint32 msg_listener_masks_sec[sizeof (msg_bld_masks_sec) / sizeof (msg_bld_masks_sec[0])];
 uint32 msg_listener_ext_masks_sec[sizeof (msg_bld_masks_sec) / sizeof (msg_bld_masks_sec[0])];
...
static uint32 msg_rt_masks_dci_apps[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_apps) / sizeof(msg_bld_masks_apps[0])];
 ...
 uint32 msg_listener_masks_apps[sizeof (msg_bld_masks_apps) / sizeof (msg_bld_masks_apps[0])];
 uint32 msg_listener_ext_masks_apps[sizeof (msg_bld_masks_apps) / sizeof (msg_bld_masks_apps[0])];
/* This table must be maintained as SSIDs are added! */
...
static uint32 msg_rt_masks_dci_adsptasks[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_adsptasks) / sizeof(msg_bld_masks_adsptasks[0])];
 uint32 msg_listener_masks_adsptasks[sizeof (msg_bld_masks_adsptasks) / sizeof (msg_bld_masks_adsptasks[0])];
 uint32 msg_listener_ext_masks_adsptasks[sizeof (msg_bld_masks_adsptasks) / sizeof (msg_bld_masks_adsptasks[0])];
...
static uint32 msg_rt_masks_dci_l4_linux[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_l4_linux) / sizeof(msg_bld_masks_l4_linux[0])];
 uint32 msg_listener_masks_l4_linux[sizeof (msg_bld_masks_l4_linux) / sizeof (msg_bld_masks_l4_linux[0])];
 uint32 msg_listener_ext_masks_l4_linux[sizeof (msg_bld_masks_l4_linux) / sizeof (msg_bld_masks_l4_linux[0])];
...
static uint32 msg_rt_masks_dci_l4_iguana[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_l4_iguana) / sizeof(msg_bld_masks_l4_iguana[0])];
   uint32 msg_listener_masks_l4_iguana[sizeof (msg_bld_masks_l4_iguana) / sizeof (msg_bld_masks_l4_iguana[0])];
 uint32 msg_listener_ext_masks_l4_iguana[sizeof (msg_bld_masks_l4_iguana) / sizeof (msg_bld_masks_l4_iguana[0])];
...
static uint32 msg_rt_masks_dci_l4_amss[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_l4_amss) / sizeof(msg_bld_masks_l4_amss[0])];
 ...
 uint32 msg_listener_masks_l4_amss[sizeof (msg_bld_masks_l4_amss) / sizeof (msg_bld_masks_l4_amss[0])];
 uint32 msg_listener_ext_masks_l4_amss[sizeof (msg_bld_masks_l4_amss) / sizeof (msg_bld_masks_l4_amss[0])];
/* This table must be maintained as SSIDs are added! */
...
static uint32 msg_rt_masks_dci_hit[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_hit) / sizeof(msg_bld_masks_hit[0])];
 uint32 msg_listener_masks_hit[sizeof (msg_bld_masks_hit) / sizeof (msg_bld_masks_hit[0])];
 uint32 msg_listener_ext_masks_hit[sizeof (msg_bld_masks_hit) / sizeof (msg_bld_masks_hit[0])];
...
static uint32 msg_rt_masks_dci_qdsp6[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_qdsp6) / sizeof(msg_bld_masks_qdsp6[0])];
 ...
 uint32 msg_listener_masks_qdsp6[sizeof (msg_bld_masks_qdsp6) / sizeof (msg_bld_masks_qdsp6[0])];
 uint32 msg_listener_ext_masks_qdsp6[sizeof (msg_bld_masks_qdsp6) / sizeof (msg_bld_masks_qdsp6[0])];
/* This table must be maintained as SSIDs are added! */
...
static uint32 msg_rt_masks_dci_umb[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_umb) / sizeof(msg_bld_masks_umb[0])];
   uint32 msg_listener_masks_umb[sizeof (msg_bld_masks_umb) / sizeof (msg_bld_masks_umb[0])];
 uint32 msg_listener_ext_masks_umb[sizeof (msg_bld_masks_umb) / sizeof (msg_bld_masks_umb[0])];
...
static uint32 msg_rt_masks_dci_lte[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_lte) / sizeof(msg_bld_masks_lte[0])];
 uint32 msg_listener_masks_lte[sizeof (msg_bld_masks_lte) / sizeof (msg_bld_masks_lte[0])];
 uint32 msg_listener_ext_masks_lte[sizeof (msg_bld_masks_lte) / sizeof (msg_bld_masks_lte[0])];
...
static uint32 msg_rt_masks_dci_qchat[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_qchat) / sizeof(msg_bld_masks_qchat[0])];
 ...
 uint32 msg_listener_masks_qchat[sizeof (msg_bld_masks_qchat) / sizeof (msg_bld_masks_qchat[0])];
 uint32 msg_listener_ext_masks_qchat[sizeof (msg_bld_masks_qchat) / sizeof (msg_bld_masks_qchat[0])];
/* This table must be maintained as SSIDs are added! */
...
static uint32 msg_rt_masks_dci_tdscdma[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_tdscdma) / sizeof(msg_bld_masks_tdscdma[0])]; 
 ...
 uint32 msg_listener_masks_tdscdma[sizeof (msg_bld_masks_tdscdma) / sizeof (msg_bld_masks_tdscdma[0])]; 
 uint32 msg_listener_ext_masks_tdscdma[sizeof (msg_bld_masks_tdscdma) / sizeof (msg_bld_masks_tdscdma[0])]; 
/* This table must be maintained as SSIDs are added! */
...
static uint32 msg_rt_masks_dci_cta[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_cta) / sizeof(msg_bld_masks_cta[0])];
 uint32 msg_listener_masks_cta[sizeof(msg_bld_masks_cta) / sizeof(msg_bld_masks_cta[0])];
 uint32 msg_listener_ext_masks_cta[sizeof(msg_bld_masks_cta) / sizeof(msg_bld_masks_cta[0])];
...
static uint32 msg_rt_masks_dci_qcnea[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_qcnea) / sizeof(msg_bld_masks_qcnea[0])];
 uint32 msg_listener_masks_qcnea[sizeof(msg_bld_masks_qcnea) / sizeof(msg_bld_masks_qcnea[0])];
 uint32 msg_listener_ext_masks_qcnea[sizeof(msg_bld_masks_qcnea) / sizeof(msg_bld_masks_qcnea[0])];
...
static uint32 msg_rt_masks_preset_dpm[DIAG_MAX_PRESET_ID][sizeof(msg_bld_masks_dpm) / sizeof(msg_bld_masks_dpm[0])];
static uint32 msg_rt_masks_dci_dpm[DIAG_MAX_DCI_ID][sizeof(msg_bld_masks_dpm) / sizeof(msg_bld_masks_dpm[0])];
 uint32 msg_listener_masks_dpm[sizeof(msg_bld_masks_dpm) / sizeof(msg_bld_masks_dpm[0])];
 uint32 msg_listener_ext_masks_dpm[sizeof(msg_bld_masks_dpm) / sizeof(msg_bld_masks_dpm[0])];
...
msg_mask_tbl_type msg_mask_tbl[] = {
   ...
   ,
  {
      ...
      msg_bld_masks_dpm,
    { (uint32*)msg_rt_masks_preset_dpm, (uint32*)msg_rt_masks_dci_dpm },
    { (uint32*)msg_rt_masks_preset_dpm, (uint32*)msg_rt_masks_dci_dpm }
  }
};

const uint32 msg_mask_tbl_size = (sizeof (msg_mask_tbl) / sizeof (msg_mask_tbl[0])) ;
listener_msg_mask_tbl_type listener_msg_mask_tbl[] = {
  {
    MSG_SSID_GEN_FIRST,
    /* FIRST + array count */
    MSG_SSID_GEN_FIRST +
      sizeof (msg_bld_masks_gen) / sizeof (msg_bld_masks_gen[0]) - 1,
	  (uint32*)msg_listener_masks_gen,
	  (uint32*)msg_listener_ext_masks_gen
  }
  ,
  {
    MSG_SSID_ONCRPC,
    ...
    MSG_SSID_ONCRPC +
      sizeof (msg_bld_masks_oncrpc) / sizeof (msg_bld_masks_oncrpc[0]) - 1,
	(uint32*) msg_listener_masks_oncrpc,
	(uint32*) msg_listener_ext_masks_oncrpc,
  }
  ,
  {
    MSG_SSID_1X,
    ...
    MSG_SSID_1X +
      sizeof (msg_bld_masks_1X) / sizeof (msg_bld_masks_1X[0]) - 1,
  (uint32*)msg_listener_masks_1X,
  (uint32*)msg_listener_ext_masks_1X  
  }
  ,
  {
    MSG_SSID_HDR_PROT,
    ...
    MSG_SSID_HDR_PROT+
      sizeof (msg_bld_masks_hdr) / sizeof (msg_bld_masks_hdr[0]) - 1,
(uint32*)msg_listener_masks_hdr,
(uint32*)msg_listener_ext_masks_hdr
  }
  ,
  {
    MSG_SSID_UMTS,
    ...
    MSG_SSID_UMTS +
      sizeof (msg_bld_masks_umts) / sizeof (msg_bld_masks_umts[0]) - 1,
(uint32*)msg_listener_masks_umts,
(uint32*)msg_listener_ext_masks_umts
  }
  ,
  {
    MSG_SSID_GSM,
    ...
    MSG_SSID_GSM +
      sizeof (msg_bld_masks_gsm) / sizeof (msg_bld_masks_gsm[0]) - 1,
(uint32*)msg_listener_masks_gsm,
(uint32*)msg_listener_ext_masks_gsm
  }
  ,
  {
    MSG_SSID_WLAN,
    ...
    MSG_SSID_WLAN +
      sizeof (msg_bld_masks_wlan) / sizeof (msg_bld_masks_wlan[0]) - 1,
(uint32*)msg_listener_masks_wlan,
(uint32*)msg_listener_ext_masks_wlan
  }
  ,
  {
    MSG_SSID_ATS,
    ...
    MSG_SSID_ATS +
      sizeof (msg_bld_masks_mcs) / sizeof (msg_bld_masks_mcs[0]) - 1,
(uint32*) msg_listener_masks_mcs,
(uint32*) msg_listener_ext_masks_mcs
  }
  ,
  {
    MSG_SSID_DS,
    ...
    MSG_SSID_DS +
      sizeof (msg_bld_masks_ds) / sizeof (msg_bld_masks_ds[0]) - 1,
(uint32*)msg_listener_masks_ds,
(uint32*)msg_listener_ext_masks_ds
  }
  ,
  {
    MSG_SSID_SEC,
    ...
    MSG_SSID_SEC +
      sizeof (msg_bld_masks_sec) / sizeof (msg_bld_masks_sec[0]) - 1,
(uint32*)msg_listener_masks_sec,
(uint32*)msg_listener_ext_masks_sec
  }
  ,
  {
    MSG_SSID_APPS,
    ...
    MSG_SSID_APPS +
      sizeof (msg_bld_masks_apps) / sizeof (msg_bld_masks_apps[0]) - 1,
(uint32*)msg_listener_masks_apps,
(uint32*)msg_listener_ext_masks_apps
  }
  ,
  {
    MSG_SSID_ADSPTASKS,
    ...
    MSG_SSID_ADSPTASKS +
      sizeof (msg_bld_masks_adsptasks) / sizeof (msg_bld_masks_adsptasks[0]) - 1,
(uint32*)msg_listener_masks_adsptasks,
(uint32*)msg_listener_ext_masks_adsptasks
  }
  ,
  {
    MSG_SSID_L4LINUX_KERNEL,
    ...
    MSG_SSID_L4LINUX_KERNEL +
      sizeof (msg_bld_masks_l4_linux) / sizeof (msg_bld_masks_l4_linux[0]) - 1,
(uint32*)msg_listener_masks_l4_linux,
(uint32*)msg_listener_ext_masks_l4_linux
  }
  ,
  {
    MSG_SSID_L4IGUANA_IGUANASERVER,
    ...
    MSG_SSID_L4IGUANA_IGUANASERVER +
      sizeof (msg_bld_masks_l4_iguana) / sizeof (msg_bld_masks_l4_iguana[0]) - 1,
(uint32*)msg_listener_masks_l4_iguana,
(uint32*)msg_listener_ext_masks_l4_iguana
  }
  ,
  {
    MSG_SSID_L4AMSS_QDIAG,
    ...
    MSG_SSID_L4AMSS_QDIAG +
      sizeof (msg_bld_masks_l4_amss) / sizeof (msg_bld_masks_l4_amss[0]) - 1,
(uint32*)msg_listener_masks_l4_amss,
(uint32*)msg_listener_ext_masks_l4_amss
  }
  ,
  {
    MSG_SSID_HIT,
    ...
    MSG_SSID_HIT+
      sizeof (msg_bld_masks_hit) / sizeof (msg_bld_masks_hit[0]) - 1,
(uint32*) msg_listener_masks_hit,
(uint32*) msg_listener_ext_masks_hit
  }
  ,
  {
    MSG_SSID_QDSP6,
    ...
    MSG_SSID_QDSP6+
      sizeof (msg_bld_masks_qdsp6) / sizeof (msg_bld_masks_qdsp6[0]) - 1,
(uint32*)msg_listener_masks_qdsp6,
(uint32*)msg_listener_ext_masks_qdsp6
  }
  ,
  {
    MSG_SSID_UMB,
    ...
    MSG_SSID_UMB+
      sizeof (msg_bld_masks_umb) / sizeof (msg_bld_masks_umb[0]) - 1,
(uint32*)msg_listener_masks_umb,
(uint32*)msg_listener_ext_masks_umb
  }
  ,
  {
    MSG_SSID_LTE,
    ...
    MSG_SSID_LTE+
      sizeof (msg_bld_masks_lte) / sizeof (msg_bld_masks_lte[0]) - 1,
(uint32*)msg_listener_masks_lte,
(uint32*)msg_listener_ext_masks_lte
  }
  ,
  {
    MSG_SSID_QCHAT,
    ...
    MSG_SSID_QCHAT+
      sizeof (msg_bld_masks_qchat) / sizeof(msg_bld_masks_qchat[0]) - 1,
(uint32*)msg_listener_masks_qchat,
(uint32*)msg_listener_ext_masks_qchat
  }
  ,
  {
    MSG_SSID_TDSCDMA_L1,
    ...
    MSG_SSID_TDSCDMA_L1+
      sizeof (msg_bld_masks_tdscdma) / sizeof(msg_bld_masks_tdscdma[0]) - 1,
(uint32*)msg_listener_masks_tdscdma,
(uint32*)msg_listener_ext_masks_tdscdma
  }
  ,
  {
      MSG_SSID_CTA,
      MSG_SSID_CTA+
        sizeof(msg_bld_masks_cta) / sizeof(msg_bld_masks_cta[0]) - 1,
(uint32*)msg_listener_masks_cta,
(uint32*)msg_listener_ext_masks_cta
  }
    ,
  {
      MSG_SSID_QCNEA,
      MSG_SSID_QCNEA+
        sizeof(msg_bld_masks_qcnea) / sizeof(msg_bld_masks_qcnea[0]) - 1,
(uint32*)msg_listener_masks_qcnea,
(uint32*)msg_listener_ext_masks_qcnea
  }
   ,
  {
      MSG_SSID_DPM,
      MSG_SSID_DPM+
        sizeof(msg_bld_masks_dpm) / sizeof(msg_bld_masks_dpm[0]) - 1,
(uint32*)msg_listener_masks_dpm,
(uint32*)msg_listener_ext_masks_dpm
  }
};
uint32 listener_msg_mask_tbl_size = (sizeof (listener_msg_mask_tbl) / sizeof (listener_msg_mask_tbl[0])) ;
