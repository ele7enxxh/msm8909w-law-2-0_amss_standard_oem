...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.mpss/3.5.c12.3/securemsm/cryptodrivers/prng/chipset/build/msm8937.SConscript#1 $
...
# 8937 interface redirection
CHIPSETREDIRECTION = 'msm8937'
...
if os.path.exists('../' + CHIPSETREDIRECTION + '/build/SConscript') :
   ...
   raise RuntimeError, "msm8937  [%s] does not exist"%script_sconfname
