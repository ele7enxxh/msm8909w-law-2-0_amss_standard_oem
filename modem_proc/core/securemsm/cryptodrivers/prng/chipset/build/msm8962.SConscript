...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.mpss/3.5.c12.3/securemsm/cryptodrivers/prng/chipset/build/msm8962.SConscript#1 $
...
# 8962 interface redirection
CHIPSETREDIRECTION = 'msm8962'
...
if os.path.exists('../' + CHIPSETREDIRECTION + '/build/SConscript') :
   ...
   raise RuntimeError, "msm8962  [%s] does not exist"%script_sconfname
