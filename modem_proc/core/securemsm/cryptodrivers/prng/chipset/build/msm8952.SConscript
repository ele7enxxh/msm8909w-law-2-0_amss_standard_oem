...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.mpss/3.5.c12.3/securemsm/cryptodrivers/prng/chipset/build/msm8952.SConscript#1 $
...
# 8952 interface redirection
CHIPSETREDIRECTION = 'msm8952'
...
if os.path.exists('../' + CHIPSETREDIRECTION + '/build/SConscript') :
   ...
   raise RuntimeError, "msm8952  [%s] does not exist"%script_sconfname
