...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.mpss/3.5.c12.3/securemsm/cryptodrivers/prng/chipset/build/msm8936.SConscript#1 $
...
# 8936 interface redirection
CHIPSETREDIRECTION = 'msm8936'
...
if os.path.exists('../' + CHIPSETREDIRECTION + '/build/SConscript') :
   ...
   raise RuntimeError, "msm8936  [%s] does not exist"%script_sconfname
