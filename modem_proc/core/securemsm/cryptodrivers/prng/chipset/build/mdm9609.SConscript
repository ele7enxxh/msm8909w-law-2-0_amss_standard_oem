...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.mpss/3.5.c12.3/securemsm/cryptodrivers/prng/chipset/build/mdm9609.SConscript#1 $
...
# 9609 interface redirection
CHIPSETREDIRECTION = 'mdm9609'
...
if os.path.exists('../' + CHIPSETREDIRECTION + '/build/SConscript') :
   ...
   raise RuntimeError, "mdm9609  [%s] does not exist"%script_sconfname
