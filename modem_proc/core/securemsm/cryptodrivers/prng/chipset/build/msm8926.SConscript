...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.mpss/3.5.c12.3/securemsm/cryptodrivers/prng/chipset/build/msm8926.SConscript#1 $
...
# 8926 interface redirection
CHIPSETREDIRECTION = 'msm8926'
...
if os.path.exists('../' + CHIPSETREDIRECTION + '/build/SConscript') :
   ...
   raise RuntimeError, "msm8926  [%s] does not exist"%script_sconfname
