...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.mpss/3.5.c12.3/securemsm/cryptodrivers/prng/chipset/build/msm8976.SConscript#1 $
...
# 8976 interface redirection
CHIPSETREDIRECTION = 'msm8976'
...
if os.path.exists('../' + CHIPSETREDIRECTION + '/build/SConscript') :
   ...
   raise RuntimeError, "msm8976  [%s] does not exist"%script_sconfname
