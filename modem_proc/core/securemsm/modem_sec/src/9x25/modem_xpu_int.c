...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.5.c12.3/securemsm/modem_sec/src/9x25/modem_xpu_int.c#1 $
...
#define TZBSP_XPU_ERR_INT_STATUS_REG_NUM    3
...
{
  {
    ...
    {5, HAL_XPU2_COUNT},            //Obsolete bit for ELAN
  ...
  },
  {
    ...
    {15, HAL_XPU2_COUNT},            //Obsolete bit for ELAN
    {16, HAL_XPU2_COUNT},            //Obsolete bit for ELAN
    {17, HAL_XPU2_COUNT},            //Obsolete bit for ELAN
    {18, HAL_XPU2_COUNT},            //Obsolete bit for ELAN
    {19, HAL_XPU2_COUNT},            //Obsolete bit for ELAN
    {20, HAL_XPU2_COUNT},            //Obsolete bit for ELAN
    {21, HAL_XPU2_BOOT_ROM},
    {22, HAL_XPU2_COUNT},
    {23, HAL_XPU2_COUNT},
    {24, HAL_XPU2_COUNT},            //Obsolete bit for ELAN
    {25, HAL_XPU2_COUNT},            //Obsolete bit for ELAN
    {26, HAL_XPU2_COUNT},            //Obsolete bit for ELAN
    {27, HAL_XPU2_COUNT},
    {28, HAL_XPU2_COUNT},
    {29, HAL_XPU2_COUNT},
    {30, HAL_XPU2_COUNT},
...
static void modem_sec_xpu_enable_interrupts(void)
{
  ...
  HWIO_OUT(TCSR_SS_XPU2_MSA_INTR0_ENABLE, 0xFFFFFFFF);
  HWIO_OUT(TCSR_SS_XPU2_MSA_INTR1_ENABLE, 0xFFFFFFFF);
  HWIO_OUT(TCSR_SS_XPU2_MSA_INTR2_ENABLE, 0xFFFFFFFF);
}
...
void modem_sec_xpu_isr()
{
  ...
  err_bitmask[1] = HWIO_TCSR_SS_XPU2_MSA_INTR1_IN;
