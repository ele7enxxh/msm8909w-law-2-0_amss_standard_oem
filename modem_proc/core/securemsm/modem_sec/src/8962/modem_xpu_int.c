...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.5.c12.3/securemsm/modem_sec/src/8962/modem_xpu_int.c#1 $
...
#define TZBSP_XPU_ERR_INT_STATUS_REG_NUM    2
...
void modem_sec_config_xpu_error_reporting (void)
{
  ...
  while (g_tzbsp_xpu_cfg[xpu_id] != HAL_XPU2_COUNT) 
  {
