...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.5.c12.3/securemsm/modem_sec/src/8974/modem_xpu_int.c#1 $
...
static void modem_sec_xpu_enable_interrupts(void)
{
  ...
  HWIO_OUT(TCSR_SS_XPU2_MSA_INTR0_ENABLE, 0x00200001);
  HWIO_OUT(TCSR_SS_XPU2_MSA_INTR1_ENABLE, 0x00200000);
}
