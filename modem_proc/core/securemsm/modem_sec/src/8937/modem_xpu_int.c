...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.5.c12.3/securemsm/modem_sec/src/8937/modem_xpu_int.c#1 $
...
{
  {
    ...
    {3, HAL_XPU2_CLK_CTL},            //Obsolete bit for ELAN
    ...
    {9, HAL_XPU2_TLMM},
    {10, HAL_XPU2_Q6PCNOC_CFG},           //Obsolete bit for ELAN
...
void modem_sec_xpu_isr()
{
  ...
  ERR_FATAL("Modem XPU Violation", 0, 0, 0); 
  return;
}
