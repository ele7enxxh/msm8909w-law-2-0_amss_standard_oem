 ...
 * fs_pm_ptable_nand.c
 *
 * Copyright (C) 2002-2013, 2015 QUALCOMM Technologies, Inc.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.5.c12.3/storage/efs/src/fs_pm_ptable_nand.c#1 $ $DateTime: 2016/12/13 07:59:23 $ $Author: mplcsds1 $

when          who     what, where, why
--------      ---     ------------------------------------------------------
2015-07-23     vm     Remove extra parenthesis, fixing compiler warning.
