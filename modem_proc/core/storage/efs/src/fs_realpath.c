 ...
 *
 * Copyright (C) 2004,2007-2014 QUALCOMM Technologies, Inc.
 */
 ...
 *                             EDIT HISTORY
 *
 * $Header: //components/rel/core.mpss/3.5.c12.3/storage/efs/src/fs_realpath.c#1 $ $DateTime: 2016/12/13 07:59:23 $ $Author: mplcsds1 $
 *
 * when         who   what, where, why
 * ----------   ----  ----------------------------------------------------
 * 2014-10-13   dks   Fix normalization for Item files.
