/**********************************************************************
 ...
 Copyright (c) 2003-2010, 2012-2014 by QUALCOMM Technologies, Inc.
 All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.5.c12.3/storage/efs/src/fs_pm_gc.c#1 $ $DateTime: 2016/12/13 07:59:23 $ $Author: mplcsds1 $

when          who     what, where, why
--------      ---     ------------------------------------------------------
2014-03-05    wek     Fix compile time warnings seen in boot loaders.
