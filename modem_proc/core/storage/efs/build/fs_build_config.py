...
#----------------------------------------------------------------------------
#
#  $Header: //components/rel/core.mpss/3.5.c12.3/storage/efs/build/fs_build_config.py#1 $ $DateTime: 2016/12/13 07:59:23 $ $Author: mplcsds1 $ $Change: 11985146 $
#
...
# ----------  ---  ----------------------------------------------------------
# 2014-10-22  dks  Enable Flash device setup for flash by default.
...
def fs_get_build_defines (env):
  ...
  if 'USES_STORAGE_NAND' in env:
    ...
    if env.has_key('APPS_PROC'):
      cpp_flags += ['EFS_PARTITION_NAME=\\"' + '0:EFS2APPS' + '\\"']
