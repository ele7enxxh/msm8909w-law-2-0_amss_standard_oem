...
#=============================================================================
#
#  $Header: //components/rel/core.mpss/3.5.c12.3/storage/tools/qdst/QDST.py#1 $
...
# --------   ---     -------------------------------------------------------------------------
# 04/06/12   ah      Minor change to regex when testing for OpenSSL
...
def TestForOpenSSL():
    ...
    #response = 'OpenSSL 0.9.8l 8 Feb 2011'
...
try:
    ...
    LOG.write("\n\nERROR: Please check that I have access to QDST.zip OR ensure it is *zipped up* correctly\n\n")
    print "\n\nERROR: Please check that I have access to QDST.zip OR ensure it is *zipped up* correctly\n\n"
    sys.exit(1)
