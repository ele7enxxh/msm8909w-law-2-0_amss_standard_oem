 ...
 *   order.
 *
 *   $Header: //components/rel/core.mpss/3.5.c12.3/storage/flash/src/dal/flash_properties.h#1 $ $DateTime: 2016/12/13 07:59:23 $ $Author: mplcsds1 $
 *
...
enum flash_property_id
{
  ...
  FLASH_SPI_MULTI_RW_SUPPORT_COUNT_ID, /* Number of pages supported
                                          in a SPI multi page operation */
  FLASH_NOR_DRV_WS_BUFF_SIZE_ID,   /* Workspace buffer for NOR flash DAL */
