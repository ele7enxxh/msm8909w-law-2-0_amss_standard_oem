 ...
 *   order.
 *
 *  $Header: //components/rel/core.mpss/3.5.c12.3/storage/flash/src/dal/flash_partition_services.c#1 $ $DateTime: 2016/12/13 07:59:23 $ $Author: mplcsds1 $
 *
 *
...
int flash_partition_table_update (flash_handle_t handle, flash_partable_t parti_table)
{
  ...
  {
    cur_block = (new_mibib_block - MIBIB_BLOCK_SEARCH_MIN);
