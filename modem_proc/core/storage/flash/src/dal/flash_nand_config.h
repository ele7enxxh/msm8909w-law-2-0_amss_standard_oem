 ...
 *   order.
 *
 *  $Header: //components/rel/core.mpss/3.5.c12.3/storage/flash/src/dal/flash_nand_config.h#1 $ $DateTime: 2016/12/13 07:59:23 $ $Author: mplcsds1 $
 *
 *
...
struct flash_nand_params
{
  ...
  uint32 dev_ids_num_bytes;                   /**< Number of bytes in device id */
};
