#ifndef FLASH_MIBIB_H
#define FLASH_MIBIB_H
/*===========================================================================
...
DESCRIPTION
  ...
  Copyright 2004-2011,2013 Qualcomm Technologies Incorporated. 
  All Rights Reserved.
...
$Header: //components/rel/core.mpss/3.5.c12.3/storage/flash/inc/flash_mibib.h#1 $
$DateTime: 2016/12/13 07:59:23 $ $Author: mplcsds1 $
   
when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
03/25/13   eo      Add minimum block limit to search for MIBIB
...
/* Skip first 10 blocks to scan for partition table.  These blocks are 
 * reserved for SBL partition. 
 */
#define MIBIB_BLOCK_SEARCH_MIN          0xA   
