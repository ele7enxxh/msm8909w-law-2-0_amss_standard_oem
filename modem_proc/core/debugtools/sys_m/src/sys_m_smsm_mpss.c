...
$Header: //components/rel/core.mpss/3.5.c12.3/debugtools/sys_m/src/sys_m_smsm_mpss.c#1 $
...
/* TZ initiated ERR FATAL:
 * Change SYS_M_HOSTS to 2 to enable this
 */
#define SYS_M_HOSTS 1
#define SYS_M_HOST_APSS 0

/* TZ initiated ERR FATAL:
 * Remove comment enable this
 */
...
DALResult sys_m_smsm_task(DALSYSEventHandle hEvent, void* tid)
{
    ...
    /*
    * TZ initiated ERR FATAL :
    * Remove the comments to enable this feature.	
