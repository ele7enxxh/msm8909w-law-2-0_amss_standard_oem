...
$Header: //components/rel/core.mpss/3.5.c12.3/debugtrace/hwevent/config/8916/hwevent_config.c#1 $
...
{0x0408200C,0x0408200C},{NULL,NULL}//HWIO_MSS_QDSP6SS_PWRDBG_CTL_ADDR
};
