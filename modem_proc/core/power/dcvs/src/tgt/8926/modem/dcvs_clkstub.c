...
/*===========================================================================
                        Edit History
$Header: //components/rel/core.mpss/3.5.c12.3/power/dcvs/src/tgt/8926/modem/dcvs_clkstub.c#1 $
...
extern DalChipInfoFamilyType dcvsTargetFamily;
extern DalChipInfoVersionType dcvsTargetChipVersion;
...
DCVS_TARGET_CLOCK_PLAN_INFO_TYPE* DCVSTargetClockPlanInfoGet(void)
{
  ...
  // save it to global variable. (temp fix for 1.0 fix)
  CORE_VERIFY(dcvsTargetFamily = DalChipInfo_ChipFamily());
  ...
  // save it to global variable. (temp fix for 1.0 fix)
  dcvsTargetChipVersion = chipVersion;
