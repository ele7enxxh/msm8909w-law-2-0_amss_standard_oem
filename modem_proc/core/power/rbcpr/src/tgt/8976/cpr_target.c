...
$Header: //components/rel/core.mpss/3.5.c12.3/power/rbcpr/src/tgt/8976/cpr_target.c#1 $
=============================================================================*/
#include "HALhwio.h"
#include "HAL_cpr.h"
  ...
  .primaryDb = 
  {
    ...
    .fuseVmodeCfgPtrs =
    {
      ...
      [0] =
      {
        ...
        .targetVsteps0 = {HWIO_QFPROM_CORR_CALIB_ROW1_MSB_ADDR,
                          HWIO_QFPROM_RAW_CALIB_ROW4_MSB_CPR2_TARG_VOLT_SPARE_BMSK,
                          HWIO_QFPROM_RAW_CALIB_ROW4_MSB_CPR2_TARG_VOLT_SPARE_BMSK},  
      ...
      [3] =
      {
        ...
        .targetVsteps0 = {HWIO_QFPROM_RAW_CALIB_ROW4_LSB_ADDR,
                          HWIO_QFPROM_RAW_CALIB_ROW4_LSB_CPR2_TARG_VOLT_NOM_2_0_BMSK,
                          HWIO_QFPROM_RAW_CALIB_ROW4_LSB_CPR2_TARG_VOLT_NOM_2_0_SHFT},  
        .targetVsteps1 = {HWIO_QFPROM_CORR_CALIB_ROW1_MSB_ADDR,
                          HWIO_QFPROM_RAW_CALIB_ROW4_MSB_CPR2_TARG_VOLT_NOM_4_3_BMSK,
                          HWIO_QFPROM_RAW_CALIB_ROW4_MSB_CPR2_TARG_VOLT_NOM_4_3_SHFT},  
        .shiftLeftBy = 0,
      },
      [4] = 
      {
        ...
        .targetVsteps0 = {HWIO_QFPROM_CORR_CALIB_ROW1_MSB_ADDR,
                          HWIO_QFPROM_CORR_CALIB_ROW4_LSB_CPR2_TARG_VOLT_TURBO_BMSK,
                          HWIO_QFPROM_CORR_CALIB_ROW4_LSB_CPR2_TARG_VOLT_TURBO_BMSK},  
        .targetVsteps1 = {HWIO_QFPROM_CORR_CALIB_ROW1_MSB_ADDR,
                          HWIO_QFPROM_CORR_CALIB_ROW4_LSB_CPR2_TARG_VOLT_TURBO_BMSK,
                          HWIO_QFPROM_CORR_CALIB_ROW4_LSB_CPR2_TARG_VOLT_TURBO_BMSK},  
