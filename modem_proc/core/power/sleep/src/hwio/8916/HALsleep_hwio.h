...
/*
  ...
  $Header: //components/rel/core.mpss/3.5.c12.3/power/sleep/src/hwio/8916/HALsleep_hwio.h#1 $
...
#define HWIO_MSS_MPLL0_MAIN_MODEM_CBCR_OFFS                                 (MSS_PERPH_REG_BASE_OFFS + 0x000010e4)
