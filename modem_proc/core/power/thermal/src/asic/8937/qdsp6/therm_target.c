...
============================================================================*/
/*=======================================================================
$Header: //components/rel/core.mpss/3.5.c12.3/power/thermal/src/asic/8937/qdsp6/therm_target.c#1 $
  ...
  switch (state)
  {
    ...
    case 1:
      ...
      npa_issue_scalar_request(mssClientHandle,
                               (npa_resource_state)VCS_CORNER_NOMINAL_PLUS );
      break;
  }
}
                                    ...
                                    unsigned int  data_size )
{
  ...
  mssClientHandle = npa_create_sync_client("/vdd/mss",
                                           "MSS_V Restrict",
