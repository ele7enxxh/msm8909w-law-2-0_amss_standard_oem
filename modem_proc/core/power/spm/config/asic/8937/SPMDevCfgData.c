...
$Header: //components/rel/core.mpss/3.5.c12.3/power/spm/config/asic/8937/SPMDevCfgData.c#1 $
...
{ 
  ...
  /* 0xE8 */  SPM_SEQ_PWR_CTL( QDSP6_MEM_RET,       0 ), /* QDSP6 Assert Mem ret Sleep */
  /* 0x2F */  SPM_SEQ_DLY_CTL( DLY2,                0 ), /* Delay for in-rush current */
  ...
  /* 0xEA */  SPM_SEQ_PWR_CTL( QDSP6_MEM_RET,       1 ), /* Deassert QDSP6 Mem ret Sleep */
...
static uint8 spmCmdSeqAPCRPLLLPM[] =
{
  ...
  /* index 16 */
  /* 0x28 */ SPM_SEQ_PWR_CTL( QDSP6_PLL_FREEZE,    2 ), /* Unfreeze QDSP6 PLL */
...
static uint8 spmCmdSeqPC[] =
{
  ...
  /* 0x28 */  SPM_SEQ_PWR_CTL( QDSP6_PLL_FREEZE,    0 ), /* Freeze QDSP6 PLL */
  /* 0x11  */  SPM_SEQ_PMIC_CTL( DATA_1,             0 ), /* PMIC to collapse modem power rail */
  /* 0x3  */  SPM_SEQ_SLEEP_CTL( NO_RPM_HS,         0 ), /* Sleep w/o RPM handshake */
  
  /* index 20 */
  /* 0x0  */  SPM_SEQ_PWR_CTL( QDSP6_RESET,         0 ), /* Assert QDSP6 reset */
  /* 0x01 */  SPM_SEQ_PMIC_CTL( DATA_0,             0 ), /* PMIC to restore modem power rail */
  ...
  /* index 24 */
  /* 0x84 */  SPM_SEQ_PWR_CTL( QDSP6_PLL_BYPASS,    2 ), /* Disable QDSP6 PLL bypass*/
...
BSP_spm_CmdSequenceType devcfgSpmCmdSeqArray[][SPM_NUM_LOW_POWER_MODES] =
{
  /* MSS has only one core */
  {
    ...
    },
    {
      ...
      14, /* Index of the RPM handshake cmd in the command sequence array */
      -1
    },
    {
      SPM_MODE_PWRC,
