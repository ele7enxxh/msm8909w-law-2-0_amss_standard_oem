...
DESCRIPTION:  
  ...
  This data is for the 9x25 MSS processor.

                Copyright (c) 2012-2103 QUALCOMM Technologies Incorporated.
                All Rights Reserved.
                Qualcomm Confidential and Proprietary

$Header: //components/rel/core.mpss/3.5.c12.3/power/spm/config/asic/9x25/SPMDevCfgData.c#1 $
...
/* SPM command sequence for Modem QDSP6 PC using PMIC */
...
/* SPM command sequence for Modem QDSP6 PC using BHS */
