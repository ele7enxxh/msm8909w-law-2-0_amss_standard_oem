...
DESCRIPTION:  
  ...
  This data is for the 8926/8962 MSS processor.

                Copyright (c) 2013 QUALCOMM Technologies Incorporated.
                All Rights Reserved.
                Qualcomm Confidential and Proprietary

$Header: //components/rel/core.mpss/3.5.c12.3/power/spm/config/asic/89xx/SPMDevCfgData.c#1 $
...
/* SPM command sequence for Modem QDSP6 PMIC based PC without RPM Handshake */
static uint8 spmCmdSeqPMIC[] =
{
  ...
  /* 0x1F, */  SPM_SEQ_DLY_CTL   (DLY1              ,0), /* Delay seq by DLY1   */
...
BSP_spm_CmdSequenceType devcfgSpmCmdSeqArray[][SPM_NUM_LOW_POWER_MODES] =
{
  /* q6 has only one core */
  {
    ...
    { SPM_MODE_PWRC_BHS,
      spmCmdSeqBHS,
      sizeof(spmCmdSeqBHS),
      8, /* Index of the RPM handshake mode cmd in the command sequence array */
      -1, /* start index of this mode in SPM_SLP_SEQ; only valid if programmed */
    },
  }
};
