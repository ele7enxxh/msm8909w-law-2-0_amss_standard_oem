...
/*
  ...
  $Header: //components/rel/core.mpss/3.5.c12.3/power/spm/src/hal/hwio/8926/HALspm_hwio.h#1 $
...
#define MSS_TOP_BASE SPM_BASE_PTR
...
#define QDSP6SS_SAW2_REG_BASE_OFFS                               0x00130000

#define HWIO_QDSP6SS_SAW2_SECURE_ADDR                            (QDSP6SS_SAW2_REG_BASE      + 0x00000000)
#define HWIO_QDSP6SS_SAW2_SECURE_OFFS                            (QDSP6SS_SAW2_REG_BASE_OFFS + 0x00000000)
...
#define HWIO_QDSP6SS_SAW2_ID_OFFS                                (QDSP6SS_SAW2_REG_BASE_OFFS + 0x00000004)
#define HWIO_QDSP6SS_SAW2_ID_RMSK                                0x3f1f1f7f
...
#define HWIO_QDSP6SS_SAW2_ID_NUM_SPM_ENTRY_BMSK                  0x3f000000
#define HWIO_QDSP6SS_SAW2_ID_NUM_SPM_ENTRY_SHFT                        0x18
#define HWIO_QDSP6SS_SAW2_ID_NUM_PWR_CTL_BMSK                      0x1f0000
...
#define HWIO_QDSP6SS_SAW2_CFG_OFFS                               (QDSP6SS_SAW2_REG_BASE_OFFS + 0x00000008)
...
#define HWIO_QDSP6SS_SAW2_SPM_STS_OFFS                           (QDSP6SS_SAW2_REG_BASE_OFFS + 0x0000000c)
#define HWIO_QDSP6SS_SAW2_SPM_STS_RMSK                           0xfffff1ff
...
#define HWIO_QDSP6SS_SAW2_SPM_STS_RPM_STATE_BMSK                      0x180
#define HWIO_QDSP6SS_SAW2_SPM_STS_RPM_STATE_SHFT                        0x7
#define HWIO_QDSP6SS_SAW2_SPM_STS_SPM_CMD_ADDR_BMSK                    0x7f
...
#define HWIO_QDSP6SS_SAW2_AVS_STS_OFFS                           (QDSP6SS_SAW2_REG_BASE_OFFS + 0x00000010)
#define HWIO_QDSP6SS_SAW2_AVS_STS_RMSK                             0xff003f
...
#define HWIO_QDSP6SS_SAW2_PMIC_STS_OFFS                          (QDSP6SS_SAW2_REG_BASE_OFFS + 0x00000014)
#define HWIO_QDSP6SS_SAW2_PMIC_STS_RMSK                          0x3ff300ff
...
#define HWIO_QDSP6SS_SAW2_RST_OFFS                               (QDSP6SS_SAW2_REG_BASE_OFFS + 0x00000018)
...
#define HWIO_QDSP6SS_SAW2_VCTL_OFFS                              (QDSP6SS_SAW2_REG_BASE_OFFS + 0x0000001c)
...
#define HWIO_QDSP6SS_SAW2_AVS_CTL_OFFS                           (QDSP6SS_SAW2_REG_BASE_OFFS + 0x00000020)
...
#define HWIO_QDSP6SS_SAW2_AVS_LIMIT_OFFS                         (QDSP6SS_SAW2_REG_BASE_OFFS + 0x00000024)
...
#define HWIO_QDSP6SS_SAW2_AVS_DLY_OFFS                           (QDSP6SS_SAW2_REG_BASE_OFFS + 0x00000028)
...
#define HWIO_QDSP6SS_SAW2_AVS_HYSTERESIS_OFFS                    (QDSP6SS_SAW2_REG_BASE_OFFS + 0x0000002c)
...
#define HWIO_QDSP6SS_SAW2_SPM_CTL_OFFS                           (QDSP6SS_SAW2_REG_BASE_OFFS + 0x00000030)
#define HWIO_QDSP6SS_SAW2_SPM_CTL_RMSK                              0x107ff
...
#define HWIO_QDSP6SS_SAW2_SPM_CTL_SPM_START_ADR_BMSK                  0x7f0
...
#define HWIO_QDSP6SS_SAW2_SPM_DLY_OFFS                           (QDSP6SS_SAW2_REG_BASE_OFFS + 0x00000034)
...
#define HWIO_QDSP6SS_SAW2_SPM_SLP_SEQ_ENTRY_n_ADDR(n)            (QDSP6SS_SAW2_REG_BASE      + 0x00000080 + 0x4 * (n))
#define HWIO_QDSP6SS_SAW2_SPM_SLP_SEQ_ENTRY_n_OFFS(n)            (QDSP6SS_SAW2_REG_BASE_OFFS + 0x00000080 + 0x4 * (n))
#define HWIO_QDSP6SS_SAW2_SPM_SLP_SEQ_ENTRY_n_RMSK               0xffffffff
#define HWIO_QDSP6SS_SAW2_SPM_SLP_SEQ_ENTRY_n_MAXn                       15
...
#define HWIO_QDSP6SS_SAW2_SPM_PMIC_DATA_n_OFFS(n)                (QDSP6SS_SAW2_REG_BASE_OFFS + 0x00000040 + 0x4 * (n))
...
#define HWIO_QDSP6SS_SAW2_VERSION_OFFS                           (QDSP6SS_SAW2_REG_BASE_OFFS + 0x00000fd0)
