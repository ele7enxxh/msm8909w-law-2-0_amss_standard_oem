...
/*
 * adsspm_ConfigData.c - contains all 8909-specific data definitions for Config Manager
 *
...
#include "icbid.h"
#include "DDIIPCInt.h"
#include "ultaudio_hwio_8909.h"
#include "msmhwiobase.h"

AsicHwioAddrRangeType lpassBaseAddr_8909 = { ULTAUDIO_CORE_BASE, ULTAUDIO_CORE_BASE_PHYS, ULTAUDIO_CORE_BASE_SIZE};

AsicCpuAggregatorMppsCppType cppFactors_8909[] = {
		{
				50, 	//MPPS
				1400    //CPP*1000
		},
...
AsicCpuAggregatorCppAdjustmentType cppFudgeFactors_8909[] = {
		{
...
AsicCpuAggregatorMppsCppArrayType cppFactorsArray_8909 = {
		ADSPPM_ARRAY(cppFactors_8909)
};

AsicCpuAggregatorCppAdjustmentArrayType cppFudgeFactorsArray_8909 = {
		ADSPPM_ARRAY(cppFudgeFactors_8909)
};


/**
 * Array of 8909 core descriptors. Arranged according to core ID enum
 */
AsicCoreDescType cores_array_8909[Adsppm_Core_Id_Max] = {
        {   //Adsppm_Core_Id_None
        ...
        {   //Adsppm_Core_Id_DCodec
                ...
                AsicPowerDomain_LpassCore, // Power Domain
                AdsppmBusPort_None, // Master port
                AdsppmBusPort_DCodec_Slave  // Slave port
        },
...
AsicCoreDescriptorArrayType cores_8909 = {
		ADSPPM_ARRAY(cores_array_8909)
};


AsicMemDescType memories_array_8909[Adsppm_Mem_Max] = {
        {   //Adsppm_Mem_None
...
AsicMemDescriptorArrayType memories_8909 = {
		ADSPPM_ARRAY(memories_array_8909)
};

/**
 * Array of 8909 core clock descriptors. Arranged by core clock ID
 */
AsicClkDescriptorType clocks_array_8909[AdsppmClk_EnumMax] = {
        {
        ...
        },
		{
                ...
                AsicClk_MemCntlNone, // MemCtrl Type
                .clkInfo.hwioInfo = {
                		HWIO_LPASS_AUDIO_CORE_AHB2AHB_CODEC_CGCR_OFFS, //CGCR Offset
                		HWIO_LPASS_AUDIO_CORE_AHB2AHB_CODEC_CGCR_CLK_ENABLE_BMSK, //Enable mask
                		HWIO_LPASS_AUDIO_CORE_AHB2AHB_CODEC_CGCR_HW_CTL_BMSK, //HW control mask
                		0	//Status mask
                },
                AdsppmClk_None, //Source
                AsicPowerDomain_LpassCore, //Power domain
...
AsicClockDescriptorArrayType clocks_8909 = {
		ADSPPM_ARRAY(clocks_array_8909)
};

/**
 * Array of 8909 Bus port descriptors arranged by Bus port ID
 */
AsicBusPortDescriptorType busPorts_array_8909[AdsppmBusPort_EnumMax] = {
        {
        ...
        },
        {
        		...
        		AsicBusPort_AhbX_S, //Connection
        		AdsppmClk_Dcodec_Hclk, //Bus clock
        		AdsppmClk_Dcodec_Hclk, //Csr clock
        		{.icbarbSlave = ICBID_SLAVE_AUDIO}, // icbarb ID
        		AdsppmBusPort_Ext_Ahb_Slave // Access port
        },
        {
...
AsicBusPortDescriptorArrayType busPorts_8909 = {
		ADSPPM_ARRAY(busPorts_array_8909)
};
 ...
 */
AdsppmBusRouteType extBusRoutes_array_8909[] = {
        {
...
AsicBusRouteArrayType extBusRoutes_8909 = {
		ADSPPM_ARRAY(extBusRoutes_array_8909)
};

AdsppmBusRouteType mipsBwRoutes_array_8909[] =
{
      {
...
AsicBusRouteArrayType mipsBwRoutes_8909 = {
		ADSPPM_ARRAY(mipsBwRoutes_array_8909)
};

/**
 * Array of power domain descriptors
 */
AsicPowerDomainDescriptorType pwrDomains_array_8909[AsicPowerDomain_EnumMax] = {
        {
        ...
        },
        {
                ...
                AdsppmBusPort_None // Bus Master, for virtio bringup
        },
        {
...
AsicPwrDescriptorArrayType pwrDomains_8909 = {
		ADSPPM_ARRAY(pwrDomains_array_8909)
};


AsicFeatureDescType features_8909 [AsicFeatureId_enum_max] =
{
