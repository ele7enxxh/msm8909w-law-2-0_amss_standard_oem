...
/*
  ...
  $Header: //components/rel/core.mpss/3.5.c12.3/power/cpr/common/hal/v2/target/8937/HAL_cpr_hwio.h#1 $
...
#define HWIO_RBIF_TIMER_ADJUST_RMSK                                           0x7ffff
...
#define HWIO_RBIF_TIMER_ADJUST_BHS_ON_RESTART_ENABLE_BMSK                     0x40000
#define HWIO_RBIF_TIMER_ADJUST_BHS_ON_RESTART_ENABLE_SHFT                        0x12
#define HWIO_RBIF_TIMER_ADJUST_GDHS_RESTART_ENABLE_BMSK                       0x20000
#define HWIO_RBIF_TIMER_ADJUST_GDHS_RESTART_ENABLE_SHFT                          0x11
...
#define HWIO_RBCPR_CTL_RMSK                                                0xffffffff
...
#define HWIO_RBCPR_CTL_SW_AUTO_CONT_NACK_UP_EN_BMSK                          0x800000
#define HWIO_RBCPR_CTL_SW_AUTO_CONT_NACK_UP_EN_SHFT                              0x17
...
#define HWIO_RBIF_IRQ_EN_0_RMSK                                                  0xff
...
#define HWIO_RBIF_IRQ_EN_0_STARVATION_ERROR_EN_BMSK                              0x80
#define HWIO_RBIF_IRQ_EN_0_STARVATION_ERROR_EN_SHFT                               0x7
...
#define HWIO_RBIF_IRQ_CLEAR_RMSK                                                 0xff
#define HWIO_RBIF_IRQ_CLEAR_IN(x)      \
        in_dword_masked(HWIO_RBIF_IRQ_CLEAR_ADDR(x), HWIO_RBIF_IRQ_CLEAR_RMSK)
#define HWIO_RBIF_IRQ_CLEAR_INM(x, m)      \
        in_dword_masked(HWIO_RBIF_IRQ_CLEAR_ADDR(x), m)
#define HWIO_RBIF_IRQ_CLEAR_OUT(x, v)      \
        out_dword(HWIO_RBIF_IRQ_CLEAR_ADDR(x),v)
#define HWIO_RBIF_IRQ_CLEAR_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_RBIF_IRQ_CLEAR_ADDR(x),m,v,HWIO_RBIF_IRQ_CLEAR_IN(x))
#define HWIO_RBIF_IRQ_CLEAR_STARVATION_ERROR_CLEAR_BMSK                          0x80
#define HWIO_RBIF_IRQ_CLEAR_STARVATION_ERROR_CLEAR_SHFT                           0x7
...
#define HWIO_RBIF_IRQ_STATUS_RMSK                                                0xff
...
#define HWIO_RBIF_IRQ_STATUS_OUT(x, v)      \
        out_dword(HWIO_RBIF_IRQ_STATUS_ADDR(x),v)
#define HWIO_RBIF_IRQ_STATUS_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_RBIF_IRQ_STATUS_ADDR(x),m,v,HWIO_RBIF_IRQ_STATUS_IN(x))
#define HWIO_RBIF_IRQ_STATUS_STARVATION_ERROR_BMSK                               0x80
#define HWIO_RBIF_IRQ_STATUS_STARVATION_ERROR_SHFT                                0x7
...
#define HWIO_RBCPR_HW_STARVATION_THRESHOLD_ADDR(x)                         ((x) + 0x00000164)
#define HWIO_RBCPR_HW_STARVATION_THRESHOLD_OFFS                            (0x00000164)
#define HWIO_RBCPR_HW_STARVATION_THRESHOLD_RMSK                            0xffffffff
#define HWIO_RBCPR_HW_STARVATION_THRESHOLD_IN(x)      \
        in_dword_masked(HWIO_RBCPR_HW_STARVATION_THRESHOLD_ADDR(x), HWIO_RBCPR_HW_STARVATION_THRESHOLD_RMSK)
#define HWIO_RBCPR_HW_STARVATION_THRESHOLD_INM(x, m)      \
        in_dword_masked(HWIO_RBCPR_HW_STARVATION_THRESHOLD_ADDR(x), m)
#define HWIO_RBCPR_HW_STARVATION_THRESHOLD_OUT(x, v)      \
        out_dword(HWIO_RBCPR_HW_STARVATION_THRESHOLD_ADDR(x),v)
#define HWIO_RBCPR_HW_STARVATION_THRESHOLD_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_RBCPR_HW_STARVATION_THRESHOLD_ADDR(x),m,v,HWIO_RBCPR_HW_STARVATION_THRESHOLD_IN(x))
#define HWIO_RBCPR_HW_STARVATION_THRESHOLD_THRESHOLD_BMSK                  0xffffffff
#define HWIO_RBCPR_HW_STARVATION_THRESHOLD_THRESHOLD_SHFT                         0x0

#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ0_ADDR(x)                        ((x) + 0x00000168)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ0_OFFS                           (0x00000168)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ0_RMSK                           0xffffffff
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ0_IN(x)      \
        in_dword_masked(HWIO_RBCPR_SENSOR_MASK_BYPASS_READ0_ADDR(x), HWIO_RBCPR_SENSOR_MASK_BYPASS_READ0_RMSK)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ0_INM(x, m)      \
        in_dword_masked(HWIO_RBCPR_SENSOR_MASK_BYPASS_READ0_ADDR(x), m)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ0_MASK_BYPASS_READ_BMSK          0xffffffff
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ0_MASK_BYPASS_READ_SHFT                 0x0

#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ1_ADDR(x)                        ((x) + 0x0000016c)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ1_OFFS                           (0x0000016c)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ1_RMSK                           0xffffffff
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ1_IN(x)      \
        in_dword_masked(HWIO_RBCPR_SENSOR_MASK_BYPASS_READ1_ADDR(x), HWIO_RBCPR_SENSOR_MASK_BYPASS_READ1_RMSK)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ1_INM(x, m)      \
        in_dword_masked(HWIO_RBCPR_SENSOR_MASK_BYPASS_READ1_ADDR(x), m)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ1_MASK_BYPASS_READ_BMSK          0xffffffff
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ1_MASK_BYPASS_READ_SHFT                 0x0

#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ2_ADDR(x)                        ((x) + 0x00000170)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ2_OFFS                           (0x00000170)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ2_RMSK                           0xffffffff
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ2_IN(x)      \
        in_dword_masked(HWIO_RBCPR_SENSOR_MASK_BYPASS_READ2_ADDR(x), HWIO_RBCPR_SENSOR_MASK_BYPASS_READ2_RMSK)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ2_INM(x, m)      \
        in_dword_masked(HWIO_RBCPR_SENSOR_MASK_BYPASS_READ2_ADDR(x), m)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ2_MASK_BYPASS_READ_BMSK          0xffffffff
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ2_MASK_BYPASS_READ_SHFT                 0x0

#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ3_ADDR(x)                        ((x) + 0x00000174)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ3_OFFS                           (0x00000174)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ3_RMSK                           0xffffffff
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ3_IN(x)      \
        in_dword_masked(HWIO_RBCPR_SENSOR_MASK_BYPASS_READ3_ADDR(x), HWIO_RBCPR_SENSOR_MASK_BYPASS_READ3_RMSK)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ3_INM(x, m)      \
        in_dword_masked(HWIO_RBCPR_SENSOR_MASK_BYPASS_READ3_ADDR(x), m)
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ3_MASK_BYPASS_READ_BMSK          0xffffffff
#define HWIO_RBCPR_SENSOR_MASK_BYPASS_READ3_MASK_BYPASS_READ_SHFT                 0x0
