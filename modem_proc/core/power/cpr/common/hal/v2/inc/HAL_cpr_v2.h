...
typedef enum
{
  HAL_CPR_INT_DONE_FLAG = 0x01,
  HAL_CPR_INT_MIN_FLAG  = 0x02,
  HAL_CPR_INT_DOWN_FLAG = 0x04,
  HAL_CPR_INT_MID_FLAG  = 0x08,
  HAL_CPR_INT_UP_FLAG   = 0x10,
  HAL_CPR_INT_MAX_FLAG  = 0x20,
...
/* ============================================
FUNCTION HAL_CPR_MASK_SENSOR_ALL
...
SIDE EFFECTS
  None
 */
void HAL_cpr_mask_sensor_all(HAL_cpr_rail_t rail, boolean);
...
/* ============================================
FUNCTION HAL_CPR_BYPASS_SENSOR_ALL
...
void HAL_cpr_bypass_sensor_all(HAL_cpr_rail_t rail, boolean);
...
void HAL_cpr_clear_int(HAL_cpr_rail_t rail, boolean);
...
void HAL_cpr_mask_sensor(HAL_cpr_rail_t rail, HAL_cpr_sensor_type, boolean);
