...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.5.c12.3/api/services/msgcfg.h#1 $
...
10/21/14   xy      Added new message SSIDs 
...
12/30/13   xy      Added new message SSIDs 
...
#define MSG_SSID_DPM_LAST                                       10414
