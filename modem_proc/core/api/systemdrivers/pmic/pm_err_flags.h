...
$Header: //components/rel/core.mpss/3.5.c12.3/api/systemdrivers/pmic/pm_err_flags.h#1 $
...
typedef enum
{
    ...
    PM_ERR_FLAG__INVALID_TCXO_INDEXED,  /**< Invlaid TCXO is being indexed. */
    ...
    PM_ERR_FLAG__INVALID_PAONCNTRL_INDEXED, /**< Invalid PAONCNTRL peripheral is being
                                                 indexed. */
    ...
    PM_ERR_FLAG__INVALID_BUA_INDEXED,  /**< Invalid BUA is being indexed. */

    PM_ERR_FLAG__INVALID,              /**< Generic invalid errorcode */

    PM_ERR_FLAG__INVALID_INT_INDEXED,  /**< Invalid INT is being indexed. */

    PM_ERR_FLAG__INVALID_BTM_INDEXED,  /**< Invalid BTM is being indexed. */

    PM_ERR_FLAG__INVALID_ARB_ADC_INDEXED,  /**< Invalid ARB ADC is being indexed. */

    PM_ERR_FLAG__BMS_INVALID_BATTERY_TEMPERATURE,  /**< Invalid battery temperature. */

    PM_ERR_FLAG__BMS_INVALID_CHARGE_CYCLES,  /**< Invalid charging cycles. */

    PM_ERR_FLAG__INVALID_UICC_INDEXED,  /**< Invalid UICC is being indexed. */

    PM_ERR_FLAG__INVALID_MBG_INDEXED  /**< Invalid MBG is being indexed. */
