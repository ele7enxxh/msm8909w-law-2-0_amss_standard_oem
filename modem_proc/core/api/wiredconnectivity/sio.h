...
/*
Copyright (c) 1990-1993, 1997-2014 Qualcomm Technologies Incorporated.  All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.5.c12.3/api/wiredconnectivity/sio.h#1 $ $DateTime: 2016/12/13 07:59:23 $ $Author: mplcsds1 $
...
#define SIO_MAJOR_SPI_AL        21      /**< SIO Major for SPI_AL DRIVER */
#define SIO_MAJOR_QSAP_FILTER   22      /**< SIO Major for QSAP filter driver */
#define SIO_MAJOR_SMUX          23      /**< SIO Major for serial mux driver */
#define SIO_MAJOR_QBI_DIAG      24      /**< SIO Major for QBI DIAG driver */
#define SIO_MAJOR_IPA           25      /**< SIO Major for IPA driver */
#define SIO_NULL_DRIVER         26      /**< SIO Major for NULL driver */
...
#define SIO_MINOR_SPI_AL_1               1   /**< SIO Minor for GSBI1 core*/
#define SIO_MINOR_SPI_AL_2               2   /**< SIO Minor for GSBI2 core*/
#define SIO_MINOR_SPI_AL_3               3   /**< SIO Minor for GSBI3 core*/
#define SIO_MINOR_SPI_AL_4               4   /**< SIO Minor for GSBI4 core*/
#define SIO_MINOR_SPI_AL_5               5   /**< SIO Minor for GSBI5 core*/
#define SIO_MINOR_SPI_AL_6               6   /**< SIO Minor for GSBI6 core*/
#define SIO_MINOR_SPI_AL_7               7   /**< SIO Minor for GSBI7 core*/
#define SIO_MINOR_SPI_AL_8               8   /**< SIO Minor for GSBI8 core*/
#define SIO_MINOR_SPI_AL_9               9   /**< SIO Minor for GSBI9 core*/
#define SIO_MINOR_SPI_AL_10              10   /**< SIO Minor for GSBI10 core*/
#define SIO_MINOR_SPI_AL_11              11   /**< SIO Minor for GSBI11 core*/
#define SIO_MINOR_SPI_AL_12              12   /**< SIO Minor for GSBI12 core*/

/* QSAP driver */
#define SIO_MINOR_QSAP_FILTER            1
#define SIO_MINOR_QSAP_FILTER_1          2
#define SIO_MINOR_QSAP_FILTER_2          3
#define SIO_MINOR_QSAP_FILTER_3          4
#define SIO_MINOR_QSAP_FILTER_4          5
#define SIO_MINOR_QSAP_FILTER_5          6
#define SIO_MINOR_QSAP_FILTER_6          7
#define SIO_MINOR_QSAP_FILTER_7          8
#define SIO_MINOR_QSAP_FILTER_8          9
#define SIO_MINOR_QSAP_FILTER_9         10
#define SIO_MINOR_QSAP_FILTER_QMUX2     11
...
/* QBI DIAG driver */
#define SIO_MINOR_QBI_DIAG               1

/* IPA Driver */
/* IPA Physical */
#define SIO_MINOR_IPA_DS_PHYS_1       1
#define SIO_MINOR_IPA_DS_PHYS_2       2
#define SIO_MINOR_IPA_DS_PHYS_3       3
#define SIO_MINOR_IPA_DS_PHYS_4       4
#define SIO_MINOR_IPA_DS_PHYS_5       5
#define SIO_MINOR_IPA_DS_PHYS_6       6
#define SIO_MINOR_IPA_DS_PHYS_7       7
#define SIO_MINOR_IPA_DS_PHYS_8       8

/* IPA Logical */
#define SIO_MINOR_IPA_DS_CH_1        11
#define SIO_MINOR_IPA_DS_CH_2        12
#define SIO_MINOR_IPA_DS_CH_3        13
#define SIO_MINOR_IPA_DS_CH_4        14
#define SIO_MINOR_IPA_DS_CH_5        15
#define SIO_MINOR_IPA_DS_CH_6        16
#define SIO_MINOR_IPA_DS_CH_7        17
#define SIO_MINOR_IPA_DS_CH_8        18
#define SIO_MINOR_IPA_DS_CH_9        19
#define SIO_MINOR_IPA_DS_CH_10       20
#define SIO_MINOR_IPA_DS_CH_11       21
#define SIO_MINOR_IPA_DS_CH_12       22
#define SIO_MINOR_IPA_DS_CH_13       23
#define SIO_MINOR_IPA_DS_CH_14       24
#define SIO_MINOR_IPA_DS_CH_15       25
#define SIO_MINOR_IPA_DS_CH_16       26
#define SIO_MINOR_IPA_DS_CH_17       27
#define SIO_MINOR_IPA_DS_CH_18       28
#define SIO_MINOR_IPA_DS_CH_19       29
#define SIO_MINOR_IPA_DS_CH_20       30
...
typedef enum
{
  ...
  SIO_PORT_USB_SER4 = DEVICE_ID(SIO_MAJOR_USB , SIO_MINOR_USB_SER4 ),
    /** -- SIO Port id for USB QDSS device */
  SIO_PORT_USB_QDSS = DEVICE_ID(SIO_MAJOR_USB , SIO_MINOR_USB_QDSS ),
  ...
  SIO_PORT_USB_EEM = DEVICE_ID(SIO_MAJOR_HSUSB_EEM , SIO_MINOR_HSUSB_EEM),
    /** -- SIO Port id for USB SMCT device */
  SIO_PORT_USB_SMCT = DEVICE_ID(SIO_MAJOR_USB , SIO_MINOR_USB_SMCT),
 ...
 /*---------------------  SPI Ports --------------------- */
    ...
    /** -- SIO Port id for SPI AL device 1 */
  SIO_PORT_SPI_AL_1 = DEVICE_ID(SIO_MAJOR_SPI_AL , SIO_MINOR_SPI_AL_1 ),
    /** -- SIO Port id for SPI AL device 2 */
  SIO_PORT_SPI_AL_2 = DEVICE_ID(SIO_MAJOR_SPI_AL , SIO_MINOR_SPI_AL_2 ),
    /** -- SIO Port id for SPI AL device 3 */
  SIO_PORT_SPI_AL_3 = DEVICE_ID(SIO_MAJOR_SPI_AL , SIO_MINOR_SPI_AL_3 ),
    /** -- SIO Port id for SPI AL device 4 */
  SIO_PORT_SPI_AL_4 = DEVICE_ID(SIO_MAJOR_SPI_AL , SIO_MINOR_SPI_AL_4 ),
    /** -- SIO Port id for SPI AL device 5 */
  SIO_PORT_SPI_AL_5 = DEVICE_ID(SIO_MAJOR_SPI_AL , SIO_MINOR_SPI_AL_5 ),
    /** -- SIO Port id for SPI AL device 6 */
  SIO_PORT_SPI_AL_6 = DEVICE_ID(SIO_MAJOR_SPI_AL , SIO_MINOR_SPI_AL_6 ),
    /** -- SIO Port id for SPI AL device 7 */
  SIO_PORT_SPI_AL_7 = DEVICE_ID(SIO_MAJOR_SPI_AL , SIO_MINOR_SPI_AL_7 ),
    /** -- SIO Port id for SPI AL device 8 */
  SIO_PORT_SPI_AL_8 = DEVICE_ID(SIO_MAJOR_SPI_AL , SIO_MINOR_SPI_AL_8 ),
    /** -- SIO Port id for SPI AL device 9 */
  SIO_PORT_SPI_AL_9 = DEVICE_ID(SIO_MAJOR_SPI_AL , SIO_MINOR_SPI_AL_9 ),
    /** -- SIO Port id for SPI AL device 10 */
  SIO_PORT_SPI_AL_10 = DEVICE_ID(SIO_MAJOR_SPI_AL , SIO_MINOR_SPI_AL_10 ),
    /** -- SIO Port id for SPI AL device 11 */
  SIO_PORT_SPI_AL_11 = DEVICE_ID(SIO_MAJOR_SPI_AL , SIO_MINOR_SPI_AL_11 ),
    /** -- SIO Port id for SPI AL device 12 */
  SIO_PORT_SPI_AL_12 = DEVICE_ID(SIO_MAJOR_SPI_AL , SIO_MINOR_SPI_AL_12 ),

  /*---------------------  QSAP-FILTER --------------------- */

  SIO_PORT_QSAP_FILTER        = DEVICE_ID(SIO_MAJOR_QSAP_FILTER, SIO_MINOR_QSAP_FILTER),
  SIO_PORT_QSAP_FILTER_1      = DEVICE_ID(SIO_MAJOR_QSAP_FILTER, SIO_MINOR_QSAP_FILTER_1),
  SIO_PORT_QSAP_FILTER_2      = DEVICE_ID(SIO_MAJOR_QSAP_FILTER, SIO_MINOR_QSAP_FILTER_2),
  SIO_PORT_QSAP_FILTER_3      = DEVICE_ID(SIO_MAJOR_QSAP_FILTER, SIO_MINOR_QSAP_FILTER_3),
  SIO_PORT_QSAP_FILTER_4      = DEVICE_ID(SIO_MAJOR_QSAP_FILTER, SIO_MINOR_QSAP_FILTER_4),
  SIO_PORT_QSAP_FILTER_5      = DEVICE_ID(SIO_MAJOR_QSAP_FILTER, SIO_MINOR_QSAP_FILTER_5),
  SIO_PORT_QSAP_FILTER_6      = DEVICE_ID(SIO_MAJOR_QSAP_FILTER, SIO_MINOR_QSAP_FILTER_6),
  SIO_PORT_QSAP_FILTER_7      = DEVICE_ID(SIO_MAJOR_QSAP_FILTER, SIO_MINOR_QSAP_FILTER_7),
  SIO_PORT_QSAP_FILTER_8      = DEVICE_ID(SIO_MAJOR_QSAP_FILTER, SIO_MINOR_QSAP_FILTER_8),
  SIO_PORT_QSAP_FILTER_9      = DEVICE_ID(SIO_MAJOR_QSAP_FILTER, SIO_MINOR_QSAP_FILTER_9),
  SIO_PORT_QSAP_FILTER_QMUX2  = DEVICE_ID(SIO_MAJOR_QSAP_FILTER, SIO_MINOR_QSAP_FILTER_QMUX2),


  /*---------------------  SERIAL MUX ---------------------- */

  /** SIO port id for serial mux logical channel 0 */
  SIO_PORT_SMUX_0 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_0),
  /** SIO port id for serial mux logical channel 1 */
  SIO_PORT_SMUX_1 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_1),
  /** SIO port id for serial mux logical channel 2 */
  SIO_PORT_SMUX_2 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_2),
  /** SIO port id for serial mux logical channel 3 */
  SIO_PORT_SMUX_3 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_3),
  /** SIO port id for serial mux logical channel 4 */
  SIO_PORT_SMUX_4 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_4),
  /** SIO port id for serial mux logical channel 5 */
  SIO_PORT_SMUX_5 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_5),
  /** SIO port id for serial mux logical channel 6 */
  SIO_PORT_SMUX_6 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_6),
  /** SIO port id for serial mux logical channel 7 */
  SIO_PORT_SMUX_7 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_7),
  /** SIO port id for serial mux logical channel 8 */
  SIO_PORT_SMUX_8 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_8),
  /** SIO port id for serial mux logical channel 9 */
  SIO_PORT_SMUX_9 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_9),
  /** SIO port id for serial mux logical channel 10 */
  SIO_PORT_SMUX_10 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_10),
  /** SIO port id for serial mux logical channel 11 */
  SIO_PORT_SMUX_11 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_11),
  /** SIO port id for serial mux logical channel 12 */
  SIO_PORT_SMUX_12 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_12),
  /** SIO port id for serial mux logical channel 13 */
  SIO_PORT_SMUX_13 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_13),
  /** SIO port id for serial mux logical channel 14 */
  SIO_PORT_SMUX_14 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_14),
  /** SIO port id for serial mux logical channel 15 */
  SIO_PORT_SMUX_15 = DEVICE_ID(SIO_MAJOR_SMUX, SIO_MINOR_SMUX_15),

  /** SIO port id for the first serial mux logical channel */
  SIO_PORT_SMUX_FIRST = SIO_PORT_SMUX_0,
  /** SIO port id for the last serial mux logical channel */
  SIO_PORT_SMUX_LAST = SIO_PORT_SMUX_15,

  /*---------------------  QB Ports --------------------- */

  SIO_PORT_QBI_DIAG = DEVICE_ID(SIO_MAJOR_QBI_DIAG, SIO_MINOR_QBI_DIAG),

  /*---------------------  IPA Physical Ports --------------------- */

    /** -- SIO Port id for IPA DS_PHYS_1 device */
  SIO_PORT_IPA_DS_PHYS_1 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_PHYS_1),
    /** -- SIO Port id for IPA DS_PHYS_2 device */
  SIO_PORT_IPA_DS_PHYS_2 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_PHYS_2),
    /** -- SIO Port id for IPA DS_PHYS_3 device */
  SIO_PORT_IPA_DS_PHYS_3 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_PHYS_3),
    /** -- SIO Port id for IPA DS_PHYS_4 device */
  SIO_PORT_IPA_DS_PHYS_4 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_PHYS_4),
    /** -- SIO Port id for IPA DS_PHYS_5 device */
  SIO_PORT_IPA_DS_PHYS_5 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_PHYS_5),
    /** -- SIO Port id for IPA DS_PHYS_6 device */
  SIO_PORT_IPA_DS_PHYS_6 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_PHYS_6),
    /** -- SIO Port id for IPA DS_PHYS_7 device */
  SIO_PORT_IPA_DS_PHYS_7 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_PHYS_7),
    /** -- SIO Port id for IPA DS_PHYS_8 device */
  SIO_PORT_IPA_DS_PHYS_8 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_PHYS_8),

  /*---------------------  IPA Logical Ports --------------------- */

   /** -- SIO Port id for IPA DS_CH_1 device */
  SIO_PORT_IPA_DS_CH_1 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_1),
    /** -- SIO Port id for IPA DS_CH_2 device */
  SIO_PORT_IPA_DS_CH_2 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_2),
    /** -- SIO Port id for IPA DS_CH_3 device */
  SIO_PORT_IPA_DS_CH_3 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_3),
    /** -- SIO Port id for IPA DS_CH_4 device */
  SIO_PORT_IPA_DS_CH_4 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_4),
    /** -- SIO Port id for IPA DS_CH_5 device */
  SIO_PORT_IPA_DS_CH_5 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_5),
    /** -- SIO Port id for IPA DS_CH_6 device */
  SIO_PORT_IPA_DS_CH_6 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_6),
    /** -- SIO Port id for IPA DS_CH_7 device */
  SIO_PORT_IPA_DS_CH_7 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_7),
    /** -- SIO Port id for IPA DS_CH_8 device */
  SIO_PORT_IPA_DS_CH_8 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_8),
    /** -- SIO Port id for IPA DS_CH_9 device */
  SIO_PORT_IPA_DS_CH_9 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_9),
    /** -- SIO Port id for IPA DS_CH_10 device */
  SIO_PORT_IPA_DS_CH_10 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_10),
    /** -- SIO Port id for IPA DS_CH_11 device */
  SIO_PORT_IPA_DS_CH_11 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_11),
    /** -- SIO Port id for IPA DS_CH_12 device */
  SIO_PORT_IPA_DS_CH_12 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_12),
    /** -- SIO Port id for IPA DS_CH_13 device */
  SIO_PORT_IPA_DS_CH_13 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_13),
    /** -- SIO Port id for IPA DS_CH_14 device */
  SIO_PORT_IPA_DS_CH_14 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_14),
    /** -- SIO Port id for IPA DS_CH_15 device */
  SIO_PORT_IPA_DS_CH_15 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_15),
    /** -- SIO Port id for IPA DS_CH_16 device */
  SIO_PORT_IPA_DS_CH_16 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_16),
    /** -- SIO Port id for IPA DS_CH_17 device */
  SIO_PORT_IPA_DS_CH_17 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_17),
    /** -- SIO Port id for IPA DS_CH_18 device */
  SIO_PORT_IPA_DS_CH_18 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_18),
    /** -- SIO Port id for IPA DS_CH_19 device */
  SIO_PORT_IPA_DS_CH_19 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_19),
    /** -- SIO Port id for IPA DS_CH_20 device */
  SIO_PORT_IPA_DS_CH_20 = DEVICE_ID(SIO_MAJOR_IPA , SIO_MINOR_IPA_DS_CH_20),
