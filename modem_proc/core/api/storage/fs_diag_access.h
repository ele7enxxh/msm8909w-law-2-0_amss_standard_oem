 ...
 * Copyright (C) 2006,2008-2010,2012,2014 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //components/rel/core.mpss/3.5.c12.3/api/storage/fs_diag_access.h#1 $ $DateTime: 2016/12/13 07:59:23 $ $Author: mplcsds1 $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2015-03-23   mj    Added enum entries for set_reservation and truncate.
2014-10-15   mj    Removed numbering comments from diag_fs_op_type.
2014-10-13   mj    Added enum entries in diag_fs_op_type.
...
/* ------------------------------------------------------------------------
 * The "/safe" is a special directory and the EFS-module itself provides
 * protection for this "/safe" directory from Diag-access.
 *
 * EFS-Clients can create their directories under this "/safe" directory
 * and will get the Diag-access protection for all their files/directories
 * that reside under this /safe directory.
 * ------------------------------------------------------------------------*/
...
typedef enum {
  ...
  DIAG_FS_CHECK_READLINK,
  DIAG_FS_CHECK_UNLINK,
  DIAG_FS_CHECK_OPENDIR,
  DIAG_FS_CHECK_READDIR,
  DIAG_FS_CHECK_CLOSEDIR,
  DIAG_FS_CHECK_RENAME,
  DIAG_FS_CHECK_STAT,
  DIAG_FS_CHECK_LSTAT,
  DIAG_FS_CHECK_FSTAT,
  DIAG_FS_CHECK_CHMOD,
  DIAG_FS_CHECK_STATFS,
  DIAG_FS_CHECK_ACCESS,
  DIAG_FS_CHECK_FORMAT,
  DIAG_FS_CHECK_TRUNCATE,
  DIAG_FS_CHECK_TRUNCATE64,
  DIAG_FS_CHECK_SET_QUOTA,
  DIAG_FS_CHECK_SET_RESERVATION,
  DIAG_FS_CHECK_GET_GROUP_INFO,
  DIAG_FS_CHECK_MD5SUM,
