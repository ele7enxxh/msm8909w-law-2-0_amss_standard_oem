 ...
 *   order.
 *
 *  $Header: //components/rel/core.mpss/3.5.c12.3/api/storage/flash.h#1 $ $DateTime: 2016/12/13 07:59:23 $ $Author: mplcsds1 $
 *
 *
 * when         who     what, where, why
 * ----------   ---     ------------------------------------------------
 * 2012-01-18   sv      Add SPI NOR power management support
 * 2011-09-22   eo      Support for erase blocks by size
 * 2010-10-11   bn      Added NOR I2C device support
