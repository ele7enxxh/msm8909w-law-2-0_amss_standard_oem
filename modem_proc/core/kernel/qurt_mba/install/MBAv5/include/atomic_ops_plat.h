...
/*=============================================================================
                 ...
                 atomic_ops_plat.h -- H E A D E R  F I L E

GENERAL DESCRIPTION
   Prototypes of atomic operations API backward compatible
...
$Header: //components/rel/core.mpss/3.5.c12.3/kernel/qurt_mba/install/MBAv5/include/atomic_ops_plat.h#1 $ 
$DateTime: 2016/12/13 07:59:23 $ $Author: mplcsds1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
08/03/11   op      Add header file backward compatible
=============================================================================*/
