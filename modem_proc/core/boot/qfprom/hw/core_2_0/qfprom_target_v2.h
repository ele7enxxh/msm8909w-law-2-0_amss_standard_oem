...
$Header: //components/rel/core.mpss/3.5.c12.3/boot/qfprom/hw/core_2_0/qfprom_target_v2.h#1 $
...
typedef enum
{
  ...
  QFPROM_MEM_CONFIG_ROW13_REGION,
  QFPROM_MEM_CONFIG_ROW14_REGION,
