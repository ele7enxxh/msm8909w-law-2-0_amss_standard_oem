...
$Header: //components/rel/core.mpss/3.5.c12.3/boot/qfprom/src/qfprom.c#1 $
...
)
{
    ...
    do
    {
        ...
        */
        ...
        memscpy(raw_data_to_write,sizeof(raw_data_to_write),row_data,sizeof(raw_data_to_write));
        memscpy(corr_data_to_write,sizeof(corr_data_to_write),row_data,sizeof(corr_data_to_write));
