...
$Header: //components/rel/core.mpss/3.5.c12.3/systemdrivers/hal/clk/hw/msm8909/src/gcc/HALclkPCNOC.c#1 $
...
static HAL_clk_ClockDescType HAL_clk_mPCNOCBFDCDClkDomainClks[] =
{
  ...
  {
    /* .szClockName      = */ "gcc_tlmm_clk", /*Need to discuss*/
  ...
  {
    /* .szClockName      = */ "gcc_pcnoc_bus_timeout1_ahb_clk", /*Need to discuss*/
