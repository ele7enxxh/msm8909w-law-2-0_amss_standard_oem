...
$Header: //components/rel/core.mpss/3.5.c12.3/systemdrivers/hal/clk/hw/msm8909/src/gcc/HALclkGCC.c#1 $
...
{
  /* .nCGRAddr             = */ 0,  /* Remove access to shared resource */
...
{
  /* .nCGRAddr             = */ 0,      /* Remove client access */
