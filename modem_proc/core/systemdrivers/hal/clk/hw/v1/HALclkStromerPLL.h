...
$Header: //components/rel/core.mpss/3.5.c12.3/systemdrivers/hal/clk/hw/v1/HALclkStromerPLL.h#1 $
 ...
 */
static boolean HAL_clk_StromerPLLEnable           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
static void    HAL_clk_StromerPLLDisable          ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
static boolean HAL_clk_StromerPLLIsEnabled        ( HAL_clk_SourceDescType *pSource );
static void    HAL_clk_StromerPLLConfig           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceConfigType eConfig );
static boolean HAL_clk_StromerPLLConfigPLL        ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig, HAL_clk_SourceConfigMode eMode);
static void    HAL_clk_StromerPLLDetectPLLConfig  ( HAL_clk_SourceDescType *pSource, HAL_clk_PLLConfigType *pmConfig );
static boolean HAL_clk_StromerPLLEnableVote       ( HAL_clk_SourceDescType *pSource );
static void    HAL_clk_StromerPLLDisableVote      ( HAL_clk_SourceDescType *pSource );
static boolean HAL_clk_StromerPLLIsVoteEnabled    ( HAL_clk_SourceDescType *pSource );
