...
$Header: //components/rel/core.mpss/3.5.c12.3/systemdrivers/pmic/config/msm8909/pm8909/pm_config_target.c#1 $
...
/* GPIO3 is used for BUA in 8909 as agianst GPIO1 in 8916 (CR-0000168562) */
