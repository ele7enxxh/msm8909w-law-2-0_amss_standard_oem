...
$Header: //components/rel/core.mpss/3.5.c12.3/systemdrivers/pmic/config/msm8909/pm8909/pm_config_modem_npa_node_rsrcs.c#1 $ 
...
npa_node_dependency
pm_modem_proc_client_dev_deps_rf1_tech_lte2 [] =
{
   PMIC_NPA_NODE_DEP_LIST( A, clk, 4 ),
   PMIC_NPA_NODE_DEP_LIST( A, ldo, 1 ),
   PMIC_NPA_NODE_DEP_LIST( A, ldo, 4 ),
...
npa_node_dependency
pm_modem_proc_client_dev_deps_rf2_tech_lte2 [] =
{
   PMIC_NPA_NODE_DEP_LIST( A, clk, 4 ),
   PMIC_NPA_NODE_DEP_LIST( A, ldo, 1 ),
   PMIC_NPA_NODE_DEP_LIST( A, ldo, 4 ),
...
/* RF3_GPS1 Client */
npa_node_dependency
pm_modem_proc_client_dev_deps_rf3_gps1 [] =
{
   PMIC_NPA_NODE_DEP_LIST( A, clk, 2 ),
   PMIC_NPA_NODE_DEP_LIST( A, clk, 4 ),
   PMIC_NPA_NODE_DEP_LIST( A, clk, 5 ),
...
/* SENSOR_VDD Client */
npa_node_dependency
pm_modem_proc_client_dev_deps_sensor_vdd [] =
{
...
/* SENSOR_VDD_2 Client */
npa_node_dependency
pm_modem_proc_client_dev_deps_sensor_vdd_2 [] =
{
   PMIC_NPA_NODE_DEP_LIST( A, ldo, 17 ),
};
...
/* SENSOR_VDDIO Client */
npa_node_dependency
pm_modem_proc_client_dev_deps_sensor_vddio [] =
{
   PMIC_NPA_NODE_DEP_LIST( A, ldo, 6 ),
};
...
npa_node_dependency
pm_modem_proc_client_dev_deps_sensor_vddio_2 [] =
{
   PMIC_NPA_NODE_DEP_LIST( A, ldo, 6 ),
};
...
pm_npa_modem_pam_node_rsrcs [] =
{
   ...
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf1_tech_do, // Node Dependency
   ...
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf1_tech_gsm, // Node Dependency
   ...
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf1_tech_gsm2, // Node Dependency
   ...
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf1_tech_gsm3, // Node Dependency
   ...
   },
   {
      ...
      PMIC_NPA_MODE_ID_RF_MODE_MAX - 1, // Maximum Value
      NPA_RESOURCE_DEFAULT, // Resource Attribute
      (void*) pm_pam_rf1_tech_lte2_rails_info, // Resource User Data
      PMIC_NPA_CLIENT_NODE_RF1_TECH_LTE2, // Node Name
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf1_tech_lte2, // Node Dependency
      NPA_ARRAY_SIZE(pm_modem_proc_client_dev_deps_rf1_tech_lte2), // Deps Count & Deps Node Dependency Count
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf1_tech_tdscdma, // Node Dependency
   ...
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf1_tech_wcdma, // Node Dependency
   ...
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf2_tech_1x, // Node Dependency
   ...
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf2_tech_do, // Node Dependency
   ...
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf2_tech_gps, // Node Dependency
   ...
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf2_tech_gsm, // Node Dependency
   ...
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf2_tech_gsm2, // Node Dependency
   ...
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf2_tech_gsm3, // Node Dependency
   ...
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf2_tech_lte, // Node Dependency
   ...
   },
   {
      ...
      PMIC_NPA_MODE_ID_RF_MODE_MAX - 1, // Maximum Value
      NPA_RESOURCE_DEFAULT, // Resource Attribute
      (void*) pm_pam_rf2_tech_lte2_rails_info, // Resource User Data
      PMIC_NPA_CLIENT_NODE_RF2_TECH_LTE2, // Node Name
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf2_tech_lte2, // Node Dependency
      NPA_ARRAY_SIZE(pm_modem_proc_client_dev_deps_rf2_tech_lte2), // Deps Count & Deps Node Dependency Count
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf2_tech_tdscdma, // Node Dependency
   ...
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf2_tech_wcdma, // Node Dependency
   ...
   },
   {
      ...
      PMIC_NPA_MODE_ID_RF_MODE_MAX - 1, // Maximum Value
      NPA_RESOURCE_DEFAULT, // Resource Attribute
      (void*) pm_pam_rf3_gps1_rails_info, // Resource User Data
      PMIC_NPA_CLIENT_NODE_RF3_GPS1, // Node Name
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_rf3_gps1, // Node Dependency
      NPA_ARRAY_SIZE(pm_modem_proc_client_dev_deps_rf3_gps1), // Deps Count & Deps Node Dependency Count
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_sensor_vdd, // Node Dependency
      NPA_ARRAY_SIZE(pm_modem_proc_client_dev_deps_sensor_vdd), // Deps Count & Deps Node Dependency Count
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_sensor_vdd_2, // Node Dependency
      NPA_ARRAY_SIZE(pm_modem_proc_client_dev_deps_sensor_vdd_2), // Deps Count & Deps Node Dependency Count
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_sensor_vddio, // Node Dependency
      NPA_ARRAY_SIZE(pm_modem_proc_client_dev_deps_sensor_vddio), // Deps Count & Deps Node Dependency Count
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_sensor_vddio_2, // Node Dependency
      NPA_ARRAY_SIZE(pm_modem_proc_client_dev_deps_sensor_vddio_2), // Deps Count & Deps Node Dependency Count
   },
   {
...
uint32 num_of_pm_modem_nodes [] = { 34 };
