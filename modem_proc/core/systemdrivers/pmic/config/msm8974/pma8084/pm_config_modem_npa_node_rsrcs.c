...
$Header: //components/rel/core.mpss/3.5.c12.3/systemdrivers/pmic/config/msm8974/pma8084/pm_config_modem_npa_node_rsrcs.c#1 $ 
...
extern pm_npa_pam_client_cfg_type
pma8084_pam_xo_shutdown_rails_info [];
...
/* ANT1 Client */
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_ant1[] =
{
...
/* HFPLL1 Client */
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_hfpll1[] =
{
...
/* PA1 Client */
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_pa1[] =
{
...
/* PLL_HF Client */
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_pll_hf[] =
{
  PMIC_NPA_NODE_DEP_LIST(A, ldo, 12),
};
...
/* PLL_SR2 Client */
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_pll_sr2[] =
{
  PMIC_NPA_NODE_DEP_LIST(A, ldo, 12),
};
...
/* QFPROM Client */
npa_node_dependency 
pma8084_modem_proc_client_dev_deps_qfprom [] =
{
...
/* RAIL_CX Client */
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_rail_cx[] =
{
...
/* RAIL_MSS Client */
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_rail_mss[] =
{
...
/* RAIL_MX Client */
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_rail_mx[] =
{
...
/* RF1 Client */
npa_node_dependency 
pma8084_modem_proc_client_dev_deps_rf1 [] =
{
  ...
  PMIC_NPA_NODE_DEP_LIST(A, ldo, 16),
   ...
   PMIC_NPA_NODE_DEP_LIST( A, ldo, 27 ),
};

/* RF1_TECH_1X Client */
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_rf1_tech_1x[] =
{
  PMIC_NPA_NODE_DEP_LIST(A, clk, 4),
  PMIC_NPA_NODE_DEP_LIST(A, clk, 5),
  PMIC_NPA_NODE_DEP_LIST(A, ldo, 4),
...
/* RF1_TECH_DO Client */
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_rf1_tech_do[] =
{
  PMIC_NPA_NODE_DEP_LIST(A, clk, 4),
  PMIC_NPA_NODE_DEP_LIST(A, clk, 5),
  PMIC_NPA_NODE_DEP_LIST(A, ldo, 4),
...
/* RF1_TECH_GPS Client */
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_rf1_tech_gps[] =
{
  PMIC_NPA_NODE_DEP_LIST(A, clk, 4),
  PMIC_NPA_NODE_DEP_LIST(A, clk, 5),
  PMIC_NPA_NODE_DEP_LIST(A, ldo, 4),
...
/* RF1_TECH_GSM Client */
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_rf1_tech_gsm[] =
{
  PMIC_NPA_NODE_DEP_LIST(A, clk, 4),
  PMIC_NPA_NODE_DEP_LIST(A, clk, 5),
  PMIC_NPA_NODE_DEP_LIST(A, ldo, 4),
...
/* RF1_TECH_LTE Client */
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_rf1_tech_lte[] =
{
  PMIC_NPA_NODE_DEP_LIST(A, clk, 4),
  PMIC_NPA_NODE_DEP_LIST(A, clk, 5),
  PMIC_NPA_NODE_DEP_LIST(A, ldo, 4),
...
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_rf1_tech_tdscdma[] =
{
  PMIC_NPA_NODE_DEP_LIST(A, clk, 4),
  PMIC_NPA_NODE_DEP_LIST(A, clk, 5),
  PMIC_NPA_NODE_DEP_LIST(A, ldo, 4),
...
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_rf1_tech_wcdma[] =
{
  PMIC_NPA_NODE_DEP_LIST(A, clk, 4),
  PMIC_NPA_NODE_DEP_LIST(A, clk, 5),
  PMIC_NPA_NODE_DEP_LIST(A, ldo, 4),
...
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_uim1_activity[] =
{
...
/* UIM1_ENABLE Client */
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_uim1_enable[] =
{
  PMIC_NPA_NODE_DEP_LIST(A, ldo, 9),
};
...
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_uim2_activity[] =
{
...
/* UIM2_ENABLE Client */
npa_node_dependency
   pma8084_modem_proc_client_dev_deps_uim2_enable[] =
{
  PMIC_NPA_NODE_DEP_LIST(A, ldo, 10),
};
...
/* VDD_MEM_UVOL Client */
npa_node_dependency
pma8084_modem_proc_client_dev_deps_vdd_mem_uvol[] =
{
  PMIC_NPA_NODE_DEP_LIST(A, smps, 1),
};
...
pma8084_npa_modem_pam_node_rsrcs[] =
{
   {
      ...
      (void*) pma8084_pam_ant1_rails_info,      // Resource User Data
      PMIC_NPA_CLIENT_NODE_ANT1,            // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_ant1,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_ant1),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_HFPLL1,               // Resource Name
      PMIC_NPA_MODE_ID_GENERIC_MAX - 1,        // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL, // Resource Attributes
      (void*) pma8084_pam_hfpll1_rails_info,      // Resource User Data
      PMIC_NPA_CLIENT_NODE_HFPLL1,               // Node Name
      NPA_NODE_DEFAULT,                                                // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_hfpll1,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_hfpll1),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_PA1,               // Resource Name
      PMIC_NPA_MODE_ID_PA_MODE_3 - 1,                 // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                       // Resource Attributes
      (void*) pma8084_pam_pa1_rails_info,      // Resource User Data
      PMIC_NPA_CLIENT_NODE_PA1,            // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_pa1,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_pa1),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_PLL_HF,               // Resource Name
      PMIC_NPA_MODE_ID_GENERIC_MAX - 1,        // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL, // Resource Attributes
      (void*) pma8084_pam_pll_hf_rails_info,      // Resource User Data
      PMIC_NPA_CLIENT_NODE_PLL_HF,               // Node Name
      NPA_NODE_DEFAULT,                                                // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_pll_hf,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_pll_hf),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_PLL_SR2,               // Resource Name
      PMIC_NPA_MODE_ID_GENERIC_MAX - 1,        // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL, // Resource Attributes
      (void*) pma8084_pam_pll_sr2_rails_info,      // Resource User Data
      PMIC_NPA_CLIENT_NODE_PLL_SR2,               // Node Name
      NPA_NODE_DEFAULT,                                                // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_pll_sr2,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_pll_sr2),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_QFPROM,                        // Resource Name
      PMIC_NPA_MODE_ID_GENERIC_MAX - 1,                // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                      // Resource Attributes
      (void*) pma8084_pam_qfprom_rails_info,                // Resource User Data
      PMIC_NPA_CLIENT_NODE_QFPROM,                     // Node Name
      NPA_NODE_DEFAULT,                                // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_qfprom,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_qfprom),      // deps count & Deps Node Dependency count
   },
   {
      ...
      (void*) pma8084_pam_rail_cx_rails_info,                // Resource User Data
      PMIC_NPA_CLIENT_NODE_RAIL_CX,                     // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_rail_cx,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_rail_cx),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_RAIL_MSS,               // Resource Name
      PMIC_NPA_MODE_ID_CORE_RAIL_MAX - 1,        // Maximum value
      NPA_RESOURCE_DEFAULT, // Resource Attributes
      (void*) pma8084_pam_rail_mss_rails_info,      // Resource User Data
      PMIC_NPA_CLIENT_NODE_RAIL_MSS,               // Node Name
      NPA_NODE_DEFAULT,                                                // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_rail_mss,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_rail_mss),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_RAIL_MX,                         // Resource Name
      PMIC_NPA_MODE_ID_CORE_RAIL_MAX - 1,                // Maximum value
      NPA_RESOURCE_DEFAULT,                              // Resource Attributes
      (void*) pma8084_pam_rail_mx_rails_info,                // Resource User Data
      PMIC_NPA_CLIENT_NODE_RAIL_MX,                     // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_rail_mx,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_rail_mx),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_RF1,                             // Resource Name
      PMIC_NPA_MODE_ID_RF_MODE_MAX - 1,                 // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                       // Resource Attributes
      (void*) pma8084_pam_rf1_rails_info,                    // Resource User Data
      PMIC_NPA_CLIENT_NODE_RF1,                         // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_rf1,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_rf1),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_RF1_TECH_1X,                    // Resource Name
      PMIC_NPA_MODE_ID_RF_MODE_MAX - 1,                 // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                       // Resource Attributes
      (void*) pma8084_pam_rf1_tech_1x_rails_info,            // Resource User Data
      PMIC_NPA_CLIENT_NODE_RF1_TECH_1X,                 // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_rf1_tech_1x,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_rf1_tech_1x),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_RF1_TECH_DO,                    // Resource Name
      PMIC_NPA_MODE_ID_RF_MODE_MAX - 1,                 // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                       // Resource Attributes
      (void*) pma8084_pam_rf1_tech_do_rails_info,            // Resource User Data
      PMIC_NPA_CLIENT_NODE_RF1_TECH_DO,                 // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_rf1_tech_do,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_rf1_tech_do),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_RF1_TECH_GPS,                  // Resource Name
      PMIC_NPA_MODE_ID_GPS_MODE_MAX - 1,                // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                      // Resource Attributes
      (void*) pma8084_pam_rf1_tech_gps_rails_info,          // Resource User Data
      PMIC_NPA_CLIENT_NODE_RF1_TECH_GPS,               // Node Name
      NPA_NODE_DEFAULT,                                // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_rf1_tech_gps,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_rf1_tech_gps),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_RF1_TECH_GSM,                  // Resource Name
      PMIC_NPA_MODE_ID_RF_MODE_MAX - 1,                // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                      // Resource Attributes
      (void*) pma8084_pam_rf1_tech_gsm_rails_info,          // Resource User Data
      PMIC_NPA_CLIENT_NODE_RF1_TECH_GSM,               // Node Name
      NPA_NODE_DEFAULT,                                // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_rf1_tech_gsm,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_rf1_tech_gsm),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_RF1_TECH_LTE,               // Resource Name
      PMIC_NPA_MODE_ID_RF_MODE_MAX - 1,                // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                      // Resource Attributes
      (void*) pma8084_pam_rf1_tech_lte_rails_info,          // Resource User Data
      PMIC_NPA_CLIENT_NODE_RF1_TECH_LTE,               // Node Name
      NPA_NODE_DEFAULT,                                // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_rf1_tech_lte,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_rf1_tech_lte),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_RF1_TECH_TDSCDMA,               // Resource Name
      PMIC_NPA_MODE_ID_RF_MODE_MAX - 1,                 // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                       // Resource Attributes
      (void*) pma8084_pam_rf1_tech_tdscdma_rails_info,       // Resource User Data
      PMIC_NPA_CLIENT_NODE_RF1_TECH_TDSCDMA,            // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_rf1_tech_tdscdma,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_rf1_tech_tdscdma),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_RF1_TECH_WCDMA,                 // Resource Name
      PMIC_NPA_MODE_ID_RF_MODE_MAX - 1,                 // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                       // Resource Attributes
      (void*) pma8084_pam_rf1_tech_wcdma_rails_info,         // Resource User Data
      PMIC_NPA_CLIENT_NODE_RF1_TECH_WCDMA,              // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_rf1_tech_wcdma,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_rf1_tech_wcdma),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_UIM1_ACTIVITY,               // Resource Name
      PMIC_NPA_MODE_ID_UIM_MODE_MAX - 1,                 // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                       // Resource Attributes
      (void*) pma8084_pam_uim1_activity_rails_info,      // Resource User Data
      PMIC_NPA_CLIENT_NODE_UIM1_ACTIVITY,            // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_uim1_activity,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_uim1_activity),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_UIM1_ENABLE,               // Resource Name
      PMIC_NPA_MODE_ID_UIM_MODE_MAX - 1,                 // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                       // Resource Attributes
      (void*) pma8084_pam_uim1_enable_rails_info,      // Resource User Data
      PMIC_NPA_CLIENT_NODE_UIM1_ENABLE,            // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_uim1_enable,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_uim1_enable),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_UIM2_ACTIVITY,               // Resource Name
      PMIC_NPA_MODE_ID_UIM_MODE_MAX - 1,                 // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                       // Resource Attributes
      (void*) pma8084_pam_uim2_activity_rails_info,      // Resource User Data
      PMIC_NPA_CLIENT_NODE_UIM2_ACTIVITY,            // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_uim2_activity,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_uim2_activity),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_UIM2_ENABLE,               // Resource Name
      PMIC_NPA_MODE_ID_UIM_MODE_MAX - 1,                 // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                       // Resource Attributes
      (void*) pma8084_pam_uim2_enable_rails_info,      // Resource User Data
      PMIC_NPA_CLIENT_NODE_UIM2_ENABLE,            // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_uim2_enable,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_uim2_enable),      // deps count & Deps Node Dependency count
   },
   {
      ...
      (void*) pma8084_pam_vdd_mem_uvol_rails_info,      // Resource User Data
      PMIC_NPA_CLIENT_NODE_VDD_MEM_UVOL,            // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pma8084_modem_proc_client_dev_deps_vdd_mem_uvol,      // Node Dependencies
      NPA_ARRAY_SIZE(pma8084_modem_proc_client_dev_deps_vdd_mem_uvol),      // deps count & Deps Node Dependency count
   },   
};

uint8 pma8084_num_of_pm_modem_nodes[] ={ 22 };


pm_npa_remote_name_type
pma8084_npa_smps_remote_resources [] = 
{  
...
pm_npa_remote_name_type  
pma8084_npa_ldo_remote_resources [] = 
{
   ...
   { PMIC_DEV_RSRC_NAME_VEC_IN( A, ldo, 27), "ldoa\x1B\x00\x00\x00" },
};

pm_npa_remote_resource_type
pma8084_npa_remote_ldo [1] =
{
   {
     pma8084_npa_ldo_remote_resources,
   10
...
pm_npa_remote_name_type
pma8084_npa_clk_remote_resources [] = 
{
