...
$Header: //components/rel/core.mpss/3.5.c12.3/systemdrivers/pmic/config/msm8974/pma8084/pm_config_target.c#1 $ 
...
XOCOREDS pma8084_XOCOREDSConfig_V6_VariantCommon[1] =
{
    {0x7FF, 0x3F}
};
pm_uicc_specific_info_type pma8084_uicc_specific[1] =
{
    {PM_GPIO_22, PM_PBS_CLIENT_6, PM_LDO_9, PM_LDO_10, PM_LDO_INVALID, PM_LDO_INVALID}
};
mppDS pma8084_MPPDSConfig_V6_VariantCommon[1] =
{
    {0x9E0, 4}
};

pm_pwr_specific_info pma8084_smps_specific_a[12] = 
{
...
pm_pwr_specific_info pma8084_ldo_specific_a[27] = 
{
...
uint32 pma8084_cx_corners_count = 6;
uint32 pma8084_cx_corners_lst[6] = 
{ 500000, 725000, 812500, 900000, 987500, 1050000};
char pma8084_PM_MODEM_CX_VREG[50] = "/pmic/device/smps/A/smps2/vec";

pm_pwr_resource_info_type pma8084_cx_rail[1] = 
{
    {RPM_SMPS_A_REQ, 2, &pma8084_cx_corners_count, pma8084_cx_corners_lst, pma8084_PM_MODEM_CX_VREG }// data 1 is the size of the LUT, data 2 is the CX LUT, data3 is the RPM resource string.
};

uint32 pma8084_mx_corners_count = 6;
uint32 pma8084_mx_corners_lst[6] = 
{675000, 950000, 950000, 950000, 1050000, 1050000 };
char pma8084_PM_MODEM_MX_VREG[50] = "/pmic/device/smps/A/smps1/vec";

pm_pwr_resource_info_type pma8084_mx_rail[1] = 
{
    {RPM_SMPS_A_REQ, 1, &pma8084_mx_corners_count, pma8084_mx_corners_lst, pma8084_PM_MODEM_MX_VREG }// data 1 is the size of the LUT, data 2 is the MX LUT, data3 is the RPM resource string 
};
