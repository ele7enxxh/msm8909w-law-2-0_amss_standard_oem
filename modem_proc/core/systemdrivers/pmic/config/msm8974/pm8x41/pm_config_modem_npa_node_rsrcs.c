...
$Header: //components/rel/core.mpss/3.5.c12.3/systemdrivers/pmic/config/msm8974/pm8x41/pm_config_modem_npa_node_rsrcs.c#1 $ 
...
#define PMIC_NPA_CLIENT_NODE_CLK_REGIME_DIG   "/node/pmic/client/clk_regime_dig"
#define PMIC_NPA_CLIENT_NODE_HFPLL1   "/node/pmic/client/hfpll1"
#define PMIC_NPA_CLIENT_NODE_MCPM_DIG   "/node/pmic/client/mcpm_dig"
#define PMIC_NPA_CLIENT_NODE_MCPM_MEM   "/node/pmic/client/mcpm_mem"
...
npa_node_dependency
   pm_modem_proc_client_dev_deps_clk_regime_dig[] =
{
...
/* MCPM_DIG Client */
npa_node_dependency
   pm_modem_proc_client_dev_deps_mcpm_dig[] =
{
  PMIC_NPA_NODE_DEP_LIST(B, smps, 1),
  PMIC_NPA_NODE_DEP_LIST(B, smps, 2),
};
...
/* MCPM_MEM Client */
npa_node_dependency
   pm_modem_proc_client_dev_deps_mcpm_mem[] =
{
  PMIC_NPA_NODE_DEP_LIST(B, smps, 1),
};
...
{
  PMIC_NPA_NODE_DEP_LIST(B, smps, 3),
}; 
...
pm_npa_modem_pam_node_rsrcs[] =
{
   ...
   {
      PMIC_NPA_GROUP_ID_CLK_REGIME_DIG,               // Resource Name
      PMIC_NPA_MODE_ID_CLK_REGIME_MODE_7 - 1,                 // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                       // Resource Attributes
      (void*) pm_pam_clk_regime_dig_rails_info,      // Resource User Data
      PMIC_NPA_CLIENT_NODE_CLK_REGIME_DIG,            // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_clk_regime_dig,      // Node Dependencies
      NPA_ARRAY_SIZE(pm_modem_proc_client_dev_deps_clk_regime_dig),      // deps count & Deps Node Dependency count
   },
   {
   ...
   {
      PMIC_NPA_GROUP_ID_MCPM_DIG,               // Resource Name
      PMIC_NPA_MODE_ID_CORNER_LEVEL_MAX - 1,                 // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                       // Resource Attributes
      (void*) pm_pam_mcpm_dig_rails_info,      // Resource User Data
      PMIC_NPA_CLIENT_NODE_MCPM_DIG,            // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_mcpm_dig,      // Node Dependencies
      NPA_ARRAY_SIZE(pm_modem_proc_client_dev_deps_mcpm_dig),      // deps count & Deps Node Dependency count
   },
   {
      PMIC_NPA_GROUP_ID_MCPM_MEM,               // Resource Name
      PMIC_NPA_MODE_ID_MCPM_MODE_MAX - 1,                 // Maximum value
      NPA_RESOURCE_SINGLE_CLIENT|NPA_RESOURCE_DRIVER_UNCONDITIONAL,                       // Resource Attributes
      (void*) pm_pam_mcpm_mem_rails_info,      // Resource User Data
      PMIC_NPA_CLIENT_NODE_MCPM_MEM,            // Node Name
      NPA_NODE_DEFAULT,                                 // Node Attributes
      NULL,
      pm_modem_proc_client_dev_deps_mcpm_mem,      // Node Dependencies
      NPA_ARRAY_SIZE(pm_modem_proc_client_dev_deps_mcpm_mem),      // deps count & Deps Node Dependency count
   },
   {
...
uint8 num_of_pm_modem_nodes[] ={ 25 };
...
{  
   ...
   { PMIC_DEV_RSRC_NAME_VEC_IN( B, smps, 1 ), "smpb\x01\x00\x00\x00" },
   { PMIC_DEV_RSRC_NAME_VEC_IN( B, smps, 2 ), "smpb\x02\x00\x00\x00" },
   { PMIC_DEV_RSRC_NAME_VEC_IN( B, smps, 3 ), "smpb\x03\x00\x00\x00" },
};
