...
$Header: //components/rel/core.mpss/3.5.c12.3/systemdrivers/pmic/config/msm8962/pm_config_target.h#1 $ 
...
#define NUM_OF_PMIC             1

#define NUM_OF_GPIO_A		22
#define NUM_OF_MPP_A            8
#define NUM_OF_RTC_A            1
#define NUM_OF_TALM_A           1
#define NUM_OF_MEGAXO_A         1
#define NUM_OF_CLK_BUFFER_A     13
#define NUM_OF_SMPS_A           12
#define NUM_OF_LDO_A            27
#define NUM_OF_VS_A             4
