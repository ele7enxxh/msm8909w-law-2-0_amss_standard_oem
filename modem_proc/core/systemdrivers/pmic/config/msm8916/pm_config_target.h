/*! \file
 *  
 *  \brief  pm_config_target.h ----This file contains customizable target specific driver settings & PMIC registers.
...
$Header: //components/rel/core.mpss/3.5.c12.3/systemdrivers/pmic/config/msm8916/pm_config_target.h#1 $ 

when       who     what, where, why
--------   ---     ----------------------------------------------------------
10/03/13   rk      Changing the no of GPIO, MPP, SMPS and LDOs
===========================================================================*/
...
#define NUM_OF_GPIO_A           4
#define NUM_OF_MPP_A            4
#define NUM_OF_RTC_A            1
#define NUM_OF_TALM_A           1
#define NUM_OF_MEGAXO_A         1
#define NUM_OF_CLK_BUFFER_A     13
#define NUM_OF_SMPS_A           4
#define NUM_OF_LDO_A            20
#define NUM_OF_VS_A             0
#define NUM_OF_BOOST_A          0

#define NUM_OF_GPIO_B           0
#define NUM_OF_MPP_B            0
#define NUM_OF_RTC_B            0
#define NUM_OF_TALM_B           0
#define NUM_OF_MEGAXO_B         0
#define NUM_OF_CLK_BUFFER_B     0
#define NUM_OF_SMPS_B           0
#define NUM_OF_LDO_B            0
#define NUM_OF_VS_B             0
