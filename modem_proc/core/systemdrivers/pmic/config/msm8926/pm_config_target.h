...
$Header: //components/rel/core.mpss/3.5.c12.3/systemdrivers/pmic/config/msm8926/pm_config_target.h#1 $ 
...
#define NUM_OF_SMPS_A           5
#define NUM_OF_LDO_A            28
#define NUM_OF_VS_A             1
