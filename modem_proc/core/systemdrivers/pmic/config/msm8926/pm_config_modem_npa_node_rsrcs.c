...
$Header: //components/rel/core.mpss/3.5.c12.3/systemdrivers/pmic/config/msm8926/pm_config_modem_npa_node_rsrcs.c#1 $ 
...
#define PMIC_NPA_MODE_ID_CORE_RAIL_MAX_UVOL 1250000
/*===========================================================================
...
{
      PMIC_NPA_NODE_DEP_LIST( A, clk, 12 ),
      PMIC_NPA_NODE_DEP_LIST( A, ldo, 14 ),
};
...
uint8 num_of_pm_modem_nodes[] ={ 23 };
...
pmic_npa_clk_remote_resources [] = 
{
   ...
   { PMIC_DEV_RSRC_NAME_VEC_IN( A, clk, 12), "clka\x0C\x00\x00\x00" },
};
