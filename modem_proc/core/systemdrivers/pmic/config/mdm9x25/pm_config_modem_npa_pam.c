...
$Header: //components/rel/core.mpss/3.5.c12.3/systemdrivers/pmic/config/mdm9x25/pm_config_modem_npa_pam.c#1 $ 
...
--------    ---      ----------------------------------------------------------
6/6/2013	arvindhr	PM8019_NPA_version_0p15_05_06_2013 - Approved 
Comments: 1.Version Notes:
Edit by Henry Wang
Added NOT_GENERATED for RF modes above 10, and added MEM_UVOL
Correcting Mx in turbo to enable (per Henry)
...
5/18/2013	arvindhr	PM8019_NPA_version_0p14_19_05_2013 - Approved 
Comments: 1.Version Notes:
Adding Thermal client
Adding capability to support GPS eLNA on LDO5 instead of LDO14
...
4/30/2013	arvindhr	PM8019_NPA_version_0p13_30_04_2013 - Approved 
Comments: 1.Version Notes: Actually incrementing the version number this time
Remove following clients on RPM :
PMIC_NPA_CLIENT_NODE_RAIL_CX
PMIC_NPA_CLIENT_NODE_RAIL_MX
 
The following were never present on 9x25:
...
4.Verification(How/Who will test): PMIC SW/RPM
	

4/30/2013	arvindhr	PM8019_NPA_version_0p12_30_04_2013 - Approved 
Comments: 1.Version Notes:
Remove following clients on RPM :
PMIC_NPA_CLIENT_NODE_RAIL_CX
PMIC_NPA_CLIENT_NODE_RAIL_MX
...
4.Verification(How/Who will test): PMIC SW
	

4/28/2013	arvindhr	PM8019_NPA_version_0p12_29_04_2013 - Approved 
Comments: 1.Version Notes: (Per RF SW, Ameya's request)
A.	All RF PAM tables (except LTE): LDO8 in Mode_2 has to be 2.05V instead of the 2.1V at present (for 1x, DO, GSM, WCDMA, TDS, GPS)

B.	LTE PAM table: We need 2 new modes…
Mode 1: 1.225V/2.1V
Mode 2: 1.3V/2.1V
Mode 3: 1.225V/2.05V
Mode 4: 1.3V/2.05V
...
3.Release Priority(Urgent/Medium/Low/Not for release): Urgent
	
4.Verification(How/Who will test): RF SW
	

3/20/2013	NA\arvindhr	PM8019_NPA_version_0p11_20_03_2013 - NOT Approved 1.Version Notes:
Deleting MX votes from Rail_Cx clients
...
3/19/2013	arvindhr	PM8019_NPA_version_0p11_20_03_2013_rev2 - Approved 
Comments: 1.Version Notes:
Deleting Mx vote from Rail_Cx
Deleting clk_regime. mcpm, slimbus clients
...
pm_pam_rf1_rails_info []=
{
   ...
   {
      (void*)pm_pam_rf1_a_ldo1,
      PM_NPA_VREG_LDO
   },
   {
      (void*)pm_pam_rf1_a_ldo7,
      PM_NPA_VREG_LDO
   },
   {
      (void*)pm_pam_rf1_a_ldo8,
      PM_NPA_VREG_LDO
   },
   {
...
pm_pam_rf1_tech_do_rails_info []=
{
   ...
   {
      (void*)pm_pam_rf1_tech_do_a_ldo8,
      PM_NPA_VREG_LDO
   },
   {
...
pm_npa_ldo_kvps
pm_pam_rf1_tech_gps_elna_a_ldo5 [] =
{
    // Mode: 		PMIC_NPA_MODE_ID_RF_MODE_0
    // Comments: 	PMIC_NPA_MODE_ID_RF_SLEEP
   {
...
pm_npa_ldo_kvps
pm_pam_rf1_tech_gps_elna_a_ldo7 [] =
{
    // Mode: 		PMIC_NPA_MODE_ID_RF_MODE_0
    // Comments: 	PMIC_NPA_MODE_ID_RF_SLEEP
   {
...
pm_npa_ldo_kvps
pm_pam_rf1_tech_gps_elna_a_ldo8 [] =
{
    // Mode: 		PMIC_NPA_MODE_ID_RF_MODE_0
    // Comments: 	PMIC_NPA_MODE_ID_RF_SLEEP
   {
...
pm_pam_rf1_tech_gps_elna_rails_info []=
{
   ...
   {
      (void*)pm_pam_rf1_tech_gps_elna_a_ldo5,
      PM_NPA_VREG_LDO
   },
   {
      (void*)pm_pam_rf1_tech_gps_elna_a_ldo7,
      PM_NPA_VREG_LDO
   },
   {
      (void*)pm_pam_rf1_tech_gps_elna_a_ldo8,
      PM_NPA_VREG_LDO
   },
};
/* RF1_TECH_GSM Client */
...
pm_pam_rf1_tech_gsm_rails_info []=
{
   ...
   {
      (void*)pm_pam_rf1_tech_gsm_a_ldo8,
      PM_NPA_VREG_LDO
   },
   {
...
pm_npa_ldo_kvps
pm_pam_rf1_tech_tdscdma_a_ldo8 [] =
{
    // Mode: 		PMIC_NPA_MODE_ID_RF_MODE_0
    // Comments: 	PMIC_NPA_MODE_ID_RF_SLEEP
   {
...
pm_pam_rf1_tech_tdscdma_rails_info []=
{
   ...
   {
      (void*)pm_pam_rf1_tech_tdscdma_a_ldo8,
      PM_NPA_VREG_LDO
   },
   {
...
pm_pam_rf1_tech_wcdma_rails_info []=
{
   ...
   {
      (void*)pm_pam_rf1_tech_wcdma_a_ldo8,
      PM_NPA_VREG_LDO
   },
   {
...
{
   {
      (void*)pm_pam_vdd_mem_uvol_a_ldo12,
      PM_NPA_VREG_LDO
   },
};
