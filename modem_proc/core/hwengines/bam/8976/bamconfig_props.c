...
--------   ---     ------------------------------------------------------------
10/20/14   SA      Added devcfg props support for tgtcfg and supported BAMs
...
{
    { BAM_USB2_HSIC_BASE, BAM_USB2_IRQVECTOR }
};
const bamclient_config_info_type  bam_lpass_baseirq_info[] =
{
    { BAM_LITE_LPASS_BASE, BAM_LITE_LPASS_IRQVECTOR }
};
