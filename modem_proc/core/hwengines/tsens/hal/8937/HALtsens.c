...
{
   HWIO_OUTM(MPM2_TS_CONTROL, HWIO_RMSK(MPM2_TS_CONTROL), uVal);
}
...
void HAL_tsens_ConfigSensor(uint32 uSensor, uint32 uVal)
{
   if (uSensor == 0)
   {
      HWIO_OUTM(MPM2_TS_CONFIG, HWIO_RMSK(MPM2_TS_CONFIG), uVal);
   }
   else
   {
      HWIO_OUTM(MPM2_TS_CONFIG_REMOTE_IN, HWIO_RMSK(MPM2_TS_CONFIG_REMOTE_IN), uVal);
   }
}
...
{
   return (HAL_tsens_Calibration) HWIO_INF(QFPROM_CORR_CALIB_ROW1_LSB, TSENS_CALIB);
}
...
{
   return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_LSB, TSENS_BASE0) << 2) & 0x3FC);/* since TSENS_BASE0 is 8 Bit*/
}
...
{
   return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_MSB, TSENS_BASE1) << 2) & 0x3FC); /* since TSENS_BASE1 is 8 Bit*/
}
...
uint32 HAL_tsens_GetPointX1(boolean bUseRedundant, uint32 uSensor)
{
   if (bUseRedundant == FALSE)
   {
      ...
      {
         case 0:
            return ((HWIO_INF(QFPROM_CORR_CALIB_ROW1_LSB, TSENS0_POINT1) << 2) & 0xFC); /*offset is 6 bit value*/
         case 1:
            return ((HWIO_INF(QFPROM_CORR_CALIB_ROW1_LSB, TSENS1_POINT1) << 2) & 0xFC);
         case 2:
            // For Sensor 2 first 5 bits are in ROW0_LSB and 6th bit in ROW0_MSB
            return
               ((((HWIO_INF(QFPROM_CORR_CALIB_ROW1_MSB, TSENS2_POINT1_5) << 5) |
                (HWIO_INF(QFPROM_CORR_CALIB_ROW1_LSB, TSENS2_POINT1_4_0))) << 2) & 0xFC);
         case 3:
            return ((HWIO_INF(QFPROM_CORR_CALIB_ROW1_MSB, TSENS3_POINT1) << 2) & 0xFC);
         case 4:
            return ((HWIO_INF(QFPROM_CORR_CALIB_ROW1_MSB, TSENS4_POINT1) << 2) & 0xFC);
         case 5:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_LSB, TSENS5_POINT1) << 2) & 0xFC);
         case 6:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_LSB, TSENS6_POINT1) << 2) & 0xFC);
         case 7:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_MSB, TSENS7_POINT1) << 2) & 0xFC);
         case 8:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_MSB, TSENS8_POINT1) << 2) & 0xFC);
         case 9:
            return ((HWIO_INF(QFPROM_CORR_CALIB_ROW5_LSB, TSENS9_POINT1) << 2) & 0xFC);
         case 10:
            return ((HWIO_INF(QFPROM_CORR_CALIB_ROW5_LSB, TSENS10_POINT1) << 2) & 0xFC);
         default:
            break;
      }
   }
...
uint32 HAL_tsens_GetPointX2(boolean bUseRedundant, uint32 uSensor)
{
   if (bUseRedundant == FALSE)
   {
      ...
      {
         case 0:
            return ((HWIO_INF(QFPROM_CORR_CALIB_ROW1_LSB, TSENS0_POINT2) << 2) & 0xFC); /*offset is 6 bit value*/
         case 1:
            return ((HWIO_INF(QFPROM_CORR_CALIB_ROW1_LSB, TSENS1_POINT2) << 2) & 0xFC);
         case 2:
            return ((HWIO_INF(QFPROM_CORR_CALIB_ROW1_MSB, TSENS2_POINT2) << 2) & 0xFC);
         case 3:
            return ((HWIO_INF(QFPROM_CORR_CALIB_ROW1_MSB, TSENS3_POINT2) << 2) & 0xFC);
         case 4:
            return ((HWIO_INF(QFPROM_CORR_CALIB_ROW1_MSB, TSENS4_POINT2) << 2) & 0xFC);
         case 5:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_LSB, TSENS5_POINT2) << 2) & 0xFC);
         case 6:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_LSB, TSENS6_POINT2) << 2) & 0xFC);
         case 7:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_MSB, TSENS7_POINT2) << 2) & 0xFC);
         case 8:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_MSB, TSENS8_POINT2) << 2) & 0xFC);
         case 9:
            return ((HWIO_INF(QFPROM_CORR_CALIB_ROW5_LSB, TSENS9_POINT2) << 2) & 0xFC);
         case 10:
            return ((HWIO_INF(QFPROM_CORR_CALIB_ROW5_LSB, TSENS10_POINT2) << 2) & 0xFC);
         default:
            break;
      }
   }
