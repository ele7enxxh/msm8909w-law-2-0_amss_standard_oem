...
/*============================================================================
  ...
  $Header: //components/rel/core.mpss/3.5.c12.3/hwengines/tsens/config/8937/TsensiConversion.c#1 $$DateTime: 2016/12/13 07:59:23 $$Author: mplcsds1 $
...
/* ============================================================================
**
**  Tsensi_Apply_D30_Correction_8917
**
**  Description:
**    Apply correction for the code at 30 deg C. Please see CR 782238 for more
**    details regarding this correction.
...
**
** ========================================================================= */
void Tsensi_Apply_D30_Correction_8917(uint32 uSensor, int32 *D30)
{
      switch (uSensor)
      {
         case 0:
...
/* ============================================================================
**
**  Tsensi_Apply_D30_D120_Correction_8917
**
**  Description:
**    Apply correction for the code at 30 deg C and 120 deg C. Please see
**    CR 782238 for more details regarding this correction.
...
**
** ========================================================================= */
void Tsensi_Apply_D30_D120_Correction_8917(uint32 uSensor, int32 *D30, int32 *D120)
{
      switch (uSensor)
      {
         case 0:
   ...
   switch (tsensCalibration)
   {
      case HAL_TSENS_ONE_POINT:
         ...
         for (uSensor = 0; uSensor < uNumSensors; uSensor++)
         {
            ...
            {
                Tsensi_Apply_D30_Correction_8917(uSensor, &anTsensX1[uSensor]);
            }
      ...
      case HAL_TSENS_TWO_POINT:
         ...
         for (uSensor = 0; uSensor < uNumSensors; uSensor++)
         {
            ...
            {
                Tsensi_Apply_D30_D120_Correction_8917(uSensor, &anTsensX1[uSensor], &anTsensX2[uSensor]);
            }
