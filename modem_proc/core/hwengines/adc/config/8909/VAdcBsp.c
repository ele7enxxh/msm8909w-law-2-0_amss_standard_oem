...
/*============================================================================
  ...
  ----------  ---  -----------------------------------------------------------
  2014-12-01  SA   Port the MPP-current-sink WAR for PM8916 to 8909 to support PM8916+MSM8909.
                   Also port CR 730175 (Increase hw settle delay of BATT_THERM and BATT_ID channels to 2ms) applicable to PM8916 for the same reason above.
