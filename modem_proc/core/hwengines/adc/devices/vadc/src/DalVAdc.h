...
============================================================================*/
/* $Header: //components/rel/core.mpss/3.5.c12.3/hwengines/adc/devices/vadc/src/DalVAdc.h#1 $ */
...
#define VADC_MAX_RECALIBRATIONS 10
#define VADC_MAX_ABS_ADCCODES 8
#define VADC_MAX_RM_ADCCODES 12
#define VADC_MAX_STATISTICS 100
...
typedef struct
{
   ...
   DALBOOL bRecalibrate;
   uint32 uMaxRecalibrations;
} VAdcChannelConfigType;
...
{
   DALBOOL bIsTimedout;
   uint32 dwRecalibCount;
}VAdcRecalib;

typedef struct 
{
   VAdcRecalib sVAdcRecalib[VADC_MAX_STATISTICS];
   uint32 uIndex;
} VAdcReclibStatistics;

typedef struct
{
   uint32 uVrefPCalibCode;
   uint32 uVrefNCalibCode;
   uint32 uVref1CalibCode;
   uint32 uVref2CalibCode;
   uint32 uVref2CalibCode_2;
}VAdcRecalibData;

typedef struct
{
   VAdcRecalibData sRecalibData[VADC_MAX_RECALIBRATIONS];
   uint32 uConfig;
   uint32 uIndex;
} VAdcAbsoluteRecalibData;
