...
/*============================================================================
  ...
  $Header: //components/rel/core.mpss/3.5.c12.3/hwengines/adc/devices/vadc/src/VAdcHal.c#1 $$DateTime: 2016/12/13 07:59:23 $$Author: mplcsds1 $
 ...
 * -------------------------------------------------------------------------*/
const static uint8 vAdcHalRegDumpAddresses[VADC_HAL_NUM_REGISTERS_TO_DUMP] = {
   VADC_REVISION1_ADDR,
   VADC_REVISION2_ADDR,
   VADC_REVISION3_ADDR,
   VADC_REVISION4_ADDR,
