...
#
#-------------------------------------------------------------------------------
#  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/perf/scripts/dynRec_manip.py#1 $
...
# --------  ------  ----    ----------------------------------------------------
# 07/17/15  hzhi    2.2     For CR 872618, add post-link detection for wrong RFC code base.
