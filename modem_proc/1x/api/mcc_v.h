...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/1x/api/mcc_v.h#1 $ $DateTime: 2016/12/13 08:00:08 $ $Author: mplcsds1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/22/11   jtm     CMI Phase 4 - Final SU API changes.
12/17/10   jj      Comments update.
12/13/10   ag      Replaced inclusion of prot.h by prot_v.h.
12/05/10   jj      Added support for Rel8/Rel9 CSFB.
...
typedef enum
{
  ...
  MCC_PSEUDO_IDLE,      /* Enter Psuedo-Idle mode for other technology to
                           CDMA handover */
  MCC_ENTER_TCH_FROM_DO,/* Handoff from a VOIP call to 1X Traffic Channel */
  MCC_LTE_1X_REDIR,     /* Redirection from LTE -> 1X */
  MCC_LTE_1X_RESEL,     /* Reselection from LTE -> 1X */
  MCC_CSFB              /* Operation in tunnel mode for LTE */
} mcc_entry_name_type;
