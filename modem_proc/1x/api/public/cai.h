...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/1x/api/public/cai.h#1 $ $DateTime: 2016/12/13 08:00:08 $ $Author: mplcsds1 $
...
/* Special value to denote that customer specific voice service option
 * is being used. The customer voice service option MUST be based on 
 * CAI_SO_VOICE_EVRC */
#define CAI_GEN_EVRC_CUST_SO 0xFFFE

#define CAI_SO_CSFB_TUNNELED_SMS 0x4C
  /* Dummy Service Option for MT CSFB SMS calls. */
