#ifndef QFE2320EPT_PA_H
#define QFE2320EPT_PA_H
/*!
   @file
   qfe2320ept_pa.h
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfdevice_qfe2320/api/qfe2320ept_pa.h#1 $
...
#include "rfdevice_physical_device.h"
    ...
    class qfe2320ept_pa: public rfdevice_pa
    {
    public:
       ...
       /* Overloaded constructor for physical device support */
        qfe2320ept_pa(rfdevice_physical_device *phy_dev_obj_ptr,rfc_phy_device_info_type *phy_device_info, rfc_logical_device_info_type *logical_device_info); 
    ...
    protected:
        ...
        qfe2320ept_portnum_type gsm_pa_band_port_mapping[RFCOM_NUM_GSM_BANDS] ;

        qfe2320ept_portnum_type wcdma_pa_band_port_mapping[RFCOM_NUM_WCDMA_BANDS];

        qfe2320ept_portnum_type cdma_pa_band_port_mapping[RFM_CDMA_MAX_BAND] ;

        qfe2320ept_portnum_type ltefdd_pa_band_port_mapping[RFCOM_NUM_LTE_BANDS] ;

        qfe2320ept_portnum_type ltetdd_pa_band_port_mapping[RFCOM_NUM_LTE_BANDS] ;

        qfe2320ept_portnum_type tdscdma_pa_band_port_mapping[RFCOM_NUM_LTE_BANDS] ;
        ...
        qfe2320ept_common_driver_settings_type pa_params;

        void qfe2320ept_rtuner_write_data(void);

        void qfe2320ept_rtuner_cal(void);
