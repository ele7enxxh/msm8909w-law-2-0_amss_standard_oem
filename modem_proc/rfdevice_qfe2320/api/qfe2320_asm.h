#ifndef QFE2320_ASM_H
#define QFE2320_ASM_H
/*!
   @file
   qfe2320_asm.h
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfdevice_qfe2320/api/qfe2320_asm.h#1 $
...
#include "rfdevice_physical_device.h"
  ...
  class qfe2320_asm: public rfdevice_asm
  {
  public:
    ...
    qfe2320_asm(rfc_device_cfg_info_type *device_info, uint8 rev_id = 0);

    /* Overloaded constructor to push the device information */
    qfe2320_asm(rfdevice_physical_device *phy_dev_obj_ptr,rfc_phy_device_info_type *phy_device_info, rfc_logical_device_info_type *logical_device_info); 
  ...
  protected:
    ...
    /*
      boolean write_script(rf_buffer_intf *buff_obj_ptr,
                           const qfe2320_ccs_data_type* reg_tbl,
    ...
    */
    ...
    qfe2320_wcdma_asm_port_data_type wcdma_rx_band_port_mapping[RFCOM_NUM_WCDMA_BANDS];

    qfe2320_gsm_asm_port_data_type gsm_rx_band_port_mapping[RFCOM_NUM_GSM_BANDS];

    qfe2320_cdma_asm_port_data_type cdma_rx_band_port_mapping[RFM_CDMA_MAX_BAND];

    qfe2320_ltefdd_asm_port_data_type ltefdd_rx_band_port_mapping[RFCOM_NUM_LTE_BANDS] ;

    qfe2320_ltetdd_asm_port_data_type ltetdd_rx_band_port_mapping[RFCOM_NUM_LTE_BANDS] ;

    qfe2320_tdscdma_asm_port_data_type tdscdma_rx_band_port_mapping[RFCOM_NUM_TDSCDMA_BANDS];

    qfe2320_wcdma_asm_port_data_type wcdma_tx_band_port_mapping[RFCOM_NUM_WCDMA_BANDS];

    qfe2320_gsm_asm_port_data_type gsm_tx_band_port_mapping[RFCOM_NUM_GSM_BANDS] ;

    qfe2320_cdma_asm_port_data_type cdma_tx_band_port_mapping[RFM_CDMA_MAX_BAND];

    qfe2320_ltefdd_asm_port_data_type ltefdd_tx_band_port_mapping[RFCOM_NUM_LTE_BANDS] ;

    qfe2320_ltetdd_asm_port_data_type ltetdd_tx_band_port_mapping[RFCOM_NUM_LTE_BANDS] ;

    qfe2320_tdscdma_asm_port_data_type tdscdma_tx_band_port_mapping[RFCOM_NUM_TDSCDMA_BANDS];
    ...
    qfe2320_common_driver_settings_type asm_params;
