...
--------   ---     ----------------------------------------------------------
03/01/10   pxu     moved some common code to hdrsrch_test_acq.cpp
...
/* Regsiter the test */
TF_REGISTER_TEST_CASE( COMPONENT, hdrsrch_test_afc_pullin_fail );

void hdrsrch_test_afc_pullin_fail::Test()
{
  test_hdrsrch_acq( );
	/* fll locked is fasle */
	hdrfw_msg_rsp.fll_acq.fllLocked = 0x00000000;

  /* Send back failed afc acq response*/
