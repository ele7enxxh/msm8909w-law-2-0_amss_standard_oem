#ifndef CPU_MONITOR_MODEM_H__
#define CPU_MONITOR_MODEM_H__
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/utils/fc/inc/cpu_monitor_modem.h#1 $ $DateTime: 2016/12/13 07:57:51 $ $Author: mplcsds1 $
...
/*~ FUNCTION fc_register_callback_func 
    CLNTNAME fc_modem_register_callback_func */

void fc_apps_register_callback_func (fc_update_remote_cpm_clnt_cb_type *);

void fc_remote_cpu_register (fc_processor_type    clnt_cpu_id, 
                             fc_in_cmd_data_type  cmd_data);
/*~ FUNCTION fc_remote_cpu_register
    CLNTNAME fc_modem_cpu_register   */

void fc_apps_cpu_register (fc_processor_type    clnt_cpu_id, 
                             fc_in_cmd_data_type  cmd_data);


void fc_remote_cpu_deregister (fc_in_cmd_data_type cmd_data);
/*~ FUNCTION fc_remote_cpu_deregister
    CLNTNAME fc_modem_cpu_deregister */

void fc_apps_cpu_deregister (fc_in_cmd_data_type cmd_data);

void fc_remote_process_measurement_req_cmd (fc_processor_type clnt_cpu_id, 
                                            fc_in_cmd_data_type cmd_data);
  /*~ FUNCTION fc_remote_process_measurement_req_cmd
      CLNTNAME fc_modem_process_measurment_req_cmd */


void fc_apps_process_measurment_req_cmd (fc_processor_type clnt_cpu_id, 
                                              fc_in_cmd_data_type cmd_data);
#endif /* CPU_MONITOR_MODEM_H__*/
