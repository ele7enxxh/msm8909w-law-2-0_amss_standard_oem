...
/*!
  ...
  @brief
  CFM(Centralized Flow control Manager) API exposed outside modem.
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/utils/api/public/cfm_ext.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
02/25/11   ax      initial version: separate API needed outside modem from cfm.h
==============================================================================*/
...
*/
#define CFM_MAX_DATA_RATE                          0xffffffff

/*! @brief modem radio access technology enumeration
*/
typedef enum
{
  CFM_MODEM_RAT_LTE= 0,   /*!< LTE radio access tech */
  CFM_MODEM_RAT_MAX       /*!< MAX */
} cfm_modem_rat_e;
...
/*!
    ...
    - The data rate is sticky. At power UP, CFM_MAX_DATA_RATE is used, it is 
...
*/
/*============================================================================*/
boolean cfm_cap_ul_data_rate
(
  cfm_modem_rat_e rat, /*!< the radio access technology rate is applied to */
  uint32          data_rate/*!< maximum data rate in number of byte per ms.  
                   Using CFM_MAX_DATA_RATE  will turn off flow control */
);
