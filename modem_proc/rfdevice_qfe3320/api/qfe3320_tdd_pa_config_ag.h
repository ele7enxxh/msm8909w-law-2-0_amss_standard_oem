...
#ifndef QFE3320_TDD_PA_CONFIG_AG_H
#define QFE3320_TDD_PA_CONFIG_AG_H/*
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfdevice_qfe3320/api/qfe3320_tdd_pa_config_ag.h#1 $
$Author: mplcsds1 $
...
boolean rfdevice_qpa_qfe3320_tdd_construct_driver_ag
(
  rfdevice_qpa_settings_type* qpa_settings,
  rfdevice_qpa_func_tbl_type* pa_fn_ptrs
);

extern void qfe3320_tdd_convert_port_mapping(rfcom_band_type_u band, rfdevice_pa_bw_enum_type bw, rfm_mode_enum_type mode, uint8 *port_index);
