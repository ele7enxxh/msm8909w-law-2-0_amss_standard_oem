/*==============================================================================
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/audio_avs/afe/drivers/hw/lpasshwio/devcfg/src/lpasshwio_devcfg_8974.c#1 $
