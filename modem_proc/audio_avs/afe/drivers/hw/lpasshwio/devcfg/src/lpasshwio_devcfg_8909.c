/*==============================================================================
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/audio_avs/afe/drivers/hw/lpasshwio/devcfg/src/lpasshwio_devcfg_8909.c#1 $
...
/***** ULT Core Info **************
  LPASS VERSION: ultaudio 1.4.0
  LPAIF VERSION: 3.3.0
  PRI I2S : (SPKR, 2 data lines)
  SEC I2S : (SPKR, 1 data line)
  TER I2S : (MIC, 2 data lines)
  QUA I2S : (BI-DIR: 2 data lines)
  PRI PCM : (BI-DIR, Tx/Rx: 8 slots)  
  RDDMA : (2)
  WRDMA : (2)
***********************************/
...
HwdAudioIfPropertyType audioif_prop =
{
   ...
   {0, 1, 3, 4, 5},     /* Interface type list, {0:PRI_MI2S, 1:PRI_PCM, 3:SEC_MI2S, 4:TER_MI2S, 5:QUAT_MI2S} */
   {4, 4, 2, 4, 4},     /* Max num channel for audio IF */
   {1, 3, 1, 2, 3},     /* Interface direction type (1: SPKR, 2: MIC, 3: BI-DIR) */
   46,                  /* LPAIF L2VIC # */
   1,                   /* LPAIF interrupt line # */
   LPASS_HW_VER_1_4_0,  /* LPASS h/w revision (ult_audio hw version) */
...
{
   0                    /* 1 for supporting, 0 for not supporting. */
};
