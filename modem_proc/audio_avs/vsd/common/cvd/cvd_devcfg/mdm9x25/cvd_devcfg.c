/*
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/audio_avs/vsd/common/cvd/cvd_devcfg/mdm9x25/cvd_devcfg.c#1 $
  $Author: mplcsds1 $
*/
...
/**
  ...
  1. Voice use case <-> clock value table as follows: 
     ...
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     TM_FLUENCE +     |  65MHz/HW thread  |  131MHz/HW thread   |  131MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
