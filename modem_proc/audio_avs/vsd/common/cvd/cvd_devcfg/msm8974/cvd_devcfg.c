/*
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/audio_avs/vsd/common/cvd/cvd_devcfg/msm8974/cvd_devcfg.c#1 $
  $Author: mplcsds1 $
*/
...
/**
  ...
  1. Voice use case <-> clock value table as follows: 
     ...
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     TM_FLUENCE +     |  81MHz/HW thread  |  163MHz/HW thread   |  163MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_clock_level_0_use_cases[ 7 ] = 
  {
