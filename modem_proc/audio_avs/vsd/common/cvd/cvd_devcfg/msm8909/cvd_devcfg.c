/*
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/audio_avs/vsd/common/cvd/cvd_devcfg/msm8909/cvd_devcfg.c#1 $
  $Author: mplcsds1 $
*/
...
/**
  ...
  1. Voice use case <-> clock value table as follows: 
     ...
     SOFT VFR         |                   |                     |                      |                      
     -----------------------------------------------------------------------------------
     NONE +           |  96MHz/HW thread  |  144MHz/HW thread   |  144MHz/HW thread    |
     HARD VFR mode    |                   |                     |                      |
     -----------------------------------------------------------------------------------
     SM_ECNS +        |  96MHz/HW thread  |  96MHz/HW thread    |  144MHz/HW thread    |
     SOFT VFR mode    |                   |                     |                      |
     -----------------------------------------------------------------------------------
     SM_ECNS +        |  96MHz/HW thread  |  144MHz/HW thread   |  144MHz/HW thread    |
     HARD VFR mode    |                   |                     |                      |
     -----------------------------------------------------------------------------------
     SM_FLUENCEV5 +   |  96MHz/HW thread  |  144MHz/HW thread   |  144MHz/HW thread    |
     any VFR mode     |                   |                     |
     -----------------------------------------------------------------------------------
     DM_VPECNS +      |  96MHz/HW thread  |  144MHz/HW thread   |  144MHz/HW thread    |
     any VFR mode     |                   |                     |
     -----------------------------------------------------------------------------------
