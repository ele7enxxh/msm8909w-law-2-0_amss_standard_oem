...
#
#-------------------------------------------------------------------------------
#  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/build/myps/elfManipulator/elfManipulator.py#1 $
...
# --------  ------  ----    ----------------------------------------------------
# 05/04/16  rmandal 1.11    CR 951834 Memory stat correction for Q6ZIP saving
# 04/24/15  ao      1.11    Added support for CR 777884 (partial decompressions) and CR 700782 (q6zip info to build.log memory summary)
# 03/05/15  hzhi    1.10    CR 800980 add fix: remove conditional code path when 'coprocimage'
#                           is defined.
# 02/27/15  hzhi    1.10    CR 800980: move section offset move up towards the end of post
#                           link stage..
...
def main():
    ...
    if (sh != const.RC_ERROR):
        ...
        print "Size of " + q6_roSection + " after compression " + str(sh.sh_size)
    ...
    if (sh != const.RC_ERROR):
        ...
        # Print out statistics
        print "Size of " + q6_rwSection + " after compression " + str(sh.sh_size)
