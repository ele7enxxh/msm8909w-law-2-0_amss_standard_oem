...
#ifndef QPA4361_PA_CONFIG_AG_H
#define QPA4361_PA_CONFIG_AG_H/*
...
boolean rfdevice_qpa_qpa4361_construct_driver_ag
(
  rfdevice_qpa_4g_settings_type* qpa_settings,
  rfdevice_qpa_4g_func_tbl_type* pa_fn_ptrs
);

uint8 rfdevice_qpa_qpa4361_get_efs_data_column
(
  uint8 port_index, 
