...
#ifndef QPA4360_PHYSICAL_DEVICE_AG_H
#define QPA4360_PHYSICAL_DEVICE_AG_H
/*!
   @file
   qpa4360_physical_device_ag.h

   @brief
   qpa4360 physical device driver
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfdevice_qpa4360/api/qpa4360_physical_device.h#1 $ 
...
#include "qpa4360_pa_config_main_ag.h"
#include "qpa4360_asm_config_main_ag.h"
#include "qpa4360_gsm_pa_config_main_ag.h"

class qpa4360_physical_device : public rfdevice_physical_device
{
public:
  qpa4360_physical_device(rfc_phy_device_info_type* cfg);
  ...
  qpa4360_physical_device* qpa4360_physical_device_p;
...
private:
  ...
  rfdevice_qpa_4g* qpa4360_pa_obj_ptr;
  rfdevice_qpa_4g* qpa4360_pa_gsm_obj_ptr;

  /* ASM */
  rfdevice_qasm_2g* qpa4360_asm_obj_ptr;
