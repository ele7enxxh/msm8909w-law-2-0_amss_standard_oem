...
#ifndef RFDEVICE_PA_QORVO_RF5425_LB_DATA_AG
#define RFDEVICE_PA_QORVO_RF5425_LB_DATA_AG
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfdevice_pa/src/rfdevice_pa_qorvo_rf5425_lb_data_ag.h#1 $ 
...
class rfdevice_pa_qorvo_rf5425_lb_data_ag:public rfdevice_pa_data
{
public:
    ...
    ~rfdevice_pa_qorvo_rf5425_lb_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_pa_qorvo_rf5425_lb_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_pa_data *rfdevice_pa_qorvo_rf5425_lb_data_ptr;
