...
#ifndef RFDEVICE_ASM_XMSSGF3G0PA_009_DATA_AG
#define RFDEVICE_ASM_XMSSGF3G0PA_009_DATA_AG
...
class rfdevice_asm_xmssgf3g0pa_009_data_ag:public rfdevice_asm_data
{
public:
    ...
    ~rfdevice_asm_xmssgf3g0pa_009_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_asm_xmssgf3g0pa_009_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_asm_data *rfdevice_asm_xmssgf3g0pa_009_data_ptr;
