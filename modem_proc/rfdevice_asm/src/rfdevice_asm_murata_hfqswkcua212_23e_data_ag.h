...
#ifndef RFDEVICE_ASM_MURATA_HFQSWKCUA212_23E_DATA_AG
#define RFDEVICE_ASM_MURATA_HFQSWKCUA212_23E_DATA_AG
...
class rfdevice_asm_murata_hfqswkcua212_23e_data_ag:public rfdevice_asm_data
{
public:
    ...
    ~rfdevice_asm_murata_hfqswkcua212_23e_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_asm_murata_hfqswkcua212_23e_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_asm_data *rfdevice_asm_murata_hfqswkcua212_23e_data_ptr;
