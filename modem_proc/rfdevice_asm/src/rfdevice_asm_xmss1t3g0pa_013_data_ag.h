...
#ifndef RFDEVICE_ASM_XMSS1T3G0PA_013_DATA_AG
#define RFDEVICE_ASM_XMSS1T3G0PA_013_DATA_AG
...
class rfdevice_asm_xmss1t3g0pa_013_data_ag:public rfdevice_asm_data
{
public:
    ...
    ~rfdevice_asm_xmss1t3g0pa_013_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_asm_xmss1t3g0pa_013_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_asm_data *rfdevice_asm_xmss1t3g0pa_013_data_ptr;
