...
#ifndef RFDEVICE_ASM_ACPM7915_DATA_AG
#define RFDEVICE_ASM_ACPM7915_DATA_AG
...
class rfdevice_asm_acpm7915_data_ag:public rfdevice_asm_data
{
public:
    ...
    ~rfdevice_asm_acpm7915_data_ag(void);  /*  Destructor  */
protected:
  rfdevice_asm_acpm7915_data_ag(void);  /*  Constructor  */

private:
  static rfdevice_asm_data *rfdevice_asm_acpm7915_data_ptr;
