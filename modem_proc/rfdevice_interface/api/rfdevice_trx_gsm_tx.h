#ifndef RFDEVICE_TRX_GSM_TX_H
#define RFDEVICE_TRX_GSM_TX_H
/*!
   @file
   rfdevice_trx_gsm_tx.h
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfdevice_interface/api/rfdevice_trx_gsm_tx.h#1 $
...
class rfdevice_trx_gsm_tx:public rfdevice_class
{

public:
  rfdevice_trx_gsm_tx();

  virtual ~rfdevice_trx_gsm_tx();
  ...
  */
  virtual boolean enter_mode(rfdevice_meas_script_data_type* script_data_ptr) = 0;
  ...
  */
  virtual uint16 therm_read( void ) = 0;
  ...
  /*!
    ...
    Pointer to rfdevice_meas_script_data_type
  */
  virtual boolean set_tx_band(rfcom_gsm_band_type band,
                              rfdevice_meas_script_data_type* script_data_ptr) = 0;
  ...
  /*!
    ...
    channel to be tuned
  */
  virtual boolean tune_tx(uint16 arfcn) = 0;
  ...
  */
  virtual boolean enable_kv_cal(boolean flag) = 0;
  ...
  */
  ...
  /*!
    ...
    @param code
  */
  virtual boolean set_kv_cal_code(uint16 code) = 0;
  ...
  */
  virtual int16 get_tx_sbi_start_delta( void ) = 0;
  ...
  */
  ...
  /*!
    ...
    @param buffer
  */
  virtual boolean tx_set_trans_script(rf_buffer_intf *buffer) = 0;
  ...
  /*!
    ...
    @param buffer
  */
  virtual boolean tx_set_stop_script(rf_buffer_intf *buffer) = 0;
  ...
  */
  ...
  /*!
    ...
    @param buffer
  */
  virtual uint16 get_therm_read(rf_buffer_intf *buffer) = 0;
  ...
  */
  virtual
  int16 get_num_therm_regs_to_read() = 0;
...
struct rfdev_gsm_tx;
typedef struct rfdev_gsm_tx rfdevice_trx_gsm_tx;
...
rfdevice_gsm_tx_get_common_device_pointer(rfdevice_trx_gsm_tx* tx_device);
