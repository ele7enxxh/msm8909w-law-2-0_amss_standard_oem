...
#ifndef RFLM_DTR_RX_HAL_AG_H
#define RFLM_DTR_RX_HAL_AG_H
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfmodem_jolokia/lm/inc/rflm_dtr_rx_hal_ag.h#1 $
...
extern rflm_dtr_rx_settings_type_ag* rflm_dtr_rx_settings_mapping[];

lm_status_type rxlm_init_settings_get (
...
void rxlm_modem_ver_init_ag ( uint32 override_id );



void update_rx_bbrx_fuse_adc_config_qfuse_ag (
...
extern lm_status_type rflm_dtr_rx_get_intra_band_ca_mode (
 			uint32 carr1_bw_khz ,
 			uint32 gap_khz ,
 			uint32 carr2_bw_khz ,
