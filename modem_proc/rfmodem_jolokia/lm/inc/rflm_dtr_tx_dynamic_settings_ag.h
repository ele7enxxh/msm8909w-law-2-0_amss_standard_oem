...
#ifndef RFLM_DTR_TX_DYNAMIC_SETTINGS_AG_H
#define RFLM_DTR_TX_DYNAMIC_SETTINGS_AG_H
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfmodem_jolokia/lm/inc/rflm_dtr_tx_dynamic_settings_ag.h#1 $
...
extern rflm_dtr_tx_peq_group_struct tx_dp_peq_peq[RFLM_DTR_TX_DP_PEQ_SW_DYNAMIC_SETTINGS_NUM];

extern void update_tx_dp_peq_peq (
 			rflm_dtr_tx_peq_group_struct *target_struct ,
 			uint32 table_index 
			);
#ifdef __cplusplus
}
