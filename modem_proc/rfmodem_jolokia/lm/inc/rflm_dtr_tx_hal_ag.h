...
#ifndef RFLM_DTR_TX_HAL_AG_H
#define RFLM_DTR_TX_HAL_AG_H
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfmodem_jolokia/lm/inc/rflm_dtr_tx_hal_ag.h#1 $
...
extern rflm_dtr_tx_settings_type_ag* rflm_dtr_tx_settings_mapping[];
