...
#ifndef TXLM_DAC_CAL_AG_H
#define TXLM_DAC_CAL_AG_H
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfmodem_jolokia/lm/inc/txlm_dac_cal_ag.h#1 $
...
extern lm_status_type txlm_dac_cal_write_settings (
 			void * cfg 
			);



extern lm_status_type txlm_dac_cal_cmd_dispatch (
 			txlm_dac_cal_cmd_enum_type dac_cal_cmd ,
 			uint8 size ,
 			uint32 * data 
			);
