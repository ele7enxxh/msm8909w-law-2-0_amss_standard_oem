...
#ifndef RFLM_DTR_RX_CONFIG_AG_H
#define RFLM_DTR_RX_CONFIG_AG_H
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfmodem_jolokia/lm/inc/rflm_dtr_rx_config_ag.h#1 $
...
extern void rflm_dtr_rx_configure_group_iqmc_a_b_coeffs(rflm_dtr_rx_iqmc_a_b_coeffs_group_struct* iqmc_a_b_coeffs_params, uint8 wbw_idx_0);

extern void rflm_dtr_rx_configure_group_iqmc(rflm_dtr_rx_iqmc_group_struct* iqmc_params, uint8 wbw_idx_0);

extern void rflm_dtr_rx_configure_chain_ag(rflm_dtr_rx_settings_type_ag* buffer, uint32 ctl_word);

extern void rflm_dtr_rx_program_ifreq_script(rflm_dtr_rx_ifreq_delta_struct* buffer );

extern void rxlm_program_secondary_notch_settings(rflm_dtr_rx_secondary_notch_settings_type* buffer );
