...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/mmcp/api/public/sys_gw.h#1 $
...
08/20/09   rm      Removing inclusion of cause.h
02/23/09   rm      CMI Phase-2 : Removing inclusion of private header files
                   from public11/28/08   rm      CMI defeaturisation
