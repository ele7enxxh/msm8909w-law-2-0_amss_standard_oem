...
#------------------------------------------------------------------------------
#
#  $Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/tools/build/scons/scripts/generic_builders.py#1 $
...
def get_builder_action(env, action, action_text='Generating ', \
    ...
    if verbose == 3:
        verbose_str = "%s ARGS: [T:%s, S:%s]" % (str(action), \
                      action_target_str, action_source_str)
    elif verbose == 2:
        verbose_str = "<== %s\n" \
            "Source: %s\n" \
            "Target: %s\n" \
            "Command: %s\n==>" % (action_text, action_source_str, \
