#ifndef RFC_EFS_CARD_WCDMA_DATA
#define RFC_EFS_CARD_WCDMA_DATA
/*!
  @file
  rfc_efs_card_wcdma_data.h

  @brief
  This file contains the class definition for the rfc_efs_card_wcdma_data, which implements the
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfa/rfc/rf_card/rfc_efs_card/wcdma/inc/rfc_efs_card_wcdma_data.h#1 $
...
class rfc_efs_card_wcdma_data:public rfc_wcdma_data
{
public:
  ...
  // Destructor
  virtual ~rfc_efs_card_wcdma_data();

protected:
  rfc_efs_card_wcdma_data(void);  /*  Constructor  */
