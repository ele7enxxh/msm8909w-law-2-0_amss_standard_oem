#ifndef RFC_CONFIGURABLE_TEST_CARD_LTE_DATA
#define RFC_CONFIGURABLE_TEST_CARD_LTE_DATA
/*!
  @file
  rfc_configurable_test_card_lte_data.h

  @brief
  This file contains the class definition for the rfc_configurable_test_card_lte_data, which implements the
...
$Header: //commercial/MPSS.JO.2.0.c1.4/Main/modem_proc/rfa/rfc/rf_card/rfc_configurable_test_card/lte/inc/rfc_configurable_test_card_lte_data.h#1 $
...
class rfc_configurable_test_card_lte_data:public rfc_lte_data
{
public:
  ...
  // Destructor
  virtual ~rfc_configurable_test_card_lte_data();

protected:
  rfc_configurable_test_card_lte_data(void);  /*  Constructor  */
};
