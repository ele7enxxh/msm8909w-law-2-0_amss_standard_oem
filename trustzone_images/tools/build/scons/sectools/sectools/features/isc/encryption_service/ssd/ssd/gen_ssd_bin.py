...
#----------------------------------------------------------------------------
#
#  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/tools/build/scons/sectools/sectools/features/isc/encryption_service/ssd/ssd/gen_ssd_bin.py#1 $
...
internal_openssl_dir = os.path.join(os.path.dirname(os.path.realpath(__file__)), openssl_win_rel_path)
