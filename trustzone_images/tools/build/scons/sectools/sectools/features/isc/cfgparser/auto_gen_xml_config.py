...
class complex_general_properties(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, max_cert_size=None, key_size=None, num_certs_in_certchain=None, num_root_certs=None):
    ...
    def hasContent_(self):
        if (
            ...
            self.num_root_certs is not None
            ):
            return True
        else:
            return False
...
class complex_elf_properties(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, has_hash_table=None, image_type=None, serial_num=None):
    ...
    def exportChildren(self, outfile, level, namespace_='tns:', name_='complex_elf_properties', fromsubclass_=False):
        ...
        if self.serial_num is not None:
            showIndent(outfile, level)
            outfile.write('<%sserial_num>%s</%sserial_num>\n' % (namespace_, self.gds_format_integer(self.serial_num, input_name='serial_num'), namespace_))
    def hasContent_(self):
        if (
            self.has_hash_table is not None or
            self.image_type is not None or
            self.serial_num is not None
            ):
            return True
        else:
            return False
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'serial_num':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError), exp:
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'serial_num')
            self.serial_num = ival_
...
class complex_ewm_properties(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, header_size=None, preamble_size=None, has_magic_num=None, ota_enabled=None, page_size=None, num_of_pages=None, min_size_with_pad=None, image_entry=None, relocatable=None):
        self.header_size = header_size
        self.preamble_size = preamble_size
        self.has_magic_num = has_magic_num
        self.ota_enabled = ota_enabled
    ...
    def hasContent_(self):
        if (
            ...
            self.page_size is not None or
            self.num_of_pages is not None or
            self.min_size_with_pad is not None or
...
class complex_default_attributes(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, msm_part=None, oem_id=None, model_id=None, sw_id=None, app_id=None, crash_dump=None, debug=None, exponent=None):
...
class complex_cert_configs_list(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, cert_config=None):
...
class complex_image(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, image_type=None, sign_id=None, cert_config=None, name=None, general_properties_overrides=None, signing_attributes_overrides=None, meta_build_location=None, post_process_commands=None):
...
class complex_encryption(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, selected_encryptor=None):
    ...
    def hasContent_(self):
        if (
            self.selected_encryptor is not None
            ):
            return True
        else:
            return False
