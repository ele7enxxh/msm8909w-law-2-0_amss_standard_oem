...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/tools/build/scons/build/build.py#1 $
...
def build (*args):
   ...
   try:
      ...
      lg.log("Running $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/tools/build/scons/build/build.py#1 $")
