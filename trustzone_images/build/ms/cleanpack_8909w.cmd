...
call build.cmd CHIPSET=msm8909w tz tzbsp_no_xpu sampleapp playready widevine keymaster commonlib USES_FLAGS=USES_PLAYREADY_PACK
...
call build.cmd CHIPSET=msm8909w tz tzbsp_no_xpu sampleapp playready widevine keymaster commonlib USES_FLAGS=USES_CLEAN_PACK -c --implicit-deps-unchanged
rem Remove the files
call build.cmd CHIPSET=msm8909w tz tzbsp_no_xpu sampleapp playready widevine keymaster commonlib -c --implicit-deps-unchanged --cleanpack
rem Recompile
call build.cmd CHIPSET=msm8909w tz tzbsp_no_xpu sampleapp playready widevine keymaster commonlib
goto END
rem Copy the build
