...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/dal/config/build/dalconfig_builder.py#1 $
...
# --------   ---     ---------------------------------------------------------
# 12/12/14   sg      cleanup_xml functionality converted to python.
