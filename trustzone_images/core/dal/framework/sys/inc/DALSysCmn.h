...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/dal/framework/sys/inc/DALSysCmn.h#1 $

when       who     description
--------   ---     ----------------------------------------------------------
09/25/12   aa      Added member dwPropsStructSectionOffset to DALPropsDir
                   to support struct section base address lookup
...
struct DALPropsDir
{
   ...
   uint32 dwPropsStructSectionOffset;
   uint32 dwNumDevices;
