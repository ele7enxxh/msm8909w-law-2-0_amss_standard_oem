...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/dal/framework/src/dal_asm_wrap.c#1 $

when       who     description
--------   ---     ----------------------------------------------------------
02/03/12   aa      Cleanup for older ARM architechure & WINSIM (V5 & less).
