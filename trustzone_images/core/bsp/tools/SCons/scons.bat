...
@REM this file is run from core/bsp/tools/SCons, internal builds include python in the core/bsp/tools/python
set PYTHONCMD=python
set COREBSP_PYTHON=%~dp0..\python
set CRM_PYTHON=C:\CRMApps\Apps\Python262
set CRM_PYTHON_OPT=C:\Apps\Python262

set COREBSP_TOOLS=%~dp0..\..\tools
...
%PYTHONPATH%\python.exe -c "from os import environ; from os.path import join, abspath; import sys; sys.path = [ join(abspath(environ.get('COREBSP_TOOLS','..\..\bsp\tools')))] + sys.path; import SCons.Script; SCons.Script.main()" %*
