...
/*=============================================================================
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/systemdebug/spmi/src/msm8916/sysdbg_spmi.c#1 $
...
SpmiCfg_ChannelCfg  pm_spmi_periph_cfg_pm8916[] =
{
...
uint32 pm_num_periph_pm8916 = sizeof(pm_spmi_periph_cfg_pm8916) / sizeof(SpmiCfg_ChannelCfg);
...
boolean spmi_init(void)
{
   ...
   SpmiCfg_ChannelCfg* periph_cfg_ptr = pm_spmi_periph_cfg_pm8916;
   if (!init)
   { 
		...
		{
			/* tz api which configures spmi channels, as it has been disabled in TZ for 8916
			doing it here */
			if (SpmiCfg_ConfigureChannels(periph_cfg_ptr, pm_num_periph_pm8916) != SPMI_SUCCESS)
			{
