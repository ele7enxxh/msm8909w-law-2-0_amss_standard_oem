...
/*=============================================================================
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/systemdebug/pmic/src/target/msm8909w/sysdbg_pmic_private.h#1 $
...
/*By fault enable the PMIC watchdog for 8909*/
#define USE_PMIC_WATCHDOG 1
