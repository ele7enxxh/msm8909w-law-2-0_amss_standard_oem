...
/*=============================================================================
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/systemdebug/pmic/src/target/msm8909w/sysdbg_pmic_target.c#1 $
...
* 
* @brief
*	This function disables the PMIC watchdog.
*
* @param[in] 
*	None
*  
...
void PM_target_wdog_disable(void)
{
