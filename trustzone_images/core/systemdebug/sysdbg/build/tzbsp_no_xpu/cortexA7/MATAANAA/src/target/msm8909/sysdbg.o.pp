#line 1 "/local/mnt/workspace/CRMBuilds/TZ.BF.2.5.c10-00004-M8909AAAAANAZT-2_20161130_222454/b/trustzone_images/core/systemdebug/sysdbg/src/target/msm8909/sysdbg.s"
;*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
;
...
#line 38 "/local/mnt/workspace/CRMBuilds/TZ.BF.2.5.c10-00004-M8909AAAAANAZT-2_20161130_222454/b/trustzone_images/core/systemdebug/sysdbg/src/target/msm8909/sysdbg.s"
...
;============================================================================
    ...
    EXPORT sysdbg_reset_check_flat_mapped
...
sysdbg_reset_check FUNCTION
    ...
    movw    r1, #((0x04800000)       & 0xFFFF)
    movt    r1, #((0x04800000 >> 16) & 0xFFFF)
    ldr     r0, [r0, r1]         ;check for debug reset
...
sysdbg_reset_check_flat_mapped FUNCTION
