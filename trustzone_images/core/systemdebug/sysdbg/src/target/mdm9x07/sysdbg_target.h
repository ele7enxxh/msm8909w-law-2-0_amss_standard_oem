...
/*=============================================================================
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/systemdebug/sysdbg/src/target/mdm9x07/sysdbg_target.h#1 $
...
#define SYSDBG_TARGET_MDM9x07  1
/*===========================================================================
...
void ddr_enter_self_refresh_and_reset(void);
...
boolean sysdbg_warmboot_init(void);
