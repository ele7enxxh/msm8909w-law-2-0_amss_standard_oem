#ifndef __RPM_TZ_HWIO_H__
#define __RPM_TZ_HWIO_H__
/*
===========================================================================
*/
/**
  ...
  'Include' filters applied: TZ_IPC[APCS_KPSS_GLB]
...
/*
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/power/rpm/client/inc/rpm_tz_hwio.h#1 $
...
/**
  ...
  'Include' filters applied: TZIPC[APCS_ACC]
  'Exclude' filters applied: RESERVED DUMMY
*/
/*
  ===========================================================================
...
| TARGET: 9625                                                              |
\--------------------------------------------------------------------------*/
#if DAL_CONFIG_TARGET_ID==0x9625
/*----------------------------------------------------------------------------
 * MODULE: APCS_ACC
 *--------------------------------------------------------------------------*/

#define APCS_ACC_REG_BASE                                           (ELAN_A5SS_BASE      + 0x00008000)

#define HWIO_APCS_TZIPC_INTERRUPT_ADDR                              (APCS_ACC_REG_BASE      + 0x00000038)
#define HWIO_APCS_TZIPC_INTERRUPT_RMSK                                0xf00007
#define HWIO_APCS_TZ_IPC_INTERRUPT_OUT(v)      \
...
| TARGET: 8626                                                              |
\--------------------------------------------------------------------------*/
#elif DAL_CONFIG_TARGET_ID==0x8626

/*----------------------------------------------------------------------------
 * MODULE: APCS_A7SS_HYP
 *--------------------------------------------------------------------------*/

#define APCS_A7SS_HYP_REG_BASE                                    (A7SS_BASE      + 0x0001a000)

#define HWIO_APCS_VMM_IPC_INTERRUPT_ADDR                          (APCS_A7SS_HYP_REG_BASE      + 0x00000004)
#define HWIO_APCS_VMM_IPC_INTERRUPT_RMSK                          0xffffffff
#define HWIO_APCS_VMM_IPC_INTERRUPT_OUT(v)      \
        out_dword(HWIO_APCS_VMM_IPC_INTERRUPT_ADDR,v)
#define HWIO_APCS_VMM_IPC_INTERRUPT_SPARE_IPC_31_28_BMSK          0xf0000000
#define HWIO_APCS_VMM_IPC_INTERRUPT_SPARE_IPC_31_28_SHFT                0x1c
#define HWIO_APCS_VMM_IPC_INTERRUPT_SPARE_IPC_27_24_BMSK           0xf000000
#define HWIO_APCS_VMM_IPC_INTERRUPT_SPARE_IPC_27_24_SHFT                0x18
#define HWIO_APCS_VMM_IPC_INTERRUPT_SPARE_IPC_23_20_BMSK            0xf00000
#define HWIO_APCS_VMM_IPC_INTERRUPT_SPARE_IPC_23_20_SHFT                0x14
#define HWIO_APCS_VMM_IPC_INTERRUPT_SPARE_IPC_19_16_BMSK             0xf0000
#define HWIO_APCS_VMM_IPC_INTERRUPT_SPARE_IPC_19_16_SHFT                0x10
#define HWIO_APCS_VMM_IPC_INTERRUPT_SPARE_IPC_15_12_BMSK              0xf000
#define HWIO_APCS_VMM_IPC_INTERRUPT_SPARE_IPC_15_12_SHFT                 0xc
#define HWIO_APCS_VMM_IPC_INTERRUPT_LPASS_ADSP_IPC_BMSK                0xf00
#define HWIO_APCS_VMM_IPC_INTERRUPT_LPASS_ADSP_IPC_SHFT                  0x8
#define HWIO_APCS_VMM_IPC_INTERRUPT_SPARE_IPC_7_4_BMSK                  0xf0
#define HWIO_APCS_VMM_IPC_INTERRUPT_SPARE_IPC_7_4_SHFT                   0x4
#define HWIO_APCS_VMM_IPC_INTERRUPT_RPM_IPC_BMSK                         0xf
#define HWIO_APCS_VMM_IPC_INTERRUPT_RPM_IPC_SHFT                         0x0

/*----------------------------------------------------------------------------
 * MODULE: APCS_KPSS_GLB
 *--------------------------------------------------------------------------*/

#define APCS_KPSS_GLB_REG_BASE                                    (A7SS_BASE      + 0x00011000)
#define HWIO_APCS_TZ_IPC_INTERRUPT_ADDR                           (APCS_KPSS_GLB_REG_BASE      + 0x00000004)
#define HWIO_APCS_TZ_IPC_INTERRUPT_OUT(v)      \
        out_dword(HWIO_APCS_TZ_IPC_INTERRUPT_ADDR,v)

/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\
| TARGET: 8610                                                              |
\--------------------------------------------------------------------------*/
#elif DAL_CONFIG_TARGET_ID==0x8610
...
| TARGET: 9635                                                              |
\--------------------------------------------------------------------------*/
#elif DAL_CONFIG_TARGET_ID==0x9635

/*----------------------------------------------------------------------------
 * MODULE: APCS_ACC
 *--------------------------------------------------------------------------*/

#define APCS_ACC_REG_BASE                                           (TORINO_A7SS_BASE      + 0x00008000)
...
| TARGET: 8916                                                              |
\--------------------------------------------------------------------------*/
#elif DAL_CONFIG_TARGET_ID==0x8916

/*----------------------------------------------------------------------------
 * MODULE: APCS_ACC
 *--------------------------------------------------------------------------*/

#define APCS_KPSS_GLB_REG_BASE                                        (A53SS_BASE      + 0x00011000)

#define HWIO_APCS_TZ_IPC_INTERRUPT_ADDR                               (APCS_KPSS_GLB_REG_BASE      + 0x00000004)
#define HWIO_APCS_TZ_IPC_INTERRUPT_RMSK                                 0xf00007
#define HWIO_APCS_TZ_IPC_INTERRUPT_OUT(v)      \
        out_dword(HWIO_APCS_TZ_IPC_INTERRUPT_ADDR,v)
#define HWIO_APCS_TZ_IPC_INTERRUPT_TZ_SPARE_IPC_BMSK                    0xf00000
#define HWIO_APCS_TZ_IPC_INTERRUPT_TZ_SPARE_IPC_SHFT                        0x14
#define HWIO_APCS_TZ_IPC_INTERRUPT_RPM_TZ_IPC_BMSK                           0x7
#define HWIO_APCS_TZ_IPC_INTERRUPT_RPM_TZ_IPC_SHFT                           0x0
...
#define HWIO_TCSR_TBU_BYPASS_ENABLE_ADDR                                                                                  (TCSR_TCSR_REGS_REG_BASE      + 0x00008000)
#define HWIO_TCSR_TBU_BYPASS_ENABLE_RMSK                                                                                       0xfff
#define HWIO_TCSR_TBU_BYPASS_ENABLE_IN          \
        in_dword_masked(HWIO_TCSR_TBU_BYPASS_ENABLE_ADDR, HWIO_TCSR_TBU_BYPASS_ENABLE_RMSK)
#define HWIO_TCSR_TBU_BYPASS_ENABLE_INM(m)      \
        in_dword_masked(HWIO_TCSR_TBU_BYPASS_ENABLE_ADDR, m)
...
#define HWIO_TCSR_TBU_BYPASS_ENABLE_OUTM(m,v) \
        out_dword_masked_ns(HWIO_TCSR_TBU_BYPASS_ENABLE_ADDR,m,v,HWIO_TCSR_TBU_BYPASS_ENABLE_IN)
#define HWIO_TCSR_TBU_BYPASS_ENABLE_TBU_BYPASS_ENABLE_BMSK                                                                     0xfff
#define HWIO_TCSR_TBU_BYPASS_ENABLE_TBU_BYPASS_ENABLE_SHFT                                                                       0x0
...
#define HWIO_TCSR_PNOC_SNOC_MEMTYPE_SHARED_VALUE_SHFT                                                                            0x3
#define HWIO_TCSR_PNOC_SNOC_MEMTYPE_MEM_TYPE_VALUE_BMSK                                                                          0x7
#define HWIO_TCSR_PNOC_SNOC_MEMTYPE_MEM_TYPE_VALUE_SHFT

/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\
| TARGET: 9x09                                                              |
\--------------------------------------------------------------------------*/
#elif DAL_CONFIG_TARGET_ID==0x9609
...
#define APCS_KPSS_GLB_REG_BASE                                        (KPSS_BASE      + 0x00011000)
