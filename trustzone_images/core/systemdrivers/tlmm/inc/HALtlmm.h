...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/systemdrivers/tlmm/inc/HALtlmm.h#1 $
...
void HAL_tlmm_SetOwnerGroup   ( uint32 *nWhichConfigSet, uint32 nWhatSize, uint32 nWhichOwner );
