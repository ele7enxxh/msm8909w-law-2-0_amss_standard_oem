...
/*
  ...
  ====================================================================
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/systemdrivers/clock/config/msm8916/ClockBSP.c#1 $
...
static ClockGroup aClockGroups[CLOCK_GROUP_TOTAL] =
{
  [CLOCK_GROUP_ABT] = {
    (HAL_clk_ClockDescType[]) {
      { HWIO_GCC_SNOC_BUS_TIMEOUT0_AHB_CBCR_ADDR },
      { HWIO_WCSS_A_PMU_BUS_TIMEOUT_CBCR_ADDR },
