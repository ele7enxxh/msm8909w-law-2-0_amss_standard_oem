...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/systemdrivers/pmic/config/mdm9x07_pm9x07/src/pm_xpu_config_pm9x07.c#1 $
...
const pm_spmi_mpu_type pm_spmi_mpu_cfg [] = {
    ...
    {0, 0x62, 15, PM_ACCESS_ROGE | PM_ACCESS_NON_SEC | PM_ACCESS_RWE, PM_VMID_AP},   /* RTC_TIMER       */
	 ...
	 /** removed S2 from here as S2 is for shared rails in 8909*/
    ...
    {1, 0x45, 56, PM_ACCESS_ROGE | PM_ACCESS_NON_SEC | PM_ACCESS_RWE, PM_VMID_RPM},         /* LDO6           */
    {1, 0x4C, 57, PM_ACCESS_ROGE | PM_ACCESS_NON_SEC | PM_ACCESS_RWE, PM_VMID_RPM},         /* LDO13          */
    {1, 0x50, 58, PM_ACCESS_ROGE | PM_ACCESS_NON_SEC | PM_ACCESS_RWE, PM_VMID_RPM},         /* LDO17          */
	
	 /** removed S3 and S4 from here */
    ...
    {1, 0x17, 68, PM_ACCESS_ROGE | PM_ACCESS_NON_SEC | PM_ACCESS_RWE, PM_VMID_RPM},      /* S2_CTRL        */
    {1, 0x19, 69, PM_ACCESS_ROGE | PM_ACCESS_NON_SEC | PM_ACCESS_RWE, PM_VMID_RPM},      /* S2_FREQ        */
    {1, 0x18, 70, PM_ACCESS_ROGE | PM_ACCESS_NON_SEC | PM_ACCESS_RWE, PM_VMID_RPM},      /* S2_PS          */
    /* 31 to 73 RPM */
    ...
    {2, 0x32, 77, PM_ACCESS_ROGE | PM_ACCESS_NON_SEC | PM_ACCESS_RWE, PM_VMID_MSS},         /* VADC3_MDM      */
