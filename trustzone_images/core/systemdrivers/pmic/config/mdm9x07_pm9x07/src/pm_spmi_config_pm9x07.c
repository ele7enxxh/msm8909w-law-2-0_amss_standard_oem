...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/systemdrivers/pmic/config/mdm9x07_pm9x07/src/pm_spmi_config_pm9x07.c#1 $
...
{
  {0x0, 0x0000}, //{0x1, 0x1741}, /* PMIC 8916, Periph S2_CTRL, S2_CTRL_VOLTAGE_CTL2 */
  {0x0, 0x0000}, //{0x0, 0x0100}, /* PMIC 8916, Periph S2_CTRL, S2_CTRL_PHASE_CNT */
  {0x0, 0x0000}, //{0x1, 0x1745}, /* PMIC 8916, Periph S2_CTRL, S2_CTRL_MODE_CTL */
  {0x0, 0x0000}, //{0x1, 0x1746}, /* PMIC 8916, Periph S2_CTRL, S2_CTRL_EN_CTL */
};
...
{
  {0x0, 0x094A}, /* PMIC 8909, TX_GTR_THRES_CTL */
};
 ...
 */
const SpmiCfg_PvcPortCfg pm_arb_pvc_cfg_8909[] =
{
  {
...
/* Number of pvc ports. */
const uint32 pm_num_pvc = sizeof(pm_arb_pvc_cfg_8909) / sizeof(SpmiCfg_PvcPortCfg);
