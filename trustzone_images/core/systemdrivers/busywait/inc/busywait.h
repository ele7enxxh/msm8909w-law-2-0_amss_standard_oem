...
/*===========================================================================
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/systemdrivers/busywait/inc/busywait.h#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
08/13/12   pbitra  Removed the frequency configuration apis. 
...
/*==========================================================================
  ...
  DESCRIPTION   This function initializes the busywait module.
