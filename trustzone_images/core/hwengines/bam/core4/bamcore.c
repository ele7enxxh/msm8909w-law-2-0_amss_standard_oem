...
===============================================================================
 ...
 $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/hwengines/bam/core4/bamcore.c#1 $
...
#define BAM_MAX_VERSION                   0x9 // Gandalf

#define BAMLITE_MIN_VERSION              0x13 // Aragorn
#define BAMLITE_MAX_VERSION              0x16 // Gandalf

#define BAMNDP_MIN_VERSION               0x20 // Aragorn
#define BAMNDP_MAX_VERSION               0x23 // Gandalf
