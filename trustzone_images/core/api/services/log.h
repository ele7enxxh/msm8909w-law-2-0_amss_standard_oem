...
Copyright (c) 1991-2009 by Qualcomm Technologies, Inc.  All Rights Reserved.
===========================================================================*/
...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/api/services/log.h#1 $
...
===========================================================================*/
  PACK(void *) log_alloc (log_code_type code, unsigned int length);
...
DESCRIPTION
  This function frees an allocated log packet without committing it to be
  sent.
