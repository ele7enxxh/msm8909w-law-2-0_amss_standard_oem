...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/api/services/memheap_lite.h#1 $ $DateTime: 2016/06/17 14:31:11 $ $Author: pwbldsvc $
...
#define MEMHEAP_SUCCESS 1
#define MEMHEAP_FAILURE 0
/* ------------------------------------------------------------------------
** Types
** ------------------------------------------------------------------------ */
...
/**
  ...
  None.
*/
typedef int (*mem_lock_fnc_type)( void * ptr);
...
/**
  ...
  None.
*/
typedef int (*mem_free_fnc_type)( void * ptr);
