...
/*===========================================================================
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/api/services/msgtgt.h#1 $
...
#define MSG_BUILD_MASK_MSG_SSID_RF        (MSG_LVL_LOW)
...
#define MSG_BUILD_MASK_MSG_SSID_APR_MODEM (MSG_LVL_HIGH) /* Audio Packet Router Modem */
#define MSG_BUILD_MASK_MSG_SSID_APR_APPS  (MSG_LVL_HIGH) /* Audio Packet Router Apps*/
#define MSG_BUILD_MASK_MSG_SSID_APR_ADSP  (MSG_LVL_HIGH) /* Audio Packet Router Adsp*/
#define MSG_BUILD_MASK_MSG_SSID_SRD_GENERAL (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_ACDB_GENERAL (MSG_LVL_LOW)
#define MSG_BUILD_MASK_MSG_SSID_DALTF  (MSG_LVL_HIGH)
...
#define MSG_BUILD_MASK_MSG_SSID_HDR_IS890   (MSG_LVL_MED)
 ...
 #define MSG_BUILD_MASK_MSG_SSID_HDR_DEBUG  (MSG_LVL_MED)
#endif
...
#define MSG_BUILD_MASK_MSG_SSID_WCDMA_L1    (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_WCDMA_L2    (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_WCDMA_MAC   (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_WCDMA_RLC   (MSG_LVL_HIGH)
#define MSG_BUILD_MASK_MSG_SSID_WCDMA_RRC   (MSG_LVL_HIGH)
...
#define MSG_BUILD_MASK_MSG_SSID_GSM_GPRS_GRR     (MSG_LVL_MED)
...
#define MSG_BUILD_MASK_MSG_SSID_MCS_RESERVED_2   (MSG_LVL_MED)
#define MSG_BUILD_MASK_MSG_SSID_MCS_RESERVED_3   (MSG_LVL_MED)
#define MSG_BUILD_MASK_MSG_SSID_MCS_RESERVED_4   (MSG_LVL_MED)
