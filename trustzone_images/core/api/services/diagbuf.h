...
/*===========================================================================
      ...
      $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/api/services/diagbuf.h#1 $
...
@param[in] code            Specifying the command code.
@param[in] length          Length requested.
@param[in] nice            padding value
@param[in] diagbuf_alloc_request Type of service requesting buffer space.
...
@return
<ul>
<li> Pointer to allocated buffer if successful
...
@param[in] *ptr             Specifying the ptr to be commited 
