...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/api/services/list.h#1 $ $DateTime: 2016/06/17 14:31:11 $ $Author: pwbldsvc $
...
typedef struct {
   ...
   list_size_type  size;
	   	...
	   	KxMutex pkcsListCriticalSection;
	#endif
} list_type;
...
#ifdef FEATURE_WINCE
	/* Critical Section Name -- Same across ALL list kxcriticalsection objects */
	#define SEC_NAME	"LIST_CRITICAL_SECTION_OBJ"
   static uint32 listSectionCounter = 0;
#endif
...
====================================================================== */
#ifdef FEATURE_WINCE
		#define LIST_LOCK(pkcs) KxMutex_Lock(pkcs)
#else
	#define LIST_LOCK() INTLOCK()
#endif /* FEATURE_WINCE */
...
====================================================================== */
#ifdef FEATURE_WINCE
		#define LIST_FREE(pkcs) KxMutex_Unlock(pkcs)
#else
	#define LIST_FREE() INTFREE()
#endif
