...
/*
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/api/systemdrivers/hwio/mdm9x09/phys/msmhwiobase.h#1 $
...
#define LPASS_LPM_SIZE_BASE                                         0x00000fff
#define LPASS_LPM_SIZE_BASE_SIZE                                    0x00000000
#define LPASS_LPM_SIZE_BASE_PHYS                                    0x00000fff

/*----------------------------------------------------------------------------
 * BASE: RPM_SS_MSG_RAM_SIZE
 *--------------------------------------------------------------------------*/

#define RPM_SS_MSG_RAM_SIZE_BASE                                    0x00007fff
#define RPM_SS_MSG_RAM_SIZE_BASE_SIZE                               0x00000000
#define RPM_SS_MSG_RAM_SIZE_BASE_PHYS                               0x00007fff

/*----------------------------------------------------------------------------
 * BASE: PRONTO_CMEM_SIZE
 *--------------------------------------------------------------------------*/

#define PRONTO_CMEM_SIZE_BASE                                       0x00008000
...
#define SYSTEM_IMEM_SIZE_BASE                                       0x00020000
...
#define GMEM_SIZE_BASE                                              0x00020000
#define GMEM_SIZE_BASE_SIZE                                         0x00000000
#define GMEM_SIZE_BASE_PHYS                                         0x00020000
...
#define PRNG_PRNG_BASE_SIZE                                         0x00000200
...
#define XPU_CFG_SNOC_CFG_MPU1132_4_M19L12_AHB_BASE                  0x0002d000
...
#define BOOT_ROM_SIZE_BASE                                          0x000fffff
#define BOOT_ROM_SIZE_BASE_SIZE                                     0x00000000
#define BOOT_ROM_SIZE_BASE_PHYS                                     0x000fffff

/*----------------------------------------------------------------------------
 * BASE: RPM_CODE_RAM_SIZE
 *--------------------------------------------------------------------------*/

#define RPM_CODE_RAM_SIZE_BASE                                      0x000fffff
#define RPM_CODE_RAM_SIZE_BASE_SIZE                                 0x00000000
#define RPM_CODE_RAM_SIZE_BASE_PHYS                                 0x000fffff
...
/*----------------------------------------------------------------------------
 * BASE: KRAIT_L2_MEM_SIZE
 *--------------------------------------------------------------------------*/

#define KRAIT_L2_MEM_SIZE_BASE                                      0x00200000
#define KRAIT_L2_MEM_SIZE_BASE_SIZE                                 0x00000000
#define KRAIT_L2_MEM_SIZE_BASE_PHYS                                 0x00200000
...
#define RPM_CODE_RAM_END_ADDRESS_BASE                               0x002fffff
#define RPM_CODE_RAM_END_ADDRESS_BASE_SIZE                          0x00000000
#define RPM_CODE_RAM_END_ADDRESS_BASE_PHYS                          0x002fffff
...
#define MSS_TCM_SIZE_BASE                                           0x004fffff
#define MSS_TCM_SIZE_BASE_SIZE                                      0x00000000
#define MSS_TCM_SIZE_BASE_PHYS                                      0x004fffff
...
#define MDSS_MDSS_TOP_BASE_SIZE                                     0x000f9000
...
#define CAMSS_CAMERA_SS_BASE_SIZE                                   0x00063000
...
/*----------------------------------------------------------------------------
 * BASE: VENUS0_VENUS_ULT
 *--------------------------------------------------------------------------*/

#define VENUS0_VENUS_ULT_BASE                                       0x01d00000
#define VENUS0_VENUS_ULT_BASE_SIZE                                  0x00800000
#define VENUS0_VENUS_ULT_BASE_PHYS                                  0x01d00000
...
#define SMMU_500_REG_WRAPPER_BASE_SIZE                              0x00110000
...
#define LPASS_LPM_BASE_SIZE                                         0x00001000
...
#define USB2_HSIC_USB_OTG_HS_EP8_PIPES2_BAGHEERA_BASE_SIZE          0x0001a000
...
#define KRAIT_L2_MEM_BASE                                           0x08000000
#define KRAIT_L2_MEM_BASE_SIZE                                      0x00000000
#define KRAIT_L2_MEM_BASE_PHYS                                      0x08000000

/*----------------------------------------------------------------------------
 * BASE: KRAIT_L2_MEM_END
 *--------------------------------------------------------------------------*/

#define KRAIT_L2_MEM_END_BASE                                       0x081fffff
#define KRAIT_L2_MEM_END_BASE_SIZE                                  0x00000000
#define KRAIT_L2_MEM_END_BASE_PHYS                                  0x081fffff

/*----------------------------------------------------------------------------
 * BASE: GMEM
 *--------------------------------------------------------------------------*/

#define GMEM_BASE                                                   0x08400000
#define GMEM_BASE_SIZE                                              0x00001000
#define GMEM_BASE_PHYS                                              0x08400000

/*----------------------------------------------------------------------------
 * BASE: GMEM_END
 *--------------------------------------------------------------------------*/

#define GMEM_END_BASE                                               0x0841ffff
#define GMEM_END_BASE_SIZE                                          0x00000000
#define GMEM_END_BASE_PHYS                                          0x0841ffff
...
#define SNOC_2_BUS_TIMEOUT_BASE                                     0x08800000
#define SNOC_2_BUS_TIMEOUT_BASE_SIZE                                0x00001000
#define SNOC_2_BUS_TIMEOUT_BASE_PHYS                                0x08800000
...
#define PRONTO_CMEM_END_BASE                                        0x0a288000
#define PRONTO_CMEM_END_BASE_SIZE                                   0x00000000
#define PRONTO_CMEM_END_BASE_PHYS                                   0x0a288000
...
#define A53SS_BASE_SIZE                                             0x00100000
...
#define EBI1_MEM_RPM_REGION0_BASE                                   0xa0000000
#define EBI1_MEM_RPM_REGION0_BASE_SIZE                              0x00000000
#define EBI1_MEM_RPM_REGION0_BASE_PHYS                              0xa0000000

/*----------------------------------------------------------------------------
 * BASE: EBI1_MEM_RPM_REGION0_END
 *--------------------------------------------------------------------------*/

#define EBI1_MEM_RPM_REGION0_END_BASE                               0xdfffffff
#define EBI1_MEM_RPM_REGION0_END_BASE_SIZE                          0x00000000
#define EBI1_MEM_RPM_REGION0_END_BASE_PHYS                          0xdfffffff

/*----------------------------------------------------------------------------
 * BASE: EBI1_MEM_RPM_REGION1
 *--------------------------------------------------------------------------*/

#define EBI1_MEM_RPM_REGION1_BASE                                   0xe0100000
#define EBI1_MEM_RPM_REGION1_BASE_SIZE                              0x00000000
#define EBI1_MEM_RPM_REGION1_BASE_PHYS                              0xe0100000
...
#define EBI1_MEM_RPM_REGION1_END_BASE                               0xffffffff
#define EBI1_MEM_RPM_REGION1_END_BASE_SIZE                          0x00000000
#define EBI1_MEM_RPM_REGION1_END_BASE_PHYS                          0xffffffff
