...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/api/mproc/smem.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
06/05/13   rv      Public API is added to retrieve SMEM base and size.
...
/*===========================================================================
FUNCTION      smem_tz_set_partitions
===========================================================================*/
/**
...
*/
/*=========================================================================*/
void smem_tz_set_partitions(void);

/*===========================================================================
FUNCTION      smem_tz_get_smem_info
===========================================================================*/
/**
  Requests the shared memory base address and size. 
  This function is available only in TZ.

  @param[out] smem_base_addr   Base address of shared memory.
  @param[out] smem_size        Size of shared memory.
