 ...
 ***********************************************************************/
 ...
 /*===========================================================================
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/api/storage/fs_lib.h#1 $ $DateTime: 2016/06/17 14:31:11 $ $Author: pwbldsvc $
 ...
 *  possibly more efficiently than regular files. This function differs
 *  slightly from efs_raw_put () in that files larger than FS_ITEM_MAX can
 *  also be placed into the filesystem. This function will determine the type
 ...
 *  then this function will store this data on a regular file.  'efs_put' can
 *  also automatically create needed parent directories, if O_AUTODIR is set.
 *
 * @param path
