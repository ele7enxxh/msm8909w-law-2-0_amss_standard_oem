 ...
 ***********************************************************************/
 ...
 /*===========================================================================
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/api/storage/fs_sys_types.h#1 $ $DateTime: 2016/06/17 14:31:11 $ $Author: pwbldsvc $
...
enum fs_filename_rule
{
  ...
  /* In this rule all characters are allowed except these characters in the box
     [/?*] and the '\0' is used to mark the end of the string. Please consult
     with Intel to get the FDI filesystem-spec for more information. */
