 ...
 *
 *  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/api/storage/fs_estdio.h#1 $ $DateTime: 2016/06/17 14:31:11 $ $Author: pwbldsvc $
 *
 ...
 * value of ::FS_MAX_TRANSACTION can be used instead. The maximum size of
 * the buffer is 2^32 = 4GBytes.
 *
