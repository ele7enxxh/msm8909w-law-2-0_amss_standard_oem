...
/*===========================================================================
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/api/storage/fs_hotplug.h#1 $ $DateTime: 2016/06/17 14:31:11 $ $Author: pwbldsvc $
...
/**
 * Iterate devices, hard-partitons, soft-partitions or FAT-partitons.
 */
