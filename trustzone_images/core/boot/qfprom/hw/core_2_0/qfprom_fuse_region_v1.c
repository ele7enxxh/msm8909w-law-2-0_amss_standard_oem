...
DESCRIPTION
 ...
 qfprom values for sec ctrl 3.0 (used by 8974/9x25).
...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/boot/qfprom/hw/core_2_0/qfprom_fuse_region_v1.c#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
03/05/13   dh      Add QFPROM_SEC_KEY_DERIVATION_KEY_REGION. update certain region's
                   read write permission fuse to corrected region instead of raw
11/09/12   dh      Remove regions that shouldn't be accessed by qfprom driver
...
const QFPROM_REGION_INFO qfprom_region_data[] =
{
    ...
    {
        QFPROM_SPARE27_REGION,
        2,
        QFPROM_FEC_NONE,
        HWIO_QFPROM_RAW_SPARE_REG27_ROW0_LSB_ADDR,
        HWIO_QFPROM_CORR_SPARE_REG27_ROW0_LSB_ADDR,
        HWIO_QFPROM_CORR_RD_WR_PERM_LSB_SPARE27_BMSK,
        HWIO_QFPROM_CORR_RD_WR_PERM_MSB_SPARE27_BMSK,
        QFPROM_ROW_LSB,
        TRUE,
        27
    },
    ...
    {
        QFPROM_CUST_PRIV_KEY0_REGION, 
        37,
        QFPROM_FEC_63_56,
        HWIO_QFPROM_RAW_CUST_PRIV_KEY0_ROWn_LSB_ADDR(0),
        HWIO_QFPROM_CORR_CUST_PRIV_KEY0_ROWn_LSB_ADDR(0),
        HWIO_QFPROM_CORR_RD_WR_PERM_LSB_CUST_PRIV_KEY0_BMSK,
        HWIO_QFPROM_CORR_RD_WR_PERM_MSB_CUST_PRIV_KEY0_BMSK,
        QFPROM_ROW_LSB,
        FALSE,
        30
    },
    {
        QFPROM_CUST_PRIV_KEY1_REGION, 
        37,
        QFPROM_FEC_63_56,
        HWIO_QFPROM_RAW_CUST_PRIV_KEY1_ROWn_LSB_ADDR(0),
        HWIO_QFPROM_CORR_CUST_PRIV_KEY1_ROWn_LSB_ADDR(0),
        HWIO_QFPROM_CORR_RD_WR_PERM_LSB_CUST_PRIV_KEY1_BMSK,
        HWIO_QFPROM_CORR_RD_WR_PERM_MSB_CUST_PRIV_KEY1_BMSK,
        QFPROM_ROW_LSB,
        TRUE,
        31
    },
