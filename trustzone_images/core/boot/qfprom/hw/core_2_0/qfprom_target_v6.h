...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/boot/qfprom/hw/core_2_0/qfprom_target_v6.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/21/14   ck      Fix blow timer to proper 8916 28nm LP value.
...
/* Blow timer clock frequency in Mhz.  Even though clock is really 2.4MHz
   using 2.5 takes care of the rounding up that is needed with 2.4 */
#define QFPROM_BLOW_TIMER_CLK_FREQ_MHZ 2.5
...
#else
  #define QFPROM_SANDBOX_RELOCATE_OFFSET			 (0x00000000)
#endif
