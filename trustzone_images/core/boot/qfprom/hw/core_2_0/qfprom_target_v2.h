...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/boot/qfprom/hw/core_2_0/qfprom_target_v2.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
07/04/13   lm      Define macro for read/write permission for corrected address
06/07/13   jz      Define 28nm LP QFPROM technology specific ACCEL value
...
* Configure QFPROM_ACCEL[QFPROM_ACCEL] SW field to a value of 0x00.
...
#define QFPROM_RAW_HIGHEST_ADDRESS_OFFSET          (0x000005FC )
