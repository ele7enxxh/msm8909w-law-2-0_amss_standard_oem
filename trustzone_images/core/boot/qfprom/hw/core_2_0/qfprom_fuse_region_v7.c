...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/boot/qfprom/hw/core_2_0/qfprom_fuse_region_v7.c#1 $
...
const QFPROM_REGION_INFO qfprom_region_data[] =
{
...

  {
    ...
    1,
    QFPROM_FEC_62_56,
    HWIO_QFPROM_RAW_CALIB_ROW4_LSB_ADDR,
    HWIO_QFPROM_CORR_CALIB_ROW4_LSB_ADDR,
    HWIO_QFPROM_CORR_RD_WR_PERM_LSB_CALIB_NEW_BMSK,
    HWIO_QFPROM_CORR_RD_WR_PERM_MSB_CALIB_NEW_BMSK,
    QFPROM_ROW_LSB,
    TRUE,
    16
  },
