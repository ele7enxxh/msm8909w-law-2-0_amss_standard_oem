...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/kernel/smmu/smmu500/8916/tz/SMMUClock.c#1 $
...
#define SMMU_8916_BRINGUP

#ifdef SMMU_8916_BRINGUP
#include "tzbsp_sys.h"
#include <HALhwio.h>
