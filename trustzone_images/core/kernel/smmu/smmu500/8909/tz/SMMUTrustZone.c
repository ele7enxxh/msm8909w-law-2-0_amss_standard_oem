...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/kernel/smmu/smmu500/8909/tz/SMMUTrustZone.c#1 $
...
#define SMMU_CB_MAX_ISR_CTX 7 // APPS: 6 + GPU: 1
...
)
{
  ...
  case SMMU_HAL_SID2VMID_SMR0_PERIPH:
    ...
    break;
  case SMMU_HAL_SID2VMID_SMR0_QDSP:         //change here
    {
      // layout of the SMMU_SID2VMID_*_SMR_n register
      // SID_MATCH : 2
      // SID_MASK : 3
      ...
      // VALID : 1
      // reserved : 20
      sSSRegShftInfo->uSIDMaskShft = 3;
      sSSRegShftInfo->uVMIDShft = 6;;
      sSSRegShftInfo->uValidShft = 11;
    }
	break;
