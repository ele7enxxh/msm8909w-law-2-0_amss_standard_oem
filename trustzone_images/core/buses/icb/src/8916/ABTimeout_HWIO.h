...
/**
  ...
  'Include' filters applied: BASE[PCNOC_4_BUS_TIMEOUT] BASE[PCNOC_5_BUS_TIMEOUT] BASE[PCNOC_6_BUS_TIMEOUT] BASE[PCNOC_1_BUS_TIMEOUT] BASE[PCNOC_2_BUS_TIMEOUT] BASE[SNOC_2_BUS_TIMEOUT] BASE[PCNOC_7_BUS_TIMEOUT] BASE[PCNOC_9_BUS_TIMEOUT] BASE[PCNOC_0_BUS_TIMEOUT] BASE[SNOC_0_BUS_TIMEOUT] BASE[PCNOC_8_BUS_TIMEOUT] TIMEOUT_INTR[TCSR_TCSR_REGS] BASE[PCNOC_3_BUS_TIMEOUT] BASE[LPASS_AHBI_TIME] 
...
/*
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/buses/icb/src/8916/ABTimeout_HWIO.h#1 $
...
#define HWIO_TCSR_TIMEOUT_INTR_STATUS_BUS_TIMEOUT_SNOC_S2_IRQ_BMSK                                                             0x4000
#define HWIO_TCSR_TIMEOUT_INTR_STATUS_BUS_TIMEOUT_SNOC_S2_IRQ_SHFT                                                                0xe
