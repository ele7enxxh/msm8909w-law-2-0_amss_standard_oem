...
$Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/buses/icb/src/8916/ABT_data.c#1 $ 
...
#define ABT_SNOC_2_BASE_ADDR    SNOC_2_BUS_TIMEOUT_REG_BASE
...
#define ABT_PCNOC_8_BMSK   HWIO_TCSR_TIMEOUT_INTR_STATUS_BUS_TIMEOUT_PCNOC_S8_IRQ_SHFT
#define ABT_PCNOC_9_BMSK   HWIO_TCSR_TIMEOUT_INTR_STATUS_BUS_TIMEOUT_PCNOC_S9_IRQ_SHFT
#define ABT_SNOC_0_BMSK    HWIO_TCSR_TIMEOUT_INTR_STATUS_BUS_TIMEOUT_SNOC_S0_IRQ_SHFT
#define ABT_SNOC_2_BMSK    HWIO_TCSR_TIMEOUT_INTR_STATUS_BUS_TIMEOUT_SNOC_S2_IRQ_SHFT
...
#define ABT_SNOC_2_CLK     NULL //"gcc_snoc_bus_timeout2_ahb_clk" 
...
//ABT_SLAVE_INFO(  name, sl_en, int_en, to_val)
  ...
  ABT_SLAVE_INFO(PCNOC_8,    TRUE,   TRUE,   0xFF),
  ABT_SLAVE_INFO(PCNOC_9,    TRUE,   TRUE,   0xFF),
  ABT_SLAVE_INFO(SNOC_0,     TRUE,   TRUE,   0xFF),
  ABT_SLAVE_INFO(SNOC_2,     TRUE,   TRUE,   0xFF),
};
