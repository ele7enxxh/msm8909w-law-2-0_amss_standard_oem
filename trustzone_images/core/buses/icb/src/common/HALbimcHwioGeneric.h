...
/*
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/buses/icb/src/common/HALbimcHwioGeneric.h#1 $
...
#define BIMC_MISC_DDR_CHn_CLK_PERIOD_ADDR(b,n)                             (BIMC_MISC_REG_BASE(b) + 0x00000028 + 0x4 * (n))
#define BIMC_MISC_DDR_CHn_CLK_PERIOD_RMSK                                     0x1001ffff
#define BIMC_MISC_DDR_CHn_CLK_PERIOD_MAXn                                              1
#define BIMC_MISC_DDR_CHn_CLK_PERIOD_INI(b,n)        \
        in_dword_masked(BIMC_MISC_DDR_CHn_CLK_PERIOD_ADDR(b,n), BIMC_MISC_DDR_CHn_CLK_PERIOD_RMSK)
#define BIMC_MISC_DDR_CHn_CLK_PERIOD_INMI(b,n,mask)    \
        in_dword_masked(BIMC_MISC_DDR_CHn_CLK_PERIOD_ADDR(b,n), mask)
#define BIMC_MISC_DDR_CHn_CLK_PERIOD_OUTI(b,n,val)    \
        out_dword(BIMC_MISC_DDR_CHn_CLK_PERIOD_ADDR(b,n),val)
#define BIMC_MISC_DDR_CHn_CLK_PERIOD_OUTMI(b,n,mask,val) \
        out_dword_masked_ns(BIMC_MISC_DDR_CHn_CLK_PERIOD_ADDR(b,n),mask,val,BIMC_MISC_DDR_CHn_CLK_PERIOD_INI(b,n))
#define BIMC_MISC_DDR_CHn_CLK_PERIOD_CLK_PERIOD_RESOLUTION_BMSK               0x10000000
#define BIMC_MISC_DDR_CHn_CLK_PERIOD_CLK_PERIOD_RESOLUTION_SHFT                     0x1c
#define BIMC_MISC_DDR_CHn_CLK_PERIOD_PERIOD_BMSK                                 0x1ffff
#define BIMC_MISC_DDR_CHn_CLK_PERIOD_PERIOD_SHFT                                     0x0
