...
/* SSE extension */
#define CKN_KEYPAD_EVENT                         8
#define CKN_SK_INPUT_FAILED                      9
#define CKN_SK_LOGIN_STARTED                    10
#define CKN_SK_LOGIN_DONE                       11
#define CKN_SK_INITTOKEN_STARTED                12
#define CKN_SK_INITTOKEN_VERIFICATION_STARTED   13
#define CKN_SK_INITTOKEN_DONE                   14
#define CKN_SK_SETPIN_STARTED                   15
#define CKN_SK_SETPIN_NEWPIN_STARTED            16
#define CKN_SK_SETPIN_VERIFICATION_STARTED      17
#define CKN_SK_SETPIN_DONE                      18
#define CKN_SK_INITPIN_STARTED                  19
#define CKN_SK_INITPIN_VERIFICATION_STARTED     20
#define CKN_SK_INITPIN_DONE                     21
#define CKN_SK_GENKEY_STARTED                   22
#define CKN_SK_GENKEY_VERIFICATION_STARTED      23
#define CKN_SK_GENKEY_DONE                      24



#define CKN_SK_VERIFICATION_DONE 11
...
/* SSE extension: generate a generic secret key using the secure keypad */
#define CKM_GENERIC_SECRET_KEY_GEN_KEYPAD     (CKM_VENDOR_DEFINED+0x00000001)
/* SSE extension: password based key generation using a generic secret key */
#define CKM_PBE_GENERIC_SECRET_KEY_MD5_DES_CBC  (CKM_VENDOR_DEFINED+0x00000008)
#define CKM_PBE_GENERIC_SECRET_KEY_SHA1_RC4_128 (CKM_VENDOR_DEFINED+0x00000009)
#define CKM_PBE_GENERIC_SECRET_KEY_SHA1_RC4_40  (CKM_VENDOR_DEFINED+0x0000000A)
#define CKM_PBE_GENERIC_SECRET_KEY_SHA1_DES3_EDE_CBC    (CKM_VENDOR_DEFINED+0x0000000B)
#define CKM_PKCS5_PBKD2_GENERIC_SECRET_KEY      (CKM_VENDOR_DEFINED+0x0000000C)
#define CKM_PBA_GENERIC_SECRET_KEY_SHA1_WITH_SHA1_HMAC  (CKM_VENDOR_DEFINED+0x0000000D)
/* SSE extension: wrapping and unwrapping to/from secure objects */
#define CKM_SO_KEY_WRAP               (CKM_VENDOR_DEFINED+0x0000000E)
...
/* SSE extension */
typedef CK_CALLBACK_FUNCTION(CK_RV, CK_SLOT_NOTIFY)(
  CK_SLOT_ID        slotID,     /* the slot ID */
  CK_NOTIFICATION   event,
  CK_VOID_PTR       pApplication  /* passed to C_Initialize */
);
...
typedef struct CK_PBE_KEYPAD_PARAMS {
  CK_BYTE_PTR      pInitVector;
  ...
  CK_ULONG         ulSaltLen;
  CK_ULONG         ulIteration;
} CK_PBE_KEYPAD_PARAMS;

typedef CK_PBE_KEYPAD_PARAMS CK_PTR CK_PBE_KEYPAD_PARAMS_PTR;

typedef struct CK_PBE_GENERIC_SECRET_KEY_PARAMS {
  CK_BYTE_PTR      pInitVector;
  CK_OBJECT_HANDLE hGenericSecretKey;
  CK_BYTE_PTR      pSalt;
  CK_ULONG         ulSaltLen;
  CK_ULONG         ulIteration;
} CK_PBE_GENERIC_SECRET_KEY_PARAMS;

typedef CK_PBE_GENERIC_SECRET_KEY_PARAMS CK_PTR CK_PBE_GENERIC_SECRET_KEY_PARAMS_PTR;

/* CK_SO_KEY_WRAP_PARAMS provides the parameters to the
 * CKM_SO_KEY_WRAP mechanism */
/* CK_SO_KEY_WRAP_PARAMS is an SSE extension */
typedef struct CK_SO_KEY_WRAP_PARAMS {
  CK_CHAR_PTR   soId;     /* string identifier for the SO to unwrap */
  CK_ULONG      soIdLen;  /* length of the SO identifier */
} CK_SO_KEY_WRAP_PARAMS;

typedef CK_SO_KEY_WRAP_PARAMS CK_PTR \
    CK_SO_KEY_WRAP_PARAMS_PTR;

/* CK_WRAPKEY_AES_CBC_PARAMS provides the parameters to the
 * CKM_WRAPKEY_AES_CBC mechanism */
/* CK_WRAPKEY_AES_CBC_PARAMS is an SSE extension */
typedef struct CK_WRAPKEY_AES_CBC_PAD_PARAMS {
  CK_BYTE  iv[16];            /**< IV */
  CK_ULONG flags;                 /**< Attributes specified as flags */
  CK_BYTE  mac[32];               /**< SHA256 HMAC of (Key+flags+wrapping_key) with KMac*/
  CK_BYTE  eKmac[48];             /**< KMac encrypted with wrapping_key*/
...
/* The following is an SSE extension */
...
typedef struct CK_PKCS5_PBKD2_GENERIC_SECRET_KEY_PARAMS {
        CK_PKCS5_PBKDF2_SALT_SOURCE_TYPE           saltSource;
        CK_VOID_PTR                                pSaltSourceData;
        CK_ULONG                                   ulSaltSourceDataLen;
        CK_ULONG                                   iterations;
        ...
        CK_ULONG                                   ulPrfDataLen;
        CK_OBJECT_HANDLE                           hGenericSecretKey;
} CK_PKCS5_PBKD2_GENERIC_SECRET_KEY_PARAMS;

typedef CK_PKCS5_PBKD2_GENERIC_SECRET_KEY_PARAMS CK_PTR CK_PKCS5_PBKD2_GENERIC_SECRET_KEY_PARAMS_PTR;
