#line 1 "/local/mnt/workspace/CRMBuilds/TZ.BF.2.5.c10-00004-M8909AAAAANAZT-2_20161130_222454/b/trustzone_images/core/securemsm/trustzone/monitor/common/src/tzbsp_qdss.s"
;*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
;
...
#line 34 "/local/mnt/workspace/CRMBuilds/TZ.BF.2.5.c10-00004-M8909AAAAANAZT-2_20161130_222454/b/trustzone_images/core/securemsm/trustzone/monitor/common/src/tzbsp_qdss.s"
...
#line 620 "/local/mnt/workspace/CRMBuilds/TZ.BF.2.5.c10-00004-M8909AAAAANAZT-2_20161130_222454/b/trustzone_images/core/securemsm/trustzone/monitor/common/src/tzbsp_qdss.s"
...
; Reads a given register where the address is in a register
  ...
  ReadRegisterR $addr_r, $val_r, $work_r
    ...
    movw    $work_r, #(0x02000000 & 0xFFFF)
    movt    $work_r, #((0x02000000 >> 16) & 0xFFFF)
    cmp     $addr_r, $work_r        ; compare address to remap area
    mov     $work_r, #0
    bhs     %f10                    ; addr >= remap, no need to offset
    movw    $work_r, #(0x04800000 & 0xFFFF)
    movt    $work_r, #((0x04800000 >> 16) & 0xFFFF)
...
restore_debug
    ...
    ; lock
    mov     r2, #(70 * 4) ; r2 = sizeof debug regs for 1 krait
    ...
    mrc     p15, 0, r1, c0, c0, 5   ; Current MPIDR
    and     r1, r1, #0xFF           ; r1 = cpu_num
    mov     r2, #(54 * 4) ; r2 = sizeof trace regs for 1 krait
...
CPU3_DBGWVR15        DCD 0
CPU3_DBGWCR15        DCD 0
#line 2171 "/local/mnt/workspace/CRMBuilds/TZ.BF.2.5.c10-00004-M8909AAAAANAZT-2_20161130_222454/b/trustzone_images/core/securemsm/trustzone/monitor/common/src/tzbsp_qdss.s"
    END
