...
/*===========================================================================
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/securemsm/trustzone/qsee/arch/msm8909w/cfg/mmu/default_tt_map.h#3 $
...
mem_block_type default_memory_map[] =
{
  ...
  { TZBSP_EXT_ELF_TT_BASE, TZBSP_EXT_ELF_TT_BASE, TZBSP_L1_TT_SIZE>>10,
   (TZ_READ_WRITE_PL1 | TZ_MEM_NON_CACHEABLE | TZ_NON_EXECUTABLE) },
#endif
