...
/**
@file tzbsp_i2c.h
@brief Provides API for I2C functionality
*/
...
/*===========================================================================
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/securemsm/trustzone/qsee/include/tzbsp_i2c.h#1 $
  $DateTime: 2016/06/17 14:31:11 $
  $Author: pwbldsvc $

when       who      what, where, why
--------   ---      ------------------------------------
11/10/12   th       Initial version.
...
typedef enum
{
  ...
  TZBSP_I2CPD_DEVICE_COUNT
  /**< Used to check the bounds of this enumeration. */

} tzbsp_i2cpd_device_id_t;
...
typedef enum
{
  ...
  PLACEHOLDER_tzbsp_i2c_interface = 0x7fffffff

} tzbsp_i2c_interface_t;
...
typedef enum
{
  ...
  /* Force enum to 32 bit */
  PLACEHOLDER_tzbsp_i2c_slaveaddr_options = 0x7fffffff

} tzbsp_i2c_slaveaddr_options_t;
...
typedef enum
{
  ...
  */
  ...
  /* Force enum to 32 bit */
  PLACEHOLDER_tzbsp_i2c_slave_device = 0x7fffffff

} tzbsp_i2c_slave_device_t;
...
typedef enum
{
  ...
  /* Force enum to 32 bit */
  PLACEHOLDER_tzbsp_i2c_read_options = 0x7fffffff

} tzbsp_i2c_read_options_t;
...
typedef struct
{
  ...
  tzbsp_i2c_slaveaddr_options_t slave_address_option;
  /**< I2C slave device address options. */

  tzbsp_i2c_slave_device_t      slave_device_type;
  /**< I2C slave device type. */

  tzbsp_i2c_read_options_t      read_option;
