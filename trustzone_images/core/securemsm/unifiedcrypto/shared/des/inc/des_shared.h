...
/*===========================================================================
  ...
  $Header: //components/rel/tz.bf/2.5.c10/trustzone_images/core/securemsm/unifiedcrypto/shared/des/inc/des_shared.h#1 $
...
typedef __packed union
{
  ...
  /* DES info - needs to be same size as 3DES */
   __packed struct __des_cipher_s
  {
    __packed struct __des_cipher_enc_s
    {
    ...
    __packed struct __des_cipher_dec_s
   {
     uint8     iv[SW_DES_BLOCK_BYTE_LEN];
     uint8     key[SW_3DES_KEY_BYTE_LEN];
     uint8     subkey[16][SW_DES_BLOCK_BYTE_LEN];
  ...
  /* 3DES info */
  __packed struct __des3_cipher_s  
  {
    __packed  struct __des3_cipher_enc_s
    {
      uint8  iv[SW_DES_BLOCK_BYTE_LEN];
      uint8  key[SW_3DES_KEY_BYTE_LEN];
    ...
    __packed struct __des3_cipher_dec_s
   {
      uint8  iv[SW_DES_BLOCK_BYTE_LEN];
      uint8  key[SW_3DES_KEY_BYTE_LEN];
      uint8  subkey[3][16][SW_DES_BLOCK_BYTE_LEN];
