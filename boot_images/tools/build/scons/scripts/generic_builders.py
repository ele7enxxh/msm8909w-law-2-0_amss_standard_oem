...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/tools/build/scons/scripts/generic_builders.py#1 $
...
def list_file_create(env, list_fname, file_list, add_header=False, rel_path_target=None, posix=False, sort=False):
   banner = ""  
