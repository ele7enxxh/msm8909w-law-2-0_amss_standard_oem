...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/tools/build/scons/scripts/hexagon.py#1 $
...
def generate(env):
   ...
   env.Replace(LINKOBJGRP = "--undefined=main ${QDSP6OBJS1} " \
      "--start-group $_LIBFLAGS_POSIX $SOURCES.posix $_LISTFILES --end-group " \
