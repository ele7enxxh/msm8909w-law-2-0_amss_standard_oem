...
from sectools.common.parsegen import aost_lic
...
class SecParseGenAOSTLic(SecParseGenBase):
    ...
    def __init__(self, data, imageinfo=None, aost_lic_properties=None,
        ...
        self._aost_lic_parsegen = aost_lic.ParseGenAOSTLic(data,
                                                           self.debug_dir,
                                                           self.debug_prefix,
                                                           self.debug_suffix)
    ...
    def data_to_sign(self):
        ...
        return self._aost_lic_parsegen.header.pack() + self._aost_lic_parsegen.metadata
