...
class secimage(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, metadata=None, general_properties=None, parsegen=None, signing=None, encryption=None, post_process=None, images_list=None, data_provisioning=None):
...
class complex_elf_properties(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, has_hash_table=None, image_type=None):
...
class complex_default_attributes(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, msm_part=None, oem_id=None, model_id=None, sw_id=None, app_id=None, crash_dump=None, rot_en=None, debug=None, exponent=None, object_id=None):
