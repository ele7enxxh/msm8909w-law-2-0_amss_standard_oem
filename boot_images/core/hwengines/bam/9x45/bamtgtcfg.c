/**
  ...
  target specific configuration data to the BAM driver.
...
===============================================================================
 ...
 $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/hwengines/bam/9x45/bamtgtcfg.c#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
09/16/14   SS      Removed scons inclusion of bam cfg file.
...
*/
const bam_target_config_type* bam_tgt_getcfg(bam_paddr bam_pa)
{
	uint32 index = 0;
...
*/
uint32 bam_tgt_getpipelockgroup(bam_paddr bam_pa, uint32 pipe_num)
{
    (void)bam_pa;
    (void)pipe_num;
    return 0;
...
*/
bam_paddr bam_tgt_getpipememstartaddr(void)
{
    return 0;
}
...
*/
bam_paddr bam_tgt_getpipememendaddr(void)
{
    return 0;
}
