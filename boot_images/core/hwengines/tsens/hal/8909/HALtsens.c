/*============================================================================
  ...
  OVERVIEW:     Implementation of the TSENS HAL for 8909.
...
/*============================================================================
  ...
  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/hwengines/tsens/hal/8909/HALtsens.c#1 $$DateTime: 2015/09/01 00:30:35 $$Author: pwbldsvc $

  when        who  what, where, why
  ----------  ---  -----------------------------------------------------------
  2014-08-04  SA   Update for 8909.
...
{
   return (HAL_tsens_Calibration) HWIO_INF(QFPROM_CORR_CALIB_ROW1_MSB, TSENS_CALIB);
}
...
{
   return ((HWIO_INF(QFPROM_CORR_CALIB_ROW1_MSB, TSENS_BASE0) << 2) & 0x3FC);/* since TSENS_BASE0 is 8 Bits*/
}
...
{
   return ((HWIO_INF(QFPROM_CORR_CALIB_ROW1_MSB, TSENS_BASE1) << 2) & 0x3FC); /* since TSENS_BASE1 is 8 Bits*/
}
...
uint32 HAL_tsens_GetPointX1(boolean bUseRedundant, uint32 uSensor)
{
   if (bUseRedundant == FALSE)
   {
      ...
      {
         case 0:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_LSB, TSENS0_POINT1) << 2) & 0xFC);/*offset is 6 bit value*/
         case 1:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_LSB, TSENS1_POINT1) << 2) & 0xFC);
         case 2:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_LSB, TSENS2_POINT1) << 2) & 0xFC);
         case 3:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_MSB, TSENS3_POINT1) << 2) & 0xFC);
         case 4:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_MSB, TSENS4_POINT1) << 2) & 0xFC);
         default:
            break;
      }
   }
...
uint32 HAL_tsens_GetPointX2(boolean bUseRedundant, uint32 uSensor)
{
   if (bUseRedundant == FALSE)
   {
      ...
      {
         case 0:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_LSB, TSENS0_POINT2) << 2) & 0xFC); /*offset is 6 bit value*/ 
         case 1:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_LSB, TSENS1_POINT2) << 2) & 0xFC);
         case 2:
            return ((((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_MSB, TSENS2_POINT2_BIT_2_5) << 2) | (HWIO_INF(QFPROM_CORR_CALIB2_ROW0_LSB, TSENS2_POINT2_BIT_0_1))) << 2) & 0xFC);
         case 3:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_MSB, TSENS3_POINT2) << 2) & 0xFC);
         case 4:
            return ((HWIO_INF(QFPROM_CORR_CALIB2_ROW0_MSB, TSENS4_POINT2) << 2) & 0xFC);
         default:          
            break;
      }
   }
