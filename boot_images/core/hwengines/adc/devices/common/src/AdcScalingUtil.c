...
/*============================================================================
  ...
  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/hwengines/adc/devices/common/src/AdcScalingUtil.c#1 $$DateTime: 2015/09/01 00:30:35 $$Author: pwbldsvc $
