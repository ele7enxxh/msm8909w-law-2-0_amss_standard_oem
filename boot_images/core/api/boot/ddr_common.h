...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/api/boot/ddr_common.h#1 $ 
$DateTime: 2015/09/01 00:30:35 $
$Author: pwbldsvc $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
08/14/13   rj      For compatibility with device programmer which doesn't need 
                   ddr type
05/23/13   tw      changed base address type from uint32 to uint64
