...
============================================================================
                             Edit History
  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/api/systemdrivers/DDIChipInfo.h#2 $ 
...
DalChipInfo_GetChipIdString(DalDeviceHandle * _h,  void * szIdString,  uint32  nMaxLength)
{
   ...
   {
      DalRemoteHandle *hRemote = (DalRemoteHandle *)DALPREPREMOTEHANDLE(_h);
      return hRemote->pVtbl->FCN_9(DALVTBLIDX(((DalChipInfoHandle *)_h)->pVtbl, GetChipIdString ), _h, (void * )szIdString, nMaxLength);
   }
...
/**
  ...
  @param[in,out]  _h         Dal Device Handle given by the caller.
  @param[in,out]  peId  Pointer to a 
                             uint32 variable passed by the caller that
                             will be populated by the driver.
