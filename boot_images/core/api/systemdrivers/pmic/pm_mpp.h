...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/api/systemdrivers/pmic/pm_mpp.h#1 $
...
===========================================================================*/												 
extern pm_err_flag_type pm_mpp_enable(unsigned pmic_device_index, pm_mpp_perph_index mpp, boolean enable);
