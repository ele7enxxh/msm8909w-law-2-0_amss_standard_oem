...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/api/power/CoreVerify.h#1 $
============================================================================*/
#ifndef COREVERIFY_H
#define COREVERIFY_H
...
#elif defined(BUILD_BOOT_CHAIN) || defined(BUILD_TOOL_CHAIN)
#include "boot_error_if.h"
#define CORE_VERIFY(x) BL_VERIFY( (x), BL_ERR_CORE_VERIFY )
