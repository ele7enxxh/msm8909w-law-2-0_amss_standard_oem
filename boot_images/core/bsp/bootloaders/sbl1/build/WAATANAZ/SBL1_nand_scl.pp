...
#line 136 "./targwaatanaza.h"




#line 11 "./custwaatanaza.h"
...
CODE_ROM 0x08005800 0x0040000
{ 
  
  SBL1_ROM 0x08005800 ALIGN 0x8
  {
...
CODE_STACKS (0x08005800 + 0x0040000) (0x0002000 + 0x0002000 + 0x0002000)
{
  ...
  ScatterAssert((ImageLimit(SBL1_ABT_STACK) - (0x08005800 + 0x0040000))
  	         <= (0x0002000 + 0x0002000 + 0x0002000))
}

CODE_RAM ((0x08005800 + 0x0040000) + (0x0002000 + 0x0002000 + 0x0002000)) (0x007B000 - 0x0040000 - (0x0002000 + 0x0002000 + 0x0002000))
{
  ...
  ScatterAssert((ImageLimit(SBL1_LOG_BUF_SECTION) - 0x08005800)
                 < (448 * 1024))
}
