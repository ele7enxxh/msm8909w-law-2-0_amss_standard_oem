...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/securemsm/cryptodrivers/ce/chipset/build/msm8956.SConscript#1 $
...
# --------   ---     ---------------------------------------------------------
# 11/06/14   bs      Intial checkin
#===============================================================================
import os
Import('env')
env = env.Clone()

# 8956 interface redirection
CHIPSETREDIRECTION = 'msm8956'
...
if os.path.exists('../' + CHIPSETREDIRECTION + '/build/SConscript') :
   ...
   raise RuntimeError, "msm8956  [%s] does not exist"%script_sconfname
...
DEL_FILES = [
    ...
    '${BUILD_ROOT}/core/securemsm/cryptodrivers/ce/chipset/build/msm8956.SConscript',
    '${BUILD_ROOT}/core/securemsm/cryptodrivers/ce/chipset/build/mdm9x45.SConscript',
    '${BUILD_ROOT}/core/securemsm/cryptodrivers/ce/chipset/build/msm8909.SConscript',
    ...
    '${BUILD_ROOT}/core/securemsm/cryptodrivers/ce/chipset/msm8909/build/SConscript'
]
