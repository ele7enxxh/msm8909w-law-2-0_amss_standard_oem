...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/securemsm/cryptodrivers/prng/chipset/build/msm8956.SConscript#1 $
...
DEL_FILES = [
    ...
    '${BUILD_ROOT}/core/securemsm/cryptodrivers/prng/chipset/build/msm8956.SConscript',
    '${BUILD_ROOT}/core/securemsm/cryptodrivers/prng/chipset/build/mdm9x35.SConscript',
