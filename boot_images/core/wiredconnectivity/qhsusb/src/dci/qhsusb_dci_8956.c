...
// 
// $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/wiredconnectivity/qhsusb/src/dci/qhsusb_dci_8956.c#2 $$DateTime: 2016/03/11 02:15:02 $$Author: pwbldsvc $
// 
// when          who     what, where, why
// ----------   -----    ----------------------------------------------------------
// 2014-11-05   bs  Initial draft for MSM8956
// 
// ===========================================================================
...
#include "qhsusb_dci_8956_hw_apis.h"  // HW target specific access. 
...
uint32 dci_core_base_address[DCI_MAX_CORES] = {USB2_HS_USB_OTG_HS_BASE_REG_BASE};
