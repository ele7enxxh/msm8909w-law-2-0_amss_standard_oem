 ...
 * $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/buses/api/spmi/SpmiBus.h#1 $
 * $Change: 8935858 $ 
 * 
 *                              Edit History
 * Date     Description
 ...
 *                   set in this mask that weren't set when registering have no affect
 ...
 * @return  SPMI_SUCCESS on success, error code on error
 */
Spmi_Result SpmiBus_Command(uint32 slaveId,    
                            Spmi_AccessPriority priority,
                            Spmi_Command cmd);
