...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/buses/icb/src/9x35/icbcfg_data.c#1 $ 
...
----------  ---    -----------------------------------------------------------
2013/07/22  sds    Branched from 9x25
...
icbcfg_data_type icbcfg_boot_data[] = 
{
    ...
    /* Ordering enforced, 5 beats write gather for SYS0 master */
    MPORT_MODE(MASTER_SYS0, 0x50000011),
};
