...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/buses/icb/src/8x62/icbcfg_data.c#1 $ 
...
#define MASTER_GPU0  2
#define MASTER_MMSS0 3
#define MASTER_SYS0  4
