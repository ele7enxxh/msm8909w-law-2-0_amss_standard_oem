...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/buses/icb/src/9x45/icbcfg_data.c#1 $ 
...
----------  ---    -----------------------------------------------------------
2014/07/17  jc     Branched for 9x45
...
icbcfg_data_type icbcfg_boot_data[] = 
{
    ...
    MPORT_MODE(MASTER_APP,  0x2012),
    MPORT_MODE(MASTER_DSP,  0x2012),
    MPORT_MODE(MASTER_MCDMA,0x2012),
    MPORT_MODE(MASTER_SYS,  0x2012),
