...
/*
  ...
  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/buses/icb/src/8x26/icbcfg_hwio.h#1 $
...
/* ICBCFG HWIO File for 8x26 target (frodo_v1.0_p3q2r0) */
...
#define HWIO_MSS_MPLL2_MAIN_MODEM_CBCR_OFFS                               (MSS_PERPH_REG_BASE_OFFS + 0x000010e4)
