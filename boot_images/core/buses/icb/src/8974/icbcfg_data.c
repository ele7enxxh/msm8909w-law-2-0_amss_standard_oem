...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/buses/icb/src/8974/icbcfg_data.c#1 $ 
...
#define MASTER_APP1  1
#define MASTER_DSP0  2
#define MASTER_MMSS0 3
#define MASTER_MMSS1 4
#define MASTER_SYS0  5
#define MASTER_SYS1  6
...
icbcfg_data_type icbcfg_boot_data[] = 
{
    ...
    MPORT_MODE(MASTER_SYS0, 0xB0000011),
    /* Ordering enforced, 8 beats write gather for SYS1 master */
    MPORT_MODE(MASTER_SYS1, 0xB0000011),
};
