...
/*
  ...
  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/buses/icb/src/8974/icbcfg_hwio.h#1 $
...
#define HWIO_MSS_UIM0_MND_CMD_CFG_RCGR_OFFS                               (MSS_PERPH_REG_BASE_OFFS + 0x00001130)
...
#define HWIO_MSS_UIM1_MND_CMD_CFG_RCGR_OFFS                               (MSS_PERPH_REG_BASE_OFFS + 0x00001134)
