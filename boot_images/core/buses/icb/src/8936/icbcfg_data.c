...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/buses/icb/src/8936/icbcfg_data.c#1 $ 
...
icbcfg_data_type icbcfg_boot_data[] = 
{
    ...
    MPORT_RD_TRACKING_INDEX(MASTER_APP, 0xBA910),
    MPORT_WR_TRACKING_INDEX(MASTER_APP, 0xBA910),
