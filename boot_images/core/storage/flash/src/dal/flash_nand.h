 ...
 *
 * Copyright (c) 2008-2012 by QUALCOMM Technologies, Inc.
 * All Rights Reserved.
 ...
 * order.
 *
 * $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/storage/flash/src/dal/flash_nand.h#1 $ $DateTime: 2015/09/01 00:30:35 $ $Author: pwbldsvc $
 *
 *
 * when         who     what, where, why
 * ----------   ---     ----------------------------------------------
 * 10/25/12     sb      NAND info to share via SMEM
...
/* version of the NAND device info in SMEM region */
#define NAND_DEV_INFO_SMEM_VER    0x1
...
extern struct nand_dev_smem_info nand_dev_info;
...
int nand_onfi_probe(flash_client_ctxt *client_ctxt,
  struct flash_nand_params **, DALBOOL *);
