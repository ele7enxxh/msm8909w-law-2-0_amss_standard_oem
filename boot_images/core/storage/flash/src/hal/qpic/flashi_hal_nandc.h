 ...
 *   order.
 *
 *  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/storage/flash/src/hal/qpic/flashi_hal_nandc.h#1 $ $DateTime: 2015/09/01 00:30:35 $ $Author: pwbldsvc $
 *
 *
...
#define HAL_QPIC_NANDC_FLASH_XFR_STEP1_PADDR \
                                          HWIO_PHYS(FLASH_XFR_STEP1)
#define HAL_QPIC_NANDC_FLASH_XFR_STEP2_PADDR \
                                          HWIO_PHYS(FLASH_XFR_STEP2)
#define HAL_QPIC_NANDC_FLASH_XFR_STEP3_PADDR \
                                          HWIO_PHYS(FLASH_XFR_STEP3)
#define HAL_QPIC_NANDC_FLASH_XFR_STEP4_PADDR \
                                          HWIO_PHYS(FLASH_XFR_STEP4)
#define HAL_QPIC_NANDC_FLASH_XFR_STEP5_PADDR \
                                          HWIO_PHYS(FLASH_XFR_STEP5)
#define HAL_QPIC_NANDC_FLASH_XFR_STEP6_PADDR \
                                          HWIO_PHYS(FLASH_XFR_STEP6)
#define HAL_QPIC_NANDC_FLASH_XFR_STEP7_PADDR \
                                          HWIO_PHYS(FLASH_XFR_STEP7)
...
#define HAL_QPIC_NANDC_FLASH_XFR_STEP1_VADDR HWIO_FLASH_XFR_STEP1_ADDR
#define HAL_QPIC_NANDC_FLASH_XFR_STEP2_VADDR HWIO_FLASH_XFR_STEP2_ADDR
#define HAL_QPIC_NANDC_FLASH_XFR_STEP3_VADDR HWIO_FLASH_XFR_STEP3_ADDR
#define HAL_QPIC_NANDC_FLASH_XFR_STEP4_VADDR HWIO_FLASH_XFR_STEP4_ADDR
#define HAL_QPIC_NANDC_FLASH_XFR_STEP5_VADDR HWIO_FLASH_XFR_STEP5_ADDR
#define HAL_QPIC_NANDC_FLASH_XFR_STEP6_VADDR HWIO_FLASH_XFR_STEP6_ADDR
#define HAL_QPIC_NANDC_FLASH_XFR_STEP7_VADDR HWIO_FLASH_XFR_STEP7_ADDR
