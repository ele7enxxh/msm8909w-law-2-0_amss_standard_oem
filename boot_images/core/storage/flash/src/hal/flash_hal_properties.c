 ...
 *   order.
 *
 *  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/storage/flash/src/hal/flash_hal_properties.c#1 $ $DateTime: 2015/09/01 00:30:35 $ $Author: pwbldsvc $
 *
 *
...
struct flash_hal_properties flash_hal_prop_tbl = {NULL};
...
void flash_hal_set_property(enum flash_hal_property id, void *value)
{
  switch (id)
  {
    case FLASH_HAL_PROPERTY_USE_STD_MEMUTIL:
      flash_hal_prop_tbl.mem_cfg.memcpy_fptr = memcpy;
