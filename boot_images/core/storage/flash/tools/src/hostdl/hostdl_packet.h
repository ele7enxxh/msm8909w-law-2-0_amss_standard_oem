 ...
 *   order.
 *
 *   $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/storage/flash/tools/src/hostdl/hostdl_packet.h#1 $ $DateTime: 2015/09/01 00:30:35 $ $Author: pwbldsvc $
 *
 ...
 * 05/15/09     sv      Revert max data length to 1024
 * 05/07/09     sv      Hostdl Optimization - Increase max data length
