...
/*===========================================================================
  ...
  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/storage/efs/src/fs_pm.c#1 $ $DateTime: 2015/09/01 00:30:35 $ $Author: pwbldsvc $
...
fs_pm_space_limit (fs_pm_t gen_gc)
{
  ...
  if (FS_ISNOR (&gc->ptable->super))
  {
     ...
     * be occupied. */
    ASSERT (size >= get_nor_urgency_free_count (gc));
