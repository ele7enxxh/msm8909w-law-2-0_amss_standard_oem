;/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
;
;                      HALsdcc - Helper functions
;
; GENERAL DESCRIPTION
;   Function to optimize data transfer
;
;  Copyright (c) 2011
...
;
;$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/storage/sdcc/src/hal/HALsdcc_util.s#1 $
;
;when          who     what, where, why
;-----------   ---     -----------------------------------------------------
;2011-11-14    rh      Ported from JFLASH.
;===========================================================================*/
