...
----------------------------------------------------------------------
2015-01-27  sb      Updated for 8956
...
#include "sdcc_hwio_8956.h"
#include "HALsdhci.h"

/** Number of SD controllers present in the MSM */
#define HAL_SDCC_CONTROLLER_COUNT    3
...
HAL_sdcc_InitializeRegisters()
{
  ...
  sdcc_reg_base[SDCC_REG_SLOT_3] = SDC3_SDCC5_REG_BASE;
  sdcc_reg_phys[SDCC_REG_SLOT_3] = SDC3_SDCC5_REG_BASE_PHYS;
  ...
  sdhc_reg_base[SDCC_REG_SLOT_3] = SDC3_SDCC5_HC_REG_BASE;
  sdhc_reg_phys[SDCC_REG_SLOT_3] = SDC3_SDCC5_HC_REG_BASE_PHYS;
