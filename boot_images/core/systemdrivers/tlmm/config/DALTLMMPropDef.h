...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/systemdrivers/tlmm/config/DALTLMMPropDef.h#1 $
...
#define TLMM_PMIC_HDRV_CTL_CLK      20
#define TLMM_PMIC_HDRV_CTL_DATA     21

#define TLMM_NUM_PORTS              22
