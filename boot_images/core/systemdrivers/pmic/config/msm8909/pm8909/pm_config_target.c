...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/systemdrivers/pmic/config/msm8909/pm8909/pm_config_target.c#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
10/16/14   akt     Add the broadcast channel info 
09/29/14   mr      Updated/Modified PBS Driver (CR-728234)
08/22/14   akt     Updated the variable name (CR-713705)
07/18/14   akt     Removed S3,S4 and updated S2 for 8909 (CR-679803)
...
{   // pm_led_type,   pm_led_channel,          level 
    ...
    {PM_LED_KPD, PM_LED_CH_MPP4, PM_MPP__I_SINK__LEVEL_40mA},
...
//    {PM_LED_BLUE, PM_LED_CH_BLUE, PM_RGB_DIM_LEVEL_MID},
    {PM_LED_TYPE_INVALID, PM_LED_CH_INVALID, 0} // PM_LED_TYPE_INVALID indicates the termination of led_array
};
...
// NOTE: PM_LPG_CHAN_INVALID indicates the termination of this array if the array size < 3
...
const SpmiCfg_ChannelCfg  pm_spmi_periph_cfg_pm8909[] =
{
    ...
    {0x1, 0x19, 69 , PM_RPM_OWNER},         /* S2_FREQ        */
    {0x1, 0x18, 70 , PM_RPM_OWNER},         /* S2_PS          */
    {0x1, 0x17, 68 , PM_RPM_OWNER},         /* S2_CTRL        */
...
const uint32 pm_num_periph_pm8909 = sizeof(pm_spmi_periph_cfg_pm8909) / sizeof(SpmiCfg_ChannelCfg);
