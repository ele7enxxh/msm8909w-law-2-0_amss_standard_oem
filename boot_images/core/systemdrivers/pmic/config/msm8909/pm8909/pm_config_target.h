...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/systemdrivers/pmic/config/msm8909/pm8909/pm_config_target.h#1 $
...
#define NUM_OF_VIB_A            1
#define NUM_OF_SMBB_A           0
#define NUM_OF_LBC_A            1
#define NUM_OF_SMPS_A           2
#define NUM_OF_LDO_A            20
#define NUM_OF_PBS_CLIENT_A     16
#define NUM_OF_LPG_A            1
#define NUM_OF_VIB_A            1
#define NUM_OF_PWM_A            1
