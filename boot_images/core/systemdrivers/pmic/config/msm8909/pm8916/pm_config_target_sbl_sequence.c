...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/systemdrivers/pmic/config/msm8909/pm8916/pm_config_target_sbl_sequence.c#1 $ 
...
pm8916_pm_sbl_seq [ ] =
{
   ...
   { 0,	0x03,	0xC200,	0x041,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 13	   
   { 0,	0x11,	0xC200,	0x040,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 14	   
   { 0,	0x80,	0xC200,	0x046,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 15	   
   ...
   { 1,	0x10,	0x4600,	0x045,	PM_SBL_WRITE,	GREATER_OR_EQUAL,	REV_ID_COMMON},	// 10	   
   ...
   { 1,	0x44,	0x4200,	0x041,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 29	   
   { 1,	0xA5,	0x4200,	0x0D0,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 30	   
   { 1,	0x01,	0x4200,	0x0DA,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 31	   
   { 1,	0x80,	0x4100,	0x046,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 32	   
   { 1,	0x80,	0x4500,	0x046,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 33	   
   { 1,	0x80,	0x5000,	0x046,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 34	   
   ...
   { 1,	0x00,	0x1700,	0x06C,	PM_SBL_WRITE,	LESS_OR_EQUAL,	REV_ID_COMMON},	// 5	   
   ...
   //sid  data  base_addr  offset  reg_op  rev_id_op  rev_id
   { 1,	0x44,	0x1400,	0x041,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 1	   
   ...
   { 1,	0x80,	0x1400,	0x045,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 7	   
   { 1,	0x28,	0x1400,	0x05A,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 8	   
   { 1,	0x05,	0x1500,	0x072,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 9	   
   { 1,	0x00,	0x1400,	0x055,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 10	   
   { 1,	0x90,	0x1400,	0x062,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 11	   
   { 1,	0x84,	0x1400,	0x059,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 12	   
   { 1,	0x00,	0x1500,	0x079,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 13	   
   { 1,	0x01,	0x1400,	0x0DA,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 14	   
   
   // MODE - S2_HFS_CONFIG: 12
   //sid  data  base_addr  offset  reg_op  rev_id_op  rev_id
   { 1,	0x44,	0x1700,	0x041,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 1	   
   ...
   { 1,	0x80,	0x1700,	0x045,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 7	   
   { 1,	0x28,	0x1700,	0x05A,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 8	   
   { 1,	0x05,	0x1800,	0x072,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 9	   
   { 1,	0x00,	0x1700,	0x055,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 10	   
   { 1,	0x90,	0x1700,	0x062,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 11	   
   { 1,	0x84,	0x1700,	0x059,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 12	   
   { 1,	0x00,	0x1800,	0x079,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 13	   
   { 1,	0x01,	0x1700,	0x0DA,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 14	   
   
   // MODE - S3_HFS_CONFIG: 13
   //sid  data  base_addr  offset  reg_op  rev_id_op  rev_id
   { 1,	0x4E,	0x1A00,	0x041,	PM_SBL_WRITE,	GREATER_OR_EQUAL,	REV_ID_COMMON},	// 1	   
   { 1,	0x76,	0x1A00,	0x041,	PM_SBL_WRITE,	LESS_OR_EQUAL,	REV_ID_COMMON},	// 2	   
   ...
   { 1,	0x80,	0x1A00,	0x045,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 8	   
   { 1,	0x28,	0x1A00,	0x05A,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 9	   
   { 1,	0x05,	0x1B00,	0x072,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 10	   
   { 1,	0x00,	0x1A00,	0x055,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 11	   
   { 1,	0x90,	0x1A00,	0x062,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 12	   
   { 1,	0x84,	0x1A00,	0x059,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 13	   
   { 1,	0x01,	0x1B00,	0x079,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 14	   
   { 1,	0xA5,	0x1C00,	0x0D0,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 15	   
   { 1,	0x0B,	0x1C00,	0x050,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 16	   
   { 1,	0x05,	0x1A00,	0x0DA,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 17	   
   
   // MODE - S4_HFS_CONFIG: 14
   //sid  data  base_addr  offset  reg_op  rev_id_op  rev_id
   { 1,	0x14,	0x1D00,	0x041,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 1	   
   ...
   { 1,	0x80,	0x1D00,	0x045,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 7	   
   { 1,	0x28,	0x1D00,	0x05A,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 8	   
   { 1,	0x05,	0x1E00,	0x072,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 9	   
   { 1,	0x00,	0x1D00,	0x055,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 10	   
   { 1,	0x90,	0x1D00,	0x062,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 11	   
   { 1,	0x84,	0x1D00,	0x059,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 12	   
   { 1,	0x01,	0x1E00,	0x079,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 13	   
   { 1,	0x01,	0x1D00,	0x0DA,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 14	   
   ...
   { 0,	0,	0x999,	0x80,	PM_SBL_PBS_RAM,	EQUAL,	REV_ID_COMMON},	// 11	   PBS Version: PBS_RAM_MSM8909_2.PMIC.HW.PM8916_2p0_1_1_1  PBS RAM Size = 128
   ...
   { 0,	0x0D,	0x3400,	0x0DA,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 4	   
   ...
   // MODE - WATCHDOG_DIS: 23
   //sid  data  base_addr  offset  reg_op  rev_id_op  rev_id
   { 0,	0x02,	0x100,	0x0D0,	PM_SBL_WRITE,	EQUAL,	REV_ID_COMMON},	// 1	   
