...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/systemdrivers/pmic/config/msm8952/pm_config_target.c#1 $ 

when       who     what, where, why
--------   ---     ----------------------------------------------------------
01/30/14   rk      Integrate SBL PM8950-x.x-OTPx.x-MSM8952-01212015v1_b0_v009 and seperate channels for broadcast peripherals (CR - 789022)
11/27/14   rk      Initial XPU access config for PMIC Peripherals in TZ for SAHI (CR - 760818)
...
const SpmiCfg_ChannelCfg  pm_spmi_periph_cfg[] =
{
    ...
    {0xE, 0x08, 58,   PM_APPS_HLOS_OWNER},	 /* PON    */
    {0xE, 0x06, 169,  PM_RPM_OWNER},		 /* SPMI   */
    {0xE, 0x05, 170,  PM_RPM_OWNER},		 /* INT    */
    ...
    {0x2, 0x06, 167,  PM_RPM_OWNER},		 /* SPMI   */
    {0x2, 0x05, 166,  PM_RPM_OWNER},		 /* INT    */
    ...
    {0x0, 0xC7, 147,  PM_WCONNECT_OWNER},		 /* GPIO8		   */
    {0x0, 0xC6, 146,  PM_APPS_HLOS_OWNER},		 /* GPIO7		   */
    {0x0, 0xC5, 145,  PM_WCONNECT_OWNER},		 /* GPIO6		   */
    {0x0, 0xC4, 144,  PM_WCONNECT_OWNER},		 /* GPIO5		   */
    {0x0, 0xC3, 143,  PM_APPS_HLOS_OWNER},		 /* GPIO4		   */
    {0x0, 0xC2, 142,  PM_MSS_OWNER},		 /* GPIO3		   */
    {0x0, 0xC1, 141,  PM_MSS_OWNER},		 /* GPIO2		   */
    {0x0, 0xC0, 140,  PM_APPS_HLOS_OWNER},		 /* GPIO1		   */
    {0x0, 0xA3, 139,  PM_APPS_HLOS_OWNER},		 /* MPP4		  */
    {0x0, 0xA2, 138,  PM_APPS_HLOS_OWNER},		 /* MPP3		  */
    {0x0, 0xA1, 137,  PM_APPS_HLOS_OWNER},		 /* MPP2		  */
    {0x0, 0xA0, 136,  PM_RPM_OWNER},		 /* MPP1		  */
    {0x0, 0x78, 13,  PM_APPS_HLOS_OWNER}, 		/* PBS_CLIENT7			*/
    {0x0, 0x77, 12,  PM_APPS_HLOS_OWNER}, 		/* PBS_CLIENT6			*/
    {0x0, 0x76, 11,  PM_APPS_HLOS_OWNER}, 		/* PBS_CLIENT5			*/
    {0x0, 0x75, 75,  PM_RPM_OWNER},         /* PBS_CLIENT4          */
    {0x0, 0x74, 129,  PM_MSS_OWNER},         /* PBS_CLIENT3          */
    {0x0, 0x73, 10,  PM_APPS_HLOS_OWNER},         /* PBS_CLIENT2          */
    {0x0, 0x72, 9,  PM_APPS_HLOS_OWNER},         /* PBS_CLIENT1          */
    {0x0, 0x71, 74,  PM_RPM_OWNER}, 		/* PBS_CLIENT0			*/
    {0x0, 0x70, 73,  PM_RPM_OWNER}, 		/* PBS_CORE 		 */
    {0x0, 0x62, 72,  PM_APPS_HLOS_OWNER}, 		/* RTC_TIMER		  */
    {0x0, 0x61, 8,  PM_APPS_HLOS_OWNER}, 		/* RTC_ALARM		  */
    {0x0, 0x60, 128,  PM_MSS_OWNER}, 		/* RTC_RW		   */
    ...
    {0x0, 0x35, 7,  PM_APPS_HLOS_OWNER}, 		/* VADC4_LC_VBAT		  */
    {0x0, 0x34, 6,  PM_APPS_HLOS_OWNER}, 		/* VADC2_LC_BTM_2		   */
    {0x0, 0x32, 124,  PM_MSS_OWNER},		 /* VADC3_LC_MDM		  */
    {0x0, 0x31, 5,  PM_APPS_HLOS_OWNER}, 		/* VADC1_LC_USR 		 */
    {0x0, 0x2C, 63,  PM_RPM_OWNER}, 		/* MBG1 		 */
    {0x0, 0x28, 4,  PM_APPS_HLOS_OWNER}, 		/* COIN 		 */
    {0x0, 0x24, 3,  PM_APPS_HLOS_OWNER}, 		/* TEMP_ALARM		   */
    {0x0, 0x1C, 123,  PM_MSS_OWNER},		 /* BUA_EXT_CHARGER 		 */
    {0x0, 0x0A, 2,  PM_APPS_HLOS_OWNER}, 		/* VREFLPDDR		  */
    {0x0, 0x09, 1,  PM_RPM_OWNER}, 		/* MISC 		 */
    {0x0, 0x08, 0,  PM_APPS_HLOS_OWNER}, 		/* PON			*/
    {0x0, 0x06, 162,  PM_RPM_OWNER},		 /* SPMI   */
    {0x0, 0x05, 161,  PM_RPM_OWNER},		 /* INT    */
...
{
    {&pm_pbs_info_data_a}, {&pm_pbs_info_data_b},
};
