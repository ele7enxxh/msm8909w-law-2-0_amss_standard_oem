...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/systemdrivers/pmic/drivers/clk/src/pm_clk_driver.c#1 $
    ...
    if (clk_ptr == NULL)
    {
      ...
      /* This is kept for design consistency with other drivers. This is not really
        ...
        if (pm_get_pmic_model(pmic_index) == PMIC_IS_PMD9635)
        {
            ...
            clk_ptr->clk_perph_index[PM_CLK_BB_2] = PM_CLK_INVALID_DATA;
        }
