...
Copyright 2011, 2015 by Qualcomm Technologies, Inc.  All Rights Reserved.
=============================================================================*/
...
/*=============================================================================
  ...
  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/boot/secboot3/hw/msm8909/sbl1/sbl1_target.c#1 $
  ...
  {  
    ...
    */
    ...
    if (sbl_sahara_interface->sahara_shared_data->image_rx_complete == TRUE)
    {
      ...
      BL_VERIFY(( (bl_shared_data.sbl_shared_data != NULL) && (mmu_l1_pagetable != NULL)), 
                  BL_ERR_NULL_PTR_PASSED );
    
      result = boot_mmu_page_table_map_single_mem_block(mmu_l1_pagetable, &hostdl_mem_block); 
