...
09/24/14   sk      Modified initial memory and IMEM moved to sbl1_addtional_memory_map
08/12/14   sk      8909 SBL NAND changes
...
{ 
  ...
  /*RPM Code RAM, L2 Non-Cacheable, Non-Executable */  
