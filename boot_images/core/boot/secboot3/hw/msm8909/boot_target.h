...
Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/boot/secboot3/hw/msm8909/boot_target.h#1 $
  $DateTime: 2015/09/01 00:30:35 $ 
  $Author: pwbldsvc $

when       who          what, where, why
--------   --------     ----------------------------------------------------------
06/01/15   aus          Added DDR memory hole for 6Gb RAM dump support
02/12/15   sc           Changes to zero initialize usb related structures
08/05/14   sk           8909 SBL NAND changes
05/21/14   lm           Added common macro's for APCS_CPSS_CFG module
...
/* Macro's for APCS_CPSS_CFG module */
#define APCS_MODULE_SEC_START_ADDR_BMSK	HWIO_APCS_START_ADDR_SEC_ADDR
#define APCS_MODULE_SEC_OUT	HWIO_APCS_START_ADDR_SEC_OUT
#define APCS_MODULE_SEC_REMAP_EN_BMSK	HWIO_APCS_START_ADDR_SEC_REMAP_EN_BMSK

/* DDR hole should be 256MB * Number of channels(1) */
#define DDR_MEMORY_HOLE_SIZE 0x10000000
