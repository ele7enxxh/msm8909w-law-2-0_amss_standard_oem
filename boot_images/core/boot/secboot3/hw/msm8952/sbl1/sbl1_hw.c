...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/boot/secboot3/hw/msm8952/sbl1/sbl1_hw.c#1 $
...
=============================================================================*/
void sbl1_save_ddr_training_data(void)
{
...
{ 
 ...
 // boot_pm_rtc_get_time(0,&pmic_rtc_value); //Logu
