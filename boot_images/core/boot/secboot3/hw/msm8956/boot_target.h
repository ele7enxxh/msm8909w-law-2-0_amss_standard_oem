...
Notice that changes are listed in reverse chronological order.
  ...
  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/boot/secboot3/hw/msm8956/boot_target.h#1 $
  $DateTime: 2015/09/01 00:30:35 $ 
  $Author: pwbldsvc $

when       who          what, where, why
--------   --------     ---------------------------------------------------------- 
01/09/15   sc           Added common Macro's for APCS_ALIAS0_APSS_CFG module
...
/* Macro's for APCS_ALIAS0_APSS_CFG module */
#define APCS_MODULE_SEC_START_ADDR_BMSK	HWIO_APCS_ALIAS0_BOOT_START_ADDR_SEC_START_ADDR_BMSK
#define APCS_MODULE_SEC_OUT	HWIO_APCS_ALIAS0_BOOT_START_ADDR_SEC_OUT
#define APCS_MODULE_SEC_REMAP_EN_BMSK	HWIO_APCS_ALIAS0_BOOT_START_ADDR_SEC_REMAP_EN_BMSK
