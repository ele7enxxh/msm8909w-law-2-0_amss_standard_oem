...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/boot/secboot3/src/boot_extern_dal_interface.h#1 $
...
* 
*/
#ifdef FEATURE_BOOT_EXTERN_DAL_COMPLETED
...
#else
  static __inline DALResult boot_DALFW_MemDescInit
  (
    DALSYSMemHandle hMem, 
    DALSysMemDescList * pMemDescList,
    uint32 dwNumBufs
...
#else
  static __inline DALSysMemDescBuf * boot_DALFW_MemDescBufPtr(DALSysMemDescList * pMemDescList, uint32 idx)
  {
    return NULL;
  }
#endif
...
#else
  static __inline void boot_DALSYS_InitMod(DALSYSConfig * pCfg)
  {
  }
#endif
...
#else
  static __inline DALResult boot_DALSYS_MemRegionAlloc
            (
              uint32 dwAttribs, 
              DALSYSMemAddr VirtualAddr,
              DALSYSMemAddr PhysicalAddr, 
...
#else
  static __inline DALResult boot_DALSYS_MemInfo(DALSYSMemHandle hMem, DALSYSMemInfo *pMemInfo)
  {
    return DAL_ERROR;
  }
#endif
...
#else
  static __inline DALResult boot_DAL_DeviceAttach(DALDEVICEID DeviceId, DalDeviceHandle **phDevice)
  {
    return DAL_ERROR;
  }
#endif
...
#else
  static __inline DALResult boot_DAL_DeviceAttachEx(const char *pszArg, 
                                                  DALDEVICEID DeviceId,
                                                  DALInterfaceVersion ClientVersion,
                                                  DalDeviceHandle **phDevice)
  {
...
#else  
  static __inline DALResult boot_DalDevice_Close(DalDeviceHandle *hDevice)
  {
    return DAL_ERROR;
  }
#endif
...
#else
  static __inline DALResult boot_DAL_DeviceDetach(DalDeviceHandle *hDevice)
  {
    return DAL_ERROR;
  }
#endif
...
#else
  static __inline DALResult boot_DALSYS_Malloc(uint32 dwSize, void **ppMem)
  {
    return DAL_ERROR;
  }
#endif
...
#else
  static __inline DALResult boot_DALSYS_Free(void *pmem)
  {
    return DAL_ERROR;
  }
#endif
...
#else
  static __inline void boot_DALSYS_HeapInit(void *pHeapBase, uint32 dwHeapSz, uint32 dwInitType) 
  {
  }
#endif  
