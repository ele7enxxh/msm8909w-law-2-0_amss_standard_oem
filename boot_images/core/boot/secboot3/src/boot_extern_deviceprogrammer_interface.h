...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/boot/secboot3/src/boot_extern_deviceprogrammer_interface.h#1 $
 ...
 *
*****************************************************************************/
#ifdef FEATURE_BOOT_EXTERN_DEVICEPROGRAMMER_COMPLETED
  void boot_deviceprogrammer_ddr_main
  (
    bl_shared_data_type *bl_shared_data
  );
#else
  static inline void boot_deviceprogrammer_ddr_main
  (
    bl_shared_data_type *bl_shared_data
  )
  {
