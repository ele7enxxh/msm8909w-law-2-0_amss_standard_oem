...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/boot/secboot3/src/boot_pbl_v1.h#1 $
...
01/06/14   ck      Updated PBL force download mode values and schema to match Bear spec.
12/26/13   ck      Removed RPM specific items as it's not needed in Bear family.
12/26/13   ck      Updated boot_pbl_shared_data_type to match new PBL struct
12/26/13   ck      Initial use for Bear Family
...
09/10/12   kedara  Comment update for fastboot options. Nand & hsic boot
                   supported in mdm9x25.
04/17/12   dh      Update boot_pbl_shared_data_type
02/28/12   dh      Add boot_rpm_apps_shared_data_type
02/03/12   dh      Initialial revision
...
typedef enum
{
  ...
  BOOT_HSIC_OPTION,                     /* 4 */
  BOOT_NAND_OPTION,                     /* 5 */
  BOOT_SPI_ON_BLSP1_OPTION,             /* 6 */
  BOOT_SPI_ON_BLSP2_OPTION,             /* 7, not supported */
