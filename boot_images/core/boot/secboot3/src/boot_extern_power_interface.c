...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/boot/secboot3/src/boot_extern_power_interface.c#1 $
...
{
	rbcpr_set_cx_mx_to_safe_turbo_voltage();
}
