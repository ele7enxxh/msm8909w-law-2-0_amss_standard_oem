...
*****************************************************************************/
#ifdef FEATURE_BOOT_EXTERN_HOTPLUG_COMPLETED
...
#else
  static inline struct hotplug_device* boot_hotplug_open_device_by_gpt_partition_type
  (
    hotplug_dev_type dev_type,
    enum hotplug_iter_device_location dev_loc,
    struct hotplug_guid *guid_type
...
#else
  static inline struct hotplug_device* boot_hotplug_open_device_by_partition_type
  (
    hotplug_dev_type dev_type,
    enum hotplug_iter_device_location dev_loc,
    uint32 partition_type
...
#else
  static inline int boot_hotplug_close_device (struct hotplug_device *hdev)
  {
    return -1;
  }
#endif
...
#else
  static inline int boot_hotplug_dev_read
  (
    struct hotplug_device *hdev,
    uint32 lba,
    unsigned char *buf,
...
#else
  static inline int boot_hotplug_dev_write
  (
    struct hotplug_device *hdev,
    uint32 lba,
    unsigned char *buf,
...
#else
  static inline void boot_hotplug_init (void)
  {
  }
#endif
...
#else
  static inline void boot_sdcc_boot_set_device_info(sdcc_boot_device_info_type *device_info)
  {
  }
#endif
...
#else
  static inline int boot_hotplug_dev_get_size(struct hotplug_device *hdev,
                                uint32 *block_count,
                                uint16 *bytes_per_block)
  {
    return 0;
 ...
 */
  ...
  int boot_hotplug_poll_device (hotplug_dev_type dev_type,
          enum hotplug_iter_device_location dev_loc);
#else
  static inline int boot_hotplug_poll_device (hotplug_dev_type dev_type,
          enum hotplug_iter_device_location dev_loc)
  {
    return 0;
  }
 ...
 */
  ...
  int boot_hotplug_poll_and_mount_first_fat (hotplug_dev_type dev_type,
                     enum hotplug_iter_device_location dev_loc);
#else
  static inline int boot_hotplug_poll_and_mount_first_fat (hotplug_dev_type dev_type,
                     enum hotplug_iter_device_location dev_loc)
  {
    return 0;
  }
