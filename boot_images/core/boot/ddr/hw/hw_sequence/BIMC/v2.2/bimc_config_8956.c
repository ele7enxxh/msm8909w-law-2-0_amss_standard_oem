...
----------   --------     -------------------------------------------------------------
02/13/2015  sc          Updated BIMC registers for RUMI emu PHY
11/23/2014  nevedeth    matches BIMC SWC version v0.2
================================================================================
...
uint32 LPDDR3_bimc_global0_config[][2] = { 
  ...
  #else
  {HWIO_BIMC_MISC_GLOBAL_CSR_DDR_CHN_DDRCC_CLK_EXTEND_ADDR(0,0), 0x00000006},
  {HWIO_BIMC_MISC_GLOBAL_CSR_DDR_CHN_DDRCC_CLK_EXTEND_ADDR(0,1), 0x00000006},
  {HWIO_BIMC_MISC_GLOBAL_CSR_DDR_CHN_CAPHY_CLK_EXTEND_ADDR(0,0), 0x00000006},
  {HWIO_BIMC_MISC_GLOBAL_CSR_DDR_CHN_CAPHY_CLK_EXTEND_ADDR(0,1), 0x00000006},
  {HWIO_BIMC_MISC_GLOBAL_CSR_DDR_CHN_DQPHY_CLK_EXTEND_ADDR(0,0), 0x00000006},
  {HWIO_BIMC_MISC_GLOBAL_CSR_DDR_CHN_DQPHY_CLK_EXTEND_ADDR(0,1), 0x00000006},
  #endif
  ...
  {HWIO_BIMC_MISC_GLOBAL_CSR_DDR_CHN_PIPESTAGES_TIMER_ADDR(0,0), 0x0000000A},  
  {HWIO_BIMC_MISC_GLOBAL_CSR_DDR_CHN_PIPESTAGES_TIMER_ADDR(0,1), 0x0000000A},  
  ...
  #else
  {HWIO_BIMC_MISC_GLOBAL_CSR_DDR_CHN_HFSPC_CFG_ADDR(0,0), 0x80000005},
  {HWIO_BIMC_MISC_GLOBAL_CSR_DDR_CHN_HFSPC_CFG_ADDR(0,1), 0x80000005},
  #endif
...
uint32 LPDDR3_bimc_dpe_config[][2] = { 
  ...
  {HWIO_ABHN_DPE_CONFIG_3_ADDR(0), 0x000F0012}, 
  {HWIO_ABHN_DPE_CONFIG_4_ADDR(0), 0x00000000},
  ...
  #ifdef FEATURE_RUMI_BOOT
  {HWIO_ABHN_DPE_DRAM_TIMING_15_ADDR(0), 0x0000D096},
  #else
