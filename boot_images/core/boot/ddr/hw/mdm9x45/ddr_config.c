...
uint32 ddr_bimc_config[][2] =
{
  ...
  {HWIO_ADDR(DDR_ADDR(DPE_DRAM_TIMING_16)), 0x00020704},
  ...
  {HWIO_ADDR(DDR_ADDR(SCMO_CMD_BUF_CFG)), 0x00000003},
  ...
  {HWIO_ADDR(DDR_ADDR(SCMO_FLUSH_CFG)), 0x00320F08},
  {HWIO_ADDR(DDR_ADDR(SCMO_FLUSH_CMD)), 0x00000000},
  {HWIO_ADDR(DDR_ADDR(SCMO_GLOBAL_MON_CFG)), 0x00000000},
...
uint32 ddr_phy_config[][2] =
{
  {0x0, 0x0}
};

uint32 ddr_caphy_config[][2] =
{
  {HWIO_ADDR(PHY_CA_ADDR(CA_IOC_SLV_CFG)), 0x80000000},
  {HWIO_ADDR(PHY_CA_ADDR(CDC_CAL_TIMER_CFG0)), 0x1211000},
  {HWIO_ADDR(PHY_CA_ADDR(CDC_CAL_TIMER_CFG1)), 0x0004},
  {HWIO_ADDR(PHY_CA_ADDR(CDC_COARSE_CAL_CFG)), 0x00000D09},
  {HWIO_ADDR(PHY_CA_ADDR(CDC_CTLR_CFG0)), 0x11A0085},
  {HWIO_ADDR(PHY_CA_ADDR(CDC_CTLR_CFG1)), 0x3F11111},
  {HWIO_ADDR(PHY_CA_ADDR(CDC_DELAY_CFG)), 0x000026B},
  ...
  {HWIO_ADDR(PHY_CA_ADDR(PAD_CFG0)), 0x20222230},
  {HWIO_ADDR(PHY_CA_ADDR(PAD_CFG1)), 0x20220030},
...
uint32 ddr_dqphy_config[][2] =
{
  {HWIO_ADDR(PHY_DQ_ADDR(CDC_CAL_TIMER_CFG0)), 0x1211000},
  {HWIO_ADDR(PHY_DQ_ADDR(CDC_CAL_TIMER_CFG1)), 0x0004},
  {HWIO_ADDR(PHY_DQ_ADDR(CDC_COARSE_CAL_CFG)), 0x00000D09},
  {HWIO_ADDR(PHY_DQ_ADDR(CDC_CTLR_CFG0)), 0x11A0085},
...
uint32 (*ddr_bimc_config_base)[2] = ddr_bimc_config;
uint32 (*ddr_phy_config_base)[2] = ddr_phy_config;
uint32 (*ddr_caphy_config_base)[2] = ddr_caphy_config;
uint32 (*ddr_dqphy_config_base)[2] = ddr_dqphy_config;
