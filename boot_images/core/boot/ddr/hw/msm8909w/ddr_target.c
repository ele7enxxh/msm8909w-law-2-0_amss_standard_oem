...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/boot/ddr/hw/msm8909w/ddr_target.c#2 $
$DateTime: 2015/10/01 02:43:38 $
$Author: pwbldsvc $
================================================================================
when       who     what, where, why
--------   ---     -------------------------------------------------------------
09/28/15   aus     Updated to new clock plan with initialization frequency of 384MHz
