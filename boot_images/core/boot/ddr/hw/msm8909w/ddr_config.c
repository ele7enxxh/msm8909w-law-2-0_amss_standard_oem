...
uint32 ddr_bimc_config_MSM8x09_LPDDR2[][2] =
{
  ...
  {HWIO_ADDR(DDR_ADDR(DPE_DRAM_TIMING_10)), 0x25782578},
  ...
  {HWIO_ADDR(DDR_ADDR(DPE_DRAM_TIMING_16)), 0x00020603},
  ...
  {HWIO_ADDR(DDR_ADDR(DPE_DRAM_TIMING_3)), 0x05140258},
...
uint32 ddr_caphy_config_MSM8x09_LPDDR2[][2] =
{
  ...
  {HWIO_ADDR(PHY_CA_ADDR(CDC_DELAY_CFG)), 0x0000190},
...
uint32 ddr_dqphy_config_MSM8x09_LPDDR2[][2] =
{
  ...
  {HWIO_ADDR(PHY_DQ_ADDR(RD_CDC_DELAY_CFG)), 0x000028B},
  ...
  {HWIO_ADDR(PHY_DQ_ADDR(WR_CDC_DELAY_CFG)), 0x0000190},
...
uint32 ddr_bimc_config_MSM8x09_LPDDR3[][2] =
{
  ...
  {HWIO_ADDR(DDR_ADDR(DPE_DRAM_TIMING_16)), 0x00040603},
...
{
  {HWIO_ADDR(PHY_CA_ADDR(PAD_CFG0)), 0x20332250},
  {0x0, 0x0}
};
