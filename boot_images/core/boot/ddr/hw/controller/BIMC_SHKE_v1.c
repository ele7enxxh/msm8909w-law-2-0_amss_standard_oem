...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/boot/ddr/hw/controller/BIMC_SHKE_v1.c#1 $
...
void HAL_SDRAM_SHKE_Init(uint32 base, SDRAM_INTERFACE interface)
{
  ...
  */
  ...
  /*
    ...
    is selected.
  */
  tREFI = ddr_divide_func((ddr_divide_func(ddr_params->tREFI,1000) * XO_SPEED_IN_KHZ), 10000) - 1;
