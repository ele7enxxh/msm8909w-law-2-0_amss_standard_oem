...
===========================================================================
  ...
  $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/boot/ddr/hw/msm8952/ddr_target.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
11/28/14   aus     Added defines for integration with SNS driver
10/07/14   rj      Updated DDR base address to support 3GB space
...
/* DDR base address */
#define DDR_BASE_1 0x80000000
#define DDR_BASE_2 0x40000000
...
// Define the ddr base
#define EBI1_BIMC_BASE 0x400000
#define EBI1_PHY_CFG_BASE 0x480000

// Define the rpm ddr base
#define RPM_BIMC_BASE_OFFSET 0x60000000
...
#define DDR_TRAINING_TEST_ADDRESS_CS0 0x80000000
...
//CHANGES FOR v1.4.1
#define ENABLE_LPDDR2 FALSE
#define ENABLE_LPDDR3 TRUE
#define ENABLE_PCDDR3 FALSE

#define RPM_BASE_ADDR 0x00200000
