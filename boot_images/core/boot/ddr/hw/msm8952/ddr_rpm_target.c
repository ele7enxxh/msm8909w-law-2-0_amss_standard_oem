...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/boot/ddr/hw/msm8952/ddr_rpm_target.c#1 $
$DateTime: 2015/09/01 00:30:35 $
$Author: pwbldsvc $
================================================================================
when       who     what, where, why
--------   ---     -------------------------------------------------------------
11/06/14   sk      Added BRIC register settings in SDI
...
{
 //d.set HWIO_BIMC_BRIC_SEGMENT0_ADDR_BASE_A_LOWER_ADDR  %LONG  0xA0000000
HWIO_OUTXI(0x00402000, BRIC_GLOBAL2_BRIC_SEGMENTN_ADDR_BASE_A_LOWER,0,0x80000000);//d.set HWIO_BIMC_BRIC_SEGMENT0_ADDR_MASK_A_LOWER_ADDR  %LONG  0xF0000000
HWIO_OUTXI(0x00402000, BRIC_GLOBAL2_BRIC_SEGMENTN_ADDR_MASK_A_LOWER,0,0x80000000);//d.set HWIO_BIMC_BRIC_SEGMENT0_ADDR_BASE_A_LOWER_ADDR %LONG   0xA0000001
HWIO_OUTXI(0x00402000, BRIC_GLOBAL2_BRIC_SEGMENTN_ADDR_MASK_A_LOWER,3,0xC0000000);//d.set HWIO_BIMC_BRIC_SEGMENT0_ADDR_MASK_A_LOWER_ADDR  %LONG  0xC0000000
HWIO_OUTXI(0x00402000, BRIC_GLOBAL2_BRIC_SEGMENTN_ADDR_BASE_A_LOWER,0,0x80000001);

HWIO_OUTXI(0x00402000, BRIC_GLOBAL2_BRIC_SEGMENTN_ADDR_BASE_B_LOWER,0,0x40000000);//d.set HWIO_BIMC_BRIC_SEGMENT0_ADDR_MASK_A_LOWER_ADDR  %LONG  0x40000000
HWIO_OUTXI(0x00402000, BRIC_GLOBAL2_BRIC_SEGMENTN_ADDR_MASK_B_LOWER,0,0xC0000000);//d.set HWIO_BIMC_BRIC_SEGMENT0_ADDR_BASE_A_LOWER_ADDR %LONG   0xC0000001
HWIO_OUTXI(0x00402000, BRIC_GLOBAL2_BRIC_SEGMENTN_ADDR_BASE_B_LOWER,0,0x40000001);
}
