...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/boot/ddr/common/params/v2/ddr_params.h#1 $
$DateTime: 2015/09/01 00:30:35 $
$Author: pwbldsvc $
================================================================================
when       who     what, where, why
--------   ---     -------------------------------------------------------------
11/10/14   sk      Added ddr_set_training_checksum and ddr_get_training_checksum functions 
