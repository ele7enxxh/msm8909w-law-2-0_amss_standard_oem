...
$Header: //components/rel/boot.bf/3.1.2.c3/boot_images/core/boot/ddr/common/params/v1/ddr_params.c#1 $
...
*   None
*/
void ddr_restore_param_wdog_reset()
{
  ...
  ddr_device_params_ch0 = device_table;
