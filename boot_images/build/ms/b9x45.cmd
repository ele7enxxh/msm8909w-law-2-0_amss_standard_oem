...
rem
rem Copyright 2014 by QUALCOMM Technologies, Incorporated.
rem All Rights Reserved.
rem
rem --------------------------------------------------------------------------
rem
rem $Header: //components/rel/boot.bf/3.1.2.c3/boot_images/build/ms/b9x45.cmd#1 $
...
rem --------   ---     ---------------------------------------------------------
rem 02/24/14   jz        Initial version (ported from 9x35)
rem 
rem ==========================================================================
...
:CONTINUE
SET BUILD_CMD=BUILD_ID=%BUILD_ID% BUILD_VER=%BUILD_VER% MSM_ID=%MSM_ID% HAL_PLATFORM=%HAL_PLATFORM% TARGET_FAMILY=%TARGET_FAMILY% BUILD_ASIC=%BUILD_ASIC% CHIPSET=%CHIPSET% --tcfgf=9x45.target.builds %*
...
:ERROR
@echo "Fail to compile 9x45. Exiting...."
@EXIT /B %ERRORLEVEL% 
