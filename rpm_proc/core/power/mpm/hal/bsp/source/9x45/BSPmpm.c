...
DESCRIPTION:
  ...
  MPM hardware block.
  This platform is for the RPM on the 9x45.

===========================================================================

                             Edit History

$Header: //components/rel/rpm.bf/2.1.1/core/power/mpm/hal/bsp/source/9x45/BSPmpm.c#1 $
...
static const uint32_t cxoDelay = 0x8;
