...
$Header: //components/rel/rpm.bf/2.1.1/core/power/mpm/hal/source/8916/HALmpmVDDCommands.c#1 $
                                ...
                                uint32_t offCxMicrovolts, uint32_t onCxMicrovolts)
{
  ...
  regVal  |= 0x1441          << HWIO_SHFT(MPM2_MPM_PMIC_VDD_OFF_CFG_1, SLAVE_ADDR);
  ...
  regVal   |= 0x1441          << HWIO_SHFT(MPM2_MPM_PMIC_VDD_ON_CFG_4, SLAVE_ADDR);
