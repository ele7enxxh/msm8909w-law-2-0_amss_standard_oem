...
/**
   ...
   @brief This file provides interface for generic Event Notification API.
...
/*============================================================================
  ...
  $Header: //components/rel/rpm.bf/2.1.1/core/power/utils/inc/CoreEventNotification.h#1 $
