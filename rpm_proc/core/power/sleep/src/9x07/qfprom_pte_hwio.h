#ifndef __QF_PROM_H__
#define __QF_PROM_H__
/*
===========================================================================
*/
/**
  ...
  Reference chip release:
    MDM9x07 (Lykan) [lykan_v1.0_p3q3r162]
...
/*
  ...
  $Header: //components/rel/rpm.bf/2.1.1/core/power/sleep/src/9x07/qfprom_pte_hwio.h#1 $
