...
=============================================================================*/
/*=============================================================================
  Copyright 2009-2012, 2015 Qualcomm Technologies Incorporated.
  All rights reserved.
...
$Header: //components/rel/rpm.bf/2.1.1/core/api/boot/ddr_drivers.h#2 $ 
...
/*!
*   @brief
*   Does vddmx switch before going to sleep
*   
*   @details
*
*   
...
/*!
*   @brief
*   Does vddmx switch after coming out of sleep
*   
*   @details
*
*   
