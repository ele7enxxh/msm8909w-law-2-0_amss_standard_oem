...
============================================================================*/
/* $Header: //components/rel/rpm.bf/2.1.1/core/api/power/npa_resource.h#2 $ */
...
/* Resource state is the bitwise update of concurrent requests */
extern const npa_resource_plugin npa_bitwise_update_plugin;
