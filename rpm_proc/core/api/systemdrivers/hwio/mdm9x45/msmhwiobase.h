...
/*
  ...
  $Header: //components/rel/rpm.bf/2.1.1/core/api/systemdrivers/hwio/mdm9x45/msmhwiobase.h#1 $
...
#define RPM_BASE                                                    0x00080000
#define RPM_BASE_SIZE                                               0x00089000
#define RPM_BASE_PHYS                                               0x00080000
...
#define SECURITY_CONTROL_BASE_PHYS                                  0x60058000
...
#define SYSTEM_NOC_BASE_SIZE                                        0x00014000
...
#define QDSS_APB_DEC_QDSS_APB_BASE                                  0x60800000
#define QDSS_APB_DEC_QDSS_APB_BASE_SIZE                             0x00030000
#define QDSS_APB_DEC_QDSS_APB_BASE_PHYS                             0x60800000

/*----------------------------------------------------------------------------
 * BASE: QDSS_AHB_DEC_QDSS_AHB
 *--------------------------------------------------------------------------*/

#define QDSS_AHB_DEC_QDSS_AHB_BASE                                  0x60870000
#define QDSS_AHB_DEC_QDSS_AHB_BASE_SIZE                             0x00030000
#define QDSS_AHB_DEC_QDSS_AHB_BASE_PHYS                             0x60870000
