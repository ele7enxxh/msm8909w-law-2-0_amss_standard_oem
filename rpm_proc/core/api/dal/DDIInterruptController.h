...
// the RPM has very tight size constraints, and a rather fancy processor that
// makes interrupts easier and nifty.  therefore, we actually provide a
// specialty implementation of this function instead of pulling the entire
