...
$Header: //components/rel/rpm.bf/2.1.1/core/systemdrivers/pmic/target/msm8952_pm8950/src/pm_mpm_target.h#1 $
...
typedef enum 
{
  ...
  PM_MPM_SLEEP_CMD_PBS_TRIG_PMIC_A,
  PM_MPM_SLEEP_CMD_PBS_TRIG_PMIC_B,
...
typedef enum 
{
  PM_MPM_ACTIVE_CMD_PBS_TRIG_PMIC_B,
  PM_MPM_ACTIVE_CMD_PBS_TRIG_PMIC_A,
  PM_MPM_ACTIVE_CMD_MX_PARENT_VOLT,
  PM_MPM_ACTIVE_CMD_MX_VOLT,
  PM_MPM_ACTIVE_CMD_CX_VOLT,
  PM_MPM_ACTIVE_CMD_S4_VOLT,
