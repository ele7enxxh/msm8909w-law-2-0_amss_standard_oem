...
$Header: //components/rel/rpm.bf/2.1.1/core/systemdrivers/pmic/config/msm8909/pm8909/pm_config_npa_dep.c#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
06/02/14   akt     Added PM8909/MSM8909 specific changes.
...
ldo_a[] =
{
   ...
   {RPM_LDO_A_REQ, 14},
   {RPM_LDO_A_REQ, 15},
   {RPM_LDO_A_REQ, 16}, // This LDO is removed in 8909
   {RPM_LDO_A_REQ, 17},
   {RPM_LDO_A_REQ, 18},
   {RPM_LDO_A_REQ, 19},
   {RPM_LDO_A_REQ, 20},
