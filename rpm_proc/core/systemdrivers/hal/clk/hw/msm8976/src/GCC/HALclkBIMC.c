...
$Header: //components/rel/rpm.bf/2.1.1/core/systemdrivers/hal/clk/hw/msm8976/src/GCC/HALclkBIMC.c#1 $
...
/* ===========================================================================
**  HAL_clk_BIMCSetMiscInfo
**
** ======================================================================== */

void HAL_clk_BIMCSetMiscInfo( uint32 nValue )
{
  HWIO_OUT(GCC_BIMC_MISC, nValue);
}
...
)
{
  ...
  /* now configure the GPU Mux RCGR to  the BIMC frequency */
