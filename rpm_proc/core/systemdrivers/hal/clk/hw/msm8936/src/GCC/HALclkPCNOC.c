...
$Header: //components/rel/rpm.bf/2.1.1/core/systemdrivers/hal/clk/hw/msm8936/src/GCC/HALclkPCNOC.c#1 $
...
static HAL_clk_ClockDescType HAL_clk_mPCNOCBFDCDClkDomainClks[] =
{
  ...
  },
  {
    ...
    /* .mRegisters       = */ { HWIO_OFFS(GCC_ULTAUDIO_PCNOC_MPORT_CBCR), HWIO_OFFS(GCC_AUDIO_CORE_BCR), {0, 0} },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ HAL_CLK_GCC_TEST_GCC_ULTAUDIO_PCNOC_MPORT_CLK
  },
  {
    /* .szClockName      = */ "gcc_ultaudio_pcnoc_sway_clk",
    /* .mRegisters       = */ { HWIO_OFFS(GCC_ULTAUDIO_PCNOC_SWAY_CBCR), HWIO_OFFS(GCC_AUDIO_CORE_BCR), {0, 0} },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
