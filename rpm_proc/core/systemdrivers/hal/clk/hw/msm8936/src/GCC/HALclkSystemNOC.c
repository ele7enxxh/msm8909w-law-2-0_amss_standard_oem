...
$Header: //components/rel/rpm.bf/2.1.1/core/systemdrivers/hal/clk/hw/msm8936/src/GCC/HALclkSystemNOC.c#1 $
...
static HAL_clk_ClockDescType HAL_clk_mSYSMMNOCBFDCDClkDomainClks[] =
{
  ...
  {
    /* .szClockName      = */ "gcc_mdp_rt_tbu_clk",
    /* .mRegisters       = */ { HWIO_OFFS(GCC_MDP_RT_TBU_CBCR), HWIO_OFFS(GCC_SMMU_BCR), HAL_CLK_FMSK(PROC_SMMU_CLK_BRANCH_ENA_VOTE, MDP_RT_TBU_CLK_ENA) },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ HAL_CLK_GCC_TEST_GCC_MDP_RT_TBU_CLK
  },
  {
