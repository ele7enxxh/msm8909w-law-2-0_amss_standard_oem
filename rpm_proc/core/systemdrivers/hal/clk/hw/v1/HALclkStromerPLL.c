...
$Header: //components/rel/rpm.bf/2.1.1/core/systemdrivers/hal/clk/hw/v1/HALclkStromerPLL.c#1 $
 ...
 *
 * Control function array for the Stromer PLLs.
 */
...
void HAL_clk_StromerPLLEnableVote
(
...
void HAL_clk_StromerPLLDisableVote
(
  HAL_clk_SourceDescType *pSource
)
{
...
boolean HAL_clk_StromerPLLIsVoteEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
void HAL_clk_StromerPLLDisable
(
  HAL_clk_SourceDescType *pSource
)
{
...
boolean HAL_clk_StromerPLLIsEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
void HAL_clk_StromerPLLConfigPLL
(
  HAL_clk_SourceDescType      *pSource,
...
)
{
  ...
  if (bPLLEnabled)
  {
    HAL_clk_StromerPLLDisable(pSource);
  }
  ...
  {
    HAL_clk_StromerPLLEnable(pSource);
  }
