...
$Header: //components/rel/rpm.bf/2.1.1/core/systemdrivers/hal/clk/hw/msm8916/src/GCC/HALclkPCNOC.c#1 $
...
static HAL_clk_ClockDescType HAL_clk_mPCNOCBFDCDClkDomainClks[] =
{
  ...
  {
    /* .szClockName      = */ "gcc_camss_top_ahb_clk",
    /* .mRegisters       = */ { HWIO_OFFS(GCC_CAMSS_TOP_AHB_CBCR), HWIO_OFFS(GCC_CAMSS_TOP_BCR), {0, 0} },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ HAL_CLK_GCC_TEST_GCC_CAMSS_TOP_AHB_CLK
  },
  {
