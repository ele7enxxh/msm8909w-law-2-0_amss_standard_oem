...
$Header: //components/rel/rpm.bf/2.1.1/core/systemdrivers/hal/clk/hw/msm8909/src/HALclkMainRPM.c#2 $
...
void HAL_clk_PlatformInitSources (void)
{
  ...
  HAL_clk_InstallPLL(
    HAL_CLK_SOURCE_BIMCPLL, &HAL_clk_aPLLContextGPLL[2], CLK_CTL_BASE);
