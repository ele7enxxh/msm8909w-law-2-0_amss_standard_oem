#===========================================================================
#
#  @file hwio_msm8909.py
#  @brief HWIO config file for the HWIO generation scripts for MSM8909.
#
#  This file can be invoked by calling:
#
#    HWIOGen.py --cfg=hwio_msm8909.py --flat=..\..\..\api\systemdrivers\hwio\msm8909\RPM_ADDRESS_FILE.FLAT
#
#  ===========================================================================
#
...
#  ===========================================================================
#
#  $Header: //components/rel/rpm.bf/2.1.1/core/systemdrivers/hwio/build/hwio_mdm9x07.py#2 $
#  $DateTime: 2015/09/29 23:32:04 $
#  $Author: pwbldsvc $
#
#  ===========================================================================
