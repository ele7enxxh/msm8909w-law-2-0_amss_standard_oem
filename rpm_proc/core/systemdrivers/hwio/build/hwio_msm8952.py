#===========================================================================
#
#  @file hwio_msm8952.py
#  @brief HWIO config file for the HWIO generation scripts for MSM8952.
#
#  This file can be invoked by calling:
#
#    HWIOGen.py --cfg=hwio_msm8952.py --flat=..\..\..\api\systemdrivers\hwio\msm8952\ARM_ADDRESS_FILE.FLAT
#
#  ===========================================================================
#
...
#  ===========================================================================
#
#  $Header: //components/rel/rpm.bf/2.1.1/core/systemdrivers/hwio/build/hwio_msm8952.py#1 $
...
base_resize = {
  ...
  'PRNG_PRNG':                       0x1000,
  'PMIC_ARB':                     0x1906000,
  'QDSS_APB_DEC_QDSS_APB':          0x27000,
  'QDSS_AHB_DEC_QDSS_AHB':          0x29000,
  'CLK_CTL':                        0x82000,
