CLOCK_TEST_DICT = {
  ...
  0x200a8: 'gcc_camss_top_ahb_clk',
  0x200a9: 'gcc_camss_ahb_clk',
  ...
  0x200b2: 'gcc_mdss_mdp_vbif_clk',
  0x200b3: 'gcc_mdss_mdp_dsi_clk',
  0x200b4: 'gcc_mdss_mdp_ahb_clk',
  0x200b8: 'gcc_camss_vfe0_clk',
  0x200ba: 'gcc_camss_vfe_vbif_ahb_clk',
  ...
  0x200e3: 'gcc_camss_vfe0_vbif_clk',
  0x200ee: 'gcc_venus0_core0_vcodec0_clk',
