...
/*
  ...
  ====================================================================
  $Header: //components/rel/rpm.bf/2.1.1/core/systemdrivers/clock/hw/msm8952/ClockRPMNPA.c#1 $
...
)
{
  ...
  static ClockResourceType* clock_res[NUM_CLOCK_RESOURCE] =
  {
    ...
    &Clock_Resources.IPAClockResource
  };
...
)
{
  ...
  if ( nState == 0 )
  {
    if ( bEnabled )
    {
      ...
      Clock_DisableClock( (ClockIdType)Clock_Resources.pIPA2XClk );
      Clock_DisableClock( (ClockIdType)Clock_Resources.pIPATBUClk );
  ...
  else
  {
    if ( !bEnabled )
    {
      ...
      Clock_EnableClock( (ClockIdType)Clock_Resources.pIPA2XClk );
      Clock_EnableClock( (ClockIdType)Clock_Resources.pIPATBUClk );
