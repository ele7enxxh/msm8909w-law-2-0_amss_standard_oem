...
$Header: //components/rel/rpm.bf/2.1.1/core/systemdrivers/clock/config/msm8909W/ClockBSP.c#3 $
...
const ClockMuxConfigType BIMCClockConfig[] =
{
  ...
  {  48000000, { HAL_CLK_SOURCE_BIMCPLL, 16, 1,  1, 1 }, CLOCK_VREG_LEVEL_LOW },
  {  96000000, { HAL_CLK_SOURCE_BIMCPLL,  8, 1,  1, 1 }, CLOCK_VREG_LEVEL_LOW },
  { 192000000, { HAL_CLK_SOURCE_BIMCPLL,  4, 1,  1, 1 }, CLOCK_VREG_LEVEL_LOW },
  { 384000000, { HAL_CLK_SOURCE_BIMCPLL,  2, 1,  1, 1 }, CLOCK_VREG_LEVEL_NOMINAL },
  { 0 }
};
