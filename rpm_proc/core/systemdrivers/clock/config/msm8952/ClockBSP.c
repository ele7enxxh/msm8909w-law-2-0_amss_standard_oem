...
$Header: //components/rel/rpm.bf/2.1.1/core/systemdrivers/clock/config/msm8952/ClockBSP.c#1 $
...
const ClockMuxConfigType RPMClockConfig[] =
{
  ...
  { 177780000, { HAL_CLK_SOURCE_GPLL0,  9, 0, 0, 0 }, CLOCK_VREG_LEVEL_LOW },
...
//  { 308570000, { HAL_CLK_SOURCE_GPLL6, 7, 0, 0, 0 }, CLOCK_VREG_LEVEL_HIGH },
  { 0 }
};
...
static ClockSourceConfigType BIMCPLLConfig[] =
{
  ...
  ** ============================================================================================================*/
  ...
  { HAL_CLK_SOURCE_RAW1, { HAL_CLK_SOURCE_XO, HAL_CLK_PLL_VCO1, 1, 2, 73,  0,  1 }, CLOCK_CONFIG_PLL_FSM_MODE_ENABLE,  700800000}, /* Index =  2 */
  { HAL_CLK_SOURCE_RAW1, { HAL_CLK_SOURCE_XO, HAL_CLK_PLL_VCO1, 1, 2, 97,  0,  1 }, CLOCK_CONFIG_PLL_FSM_MODE_ENABLE,  931200000}, /* Index =  3 */
};
...
ClockMuxConfigType BIMCClockConfig[] =
{
  ...
  { 175200000, { HAL_CLK_SOURCE_GPLL5,  8, 1,  0, 0 }, CLOCK_VREG_LEVEL_LOW,     0, CHIPINFO_FAMILY_UNKNOWN, &BIMCPLLConfig[2]},
  { 201600000, { HAL_CLK_SOURCE_RAW1,   4, 1, 0, 0 }, CLOCK_VREG_LEVEL_NOMINAL, 0, CHIPINFO_FAMILY_UNKNOWN, &BIMCPLLConfig[0]},
  { 259200000, { HAL_CLK_SOURCE_RAW1,   4, 1, 0, 0 }, CLOCK_VREG_LEVEL_NOMINAL, 0, CHIPINFO_FAMILY_UNKNOWN, &BIMCPLLConfig[1]},
  { 350400000, { HAL_CLK_SOURCE_RAW1,   4, 0, 16, 0 }, CLOCK_VREG_LEVEL_NOMINAL, 0, CHIPINFO_FAMILY_UNKNOWN, &BIMCPLLConfig[2]},
  { 465600000, { HAL_CLK_SOURCE_GPLL5,  4, 0, 20, 0 }, CLOCK_VREG_LEVEL_HIGH,    0, CHIPINFO_FAMILY_UNKNOWN, &BIMCPLLConfig[3]},
  { 0 }
};
...
{
  {  19200000, { HAL_CLK_SOURCE_XO,     1, 0, 0, 0 }, CLOCK_VREG_LEVEL_LOW },
  { 154290000, { HAL_CLK_SOURCE_GPLL6,  14, 0, 0, 0 }, CLOCK_VREG_LEVEL_LOW },
  { 308570000, { HAL_CLK_SOURCE_GPLL6,  7, 0, 0, 0 }, CLOCK_VREG_LEVEL_NOMINAL },
  { 0 }
};
...
const ClockMuxConfigType QDSSTSCTRDiv2ClockConfig[] =
{
  {  19200000, { HAL_CLK_SOURCE_XO,    1, 0, 0, 0 }, CLOCK_VREG_LEVEL_LOW },
  { 154290000, { HAL_CLK_SOURCE_GPLL6, 14, 0, 0, 0 }, CLOCK_VREG_LEVEL_LOW },
  { 288000000, { HAL_CLK_SOURCE_GPLL4,  8, 0, 0, 0 }, CLOCK_VREG_LEVEL_NOMINAL },
  { 0 }
};
