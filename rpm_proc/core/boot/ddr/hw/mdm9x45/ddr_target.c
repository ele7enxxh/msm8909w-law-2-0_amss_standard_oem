...
$Header: //components/rel/rpm.bf/2.1.1/core/boot/ddr/hw/mdm9x45/ddr_target.c#1 $
$DateTime: 2015/02/25 02:53:43 $
$Author: pwbldsvc $
================================================================================
when       who     what, where, why
--------   ---     -------------------------------------------------------------
12/04/14   tw      port bimc pc parallization fix
...
{
  0x26B,  /* RAILWAY_NO_REQUEST */
  0x26B,  /* RAILWAY_RETENTION */
  0x26B,  /* RAILWAY_SVS_KRAIT */
  0x26B,  /* RAILWAY_SVS_SOC */
  0x26B,  /* RAILWAY_NOMINAL */
  0x1E2,  /* RAILWAY_TURBO */
  0x1E2,  /* RAILWAY_TURBO_HIGH */
  0x1E2,  /* RAILWAY_SUPER_TURBO */
  0x1E2,  /* RAILWAY_SUPER_TURBO_NO_CPR */
};
...
void ddr_exit_power_collapse(uint32 clk_speed)
{
  ...
  /* Update CDC configuration according to voltage */
  ddr_func_tbl->phy_update_cdc_config(DDR_BASE, SDRAM_INTERFACE_0, ddr_phy_config_vddmx[ddr_status.vddmx_voltage]);
