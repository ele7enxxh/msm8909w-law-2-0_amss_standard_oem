...
$Header: //components/rel/rpm.bf/2.1.1/core/boot/ddr/hw/msm8909w/ddr_target.c#2 $
$DateTime: 2015/10/01 01:07:22 $
$Author: pwbldsvc $
================================================================================
...
{
  0x28B,  /* RAILWAY_NO_REQUEST */
  0x28B,  /* RAILWAY_RETENTION */
  0x28B,  /* RAILWAY_SVS_KRAIT */
  0x28B,  /* RAILWAY_SVS_SOC */
  0x28B,  /* RAILWAY_SVS_HIGH */
  0x28B,  /* RAILWAY_NOMINAL */
  0x28B,  /* RAILWAY_TURBO */
  0x28B,  /* RAILWAY_TURBO_HIGH */
  0x28B,  /* RAILWAY_SUPER_TURBO */
  0x28B,  /* RAILWAY_SUPER_TURBO_NO_CPR */
};
...
void ddr_pre_vddmx_switch(const railway_settings *proposal, void * callback_cookie)
{
      ...
      ddr_status.sdram0_cs1 == DDR_ACTIVE)
  {
    if (proposal->microvolts < ddr_status.vddmx_voltage)
    {
      ...
      ddr_func_tbl->phy_update_cdc_delay(DDR_BASE, SDRAM_INTERFACE_0, FALSE, ddr_phy_config_vddmx[proposal->mode], proposal->microvolts);
